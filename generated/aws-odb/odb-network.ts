...
export interface CcOdbNetworkProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#availability_zone CcOdbNetwork#availability_zone}
    */
    readonly availabilityZone?: string;
    /**
    * The AZ ID of the AZ where the ODB network is located.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#availability_zone_id CcOdbNetwork#availability_zone_id}
    */
    readonly availabilityZoneId?: string;
    /**
    * The CIDR range of the backup subnet in the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#backup_subnet_cidr CcOdbNetwork#backup_subnet_cidr}
    */
    readonly backupSubnetCidr?: string;
    /**
    * The CIDR range of the client subnet in the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#client_subnet_cidr CcOdbNetwork#client_subnet_cidr}
    */
    readonly clientSubnetCidr?: string;
    /**
    * The cross-Region Amazon S3 restore sources for the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#cross_region_s3_restore_sources CcOdbNetwork#cross_region_s3_restore_sources}
    */
    readonly crossRegionS3RestoreSources?: string[];
    /**
    * The domain name to use for the resources in the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#custom_domain_name CcOdbNetwork#custom_domain_name}
    */
    readonly customDomainName?: string;
    /**
    * The DNS prefix to the default DNS domain name. The default DNS domain name is oraclevcn.com.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#default_dns_prefix CcOdbNetwork#default_dns_prefix}
    */
    readonly defaultDnsPrefix?: string;
    /**
    * Specifies whether to delete associated OCI networking resources along with the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#delete_associated_resources CcOdbNetwork#delete_associated_resources}
    */
    readonly deleteAssociatedResources?: boolean | cdktn.IResolvable;
    /**
    * The user-friendly name of the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#display_name CcOdbNetwork#display_name}
    */
    readonly displayName?: string;
    /**
    * The AWS Key Management Service (KMS) access configuration for the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#kms_access CcOdbNetwork#kms_access}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#kms_policy_document CcOdbNetwork#kms_policy_document}
    */
    readonly kmsPolicyDocument?: string;
    /**
    * Specifies the configuration for Amazon S3 access from the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#s3_access CcOdbNetwork#s3_access}
    */
    readonly s3Access?: string;
    /**
    * Specifies the endpoint policy for Amazon S3 access from the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#s3_policy_document CcOdbNetwork#s3_policy_document}
    */
    readonly s3PolicyDocument?: string;
    /**
    * The AWS Security Token Service (STS) access configuration for the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#sts_access CcOdbNetwork#sts_access}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#sts_policy_document CcOdbNetwork#sts_policy_document}
    */
    readonly stsPolicyDocument?: string;
    /**
    * Tags to assign to the Odb Network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#tags CcOdbNetwork#tags}
    */
    readonly tags?: CcOdbNetwork.TagProperty[] | cdktn.IResolvable;
    /**
    * Specifies the configuration for Zero-ETL access from the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#zero_etl_access CcOdbNetwork#zero_etl_access}
    */
...
export class CcOdbNetwork extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcOdbNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#key CcOdbNetwork#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that's 1 to 256 characters in length. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/odb_odb_network#value CcOdbNetwork#value}
    */
