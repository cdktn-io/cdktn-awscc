...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcOdbPeeringConnectionProps extends cdktn.TerraformMetaArguments {
    /**
    * The additional CIDR blocks for the ODB peering connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#additional_peer_network_cidrs CcOdbPeeringConnection#additional_peer_network_cidrs}
    */
    readonly additionalPeerNetworkCidrs?: string[];
    /**
    * The name of the ODB peering connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#display_name CcOdbPeeringConnection#display_name}
    */
    readonly displayName?: string;
    /**
    * The unique identifier of the ODB network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#odb_network_id CcOdbPeeringConnection#odb_network_id}
    */
    readonly odbNetworkId?: string;
    /**
    * The unique identifier of the peer network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#peer_network_id CcOdbPeeringConnection#peer_network_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#peer_network_route_table_ids CcOdbPeeringConnection#peer_network_route_table_ids}
    */
    readonly peerNetworkRouteTableIds?: string[];
    /**
    * Tags to assign to the Odb peering connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#tags CcOdbPeeringConnection#tags}
    */
    readonly tags?: CcOdbPeeringConnection.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection awscc_odb_odb_peering_connection}
*/
export class CcOdbPeeringConnection extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcOdbPeeringConnection resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcOdbPeeringConnection to import
    * @param importFromId The id of the existing CcOdbPeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcOdbPeeringConnection to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection awscc_odb_odb_peering_connection} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcOdbPeeringConnectionProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcOdbPeeringConnectionProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcOdbPeeringConnection.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcOdbPeeringConnection.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccOdbPeeringConnectionTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccOdbPeeringConnectionTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcOdbPeeringConnection.TagPropertyList",
            },
        };
...
export function ccOdbPeeringConnectionTagPropertyToTerraform(struct?: CcOdbPeeringConnection.TagProperty | cdktn.IResolvable): any {
...
export function ccOdbPeeringConnectionTagPropertyToHclTerraform(struct?: CcOdbPeeringConnection.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcOdbPeeringConnection {
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#key CcOdbPeeringConnection#key}
    */
    readonly key?: string;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/odb_odb_peering_connection#value CcOdbPeeringConnection#value}
    */
