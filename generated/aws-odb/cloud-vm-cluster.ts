...
export interface CcCloudVmClusterProps extends cdktn.TerraformMetaArguments {
    /**
    * The unique identifier of the Exadata infrastructure that this VM cluster belongs to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#cloud_exadata_infrastructure_id CcCloudVmCluster#cloud_exadata_infrastructure_id}
    */
    readonly cloudExadataInfrastructureId?: string;
    /**
    * The name of the Grid Infrastructure (GI) cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#cluster_name CcCloudVmCluster#cluster_name}
    */
    readonly clusterName?: string;
    /**
    * The number of CPU cores enabled on the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#cpu_core_count CcCloudVmCluster#cpu_core_count}
    */
    readonly cpuCoreCount?: number;
    /**
    * The set of diagnostic collection options enabled for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#data_collection_options CcCloudVmCluster#data_collection_options}
    */
    readonly dataCollectionOptions?: CcCloudVmCluster.DataCollectionOptionsProperty;
    /**
    * The size of the data disk group, in terabytes (TB), that's allocated for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#data_storage_size_in_t_bs CcCloudVmCluster#data_storage_size_in_t_bs}
    */
    readonly dataStorageSizeInTBs?: number;
    /**
    * The amount of local node storage, in gigabytes (GB), that's allocated for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_node_storage_size_in_g_bs CcCloudVmCluster#db_node_storage_size_in_g_bs}
    */
    readonly dbNodeStorageSizeInGBs?: number;
    /**
    * The DB nodes that are implicitly created and managed as part of this VM Cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_nodes CcCloudVmCluster#db_nodes}
    */
    readonly dbNodes?: CcCloudVmCluster.DbNodeProperty[] | cdktn.IResolvable;
    /**
    * The list of database servers for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_servers CcCloudVmCluster#db_servers}
    */
    readonly dbServers?: string[];
    /**
    * The user-friendly name for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#display_name CcCloudVmCluster#display_name}
    */
    readonly displayName?: string;
    /**
    * The software version of the Oracle Grid Infrastructure (GI) for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#gi_version CcCloudVmCluster#gi_version}
    */
    readonly giVersion?: string;
    /**
    * The host name for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#hostname CcCloudVmCluster#hostname}
    */
    readonly hostname?: string;
    /**
    * The AWS Identity and Access Management (IAM) service roles associated with the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#iam_roles CcCloudVmCluster#iam_roles}
    */
    readonly iamRoles?: CcCloudVmCluster.IamRoleProperty[] | cdktn.IResolvable;
    /**
    * Indicates whether database backups to local Exadata storage is enabled for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#is_local_backup_enabled CcCloudVmCluster#is_local_backup_enabled}
    */
    readonly isLocalBackupEnabled?: boolean | cdktn.IResolvable;
    /**
    * Indicates whether the VM cluster is configured with a sparse disk group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#is_sparse_diskgroup_enabled CcCloudVmCluster#is_sparse_diskgroup_enabled}
    */
    readonly isSparseDiskgroupEnabled?: boolean | cdktn.IResolvable;
    /**
    * The Oracle license model applied to the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#license_model CcCloudVmCluster#license_model}
    */
    readonly licenseModel?: string;
    /**
    * The amount of memory, in gigabytes (GB), that's allocated for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#memory_size_in_g_bs CcCloudVmCluster#memory_size_in_g_bs}
    */
    readonly memorySizeInGBs?: number;
    /**
    * The unique identifier of the ODB network for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#odb_network_id CcCloudVmCluster#odb_network_id}
    */
    readonly odbNetworkId?: string;
    /**
    * Property description not available.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#scan_listener_port_tcp CcCloudVmCluster#scan_listener_port_tcp}
    */
    readonly scanListenerPortTcp?: number;
    /**
    * The public key portion of one or more key pairs used for SSH access to the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#ssh_public_keys CcCloudVmCluster#ssh_public_keys}
    */
    readonly sshPublicKeys?: string[];
    /**
    * The operating system version of the image chosen for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#system_version CcCloudVmCluster#system_version}
    */
    readonly systemVersion?: string;
    /**
    * Tags to assign to the Vm Cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#tags CcCloudVmCluster#tags}
    */
    readonly tags?: CcCloudVmCluster.TagsProperty[] | cdktn.IResolvable;
    /**
    * The time zone of the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#time_zone CcCloudVmCluster#time_zone}
    */
...
export class CcCloudVmCluster extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcCloudVmClusterProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcCloudVmClusterProps = {}) {
        super(scope, id, {
    ...
    private _dataCollectionOptions = new CcCloudVmCluster.DataCollectionOptionsPropertyOutputReference(this, "data_collection_options");
    public get dataCollectionOptions() {
        return this._dataCollectionOptions;
    }
    public putDataCollectionOptions(value: CcCloudVmCluster.DataCollectionOptionsProperty) {
    ...
    private _dbNodes = new CcCloudVmCluster.DbNodePropertyList(this, "db_nodes", false);
    public get dbNodes() {
        return this._dbNodes;
    }
    public putDbNodes(value: CcCloudVmCluster.DbNodeProperty[] | cdktn.IResolvable) {
    ...
    private _iamRoles = new CcCloudVmCluster.IamRolePropertyList(this, "iam_roles", true);
    public get iamRoles() {
        return this._iamRoles;
    }
    public putIamRoles(value: CcCloudVmCluster.IamRoleProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcCloudVmCluster.TagsPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcCloudVmCluster.TagsProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            data_collection_options: ccCloudVmClusterDataCollectionOptionsPropertyToTerraform(this._dataCollectionOptions.internalValue),
            ...
            db_nodes: cdktn.listMapper(ccCloudVmClusterDbNodePropertyToTerraform, false)(this._dbNodes.internalValue),
            ...
            iam_roles: cdktn.listMapper(ccCloudVmClusterIamRolePropertyToTerraform, false)(this._iamRoles.internalValue),
            ...
            tags: cdktn.listMapper(ccCloudVmClusterTagsPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            data_collection_options: {
                value: ccCloudVmClusterDataCollectionOptionsPropertyToHclTerraform(this._dataCollectionOptions.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcCloudVmCluster.DataCollectionOptionsProperty",
            },
            ...
            db_nodes: {
                value: cdktn.listMapperHcl(ccCloudVmClusterDbNodePropertyToHclTerraform, false)(this._dbNodes.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCloudVmCluster.DbNodePropertyList",
            },
            db_servers: {
            ...
            iam_roles: {
                value: cdktn.listMapperHcl(ccCloudVmClusterIamRolePropertyToHclTerraform, false)(this._iamRoles.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcCloudVmCluster.IamRolePropertyList",
            },
            ...
            tags: {
                value: cdktn.listMapperHcl(ccCloudVmClusterTagsPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCloudVmCluster.TagsPropertyList",
            },
            time_zone: {
...
export function ccCloudVmClusterDataCollectionOptionsPropertyToTerraform(struct?: CcCloudVmCluster.DataCollectionOptionsProperty | cdktn.IResolvable): any {
...
export function ccCloudVmClusterDataCollectionOptionsPropertyToHclTerraform(struct?: CcCloudVmCluster.DataCollectionOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterTagPropertyToTerraform(struct?: CcCloudVmCluster.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterTagPropertyToHclTerraform(struct?: CcCloudVmCluster.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterDbNodePropertyToTerraform(struct?: CcCloudVmCluster.DbNodeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        tags: cdktn.listMapper(ccCloudVmClusterTagPropertyToTerraform, false)(struct!.tags),
...
export function ccCloudVmClusterDbNodePropertyToHclTerraform(struct?: CcCloudVmCluster.DbNodeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        tags: {
            value: cdktn.listMapperHcl(ccCloudVmClusterTagPropertyToHclTerraform, false)(struct!.tags),
            isBlock: true,
            type: "list",
...
export function ccCloudVmClusterIamRolePropertyToTerraform(struct?: CcCloudVmCluster.IamRoleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterIamRolePropertyToHclTerraform(struct?: CcCloudVmCluster.IamRoleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterTagsPropertyToTerraform(struct?: CcCloudVmCluster.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudVmClusterTagsPropertyToHclTerraform(struct?: CcCloudVmCluster.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcCloudVmCluster {
export interface DataCollectionOptionsProperty {
    /**
    * Indicates whether diagnostic collection is enabled for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#is_diagnostics_events_enabled CcCloudVmCluster#is_diagnostics_events_enabled}
    */
    readonly isDiagnosticsEventsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Indicates whether health monitoring is enabled for the VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#is_health_monitoring_enabled CcCloudVmCluster#is_health_monitoring_enabled}
    */
    readonly isHealthMonitoringEnabled?: boolean | cdktn.IResolvable;
    /**
    * Indicates whether incident logs are enabled for the cloud VM cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#is_incident_logs_enabled CcCloudVmCluster#is_incident_logs_enabled}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#key CcCloudVmCluster#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that's 1 to 256 characters in length. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#value CcCloudVmCluster#value}
    */
...
export interface DbNodeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#backup_ip_id CcCloudVmCluster#backup_ip_id}
    */
    readonly backupIpId?: string;
    /**
    * The OCID of the second backup virtual network interface card (VNIC) for the DB node.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#backup_vnic_2_id CcCloudVmCluster#backup_vnic_2_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_node_arn CcCloudVmCluster#db_node_arn}
    */
    readonly dbNodeArn?: string;
    /**
    * The unique identifier of the DB node.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_node_id CcCloudVmCluster#db_node_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_server_id CcCloudVmCluster#db_server_id}
    */
    readonly dbServerId?: string;
    /**
    * The OCID of the DB system.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#db_system_id CcCloudVmCluster#db_system_id}
    */
    readonly dbSystemId?: string;
    /**
    * The OCID of the host IP address that's associated with the DB node.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#host_ip_id CcCloudVmCluster#host_ip_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#ocid CcCloudVmCluster#ocid}
    */
    readonly ocid?: string;
    /**
    * The current status of the DB node.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#status CcCloudVmCluster#status}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#vnic_2_id CcCloudVmCluster#vnic_2_id}
    */
    readonly vnic2Id?: string;
    /**
    * The OCID of the VNIC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#vnic_id CcCloudVmCluster#vnic_id}
    */
    readonly vnicId?: string;
}
export class DbNodePropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): DbNodeProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: DbNodeProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export class DbNodePropertyList extends cdktn.ComplexList {
    public internalValue? : DbNodeProperty[] | cdktn.IResolvable
    ...
    * @param index the index of the item to return
    */
    public get(index: number): DbNodePropertyOutputReference {
        return new DbNodePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface IamRoleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#aws_integration CcCloudVmCluster#aws_integration}
    */
    readonly awsIntegration?: string;
    /**
    * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) service role.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_vm_cluster#iam_role_arn CcCloudVmCluster#iam_role_arn}
    */
...
export class IamRolePropertyList extends cdktn.ComplexList {
    public internalValue? : IamRoleProperty[] | cdktn.IResolvable
    ...
    * @param index the index of the item to return
    */
    public get(index: number): IamRolePropertyOutputReference {
        return new IamRolePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
