...
export interface CcCloudExadataInfrastructureProps extends cdktn.TerraformMetaArguments {
    /**
    * The name of the Availability Zone (AZ) where the Exadata infrastructure is located.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#availability_zone CcCloudExadataInfrastructure#availability_zone}
    */
    readonly availabilityZone?: string;
    /**
    * The AZ ID of the AZ where the Exadata infrastructure is located.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#availability_zone_id CcCloudExadataInfrastructure#availability_zone_id}
    */
    readonly availabilityZoneId?: string;
    /**
    * The number of database servers for the Exadata infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#compute_count CcCloudExadataInfrastructure#compute_count}
    */
    readonly computeCount?: number;
    /**
    * The email addresses of contacts to receive notification from Oracle about maintenance updates for the Exadata infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#customer_contacts_to_send_to_oci CcCloudExadataInfrastructure#customer_contacts_to_send_to_oci}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#database_server_type CcCloudExadataInfrastructure#database_server_type}
    */
    readonly databaseServerType?: string;
    /**
    * The user-friendly name for the Exadata infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#display_name CcCloudExadataInfrastructure#display_name}
    */
    readonly displayName?: string;
    /**
    * The scheduling details for the maintenance window. Patching and system updates take place during the maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#maintenance_window CcCloudExadataInfrastructure#maintenance_window}
    */
    readonly maintenanceWindow?: CcCloudExadataInfrastructure.MaintenanceWindowProperty;
    /**
    * The model name of the Exadata infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#shape CcCloudExadataInfrastructure#shape}
    */
    readonly shape?: string;
    /**
    * The number of storage servers that are activated for the Exadata infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#storage_count CcCloudExadataInfrastructure#storage_count}
    */
    readonly storageCount?: number;
    /**
    * The storage server model type of the Exadata infrastructure. For the list of valid model names, use the ListDbSystemShapes operation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#storage_server_type CcCloudExadataInfrastructure#storage_server_type}
    */
    readonly storageServerType?: string;
    /**
    * Tags to assign to the Exadata Infrastructure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#tags CcCloudExadataInfrastructure#tags}
    */
...
export class CcCloudExadataInfrastructure extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCloudExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcCloudExadataInfrastructureProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcCloudExadataInfrastructureProps = {}) {
        super(scope, id, {
    ...
    private _customerContactsToSendToOci = new CcCloudExadataInfrastructure.CustomerContactPropertyList(this, "customer_contacts_to_send_to_oci", false);
    public get customerContactsToSendToOci() {
        return this._customerContactsToSendToOci;
    }
    public putCustomerContactsToSendToOci(value: CcCloudExadataInfrastructure.CustomerContactProperty[] | cdktn.IResolvable) {
    ...
    private _maintenanceWindow = new CcCloudExadataInfrastructure.MaintenanceWindowPropertyOutputReference(this, "maintenance_window");
    public get maintenanceWindow() {
        return this._maintenanceWindow;
    }
    public putMaintenanceWindow(value: CcCloudExadataInfrastructure.MaintenanceWindowProperty) {
    ...
    private _tags = new CcCloudExadataInfrastructure.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcCloudExadataInfrastructure.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            customer_contacts_to_send_to_oci: cdktn.listMapper(ccCloudExadataInfrastructureCustomerContactPropertyToTerraform, false)(this._customerContactsToSendToOci.internalValue),
            database_server_type: cdktn.stringToTerraform(this._databaseServerType),
            display_name: cdktn.stringToTerraform(this._displayName),
            maintenance_window: ccCloudExadataInfrastructureMaintenanceWindowPropertyToTerraform(this._maintenanceWindow.internalValue),
            ...
            tags: cdktn.listMapper(ccCloudExadataInfrastructureTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            customer_contacts_to_send_to_oci: {
                value: cdktn.listMapperHcl(ccCloudExadataInfrastructureCustomerContactPropertyToHclTerraform, false)(this._customerContactsToSendToOci.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCloudExadataInfrastructure.CustomerContactPropertyList",
            },
            ...
            maintenance_window: {
                value: ccCloudExadataInfrastructureMaintenanceWindowPropertyToHclTerraform(this._maintenanceWindow.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcCloudExadataInfrastructure.MaintenanceWindowProperty",
            },
            shape: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccCloudExadataInfrastructureTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCloudExadataInfrastructure.TagPropertyList",
            },
        };
...
export function ccCloudExadataInfrastructureCustomerContactPropertyToTerraform(struct?: CcCloudExadataInfrastructure.CustomerContactProperty | cdktn.IResolvable): any {
...
export function ccCloudExadataInfrastructureCustomerContactPropertyToHclTerraform(struct?: CcCloudExadataInfrastructure.CustomerContactProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudExadataInfrastructureMaintenanceWindowPropertyToTerraform(struct?: CcCloudExadataInfrastructure.MaintenanceWindowProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudExadataInfrastructureMaintenanceWindowPropertyToHclTerraform(struct?: CcCloudExadataInfrastructure.MaintenanceWindowProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudExadataInfrastructureTagPropertyToTerraform(struct?: CcCloudExadataInfrastructure.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCloudExadataInfrastructureTagPropertyToHclTerraform(struct?: CcCloudExadataInfrastructure.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcCloudExadataInfrastructure {
export interface CustomerContactProperty {
    /**
    * The email address of the contact.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#email CcCloudExadataInfrastructure#email}
    */
    readonly email?: string;
}
export class CustomerContactPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): CustomerContactProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: CustomerContactProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class CustomerContactPropertyList extends cdktn.ComplexList {
    public internalValue? : CustomerContactProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): CustomerContactPropertyOutputReference {
        return new CustomerContactPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface MaintenanceWindowProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#custom_action_timeout_in_mins CcCloudExadataInfrastructure#custom_action_timeout_in_mins}
    */
    readonly customActionTimeoutInMins?: number;
    /**
    * The days of the week when maintenance can be performed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#days_of_week CcCloudExadataInfrastructure#days_of_week}
    */
    readonly daysOfWeek?: string[];
    /**
    * The hours of the day when maintenance can be performed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#hours_of_day CcCloudExadataInfrastructure#hours_of_day}
    */
    readonly hoursOfDay?: number[];
    /**
    * Indicates whether custom action timeout is enabled.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#is_custom_action_timeout_enabled CcCloudExadataInfrastructure#is_custom_action_timeout_enabled}
    */
    readonly isCustomActionTimeoutEnabled?: boolean | cdktn.IResolvable;
    /**
    * The lead time in weeks before the maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#lead_time_in_weeks CcCloudExadataInfrastructure#lead_time_in_weeks}
    */
    readonly leadTimeInWeeks?: number;
    /**
    * The months when maintenance can be performed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#months CcCloudExadataInfrastructure#months}
    */
    readonly months?: string[];
    /**
    * The patching mode for the maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#patching_mode CcCloudExadataInfrastructure#patching_mode}
    */
    readonly patchingMode?: string;
    /**
    * The preference for the maintenance window scheduling.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#preference CcCloudExadataInfrastructure#preference}
    */
    readonly preference?: string;
    /**
    * The weeks of the month when maintenance can be performed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#weeks_of_month CcCloudExadataInfrastructure#weeks_of_month}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#key CcCloudExadataInfrastructure#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that's 1 to 256 characters in length. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/odb_cloud_exadata_infrastructure#value CcCloudExadataInfrastructure#value}
    */
