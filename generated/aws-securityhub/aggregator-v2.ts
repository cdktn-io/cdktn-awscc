...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_aggregator_v2
...
export interface CcAggregatorV2Props extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_aggregator_v2#linked_regions CcAggregatorV2#linked_regions}
    */
    readonly linkedRegions: string[];
    /**
    * Indicates to link a list of included Regions
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_aggregator_v2#region_linking_mode CcAggregatorV2#region_linking_mode}
    */
    readonly regionLinkingMode: string;
    /**
    * A key-value pair to associate with the Security Hub V2 resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_aggregator_v2#tags CcAggregatorV2#tags}
    */
...
export class CcAggregatorV2 extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAggregatorV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_aggregator_v2#import import section} in the documentation of this resource for the id to use
