...
export interface CcSecurityControlProps extends cdktn.TerraformMetaArguments {
    /**
    * The most recent reason for updating the customizable properties of a security control. This differs from the UpdateReason field of the BatchUpdateStandardsControlAssociations API, which tracks the reason for updating the enablement status of a control. This field accepts alphanumeric characters in addition to white spaces, dashes, and underscores.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#last_update_reason CcSecurityControl#last_update_reason}
    */
    readonly lastUpdateReason?: string;
    /**
    * An object that identifies the name of a control parameter, its current value, and whether it has been customized.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#parameters CcSecurityControl#parameters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#security_control_arn CcSecurityControl#security_control_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#security_control_id CcSecurityControl#security_control_id}
    */
...
export class CcSecurityControl extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSecurityControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSecurityControlProps
    */
    public constructor(scope: Construct, id: string, config: CcSecurityControlProps) {
        super(scope, id, {
    ...
    private _parameters = new CcSecurityControl.ParameterConfigurationPropertyMap(this, "parameters");
    public get parameters() {
        return this._parameters;
    }
    public putParameters(value: { [key: string]: CcSecurityControl.ParameterConfigurationProperty } | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            parameters: cdktn.hashMapper(ccSecurityControlParameterConfigurationPropertyToTerraform)(this._parameters.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            parameters: {
                value: cdktn.hashMapperHcl(ccSecurityControlParameterConfigurationPropertyToHclTerraform)(this._parameters.internalValue),
                isBlock: true,
                type: "map",
                storageClassType: "CcSecurityControl.ParameterConfigurationPropertyMap",
            },
...
export function ccSecurityControlParameterValuePropertyToTerraform(struct?: CcSecurityControl.ParameterValueProperty | cdktn.IResolvable): any {
...
export function ccSecurityControlParameterValuePropertyToHclTerraform(struct?: CcSecurityControl.ParameterValueProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSecurityControlParameterConfigurationPropertyToTerraform(struct?: CcSecurityControl.ParameterConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        value: ccSecurityControlParameterValuePropertyToTerraform(struct!.value),
        value_type: cdktn.stringToTerraform(struct!.valueType),
    }
}


export function ccSecurityControlParameterConfigurationPropertyToHclTerraform(struct?: CcSecurityControl.ParameterConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        value: {
            value: ccSecurityControlParameterValuePropertyToHclTerraform(struct!.value),
            isBlock: true,
            type: "struct",
...
export namespace CcSecurityControl {
export interface ParameterValueProperty {
    /**
    * A control parameter that is a boolean.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#boolean CcSecurityControl#boolean}
    */
    readonly boolean?: boolean | cdktn.IResolvable;
    /**
    * A control parameter that is a double.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#double CcSecurityControl#double}
    */
    readonly double?: number;
    /**
    * A control parameter that is a enum.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#enum CcSecurityControl#enum}
    */
    readonly enum?: string;
    /**
    * A control parameter that is a list of enums.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#enum_list CcSecurityControl#enum_list}
    */
    readonly enumList?: string[];
    /**
    * A control parameter that is a integer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#integer CcSecurityControl#integer}
    */
    readonly integer?: number;
    /**
    * A control parameter that is a list of integers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#integer_list CcSecurityControl#integer_list}
    */
    readonly integerList?: number[];
    /**
    * A control parameter that is a string.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#string CcSecurityControl#string}
    */
    readonly string?: string;
    /**
    * A control parameter that is a list of strings.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#string_list CcSecurityControl#string_list}
    */
...
export interface ParameterConfigurationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#value CcSecurityControl#value}
    */
    readonly value?: ParameterValueProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_security_control#value_type CcSecurityControl#value_type}
    */
