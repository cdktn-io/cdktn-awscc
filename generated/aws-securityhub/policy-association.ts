...
export interface CcPolicyAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityhub_policy_association#configuration_policy_id CcPolicyAssociation#configuration_policy_id}
    */
    readonly configurationPolicyId: string;
    /**
    * The identifier of the target account, organizational unit, or the root
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityhub_policy_association#target_id CcPolicyAssociation#target_id}
    */
    readonly targetId: string;
    /**
    * Indicates whether the target is an AWS account, organizational unit, or the organization root
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityhub_policy_association#target_type CcPolicyAssociation#target_type}
    */
...
export class CcPolicyAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPolicyAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/securityhub_policy_association#import import section} in the documentation of this resource for the id to use
