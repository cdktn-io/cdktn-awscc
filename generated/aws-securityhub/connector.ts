...
export interface CcConnectorProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#description CcConnector#description}
    */
    readonly description?: string;
    /**
    * The name of the connector.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#name CcConnector#name}
    */
    readonly name: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#provider_name CcConnector#provider_name}
    */
    readonly providerName: CcConnector.ProviderNameProperty;
    /**
    * A key-value pair to associate with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#tags CcConnector#tags}
    */
...
export class CcConnector extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#import import section} in the documentation of this resource for the id to use
...
export interface ScopeConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#scope_type CcConnector#scope_type}
    */
    readonly scopeType: string;
    /**
    * The list of scope values, such as subscription IDs, when the scope type is ``subscription``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#scope_values CcConnector#scope_values}
    */
...
export interface AzureProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#aws_config_connector_arn CcConnector#aws_config_connector_arn}
    */
    readonly awsConfigConnectorArn: string;
    /**
    * The list of Azure regions to monitor.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#azure_regions CcConnector#azure_regions}
    */
    readonly azureRegions: string[];
    /**
    * The scope configuration that defines which Azure resources are monitored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#scope_configuration CcConnector#scope_configuration}
    */
...
export interface ProviderNameProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/securityhub_connector#azure CcConnector#azure}
    */
