...
export interface CcFindingAggregatorProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_finding_aggregator#region_linking_mode CcFindingAggregator#region_linking_mode}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_finding_aggregator#regions CcFindingAggregator#regions}
    */
...
export class CcFindingAggregator extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcFindingAggregator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/securityhub_finding_aggregator#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcFindingAggregatorProps
    */
    public constructor(scope: Construct, id: string, config: CcFindingAggregatorProps) {
        super(scope, id, {
...
export namespace CcFindingAggregator {
}
