...
export interface CcLoggingConfigurationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#log_destination_configs CcLoggingConfiguration#log_destination_configs}
    */
    readonly logDestinationConfigs: string[];
    /**
    * Filtering that specifies which web requests are kept in the logs and which are dropped. You can filter on the rule action and on the web request labels that were applied by matching rules during web ACL evaluation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#logging_filter CcLoggingConfiguration#logging_filter}
    */
    readonly loggingFilter?: CcLoggingConfiguration.LoggingFilterProperty;
    /**
    * The parts of the request that you want to keep out of the logs. For example, if you redact the HEADER field, the HEADER field in the firehose will be xxx.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#redacted_fields CcLoggingConfiguration#redacted_fields}
    */
    readonly redactedFields?: CcLoggingConfiguration.FieldToMatchProperty[] | cdktn.IResolvable;
    /**
    * The Amazon Resource Name (ARN) of the web ACL that you want to associate with LogDestinationConfigs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#resource_arn CcLoggingConfiguration#resource_arn}
    */
...
export class CcLoggingConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLoggingConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#import import section} in the documentation of this resource for the id to use
...
export interface ActionConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#action CcLoggingConfiguration#action}
    */
...
export interface LabelNameConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#label_name CcLoggingConfiguration#label_name}
    */
...
export interface ConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#action_condition CcLoggingConfiguration#action_condition}
    */
    readonly actionCondition?: ActionConditionProperty;
    /**
    * A single label name condition.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#label_name_condition CcLoggingConfiguration#label_name_condition}
    */
...
export interface FilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#behavior CcLoggingConfiguration#behavior}
    */
    readonly behavior?: string;
    /**
    * Match conditions for the filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#conditions CcLoggingConfiguration#conditions}
    */
    readonly conditions?: ConditionProperty[] | cdktn.IResolvable;
    /**
    * Logic to apply to the filtering conditions. You can specify that, in order to satisfy the filter, a log must match all conditions or must match at least one condition.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#requirement CcLoggingConfiguration#requirement}
    */
...
export interface LoggingFilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#default_behavior CcLoggingConfiguration#default_behavior}
    */
    readonly defaultBehavior?: string;
    /**
    * The filters that you want to apply to the logs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#filters CcLoggingConfiguration#filters}
    */
...
export interface SingleHeaderProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#name CcLoggingConfiguration#name}
    */
...
export interface FieldToMatchProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#method CcLoggingConfiguration#method}
    */
    readonly method?: string;
    /**
    * Inspect the query string. This is the part of a URL that appears after a ? character, if any. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#query_string CcLoggingConfiguration#query_string}
    */
    readonly queryString?: string;
    /**
    * Inspect a single header. Provide the name of the header to inspect, for example, User-Agent or Referer. This setting isn't case sensitive.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#single_header CcLoggingConfiguration#single_header}
    */
    readonly singleHeader?: SingleHeaderProperty;
    /**
    * Inspect the request URI path. This is the part of a web request that identifies a resource, for example, /images/daily-ad.jpg. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wafv2_logging_configuration#uri_path CcLoggingConfiguration#uri_path}
    */
