...
export interface CcVectorBucketPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy#policy CcVectorBucketPolicy#policy}
    */
    readonly policy: string;
    /**
    * The Amazon Resource Name (ARN) of the vector bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy#vector_bucket_arn CcVectorBucketPolicy#vector_bucket_arn}
    */
    readonly vectorBucketArn?: string;
    /**
    * The name of the vector bucket
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy#vector_bucket_name CcVectorBucketPolicy#vector_bucket_name}
    */
...
export class CcVectorBucketPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVectorBucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3vectors_vector_bucket_policy#import import section} in the documentation of this resource for the id to use
