...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcMlflowTrackingServerProps extends cdktn.TerraformMetaArguments {
    /**
    * The Amazon S3 URI for MLFlow Tracking Server artifacts.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#artifact_store_uri CcMlflowTrackingServer#artifact_store_uri}
    */
    readonly artifactStoreUri: string;
    /**
    * A flag to enable Automatic SageMaker Model Registration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#automatic_model_registration CcMlflowTrackingServer#automatic_model_registration}
    */
    readonly automaticModelRegistration?: boolean | cdktn.IResolvable;
    /**
    * The MLFlow Version used on the MLFlow Tracking Server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#mlflow_version CcMlflowTrackingServer#mlflow_version}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#role_arn CcMlflowTrackingServer#role_arn}
    */
    readonly roleArn: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#tags CcMlflowTrackingServer#tags}
    */
    readonly tags?: CcMlflowTrackingServer.TagProperty[] | cdktn.IResolvable;
    /**
    * The name of the MLFlow Tracking Server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#tracking_server_name CcMlflowTrackingServer#tracking_server_name}
    */
    readonly trackingServerName: string;
    /**
    * The size of the MLFlow Tracking Server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#tracking_server_size CcMlflowTrackingServer#tracking_server_size}
    */
    readonly trackingServerSize?: string;
    /**
    * The start of the time window for maintenance of the MLFlow Tracking Server in UTC time.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#weekly_maintenance_window_start CcMlflowTrackingServer#weekly_maintenance_window_start}
    */
    readonly weeklyMaintenanceWindowStart?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server awscc_sagemaker_mlflow_tracking_server}
*/
export class CcMlflowTrackingServer extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMlflowTrackingServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server awscc_sagemaker_mlflow_tracking_server} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcMlflowTrackingServerProps
    */
    public constructor(scope: Construct, id: string, config: CcMlflowTrackingServerProps) {
        super(scope, id, {
    ...
    private _tags = new CcMlflowTrackingServer.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcMlflowTrackingServer.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccMlflowTrackingServerTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccMlflowTrackingServerTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcMlflowTrackingServer.TagPropertyList",
            },
...
export function ccMlflowTrackingServerTagPropertyToTerraform(struct?: CcMlflowTrackingServer.TagProperty | cdktn.IResolvable): any {
...
export function ccMlflowTrackingServerTagPropertyToHclTerraform(struct?: CcMlflowTrackingServer.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcMlflowTrackingServer {
export interface TagProperty {
    /**
    * The key name of the tag. You can specify a value that is 1 to 127 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#key CcMlflowTrackingServer#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_mlflow_tracking_server#value CcMlflowTrackingServer#value}
    */
