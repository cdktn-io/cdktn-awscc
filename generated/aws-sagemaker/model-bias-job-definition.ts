...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcModelBiasJobDefinitionProps extends cdktn.TerraformMetaArguments {
    /**
    * The name of the endpoint used to run the monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#endpoint_name CcModelBiasJobDefinition#endpoint_name}
    */
    readonly endpointName?: string;
    /**
    * The name of the job definition.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#job_definition_name CcModelBiasJobDefinition#job_definition_name}
    */
    readonly jobDefinitionName?: string;
    /**
    * Identifies the resources to deploy for a monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#job_resources CcModelBiasJobDefinition#job_resources}
    */
    readonly jobResources: CcModelBiasJobDefinition.MonitoringResourcesProperty;
    /**
    * Container image configuration object for the monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#model_bias_app_specification CcModelBiasJobDefinition#model_bias_app_specification}
    */
    readonly modelBiasAppSpecification: CcModelBiasJobDefinition.ModelBiasAppSpecificationProperty;
    /**
    * Baseline configuration used to validate that the data conforms to the specified constraints and statistics.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#model_bias_baseline_config CcModelBiasJobDefinition#model_bias_baseline_config}
    */
    readonly modelBiasBaselineConfig?: CcModelBiasJobDefinition.ModelBiasBaselineConfigProperty;
    /**
    * The inputs for a monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#model_bias_job_input CcModelBiasJobDefinition#model_bias_job_input}
    */
    readonly modelBiasJobInput: CcModelBiasJobDefinition.ModelBiasJobInputProperty;
    /**
    * The output configuration for monitoring jobs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#model_bias_job_output_config CcModelBiasJobDefinition#model_bias_job_output_config}
    */
    readonly modelBiasJobOutputConfig: CcModelBiasJobDefinition.MonitoringOutputConfigProperty;
    /**
    * Networking options for a job, such as network traffic encryption between containers, whether to allow inbound and outbound network calls to and from containers, and the VPC subnets and security groups to use for VPC-enabled jobs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#network_config CcModelBiasJobDefinition#network_config}
    */
    readonly networkConfig?: CcModelBiasJobDefinition.NetworkConfigProperty;
    /**
    * The Amazon Resource Name (ARN) of an IAM role that Amazon SageMaker can assume to perform tasks on your behalf.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#role_arn CcModelBiasJobDefinition#role_arn}
    */
    readonly roleArn: string;
    /**
    * Specifies a time limit for how long the monitoring job is allowed to run.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#stopping_condition CcModelBiasJobDefinition#stopping_condition}
    */
    readonly stoppingCondition?: CcModelBiasJobDefinition.StoppingConditionProperty;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#tags CcModelBiasJobDefinition#tags}
    */
    readonly tags?: CcModelBiasJobDefinition.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition awscc_sagemaker_model_bias_job_definition}
*/
export class CcModelBiasJobDefinition extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcModelBiasJobDefinition resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcModelBiasJobDefinition to import
    * @param importFromId The id of the existing CcModelBiasJobDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcModelBiasJobDefinition to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition awscc_sagemaker_model_bias_job_definition} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcModelBiasJobDefinitionProps
    */
    public constructor(scope: Construct, id: string, config: CcModelBiasJobDefinitionProps) {
        super(scope, id, {
    ...
    private _jobResources = new CcModelBiasJobDefinition.MonitoringResourcesPropertyOutputReference(this, "job_resources");
    public get jobResources() {
        return this._jobResources;
    }
    public putJobResources(value: CcModelBiasJobDefinition.MonitoringResourcesProperty) {
    ...
    private _modelBiasAppSpecification = new CcModelBiasJobDefinition.ModelBiasAppSpecificationPropertyOutputReference(this, "model_bias_app_specification");
    public get modelBiasAppSpecification() {
        return this._modelBiasAppSpecification;
    }
    public putModelBiasAppSpecification(value: CcModelBiasJobDefinition.ModelBiasAppSpecificationProperty) {
    ...
    private _modelBiasBaselineConfig = new CcModelBiasJobDefinition.ModelBiasBaselineConfigPropertyOutputReference(this, "model_bias_baseline_config");
    public get modelBiasBaselineConfig() {
        return this._modelBiasBaselineConfig;
    }
    public putModelBiasBaselineConfig(value: CcModelBiasJobDefinition.ModelBiasBaselineConfigProperty) {
    ...
    private _modelBiasJobInput = new CcModelBiasJobDefinition.ModelBiasJobInputPropertyOutputReference(this, "model_bias_job_input");
    public get modelBiasJobInput() {
        return this._modelBiasJobInput;
    }
    public putModelBiasJobInput(value: CcModelBiasJobDefinition.ModelBiasJobInputProperty) {
    ...
    private _modelBiasJobOutputConfig = new CcModelBiasJobDefinition.MonitoringOutputConfigPropertyOutputReference(this, "model_bias_job_output_config");
    public get modelBiasJobOutputConfig() {
        return this._modelBiasJobOutputConfig;
    }
    public putModelBiasJobOutputConfig(value: CcModelBiasJobDefinition.MonitoringOutputConfigProperty) {
    ...
    private _networkConfig = new CcModelBiasJobDefinition.NetworkConfigPropertyOutputReference(this, "network_config");
    public get networkConfig() {
        return this._networkConfig;
    }
    public putNetworkConfig(value: CcModelBiasJobDefinition.NetworkConfigProperty) {
    ...
    private _stoppingCondition = new CcModelBiasJobDefinition.StoppingConditionPropertyOutputReference(this, "stopping_condition");
    public get stoppingCondition() {
        return this._stoppingCondition;
    }
    public putStoppingCondition(value: CcModelBiasJobDefinition.StoppingConditionProperty) {
    ...
    private _tags = new CcModelBiasJobDefinition.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcModelBiasJobDefinition.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            job_resources: ccModelBiasJobDefinitionMonitoringResourcesPropertyToTerraform(this._jobResources.internalValue),
            model_bias_app_specification: ccModelBiasJobDefinitionModelBiasAppSpecificationPropertyToTerraform(this._modelBiasAppSpecification.internalValue),
            model_bias_baseline_config: ccModelBiasJobDefinitionModelBiasBaselineConfigPropertyToTerraform(this._modelBiasBaselineConfig.internalValue),
            model_bias_job_input: ccModelBiasJobDefinitionModelBiasJobInputPropertyToTerraform(this._modelBiasJobInput.internalValue),
            model_bias_job_output_config: ccModelBiasJobDefinitionMonitoringOutputConfigPropertyToTerraform(this._modelBiasJobOutputConfig.internalValue),
            network_config: ccModelBiasJobDefinitionNetworkConfigPropertyToTerraform(this._networkConfig.internalValue),
            role_arn: cdktn.stringToTerraform(this._roleArn),
            stopping_condition: ccModelBiasJobDefinitionStoppingConditionPropertyToTerraform(this._stoppingCondition.internalValue),
            tags: cdktn.listMapper(ccModelBiasJobDefinitionTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            job_resources: {
                value: ccModelBiasJobDefinitionMonitoringResourcesPropertyToHclTerraform(this._jobResources.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.MonitoringResourcesProperty",
            },
            model_bias_app_specification: {
                value: ccModelBiasJobDefinitionModelBiasAppSpecificationPropertyToHclTerraform(this._modelBiasAppSpecification.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.ModelBiasAppSpecificationProperty",
            },
            model_bias_baseline_config: {
                value: ccModelBiasJobDefinitionModelBiasBaselineConfigPropertyToHclTerraform(this._modelBiasBaselineConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.ModelBiasBaselineConfigProperty",
            },
            model_bias_job_input: {
                value: ccModelBiasJobDefinitionModelBiasJobInputPropertyToHclTerraform(this._modelBiasJobInput.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.ModelBiasJobInputProperty",
            },
            model_bias_job_output_config: {
                value: ccModelBiasJobDefinitionMonitoringOutputConfigPropertyToHclTerraform(this._modelBiasJobOutputConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.MonitoringOutputConfigProperty",
            },
            network_config: {
                value: ccModelBiasJobDefinitionNetworkConfigPropertyToHclTerraform(this._networkConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.NetworkConfigProperty",
            },
            role_arn: {
            ...
            stopping_condition: {
                value: ccModelBiasJobDefinitionStoppingConditionPropertyToHclTerraform(this._stoppingCondition.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcModelBiasJobDefinition.StoppingConditionProperty",
            },
            tags: {
                value: cdktn.listMapperHcl(ccModelBiasJobDefinitionTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcModelBiasJobDefinition.TagPropertyList",
            },
        };
...
export function ccModelBiasJobDefinitionClusterConfigPropertyToTerraform(struct?: CcModelBiasJobDefinition.ClusterConfigProperty | cdktn.IResolvable): any {
...
export function ccModelBiasJobDefinitionClusterConfigPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.ClusterConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionMonitoringResourcesPropertyToTerraform(struct?: CcModelBiasJobDefinition.MonitoringResourcesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        cluster_config: ccModelBiasJobDefinitionClusterConfigPropertyToTerraform(struct!.clusterConfig),
    }
}


export function ccModelBiasJobDefinitionMonitoringResourcesPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.MonitoringResourcesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        cluster_config: {
            value: ccModelBiasJobDefinitionClusterConfigPropertyToHclTerraform(struct!.clusterConfig),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionModelBiasAppSpecificationPropertyToTerraform(struct?: CcModelBiasJobDefinition.ModelBiasAppSpecificationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionModelBiasAppSpecificationPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.ModelBiasAppSpecificationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionConstraintsResourcePropertyToTerraform(struct?: CcModelBiasJobDefinition.ConstraintsResourceProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionConstraintsResourcePropertyToHclTerraform(struct?: CcModelBiasJobDefinition.ConstraintsResourceProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionModelBiasBaselineConfigPropertyToTerraform(struct?: CcModelBiasJobDefinition.ModelBiasBaselineConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        constraints_resource: ccModelBiasJobDefinitionConstraintsResourcePropertyToTerraform(struct!.constraintsResource),
    }
}


export function ccModelBiasJobDefinitionModelBiasBaselineConfigPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.ModelBiasBaselineConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        constraints_resource: {
            value: ccModelBiasJobDefinitionConstraintsResourcePropertyToHclTerraform(struct!.constraintsResource),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionCsvPropertyToTerraform(struct?: CcModelBiasJobDefinition.CsvProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionCsvPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.CsvProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionJsonPropertyToTerraform(struct?: CcModelBiasJobDefinition.JsonProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionJsonPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.JsonProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionDatasetFormatPropertyToTerraform(struct?: CcModelBiasJobDefinition.DatasetFormatProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        csv: ccModelBiasJobDefinitionCsvPropertyToTerraform(struct!.csv),
        json: ccModelBiasJobDefinitionJsonPropertyToTerraform(struct!.json),
        parquet: cdktn.booleanToTerraform(struct!.parquet),
    }
}


export function ccModelBiasJobDefinitionDatasetFormatPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.DatasetFormatProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        csv: {
            value: ccModelBiasJobDefinitionCsvPropertyToHclTerraform(struct!.csv),
            isBlock: true,
            type: "struct",
            storageClassType: "CsvProperty",
        },
        json: {
            value: ccModelBiasJobDefinitionJsonPropertyToHclTerraform(struct!.json),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionBatchTransformInputPropertyToTerraform(struct?: CcModelBiasJobDefinition.BatchTransformInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        dataset_format: ccModelBiasJobDefinitionDatasetFormatPropertyToTerraform(struct!.datasetFormat),
...
export function ccModelBiasJobDefinitionBatchTransformInputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.BatchTransformInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        dataset_format: {
            value: ccModelBiasJobDefinitionDatasetFormatPropertyToHclTerraform(struct!.datasetFormat),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionEndpointInputPropertyToTerraform(struct?: CcModelBiasJobDefinition.EndpointInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionEndpointInputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.EndpointInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionMonitoringGroundTruthS3InputPropertyToTerraform(struct?: CcModelBiasJobDefinition.MonitoringGroundTruthS3InputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionMonitoringGroundTruthS3InputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.MonitoringGroundTruthS3InputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionModelBiasJobInputPropertyToTerraform(struct?: CcModelBiasJobDefinition.ModelBiasJobInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        batch_transform_input: ccModelBiasJobDefinitionBatchTransformInputPropertyToTerraform(struct!.batchTransformInput),
        endpoint_input: ccModelBiasJobDefinitionEndpointInputPropertyToTerraform(struct!.endpointInput),
        ground_truth_s3_input: ccModelBiasJobDefinitionMonitoringGroundTruthS3InputPropertyToTerraform(struct!.groundTruthS3Input),
    }
}


export function ccModelBiasJobDefinitionModelBiasJobInputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.ModelBiasJobInputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        batch_transform_input: {
            value: ccModelBiasJobDefinitionBatchTransformInputPropertyToHclTerraform(struct!.batchTransformInput),
            isBlock: true,
            type: "struct",
            storageClassType: "BatchTransformInputProperty",
        },
        endpoint_input: {
            value: ccModelBiasJobDefinitionEndpointInputPropertyToHclTerraform(struct!.endpointInput),
            isBlock: true,
            type: "struct",
            storageClassType: "EndpointInputProperty",
        },
        ground_truth_s3_input: {
            value: ccModelBiasJobDefinitionMonitoringGroundTruthS3InputPropertyToHclTerraform(struct!.groundTruthS3Input),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionS3OutputPropertyToTerraform(struct?: CcModelBiasJobDefinition.S3OutputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionS3OutputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.S3OutputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionMonitoringOutputPropertyToTerraform(struct?: CcModelBiasJobDefinition.MonitoringOutputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        s3_output: ccModelBiasJobDefinitionS3OutputPropertyToTerraform(struct!.s3Output),
    }
}


export function ccModelBiasJobDefinitionMonitoringOutputPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.MonitoringOutputProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        s3_output: {
            value: ccModelBiasJobDefinitionS3OutputPropertyToHclTerraform(struct!.s3Output),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionMonitoringOutputConfigPropertyToTerraform(struct?: CcModelBiasJobDefinition.MonitoringOutputConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        monitoring_outputs: cdktn.listMapper(ccModelBiasJobDefinitionMonitoringOutputPropertyToTerraform, false)(struct!.monitoringOutputs),
    }
}


export function ccModelBiasJobDefinitionMonitoringOutputConfigPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.MonitoringOutputConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        monitoring_outputs: {
            value: cdktn.listMapperHcl(ccModelBiasJobDefinitionMonitoringOutputPropertyToHclTerraform, false)(struct!.monitoringOutputs),
            isBlock: true,
            type: "list",
...
export function ccModelBiasJobDefinitionVpcConfigPropertyToTerraform(struct?: CcModelBiasJobDefinition.VpcConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionVpcConfigPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.VpcConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionNetworkConfigPropertyToTerraform(struct?: CcModelBiasJobDefinition.NetworkConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        vpc_config: ccModelBiasJobDefinitionVpcConfigPropertyToTerraform(struct!.vpcConfig),
    }
}


export function ccModelBiasJobDefinitionNetworkConfigPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.NetworkConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        vpc_config: {
            value: ccModelBiasJobDefinitionVpcConfigPropertyToHclTerraform(struct!.vpcConfig),
            isBlock: true,
            type: "struct",
...
export function ccModelBiasJobDefinitionStoppingConditionPropertyToTerraform(struct?: CcModelBiasJobDefinition.StoppingConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionStoppingConditionPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.StoppingConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionTagPropertyToTerraform(struct?: CcModelBiasJobDefinition.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccModelBiasJobDefinitionTagPropertyToHclTerraform(struct?: CcModelBiasJobDefinition.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcModelBiasJobDefinition {
export interface ClusterConfigProperty {
    /**
    * The number of ML compute instances to use in the model monitoring job. For distributed processing jobs, specify a value greater than 1. The default value is 1.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#instance_count CcModelBiasJobDefinition#instance_count}
    */
    readonly instanceCount: number;
    /**
    * The ML compute instance type for the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#instance_type CcModelBiasJobDefinition#instance_type}
    */
    readonly instanceType: string;
    /**
    * The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the model monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#volume_kms_key_id CcModelBiasJobDefinition#volume_kms_key_id}
    */
    readonly volumeKmsKeyId?: string;
    /**
    * The size of the ML storage volume, in gigabytes, that you want to provision. You must specify sufficient ML storage for your scenario.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#volume_size_in_gb CcModelBiasJobDefinition#volume_size_in_gb}
    */
...
export interface MonitoringResourcesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#cluster_config CcModelBiasJobDefinition#cluster_config}
    */
...
export interface ModelBiasAppSpecificationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#config_uri CcModelBiasJobDefinition#config_uri}
    */
    readonly configUri: string;
    /**
    * Sets the environment variables in the Docker container
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#environment CcModelBiasJobDefinition#environment}
    */
    readonly environment?: { [key: string]: string };
    /**
    * The container image to be run by the monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#image_uri CcModelBiasJobDefinition#image_uri}
    */
    readonly imageUri: string;
}
export class ModelBiasAppSpecificationPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): ModelBiasAppSpecificationProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: ModelBiasAppSpecificationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export interface ConstraintsResourceProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#s3_uri CcModelBiasJobDefinition#s3_uri}
    */
...
export interface ModelBiasBaselineConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#baselining_job_name CcModelBiasJobDefinition#baselining_job_name}
    */
    readonly baseliningJobName?: string;
    /**
    * The baseline constraints resource for a monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#constraints_resource CcModelBiasJobDefinition#constraints_resource}
    */
    readonly constraintsResource?: ConstraintsResourceProperty;
}
export class ModelBiasBaselineConfigPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): ModelBiasBaselineConfigProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: ModelBiasBaselineConfigProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export interface CsvProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#header CcModelBiasJobDefinition#header}
    */
...
export interface JsonProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#line CcModelBiasJobDefinition#line}
    */
...
export interface DatasetFormatProperty {
    ...
    * The CSV format
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#csv CcModelBiasJobDefinition#csv}
    */
    readonly csv?: CsvProperty;
    /**
    * The Json format
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#json CcModelBiasJobDefinition#json}
    */
    readonly json?: JsonProperty;
    /**
    * A flag indicate if the dataset format is Parquet
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#parquet CcModelBiasJobDefinition#parquet}
    */
...
export interface BatchTransformInputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#data_captured_destination_s3_uri CcModelBiasJobDefinition#data_captured_destination_s3_uri}
    */
    readonly dataCapturedDestinationS3Uri?: string;
    /**
    * The dataset format of the data to monitor
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#dataset_format CcModelBiasJobDefinition#dataset_format}
    */
    readonly datasetFormat?: DatasetFormatProperty;
    /**
    * Monitoring end time offset, e.g. PT0H
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#end_time_offset CcModelBiasJobDefinition#end_time_offset}
    */
    readonly endTimeOffset?: string;
    /**
    * JSONpath to locate features in JSONlines dataset
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#features_attribute CcModelBiasJobDefinition#features_attribute}
    */
    readonly featuresAttribute?: string;
    /**
    * Index or JSONpath to locate predicted label(s)
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#inference_attribute CcModelBiasJobDefinition#inference_attribute}
    */
    readonly inferenceAttribute?: string;
    /**
    * Path to the filesystem where the endpoint data is available to the container.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#local_path CcModelBiasJobDefinition#local_path}
    */
    readonly localPath?: string;
    /**
    * Index or JSONpath to locate probabilities
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#probability_attribute CcModelBiasJobDefinition#probability_attribute}
    */
    readonly probabilityAttribute?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#probability_threshold_attribute CcModelBiasJobDefinition#probability_threshold_attribute}
    */
    readonly probabilityThresholdAttribute?: number;
    /**
    * Whether input data distributed in Amazon S3 is fully replicated or sharded by an S3 key. Defauts to FullyReplicated
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#s3_data_distribution_type CcModelBiasJobDefinition#s3_data_distribution_type}
    */
    readonly s3DataDistributionType?: string;
    /**
    * Whether the Pipe or File is used as the input mode for transfering data for the monitoring job. Pipe mode is recommended for large datasets. File mode is useful for small files that fit in memory. Defaults to File.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#s3_input_mode CcModelBiasJobDefinition#s3_input_mode}
    */
    readonly s3InputMode?: string;
    /**
    * Monitoring start time offset, e.g. -PT1H
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#start_time_offset CcModelBiasJobDefinition#start_time_offset}
    */
...
export interface ModelBiasJobInputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#batch_transform_input CcModelBiasJobDefinition#batch_transform_input}
    */
    readonly batchTransformInput?: BatchTransformInputProperty;
    /**
    * The endpoint for a monitoring job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#endpoint_input CcModelBiasJobDefinition#endpoint_input}
    */
    readonly endpointInput?: EndpointInputProperty;
    /**
    * Ground truth input provided in S3 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#ground_truth_s3_input CcModelBiasJobDefinition#ground_truth_s3_input}
    */
    readonly groundTruthS3Input: MonitoringGroundTruthS3InputProperty;
}
export class ModelBiasJobInputPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): ModelBiasJobInputProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: ModelBiasJobInputProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export interface S3OutputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#s3_upload_mode CcModelBiasJobDefinition#s3_upload_mode}
    */
...
export interface MonitoringOutputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#s3_output CcModelBiasJobDefinition#s3_output}
    */
...
export interface MonitoringOutputConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#kms_key_id CcModelBiasJobDefinition#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * Monitoring outputs for monitoring jobs. This is where the output of the periodic monitoring jobs is uploaded.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#monitoring_outputs CcModelBiasJobDefinition#monitoring_outputs}
    */
...
export interface VpcConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#security_group_ids CcModelBiasJobDefinition#security_group_ids}
    */
    readonly securityGroupIds?: string[];
    /**
    * The ID of the subnets in the VPC to which you want to connect to your monitoring jobs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#subnets CcModelBiasJobDefinition#subnets}
    */
...
export interface NetworkConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#enable_inter_container_traffic_encryption CcModelBiasJobDefinition#enable_inter_container_traffic_encryption}
    */
    readonly enableInterContainerTrafficEncryption?: boolean | cdktn.IResolvable;
    /**
    * Whether to allow inbound and outbound network calls to and from the containers used for the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#enable_network_isolation CcModelBiasJobDefinition#enable_network_isolation}
    */
    readonly enableNetworkIsolation?: boolean | cdktn.IResolvable;
    /**
    * Specifies a VPC that your training jobs and hosted models have access to. Control access to and from your training and model containers by configuring the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#vpc_config CcModelBiasJobDefinition#vpc_config}
    */
...
export interface StoppingConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#max_runtime_in_seconds CcModelBiasJobDefinition#max_runtime_in_seconds}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#key CcModelBiasJobDefinition#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sagemaker_model_bias_job_definition#value CcModelBiasJobDefinition#value}
    */
