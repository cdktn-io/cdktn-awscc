...
export interface CcProcessingJobProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#app_specification CcProcessingJob#app_specification}
    */
    readonly appSpecification: CcProcessingJob.AppSpecificationProperty;
    /**
    * Sets the environment variables in the Docker container
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#environment CcProcessingJob#environment}
    */
    readonly environment?: { [key: string]: string };
    /**
    * Associates a SageMaker job as a trial component with an experiment and trial.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#experiment_config CcProcessingJob#experiment_config}
    */
    readonly experimentConfig?: CcProcessingJob.ExperimentConfigProperty;
    /**
    * Networking options for a job, such as network traffic encryption between containers, whether to allow inbound and outbound network calls to and from containers, and the VPC subnets and security groups to use for VPC-enabled jobs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#network_config CcProcessingJob#network_config}
    */
    readonly networkConfig?: CcProcessingJob.NetworkConfigProperty;
    /**
    * An array of inputs configuring the data to download into the processing container.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#processing_inputs CcProcessingJob#processing_inputs}
    */
    readonly processingInputs?: CcProcessingJob.ProcessingInputsObjectProperty[] | cdktn.IResolvable;
    /**
    * The name of the processing job. The name must be unique within an AWS Region in the AWS account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#processing_job_name CcProcessingJob#processing_job_name}
    */
    readonly processingJobName?: string;
    /**
    * Configuration for uploading output from the processing container.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#processing_output_config CcProcessingJob#processing_output_config}
    */
    readonly processingOutputConfig?: CcProcessingJob.ProcessingOutputConfigProperty;
    /**
    * Identifies the resources, ML compute instances, and ML storage volumes to deploy for a processing job. In distributed training, you specify more than one instance.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#processing_resources CcProcessingJob#processing_resources}
    */
    readonly processingResources: CcProcessingJob.ProcessingResourcesProperty;
    /**
    * The Amazon Resource Name (ARN) of an IAM role that Amazon SageMaker can assume to perform tasks on your behalf.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#role_arn CcProcessingJob#role_arn}
    */
    readonly roleArn: string;
    /**
    * Configures conditions under which the processing job should be stopped, such as how long the processing job has been running. After the condition is met, the processing job is stopped.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#stopping_condition CcProcessingJob#stopping_condition}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#tags CcProcessingJob#tags}
    */
...
export class CcProcessingJob extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcProcessingJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#import import section} in the documentation of this resource for the id to use
...
export interface AppSpecificationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#container_arguments CcProcessingJob#container_arguments}
    */
    readonly containerArguments?: string[];
    /**
    * The entrypoint for a container used to run a processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#container_entrypoint CcProcessingJob#container_entrypoint}
    */
    readonly containerEntrypoint?: string[];
    /**
    * The container image to be run by the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#image_uri CcProcessingJob#image_uri}
    */
...
export interface ExperimentConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#experiment_name CcProcessingJob#experiment_name}
    */
    readonly experimentName?: string;
    /**
    * The name of the experiment run to associate with the trial component.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#run_name CcProcessingJob#run_name}
    */
    readonly runName?: string;
    /**
    * The display name for the trial component. If this key isn't specified, the display name is the trial component name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#trial_component_display_name CcProcessingJob#trial_component_display_name}
    */
    readonly trialComponentDisplayName?: string;
    /**
    * The name of an existing trial to associate the trial component with. If not specified, a new trial is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#trial_name CcProcessingJob#trial_name}
    */
...
export interface VpcConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#security_group_ids CcProcessingJob#security_group_ids}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#subnets CcProcessingJob#subnets}
    */
...
export interface NetworkConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#enable_inter_container_traffic_encryption CcProcessingJob#enable_inter_container_traffic_encryption}
    */
    readonly enableInterContainerTrafficEncryption?: boolean | cdktn.IResolvable;
    /**
    * Whether to allow inbound and outbound network calls to and from the containers used for the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#enable_network_isolation CcProcessingJob#enable_network_isolation}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#vpc_config CcProcessingJob#vpc_config}
    */
...
export interface AthenaDatasetDefinitionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#catalog CcProcessingJob#catalog}
    */
    readonly catalog?: string;
    /**
    * The name of the database used in the Athena query execution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#database CcProcessingJob#database}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#kms_key_id CcProcessingJob#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * The compression used for Athena query results.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#output_compression CcProcessingJob#output_compression}
    */
    readonly outputCompression?: string;
    /**
    * The data storage format for Athena query results.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#output_format CcProcessingJob#output_format}
    */
    readonly outputFormat?: string;
    /**
    * The location in Amazon S3 where Athena query results are stored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#output_s3_uri CcProcessingJob#output_s3_uri}
    */
    readonly outputS3Uri?: string;
    /**
    * The SQL query statements, to be executed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#query_string CcProcessingJob#query_string}
    */
    readonly queryString?: string;
    /**
    * The name of the workgroup in which the Athena query is being started.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#work_group CcProcessingJob#work_group}
    */
...
export interface RedshiftDatasetDefinitionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#cluster_id CcProcessingJob#cluster_id}
    */
    readonly clusterId?: string;
    /**
    * The IAM role attached to your Redshift cluster that Amazon SageMaker uses to generate datasets.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#cluster_role_arn CcProcessingJob#cluster_role_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#db_user CcProcessingJob#db_user}
    */
...
export interface DatasetDefinitionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#athena_dataset_definition CcProcessingJob#athena_dataset_definition}
    */
    readonly athenaDatasetDefinition?: AthenaDatasetDefinitionProperty;
    /**
    * Whether the generated dataset is FullyReplicated or ShardedByS3Key (default).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#data_distribution_type CcProcessingJob#data_distribution_type}
    */
    readonly dataDistributionType?: string;
    /**
    * Whether to use File or Pipe input mode. In File (default) mode, Amazon SageMaker copies the data from the input source onto the local Amazon Elastic Block Store (Amazon EBS) volumes before starting your training algorithm. This is the most commonly used input mode. In Pipe mode, Amazon SageMaker streams input data from the source directly to your algorithm without using the EBS volume.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#input_mode CcProcessingJob#input_mode}
    */
    readonly inputMode?: string;
    /**
    * The local path where you want Amazon SageMaker to download the Dataset Definition inputs to run a processing job. LocalPath is an absolute path to the input data. This is a required parameter when AppManaged is False (default).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#local_path CcProcessingJob#local_path}
    */
    readonly localPath?: string;
    /**
    * Configuration for Redshift Dataset Definition input.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#redshift_dataset_definition CcProcessingJob#redshift_dataset_definition}
    */
...
export interface S3InputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_compression_type CcProcessingJob#s3_compression_type}
    */
    readonly s3CompressionType?: string;
    /**
    * Whether to distribute the data from Amazon S3 to all processing instances with `FullyReplicated`, or whether the data from Amazon S3 is shared by Amazon S3 key, downloading one shard of data to each processing instance.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_data_distribution_type CcProcessingJob#s3_data_distribution_type}
    */
    readonly s3DataDistributionType?: string;
    /**
    * Whether you use an S3Prefix or a ManifestFile for the data type. If you choose S3Prefix, S3Uri identifies a key name prefix. Amazon SageMaker uses all objects with the specified key name prefix for the processing job. If you choose ManifestFile, S3Uri identifies an object that is a manifest file containing a list of object keys that you want Amazon SageMaker to use for the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_data_type CcProcessingJob#s3_data_type}
    */
    readonly s3DataType?: string;
    /**
    * Whether to use File or Pipe input mode. In File mode, Amazon SageMaker copies the data from the input source onto the local ML storage volume before starting your processing container. This is the most commonly used input mode. In Pipe mode, Amazon SageMaker streams input data from the source directly to your processing container into named pipes without using the ML storage volume.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_input_mode CcProcessingJob#s3_input_mode}
    */
    readonly s3InputMode?: string;
    /**
    * The URI of the Amazon S3 prefix Amazon SageMaker downloads data required to run a processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_uri CcProcessingJob#s3_uri}
    */
...
export interface ProcessingInputsObjectProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#app_managed CcProcessingJob#app_managed}
    */
    readonly appManaged?: boolean | cdktn.IResolvable;
    /**
    * Configuration for Dataset Definition inputs. The Dataset Definition input must specify exactly one of either `AthenaDatasetDefinition` or `RedshiftDatasetDefinition` types.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#dataset_definition CcProcessingJob#dataset_definition}
    */
    readonly datasetDefinition?: DatasetDefinitionProperty;
    /**
    * The name for the processing job input.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#input_name CcProcessingJob#input_name}
    */
    readonly inputName?: string;
    /**
    * Configuration for downloading input data from Amazon S3 into the processing container.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_input CcProcessingJob#s3_input}
    */
...
export interface FeatureStoreOutputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#feature_group_name CcProcessingJob#feature_group_name}
    */
...
export interface S3OutputProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_upload_mode CcProcessingJob#s3_upload_mode}
    */
...
export interface ProcessingOutputsObjectProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#feature_store_output CcProcessingJob#feature_store_output}
    */
    readonly featureStoreOutput?: FeatureStoreOutputProperty;
    /**
    * The name for the processing job output.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#output_name CcProcessingJob#output_name}
    */
    readonly outputName?: string;
    /**
    * Configuration for uploading output data to Amazon S3 from the processing container.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#s3_output CcProcessingJob#s3_output}
    */
...
export interface ProcessingOutputConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#outputs CcProcessingJob#outputs}
    */
...
export interface ClusterConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#instance_count CcProcessingJob#instance_count}
    */
    readonly instanceCount: number;
    /**
    * The ML compute instance type for the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#instance_type CcProcessingJob#instance_type}
    */
    readonly instanceType: string;
    /**
    * The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the processing job.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#volume_kms_key_id CcProcessingJob#volume_kms_key_id}
    */
    readonly volumeKmsKeyId?: string;
    /**
    * The size of the ML storage volume in gigabytes that you want to provision. You must specify sufficient ML storage for your scenario.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#volume_size_in_gb CcProcessingJob#volume_size_in_gb}
    */
...
export interface ProcessingResourcesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#cluster_config CcProcessingJob#cluster_config}
    */
...
export interface StoppingConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#max_runtime_in_seconds CcProcessingJob#max_runtime_in_seconds}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#key CcProcessingJob#key}
    */
    readonly key?: string;
    /**
    * The tag value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/sagemaker_processing_job#value CcProcessingJob#value}
    */
