...
export interface CcAutoScalingConfigurationProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#auto_scaling_configuration_name CcAutoScalingConfiguration#auto_scaling_configuration_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#max_concurrency CcAutoScalingConfiguration#max_concurrency}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#max_size CcAutoScalingConfiguration#max_size}
    */
    readonly maxSize?: number;
    /**
    * The minimum number of instances that App Runner provisions for a service. The service always has at least MinSize provisioned instances. Some of them actively serve traffic. The rest of them (provisioned and inactive instances) are a cost-effective compute capacity reserve and are ready to be quickly activated. You pay for memory usage of all the provisioned instances. You pay for CPU usage of only the active subset.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#min_size CcAutoScalingConfiguration#min_size}
    */
    readonly minSize?: number;
    /**
    * A list of metadata items that you can associate with your auto scaling configuration resource. A tag is a key-value pair.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#tags CcAutoScalingConfiguration#tags}
    */
...
export class CcAutoScalingConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAutoScalingConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcAutoScalingConfigurationProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcAutoScalingConfigurationProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcAutoScalingConfiguration.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcAutoScalingConfiguration.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccAutoScalingConfigurationTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccAutoScalingConfigurationTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcAutoScalingConfiguration.TagPropertyList",
            },
        };
...
export function ccAutoScalingConfigurationTagPropertyToTerraform(struct?: CcAutoScalingConfiguration.TagProperty | cdktn.IResolvable): any {
...
export function ccAutoScalingConfigurationTagPropertyToHclTerraform(struct?: CcAutoScalingConfiguration.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#key CcAutoScalingConfiguration#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apprunner_auto_scaling_configuration#value CcAutoScalingConfiguration#value}
    */
