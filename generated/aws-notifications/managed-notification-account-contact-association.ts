...
export interface CcManagedNotificationAccountContactAssociationProps extends cdktn.TerraformMetaArguments {
    /**
    * This unique identifier for Contact
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/notifications_managed_notification_account_contact_association#contact_identifier CcManagedNotificationAccountContactAssociation#contact_identifier}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/notifications_managed_notification_account_contact_association#managed_notification_configuration_arn CcManagedNotificationAccountContactAssociation#managed_notification_configuration_arn}
    */
...
export class CcManagedNotificationAccountContactAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcManagedNotificationAccountContactAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/notifications_managed_notification_account_contact_association#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcManagedNotificationAccountContactAssociationProps
    */
    public constructor(scope: Construct, id: string, config: CcManagedNotificationAccountContactAssociationProps) {
        super(scope, id, {
...
export namespace CcManagedNotificationAccountContactAssociation {
}
