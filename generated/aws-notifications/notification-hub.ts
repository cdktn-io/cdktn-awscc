...
export interface CcNotificationHubProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/notifications_notification_hub#region CcNotificationHub#region}
    */
...
export class CcNotificationHub extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcNotificationHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/notifications_notification_hub#import import section} in the documentation of this resource for the id to use
