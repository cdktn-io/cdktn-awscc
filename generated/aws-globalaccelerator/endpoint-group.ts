...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcEndpointGroupProps extends cdktn.TerraformMetaArguments {
    /**
    * The list of endpoint objects.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#endpoint_configurations CcEndpointGroup#endpoint_configurations}
    */
    readonly endpointConfigurations?: CcEndpointGroup.EndpointConfigurationProperty[] | cdktn.IResolvable;
    /**
    * The name of the AWS Region where the endpoint group is located
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#endpoint_group_region CcEndpointGroup#endpoint_group_region}
    */
    readonly endpointGroupRegion: string;
    /**
    * The time in seconds between each health check for an endpoint. Must be a value of 10 or 30
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#health_check_interval_seconds CcEndpointGroup#health_check_interval_seconds}
    */
    readonly healthCheckIntervalSeconds?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#health_check_path CcEndpointGroup#health_check_path}
    */
    readonly healthCheckPath?: string;
    /**
    * The port that AWS Global Accelerator uses to check the health of endpoints in this endpoint group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#health_check_port CcEndpointGroup#health_check_port}
    */
    readonly healthCheckPort?: number;
    /**
    * The protocol that AWS Global Accelerator uses to check the health of endpoints in this endpoint group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#health_check_protocol CcEndpointGroup#health_check_protocol}
    */
    readonly healthCheckProtocol?: string;
    /**
    * The Amazon Resource Name (ARN) of the listener
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#listener_arn CcEndpointGroup#listener_arn}
    */
    readonly listenerArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#port_overrides CcEndpointGroup#port_overrides}
    */
    readonly portOverrides?: CcEndpointGroup.PortOverrideProperty[] | cdktn.IResolvable;
    /**
    * The number of consecutive health checks required to set the state of the endpoint to unhealthy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#threshold_count CcEndpointGroup#threshold_count}
    */
    readonly thresholdCount?: number;
    /**
    * The percentage of traffic to sent to an AWS Region
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#traffic_dial_percentage CcEndpointGroup#traffic_dial_percentage}
    */
    readonly trafficDialPercentage?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group awscc_globalaccelerator_endpoint_group}
*/
export class CcEndpointGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group awscc_globalaccelerator_endpoint_group} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcEndpointGroupProps
    */
    public constructor(scope: Construct, id: string, config: CcEndpointGroupProps) {
        super(scope, id, {
    ...
    private _endpointConfigurations = new CcEndpointGroup.EndpointConfigurationPropertyList(this, "endpoint_configurations", false);
    public get endpointConfigurations() {
        return this._endpointConfigurations;
    }
    public putEndpointConfigurations(value: CcEndpointGroup.EndpointConfigurationProperty[] | cdktn.IResolvable) {
    ...
    private _portOverrides = new CcEndpointGroup.PortOverridePropertyList(this, "port_overrides", false);
    public get portOverrides() {
        return this._portOverrides;
    }
    public putPortOverrides(value: CcEndpointGroup.PortOverrideProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            endpoint_configurations: cdktn.listMapper(ccEndpointGroupEndpointConfigurationPropertyToTerraform, false)(this._endpointConfigurations.internalValue),
            ...
            port_overrides: cdktn.listMapper(ccEndpointGroupPortOverridePropertyToTerraform, false)(this._portOverrides.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            endpoint_configurations: {
                value: cdktn.listMapperHcl(ccEndpointGroupEndpointConfigurationPropertyToHclTerraform, false)(this._endpointConfigurations.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcEndpointGroup.EndpointConfigurationPropertyList",
            },
            ...
            port_overrides: {
                value: cdktn.listMapperHcl(ccEndpointGroupPortOverridePropertyToHclTerraform, false)(this._portOverrides.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcEndpointGroup.PortOverridePropertyList",
            },
            threshold_count: {
...
export function ccEndpointGroupEndpointConfigurationPropertyToTerraform(struct?: CcEndpointGroup.EndpointConfigurationProperty | cdktn.IResolvable): any {
...
export function ccEndpointGroupEndpointConfigurationPropertyToHclTerraform(struct?: CcEndpointGroup.EndpointConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccEndpointGroupPortOverridePropertyToTerraform(struct?: CcEndpointGroup.PortOverrideProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccEndpointGroupPortOverridePropertyToHclTerraform(struct?: CcEndpointGroup.PortOverrideProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcEndpointGroup {
export interface EndpointConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#attachment_arn CcEndpointGroup#attachment_arn}
    */
    readonly attachmentArn?: string;
    /**
    * true if client ip should be preserved
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#client_ip_preservation_enabled CcEndpointGroup#client_ip_preservation_enabled}
    */
    readonly clientIpPreservationEnabled?: boolean | cdktn.IResolvable;
    /**
    * Id of the endpoint. For Network/Application Load Balancer this value is the ARN.  For EIP, this value is the allocation ID.  For EC2 instances, this is the EC2 instance ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#endpoint_id CcEndpointGroup#endpoint_id}
    */
    readonly endpointId?: string;
    /**
    * The weight for the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#weight CcEndpointGroup#weight}
    */
...
export interface PortOverrideProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#endpoint_port CcEndpointGroup#endpoint_port}
    */
    readonly endpointPort?: number;
    /**
    * A network port number
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/globalaccelerator_endpoint_group#listener_port CcEndpointGroup#listener_port}
    */
