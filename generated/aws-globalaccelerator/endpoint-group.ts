...
export interface CcEndpointGroupProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#endpoint_configurations CcEndpointGroup#endpoint_configurations}
    */
    readonly endpointConfigurations?: CcEndpointGroup.EndpointConfigurationProperty[] | cdktn.IResolvable;
    /**
    * The name of the AWS Region where the endpoint group is located
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#endpoint_group_region CcEndpointGroup#endpoint_group_region}
    */
    readonly endpointGroupRegion: string;
    /**
    * The time in seconds between each health check for an endpoint. Must be a value of 10 or 30
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#health_check_interval_seconds CcEndpointGroup#health_check_interval_seconds}
    */
    readonly healthCheckIntervalSeconds?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#health_check_path CcEndpointGroup#health_check_path}
    */
    readonly healthCheckPath?: string;
    /**
    * The port that AWS Global Accelerator uses to check the health of endpoints in this endpoint group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#health_check_port CcEndpointGroup#health_check_port}
    */
    readonly healthCheckPort?: number;
    /**
    * The protocol that AWS Global Accelerator uses to check the health of endpoints in this endpoint group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#health_check_protocol CcEndpointGroup#health_check_protocol}
    */
    readonly healthCheckProtocol?: string;
    /**
    * The Amazon Resource Name (ARN) of the listener
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#listener_arn CcEndpointGroup#listener_arn}
    */
    readonly listenerArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#port_overrides CcEndpointGroup#port_overrides}
    */
    readonly portOverrides?: CcEndpointGroup.PortOverrideProperty[] | cdktn.IResolvable;
    /**
    * The number of consecutive health checks required to set the state of the endpoint to unhealthy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#threshold_count CcEndpointGroup#threshold_count}
    */
    readonly thresholdCount?: number;
    /**
    * The percentage of traffic to sent to an AWS Region
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#traffic_dial_percentage CcEndpointGroup#traffic_dial_percentage}
    */
...
export class CcEndpointGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#import import section} in the documentation of this resource for the id to use
...
export interface EndpointConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#attachment_arn CcEndpointGroup#attachment_arn}
    */
    readonly attachmentArn?: string;
    /**
    * true if client ip should be preserved
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#client_ip_preservation_enabled CcEndpointGroup#client_ip_preservation_enabled}
    */
    readonly clientIpPreservationEnabled?: boolean | cdktn.IResolvable;
    /**
    * Id of the endpoint. For Network/Application Load Balancer this value is the ARN.  For EIP, this value is the allocation ID.  For EC2 instances, this is the EC2 instance ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#endpoint_id CcEndpointGroup#endpoint_id}
    */
    readonly endpointId?: string;
    /**
    * The weight for the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#weight CcEndpointGroup#weight}
    */
...
export interface PortOverrideProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#endpoint_port CcEndpointGroup#endpoint_port}
    */
    readonly endpointPort?: number;
    /**
    * A network port number
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_endpoint_group#listener_port CcEndpointGroup#listener_port}
    */
