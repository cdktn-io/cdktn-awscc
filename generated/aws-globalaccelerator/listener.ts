...
export interface CcListenerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#accelerator_arn CcListener#accelerator_arn}
    */
    readonly acceleratorArn: string;
    /**
    * Client affinity lets you direct all requests from a user to the same endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#client_affinity CcListener#client_affinity}
    */
    readonly clientAffinity?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#port_ranges CcListener#port_ranges}
    */
    readonly portRanges: CcListener.PortRangeProperty[] | cdktn.IResolvable;
    /**
    * The protocol for the listener.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#protocol CcListener#protocol}
    */
...
export class CcListener extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _portRanges = new CcListener.PortRangePropertyList(this, "port_ranges", false);
    public get portRanges() {
        return this._portRanges;
    }
    public putPortRanges(value: CcListener.PortRangeProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            port_ranges: cdktn.listMapper(ccListenerPortRangePropertyToTerraform, false)(this._portRanges.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            port_ranges: {
                value: cdktn.listMapperHcl(ccListenerPortRangePropertyToHclTerraform, false)(this._portRanges.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcListener.PortRangePropertyList",
            },
            protocol: {
...
export function ccListenerPortRangePropertyToTerraform(struct?: CcListener.PortRangeProperty | cdktn.IResolvable): any {
...
export function ccListenerPortRangePropertyToHclTerraform(struct?: CcListener.PortRangeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface PortRangeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#from_port CcListener#from_port}
    */
    readonly fromPort: number;
    /**
    * A network port number
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/globalaccelerator_listener#to_port CcListener#to_port}
    */
