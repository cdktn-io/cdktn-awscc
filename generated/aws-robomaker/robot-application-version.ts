...
export interface CcRobotApplicationVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/robomaker_robot_application_version#application CcRobotApplicationVersion#application}
    */
    readonly application: string;
    /**
    * The revision ID of robot application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/robomaker_robot_application_version#current_revision_id CcRobotApplicationVersion#current_revision_id}
    */
...
export class CcRobotApplicationVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRobotApplicationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/robomaker_robot_application_version#import import section} in the documentation of this resource for the id to use
