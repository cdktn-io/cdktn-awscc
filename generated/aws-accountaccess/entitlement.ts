...
export interface CcEntitlementProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#application_arn CcEntitlement#application_arn}
    */
    readonly applicationArn: string;
    /**
    * The entitlement details
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#entitlement CcEntitlement#entitlement}
    */
...
export class CcEntitlement extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEntitlement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#import import section} in the documentation of this resource for the id to use
...
export interface IdentityCenterPrincipalProperty {
    ...
    * The ID of the group
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#group_id CcEntitlement#group_id}
    */
    readonly groupId?: string;
    /**
    * The ID of the user
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#user_id CcEntitlement#user_id}
    */
...
export interface PrincipalProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#identity_center CcEntitlement#identity_center}
    */
...
export interface PrincipalRoleEntitlementProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#principal CcEntitlement#principal}
    */
    readonly principal: PrincipalProperty;
    /**
    * The ARN of the IAM role
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#role_arn CcEntitlement#role_arn}
    */
...
export interface EntitlementProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/accountaccess_entitlement#principal_role CcEntitlement#principal_role}
    */
