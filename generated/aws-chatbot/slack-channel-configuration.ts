...
export interface CcSlackChannelConfigurationProps extends cdktn.TerraformMetaArguments {
    /**
    * The name of the configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#configuration_name CcSlackChannelConfiguration#configuration_name}
    */
    readonly configurationName: string;
    /**
    * ARNs of Custom Actions to associate with notifications in the provided chat channel.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#customization_resource_arns CcSlackChannelConfiguration#customization_resource_arns}
    */
    readonly customizationResourceArns?: string[];
    /**
    * The list of IAM policy ARNs that are applied as channel guardrails. The AWS managed 'AdministratorAccess' policy is applied as a default if this is not set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#guardrail_policies CcSlackChannelConfiguration#guardrail_policies}
    */
    readonly guardrailPolicies?: string[];
    /**
    * The ARN of the IAM role that defines the permissions for AWS Chatbot
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#iam_role_arn CcSlackChannelConfiguration#iam_role_arn}
    */
    readonly iamRoleArn: string;
    /**
    * Specifies the logging level for this configuration:ERROR,INFO or NONE. This property affects the log entries pushed to Amazon CloudWatch logs
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#logging_level CcSlackChannelConfiguration#logging_level}
    */
    readonly loggingLevel?: string;
    /**
    * The id of the Slack channel
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#slack_channel_id CcSlackChannelConfiguration#slack_channel_id}
    */
    readonly slackChannelId: string;
    /**
    * The id of the Slack workspace
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#slack_workspace_id CcSlackChannelConfiguration#slack_workspace_id}
    */
    readonly slackWorkspaceId: string;
    /**
    * ARNs of SNS topics which delivers notifications to AWS Chatbot, for example CloudWatch alarm notifications.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#sns_topic_arns CcSlackChannelConfiguration#sns_topic_arns}
    */
    readonly snsTopicArns?: string[];
    /**
    * The tags to add to the configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#tags CcSlackChannelConfiguration#tags}
    */
    readonly tags?: CcSlackChannelConfiguration.TagProperty[] | cdktn.IResolvable;
    /**
    * Enables use of a user role requirement in your chat configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#user_role_required CcSlackChannelConfiguration#user_role_required}
    */
...
export class CcSlackChannelConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSlackChannelConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSlackChannelConfigurationProps
    */
    public constructor(scope: Construct, id: string, config: CcSlackChannelConfigurationProps) {
        super(scope, id, {
    ...
    private _tags = new CcSlackChannelConfiguration.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcSlackChannelConfiguration.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccSlackChannelConfigurationTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccSlackChannelConfigurationTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSlackChannelConfiguration.TagPropertyList",
            },
            user_role_required: {
...
export function ccSlackChannelConfigurationTagPropertyToTerraform(struct?: CcSlackChannelConfiguration.TagProperty | cdktn.IResolvable): any {
...
export function ccSlackChannelConfigurationTagPropertyToHclTerraform(struct?: CcSlackChannelConfiguration.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#key CcSlackChannelConfiguration#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/chatbot_slack_channel_configuration#value CcSlackChannelConfiguration#value}
    */
