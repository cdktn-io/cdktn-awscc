...
export interface CcNotificationChannelProps extends cdktn.TerraformMetaArguments {
    ...
    * A resource ARN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/fms_notification_channel#sns_role_name CcNotificationChannel#sns_role_name}
    */
    readonly snsRoleName: string;
    /**
    * A resource ARN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/fms_notification_channel#sns_topic_arn CcNotificationChannel#sns_topic_arn}
    */
...
export class CcNotificationChannel extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcNotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/fms_notification_channel#import import section} in the documentation of this resource for the id to use
