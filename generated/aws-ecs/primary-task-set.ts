...
export interface CcPrimaryTaskSetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecs_primary_task_set#cluster CcPrimaryTaskSet#cluster}
    */
    readonly cluster: string;
    /**
    * The short name or full Amazon Resource Name (ARN) of the service to create the task set in.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecs_primary_task_set#service CcPrimaryTaskSet#service}
    */
    readonly service: string;
    /**
    * The ID or full Amazon Resource Name (ARN) of the task set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecs_primary_task_set#task_set_id CcPrimaryTaskSet#task_set_id}
    */
...
export class CcPrimaryTaskSet extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPrimaryTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecs_primary_task_set#import import section} in the documentation of this resource for the id to use
