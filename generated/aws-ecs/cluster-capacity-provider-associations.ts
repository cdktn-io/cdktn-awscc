...
export interface CcClusterCapacityProviderAssociationsProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#capacity_providers CcClusterCapacityProviderAssociations#capacity_providers}
    */
    readonly capacityProviders?: string[];
    /**
    * The name of the cluster
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#cluster CcClusterCapacityProviderAssociations#cluster}
    */
    readonly cluster: string;
    /**
    * List of capacity providers to associate with the cluster
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#default_capacity_provider_strategy CcClusterCapacityProviderAssociations#default_capacity_provider_strategy}
    */
...
export class CcClusterCapacityProviderAssociations extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcClusterCapacityProviderAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#import import section} in the documentation of this resource for the id to use
...
export interface CapacityProviderStrategyProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#base CcClusterCapacityProviderAssociations#base}
    */
    readonly base?: number;
    /**
    * If using ec2 auto-scaling, the name of the associated capacity provider. Otherwise FARGATE, FARGATE_SPOT.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#capacity_provider CcClusterCapacityProviderAssociations#capacity_provider}
    */
    readonly capacityProvider: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecs_cluster_capacity_provider_associations#weight CcClusterCapacityProviderAssociations#weight}
    */
