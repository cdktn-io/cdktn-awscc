...
export interface CcIdentityProviderProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#identity_provider_details CcIdentityProvider#identity_provider_details}
    */
    readonly identityProviderDetails: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#identity_provider_name CcIdentityProvider#identity_provider_name}
    */
    readonly identityProviderName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#identity_provider_type CcIdentityProvider#identity_provider_type}
    */
    readonly identityProviderType: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#portal_arn CcIdentityProvider#portal_arn}
    */
    readonly portalArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#tags CcIdentityProvider#tags}
    */
...
export class CcIdentityProvider extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcIdentityProviderProps
    */
    public constructor(scope: Construct, id: string, config: CcIdentityProviderProps) {
        super(scope, id, {
    ...
    private _tags = new CcIdentityProvider.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcIdentityProvider.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccIdentityProviderTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccIdentityProviderTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcIdentityProvider.TagPropertyList",
            },
        };
...
export function ccIdentityProviderTagPropertyToTerraform(struct?: CcIdentityProvider.TagProperty | cdktn.IResolvable): any {
...
export function ccIdentityProviderTagPropertyToHclTerraform(struct?: CcIdentityProvider.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#key CcIdentityProvider#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesweb_identity_provider#value CcIdentityProvider#value}
    */
