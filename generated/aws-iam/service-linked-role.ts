...
export interface CcServiceLinkedRoleProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iam_service_linked_role#aws_service_name CcServiceLinkedRole#aws_service_name}
    */
    readonly awsServiceName?: string;
    /**
    * A string that you provide, which is combined with the service-provided prefix to form the complete role name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iam_service_linked_role#custom_suffix CcServiceLinkedRole#custom_suffix}
    */
    readonly customSuffix?: string;
    /**
    * The description of the role.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iam_service_linked_role#description CcServiceLinkedRole#description}
    */
...
export class CcServiceLinkedRole extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcServiceLinkedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iam_service_linked_role#import import section} in the documentation of this resource for the id to use
