...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3outposts_bucket_policy
...
export interface CcBucketPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3outposts_bucket_policy#bucket CcBucketPolicy#bucket}
    */
    readonly bucket: string;
    /**
    * A policy document containing permissions to add to the specified bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3outposts_bucket_policy#policy_document CcBucketPolicy#policy_document}
    */
...
export class CcBucketPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcBucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/s3outposts_bucket_policy#import import section} in the documentation of this resource for the id to use
