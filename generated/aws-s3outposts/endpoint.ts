...
export interface CcEndpointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#access_type CcEndpoint#access_type}
    */
    readonly accessType?: string;
    /**
    * The ID of the customer-owned IPv4 pool for the Endpoint. IP addresses will be allocated from this pool for the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#customer_owned_ipv_4_pool CcEndpoint#customer_owned_ipv_4_pool}
    */
    readonly customerOwnedIpv4Pool?: string;
    /**
    * The failure reason, if any, for a create or delete endpoint operation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#failed_reason CcEndpoint#failed_reason}
    */
    readonly failedReason?: CcEndpoint.FailedReasonProperty;
    /**
    * The id of the customer outpost on which the bucket resides.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#outpost_id CcEndpoint#outpost_id}
    */
    readonly outpostId: string;
    /**
    * The ID of the security group to use with the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#security_group_id CcEndpoint#security_group_id}
    */
    readonly securityGroupId: string;
    /**
    * The ID of the subnet in the selected VPC. The subnet must belong to the Outpost.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#subnet_id CcEndpoint#subnet_id}
    */
...
export class CcEndpoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#import import section} in the documentation of this resource for the id to use
...
export interface FailedReasonProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#error_code CcEndpoint#error_code}
    */
    readonly errorCode?: string;
    /**
    * Additional error details describing the endpoint failure and recommended action.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/s3outposts_endpoint#message CcEndpoint#message}
    */
