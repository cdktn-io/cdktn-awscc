...
export interface CcAccessPointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#bucket CcAccessPoint#bucket}
    */
    readonly bucket: string;
    /**
    * A name for the AccessPoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#name CcAccessPoint#name}
    */
    readonly name: string;
    /**
    * The access point policy associated with this access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#policy CcAccessPoint#policy}
    */
    readonly policy?: string;
    /**
    * Virtual Private Cloud (VPC) from which requests can be made to the AccessPoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#vpc_configuration CcAccessPoint#vpc_configuration}
    */
...
export class CcAccessPoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#import import section} in the documentation of this resource for the id to use
...
export interface VpcConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3outposts_access_point#vpc_id CcAccessPoint#vpc_id}
    */
