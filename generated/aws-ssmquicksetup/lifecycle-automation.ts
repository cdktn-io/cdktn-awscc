...
export interface CcLifecycleAutomationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssmquicksetup_lifecycle_automation#automation_document CcLifecycleAutomation#automation_document}
    */
    readonly automationDocument: string;
    /**
    * Parameters to be passed to the Automation Document
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssmquicksetup_lifecycle_automation#automation_parameters CcLifecycleAutomation#automation_parameters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssmquicksetup_lifecycle_automation#resource_key CcLifecycleAutomation#resource_key}
    */
    readonly resourceKey: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssmquicksetup_lifecycle_automation#tags CcLifecycleAutomation#tags}
    */
...
export class CcLifecycleAutomation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLifecycleAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssmquicksetup_lifecycle_automation#import import section} in the documentation of this resource for the id to use
