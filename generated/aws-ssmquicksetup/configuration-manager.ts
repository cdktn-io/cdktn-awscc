...
export interface CcConfigurationManagerProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#configuration_definitions CcConfigurationManager#configuration_definitions}
    */
    readonly configurationDefinitions: CcConfigurationManager.ConfigurationDefinitionProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#description CcConfigurationManager#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#name CcConfigurationManager#name}
    */
    readonly name?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#tags CcConfigurationManager#tags}
    */
...
export class CcConfigurationManager extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcConfigurationManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcConfigurationManagerProps
    */
    public constructor(scope: Construct, id: string, config: CcConfigurationManagerProps) {
        super(scope, id, {
    ...
    private _configurationDefinitions = new CcConfigurationManager.ConfigurationDefinitionPropertyList(this, "configuration_definitions", false);
    public get configurationDefinitions() {
        return this._configurationDefinitions;
    }
    public putConfigurationDefinitions(value: CcConfigurationManager.ConfigurationDefinitionProperty[] | cdktn.IResolvable) {
    ...
    private _statusSummaries = new CcConfigurationManager.StatusSummariesPropertyList(this, "status_summaries", false);
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            configuration_definitions: cdktn.listMapper(ccConfigurationManagerConfigurationDefinitionPropertyToTerraform, false)(this._configurationDefinitions.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            configuration_definitions: {
                value: cdktn.listMapperHcl(ccConfigurationManagerConfigurationDefinitionPropertyToHclTerraform, false)(this._configurationDefinitions.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcConfigurationManager.ConfigurationDefinitionPropertyList",
            },
            description: {
...
export function ccConfigurationManagerConfigurationDefinitionPropertyToTerraform(struct?: CcConfigurationManager.ConfigurationDefinitionProperty | cdktn.IResolvable): any {
...
export function ccConfigurationManagerConfigurationDefinitionPropertyToHclTerraform(struct?: CcConfigurationManager.ConfigurationDefinitionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccConfigurationManagerStatusSummariesPropertyToTerraform(struct?: CcConfigurationManager.StatusSummariesProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccConfigurationManagerStatusSummariesPropertyToHclTerraform(struct?: CcConfigurationManager.StatusSummariesProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface ConfigurationDefinitionProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#id CcConfigurationManager#id}
    *
    ...
    */
    readonly id?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#local_deployment_administration_role_arn CcConfigurationManager#local_deployment_administration_role_arn}
    */
    readonly localDeploymentAdministrationRoleArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#local_deployment_execution_role_name CcConfigurationManager#local_deployment_execution_role_name}
    */
    readonly localDeploymentExecutionRoleName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#parameters CcConfigurationManager#parameters}
    */
    readonly parameters: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#type CcConfigurationManager#type}
    */
    readonly type: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ssmquicksetup_configuration_manager#type_version CcConfigurationManager#type_version}
    */
