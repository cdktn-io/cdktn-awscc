...
export interface CcRouteProps extends cdktn.TerraformMetaArguments {
    ...
    * The API identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#api_id CcRoute#api_id}
    */
    readonly apiId: string;
    /**
    * Specifies whether an API key is required for the route. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#api_key_required CcRoute#api_key_required}
    */
    readonly apiKeyRequired?: boolean | cdktn.IResolvable;
    /**
    * The authorization scopes supported by this route.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#authorization_scopes CcRoute#authorization_scopes}
    */
    readonly authorizationScopes?: string[];
    /**
    * The authorization type for the route. For WebSocket APIs, valid values are ``NONE`` for open access, ``AWS_IAM`` for using AWS IAM permissions, and ``CUSTOM`` for using a Lambda authorizer. For HTTP APIs, valid values are ``NONE`` for open access, ``JWT`` for using JSON Web Tokens, ``AWS_IAM`` for using AWS IAM permissions, and ``CUSTOM`` for using a Lambda authorizer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#authorization_type CcRoute#authorization_type}
    */
    readonly authorizationType?: string;
    /**
    * The identifier of the ``Authorizer`` resource to be associated with this route. The authorizer identifier is generated by API Gateway when you created the authorizer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#authorizer_id CcRoute#authorizer_id}
    */
    readonly authorizerId?: string;
    /**
    * The model selection expression for the route. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#model_selection_expression CcRoute#model_selection_expression}
    */
    readonly modelSelectionExpression?: string;
    /**
    * The operation name for the route.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#operation_name CcRoute#operation_name}
    */
    readonly operationName?: string;
    /**
    * The request models for the route. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#request_models CcRoute#request_models}
    */
    readonly requestModels?: string;
    /**
    * The request parameters for the route. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#request_parameters CcRoute#request_parameters}
    */
    readonly requestParameters?: string;
    /**
    * The route key for the route. For HTTP APIs, the route key can be either ``$default``, or a combination of an HTTP method and resource path, for example, ``GET /pets``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#route_key CcRoute#route_key}
    */
    readonly routeKey: string;
    /**
    * The route response selection expression for the route. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#route_response_selection_expression CcRoute#route_response_selection_expression}
    */
    readonly routeResponseSelectionExpression?: string;
    /**
    * The target for the route.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#target CcRoute#target}
    */
...
export class CcRoute extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigatewayv2_route#import import section} in the documentation of this resource for the id to use
