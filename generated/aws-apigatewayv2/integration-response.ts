...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response
...
export interface CcIntegrationResponseProps extends cdktn.TerraformMetaArguments {
    ...
    * The API identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#api_id CcIntegrationResponse#api_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#content_handling_strategy CcIntegrationResponse#content_handling_strategy}
    */
    readonly contentHandlingStrategy?: string;
    /**
    * The integration ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#integration_id CcIntegrationResponse#integration_id}
    */
    readonly integrationId: string;
    /**
    * The integration response key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#integration_response_key CcIntegrationResponse#integration_response_key}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#response_parameters CcIntegrationResponse#response_parameters}
    */
    readonly responseParameters?: string;
    /**
    * The collection of response templates for the integration response as a string-to-string map of key-value pairs. Response templates are represented as a key/value map, with a content-type as the key and a template as the value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#response_templates CcIntegrationResponse#response_templates}
    */
    readonly responseTemplates?: string;
    /**
    * The template selection expression for the integration response. Supported only for WebSocket APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#template_selection_expression CcIntegrationResponse#template_selection_expression}
    */
...
export class CcIntegrationResponse extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcIntegrationResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_integration_response#import import section} in the documentation of this resource for the id to use
