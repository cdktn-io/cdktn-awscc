...
export interface CcDomainNameProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#domain_name CcDomainName#domain_name}
    */
    readonly domainName: string;
    /**
    * The domain name configurations.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#domain_name_configurations CcDomainName#domain_name_configurations}
    */
    readonly domainNameConfigurations?: CcDomainName.DomainNameConfigurationProperty[] | cdktn.IResolvable;
    /**
    * The mutual TLS authentication configuration for a custom domain name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#mutual_tls_authentication CcDomainName#mutual_tls_authentication}
    */
    readonly mutualTlsAuthentication?: CcDomainName.MutualTlsAuthenticationProperty;
    /**
    * The routing mode API Gateway uses to route traffic to your APIs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#routing_mode CcDomainName#routing_mode}
    */
    readonly routingMode?: string;
    /**
    * The collection of tags associated with a domain name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#tags CcDomainName#tags}
    */
...
export class CcDomainName extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _domainNameConfigurations = new CcDomainName.DomainNameConfigurationPropertyList(this, "domain_name_configurations", false);
    public get domainNameConfigurations() {
        return this._domainNameConfigurations;
    }
    public putDomainNameConfigurations(value: CcDomainName.DomainNameConfigurationProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            domain_name_configurations: cdktn.listMapper(ccDomainNameDomainNameConfigurationPropertyToTerraform, false)(this._domainNameConfigurations.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            domain_name_configurations: {
                value: cdktn.listMapperHcl(ccDomainNameDomainNameConfigurationPropertyToHclTerraform, false)(this._domainNameConfigurations.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDomainName.DomainNameConfigurationPropertyList",
            },
...
export function ccDomainNameDomainNameConfigurationPropertyToTerraform(struct?: CcDomainName.DomainNameConfigurationProperty | cdktn.IResolvable): any {
...
export function ccDomainNameDomainNameConfigurationPropertyToHclTerraform(struct?: CcDomainName.DomainNameConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface DomainNameConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#certificate_arn CcDomainName#certificate_arn}
    */
    readonly certificateArn?: string;
    /**
    * The user-friendly name of the certificate that will be used by the edge-optimized endpoint for this domain name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#certificate_name CcDomainName#certificate_name}
    */
    readonly certificateName?: string;
    /**
    * The endpoint type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#endpoint_type CcDomainName#endpoint_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#ip_address_type CcDomainName#ip_address_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#ownership_verification_certificate_arn CcDomainName#ownership_verification_certificate_arn}
    */
    readonly ownershipVerificationCertificateArn?: string;
    /**
    * The Transport Layer Security (TLS) version of the security policy for this domain name. The valid values are ``TLS_1_0`` and ``TLS_1_2``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#security_policy CcDomainName#security_policy}
    */
...
export class DomainNameConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): DomainNameConfigurationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: DomainNameConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class DomainNameConfigurationPropertyList extends cdktn.ComplexList {
    public internalValue? : DomainNameConfigurationProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): DomainNameConfigurationPropertyOutputReference {
        return new DomainNameConfigurationPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface MutualTlsAuthenticationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#truststore_uri CcDomainName#truststore_uri}
    */
    readonly truststoreUri?: string;
    /**
    * The version of the S3 object that contains your truststore. To specify a version, you must have versioning enabled for the S3 bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/apigatewayv2_domain_name#truststore_version CcDomainName#truststore_version}
    */
