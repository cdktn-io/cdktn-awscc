...
export interface CcPresetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#category CcPreset#category}
    */
    readonly category?: string;
    /**
    * The new description for the preset, if you are changing it.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#description CcPreset#description}
    */
    readonly description?: string;
    /**
    * The name of the preset that you are modifying.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#name CcPreset#name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#settings_json CcPreset#settings_json}
    */
    readonly settingsJson: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#tags CcPreset#tags}
    */
...
export class CcPreset extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPreset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/mediaconvert_preset#import import section} in the documentation of this resource for the id to use
