...
export interface CcQueueProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#cluster_id CcQueue#cluster_id}
    */
    readonly clusterId: string;
    /**
    * The list of compute node group configurations associated with the queue. Queues assign jobs to associated compute node groups.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#compute_node_group_configurations CcQueue#compute_node_group_configurations}
    */
    readonly computeNodeGroupConfigurations?: CcQueue.ComputeNodeGroupConfigurationProperty[] | cdktn.IResolvable;
    /**
    * The name that identifies the queue.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#name CcQueue#name}
    */
    readonly name?: string;
    /**
    * The Slurm configuration for the queue.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#slurm_configuration CcQueue#slurm_configuration}
    */
    readonly slurmConfiguration?: CcQueue.SlurmConfigurationProperty;
    /**
    * 1 or more tags added to the resource. Each tag consists of a tag key and tag value. The tag value is optional and can be an empty string.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#tags CcQueue#tags}
    */
...
export class CcQueue extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#import import section} in the documentation of this resource for the id to use
...
export interface ComputeNodeGroupConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#compute_node_group_id CcQueue#compute_node_group_id}
    */
...
export interface SlurmCustomSettingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#parameter_name CcQueue#parameter_name}
    */
    readonly parameterName?: string;
    /**
    * The value for the configured Slurm setting.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#parameter_value CcQueue#parameter_value}
    */
...
export interface SlurmConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcs_queue#slurm_custom_settings CcQueue#slurm_custom_settings}
    */
