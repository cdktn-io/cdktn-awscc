...
export interface CcClusterProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#deletion_protection_enabled CcCluster#deletion_protection_enabled}
    */
    readonly deletionProtectionEnabled?: boolean | cdktn.IResolvable;
    /**
    * The KMS key that encrypts data on the cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#kms_encryption_key CcCluster#kms_encryption_key}
    */
    readonly kmsEncryptionKey?: string;
    /**
    * The Multi-region properties associated to this cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#multi_region_properties CcCluster#multi_region_properties}
    */
    readonly multiRegionProperties?: CcCluster.MultiRegionPropertiesProperty;
    /**
    * The IAM policy applied to the cluster resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#policy_document CcCluster#policy_document}
    */
    readonly policyDocument?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#tags CcCluster#tags}
    */
...
export class CcCluster extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _encryptionDetails = new CcCluster.EncryptionDetailsPropertyOutputReference(this, "encryption_details");
    ...
    private _multiRegionProperties = new CcCluster.MultiRegionPropertiesPropertyOutputReference(this, "multi_region_properties");
    public get multiRegionProperties() {
        return this._multiRegionProperties;
    }
    public putMultiRegionProperties(value: CcCluster.MultiRegionPropertiesProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            multi_region_properties: ccClusterMultiRegionPropertiesPropertyToTerraform(this._multiRegionProperties.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            multi_region_properties: {
                value: ccClusterMultiRegionPropertiesPropertyToHclTerraform(this._multiRegionProperties.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcCluster.MultiRegionPropertiesProperty",
            },
            policy_document: {
...
export function ccClusterEncryptionDetailsPropertyToTerraform(struct?: CcCluster.EncryptionDetailsProperty): any {
...
export function ccClusterEncryptionDetailsPropertyToHclTerraform(struct?: CcCluster.EncryptionDetailsProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccClusterMultiRegionPropertiesPropertyToTerraform(struct?: CcCluster.MultiRegionPropertiesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccClusterMultiRegionPropertiesPropertyToHclTerraform(struct?: CcCluster.MultiRegionPropertiesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface MultiRegionPropertiesProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#clusters CcCluster#clusters}
    */
    readonly clusters?: string[];
    /**
    * The witness region in a multi-region cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#witness_region CcCluster#witness_region}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#key CcCluster#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dsql_cluster#value CcCluster#value}
    */
