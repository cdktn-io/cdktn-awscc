...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcStreamProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#exclusive_end_time CcStream#exclusive_end_time}
    */
    readonly exclusiveEndTime?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#inclusive_start_time CcStream#inclusive_start_time}
    */
    readonly inclusiveStartTime: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#kinesis_configuration CcStream#kinesis_configuration}
    */
    readonly kinesisConfiguration: CcStream.KinesisConfigurationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#ledger_name CcStream#ledger_name}
    */
    readonly ledgerName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#role_arn CcStream#role_arn}
    */
    readonly roleArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#stream_name CcStream#stream_name}
    */
    readonly streamName: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#tags CcStream#tags}
    */
    readonly tags?: CcStream.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream awscc_qldb_stream}
*/
export class CcStream extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream awscc_qldb_stream} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _kinesisConfiguration = new CcStream.KinesisConfigurationPropertyOutputReference(this, "kinesis_configuration");
    public get kinesisConfiguration() {
        return this._kinesisConfiguration;
    }
    public putKinesisConfiguration(value: CcStream.KinesisConfigurationProperty) {
    ...
    private _tags = new CcStream.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            kinesis_configuration: ccStreamKinesisConfigurationPropertyToTerraform(this._kinesisConfiguration.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            kinesis_configuration: {
                value: ccStreamKinesisConfigurationPropertyToHclTerraform(this._kinesisConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcStream.KinesisConfigurationProperty",
            },
            ledger_name: {
...
export function ccStreamKinesisConfigurationPropertyToTerraform(struct?: CcStream.KinesisConfigurationProperty | cdktn.IResolvable): any {
...
export function ccStreamKinesisConfigurationPropertyToHclTerraform(struct?: CcStream.KinesisConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface KinesisConfigurationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#aggregation_enabled CcStream#aggregation_enabled}
    */
    readonly aggregationEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#stream_arn CcStream#stream_arn}
    */
...
export class KinesisConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): KinesisConfigurationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: KinesisConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#key CcStream#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/qldb_stream#value CcStream#value}
    */
