...
export interface CcSceneProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#capabilities CcScene#capabilities}
    */
    readonly capabilities?: string[];
    /**
    * The relative path that specifies the location of the content definition file.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#content_location CcScene#content_location}
    */
    readonly contentLocation: string;
    /**
    * The description of the scene.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#description CcScene#description}
    */
    readonly description?: string;
    /**
    * The ID of the scene.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#scene_id CcScene#scene_id}
    */
    readonly sceneId: string;
    /**
    * A key-value pair of scene metadata for the scene.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#scene_metadata CcScene#scene_metadata}
    */
    readonly sceneMetadata?: { [key: string]: string };
    /**
    * A key-value pair to associate with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#tags CcScene#tags}
    */
    readonly tags?: { [key: string]: string };
    /**
    * The ID of the scene.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#workspace_id CcScene#workspace_id}
    */
...
export class CcScene extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcScene that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/iottwinmaker_scene#import import section} in the documentation of this resource for the id to use
