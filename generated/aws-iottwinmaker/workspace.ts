...
export interface CcWorkspaceProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#description CcWorkspace#description}
    */
    readonly description?: string;
    /**
    * The ARN of the execution role associated with the workspace.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#role CcWorkspace#role}
    */
    readonly role: string;
    /**
    * The ARN of the S3 bucket where resources associated with the workspace are stored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#s3_location CcWorkspace#s3_location}
    */
    readonly s3Location: string;
    /**
    * A map of key-value pairs to associate with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#tags CcWorkspace#tags}
    */
    readonly tags?: { [key: string]: string };
    /**
    * The ID of the workspace.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#workspace_id CcWorkspace#workspace_id}
    */
...
export class CcWorkspace extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iottwinmaker_workspace#import import section} in the documentation of this resource for the id to use
