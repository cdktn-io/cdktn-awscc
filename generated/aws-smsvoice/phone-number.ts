...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcPhoneNumberProps extends cdktn.TerraformMetaArguments {
    /**
    * When set to true the sender ID can't be deleted. By default this is set to false.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#deletion_protection_enabled CcPhoneNumber#deletion_protection_enabled}
    */
    readonly deletionProtectionEnabled?: boolean | cdktn.IResolvable;
    /**
    * The two-character code, in ISO 3166-1 alpha-2 format, for the country or region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#iso_country_code CcPhoneNumber#iso_country_code}
    */
    readonly isoCountryCode: string;
    /**
    * A keyword is a word that you can search for on a particular phone number or pool. It is also a specific word or phrase that an end user can send to your number to elicit a response, such as an informational message or a special offer. When your number receives a message that begins with a keyword, AWS End User Messaging SMS and Voice responds with a customizable message. Keywords "HELP" and "STOP" are mandatory keywords
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#mandatory_keywords CcPhoneNumber#mandatory_keywords}
    */
    readonly mandatoryKeywords: CcPhoneNumber.MandatoryKeywordsProperty;
    /**
    * Indicates if the phone number will be used for text messages, voice messages, or both.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#number_capabilities CcPhoneNumber#number_capabilities}
    */
    readonly numberCapabilities: string[];
    /**
    * The type of phone number to request.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#number_type CcPhoneNumber#number_type}
    */
    readonly numberType: string;
    /**
    * The name of the OptOutList to associate with the phone number. You can use the OptOutListName or OptOutListArn.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#opt_out_list_name CcPhoneNumber#opt_out_list_name}
    */
    readonly optOutListName?: string;
    /**
    * A keyword is a word that you can search for on a particular phone number or pool. It is also a specific word or phrase that an end user can send to your number to elicit a response, such as an informational message or a special offer. When your number receives a message that begins with a keyword, AWS End User Messaging SMS and Voice responds with a customizable message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#optional_keywords CcPhoneNumber#optional_keywords}
    */
    readonly optionalKeywords?: CcPhoneNumber.OptionalKeywordProperty[] | cdktn.IResolvable;
    /**
    * By default this is set to false. When an end recipient sends a message that begins with HELP or STOP to one of your dedicated numbers, AWS End User Messaging SMS and Voice automatically replies with a customizable message and adds the end recipient to the OptOutList. When set to true you're responsible for responding to HELP and STOP requests. You're also responsible for tracking and honoring opt-out requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#self_managed_opt_outs_enabled CcPhoneNumber#self_managed_opt_outs_enabled}
    */
    readonly selfManagedOptOutsEnabled?: boolean | cdktn.IResolvable;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#tags CcPhoneNumber#tags}
    */
    readonly tags?: CcPhoneNumber.TagProperty[] | cdktn.IResolvable;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#two_way CcPhoneNumber#two_way}
    */
    readonly twoWay?: CcPhoneNumber.TwoWayProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number awscc_smsvoice_phone_number}
*/
export class CcPhoneNumber extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcPhoneNumber resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcPhoneNumber to import
    * @param importFromId The id of the existing CcPhoneNumber that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcPhoneNumber to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number awscc_smsvoice_phone_number} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcPhoneNumberProps
    */
    public constructor(scope: Construct, id: string, config: CcPhoneNumberProps) {
        super(scope, id, {
    ...
    private _mandatoryKeywords = new CcPhoneNumber.MandatoryKeywordsPropertyOutputReference(this, "mandatory_keywords");
    public get mandatoryKeywords() {
        return this._mandatoryKeywords;
    }
    public putMandatoryKeywords(value: CcPhoneNumber.MandatoryKeywordsProperty) {
    ...
    private _optionalKeywords = new CcPhoneNumber.OptionalKeywordPropertyList(this, "optional_keywords", true);
    public get optionalKeywords() {
        return this._optionalKeywords;
    }
    public putOptionalKeywords(value: CcPhoneNumber.OptionalKeywordProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcPhoneNumber.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcPhoneNumber.TagProperty[] | cdktn.IResolvable) {
    ...
    private _twoWay = new CcPhoneNumber.TwoWayPropertyOutputReference(this, "two_way");
    public get twoWay() {
        return this._twoWay;
    }
    public putTwoWay(value: CcPhoneNumber.TwoWayProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            mandatory_keywords: ccPhoneNumberMandatoryKeywordsPropertyToTerraform(this._mandatoryKeywords.internalValue),
            ...
            optional_keywords: cdktn.listMapper(ccPhoneNumberOptionalKeywordPropertyToTerraform, false)(this._optionalKeywords.internalValue),
            self_managed_opt_outs_enabled: cdktn.booleanToTerraform(this._selfManagedOptOutsEnabled),
            tags: cdktn.listMapper(ccPhoneNumberTagPropertyToTerraform, false)(this._tags.internalValue),
            two_way: ccPhoneNumberTwoWayPropertyToTerraform(this._twoWay.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            mandatory_keywords: {
                value: ccPhoneNumberMandatoryKeywordsPropertyToHclTerraform(this._mandatoryKeywords.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcPhoneNumber.MandatoryKeywordsProperty",
            },
            number_capabilities: {
            ...
            optional_keywords: {
                value: cdktn.listMapperHcl(ccPhoneNumberOptionalKeywordPropertyToHclTerraform, false)(this._optionalKeywords.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcPhoneNumber.OptionalKeywordPropertyList",
            },
            ...
            tags: {
                value: cdktn.listMapperHcl(ccPhoneNumberTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcPhoneNumber.TagPropertyList",
            },
            two_way: {
                value: ccPhoneNumberTwoWayPropertyToHclTerraform(this._twoWay.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcPhoneNumber.TwoWayProperty",
            },
        };
...
export function ccPhoneNumberMandatoryKeywordPropertyToTerraform(struct?: CcPhoneNumber.MandatoryKeywordProperty | cdktn.IResolvable): any {
...
export function ccPhoneNumberMandatoryKeywordPropertyToHclTerraform(struct?: CcPhoneNumber.MandatoryKeywordProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberStopPropertyToTerraform(struct?: CcPhoneNumber.StopProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberStopPropertyToHclTerraform(struct?: CcPhoneNumber.StopProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberMandatoryKeywordsPropertyToTerraform(struct?: CcPhoneNumber.MandatoryKeywordsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        help: ccPhoneNumberMandatoryKeywordPropertyToTerraform(struct!.help),
        stop: ccPhoneNumberStopPropertyToTerraform(struct!.stop),
    }
}


export function ccPhoneNumberMandatoryKeywordsPropertyToHclTerraform(struct?: CcPhoneNumber.MandatoryKeywordsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        help: {
            value: ccPhoneNumberMandatoryKeywordPropertyToHclTerraform(struct!.help),
            isBlock: true,
            type: "struct",
            storageClassType: "MandatoryKeywordProperty",
        },
        stop: {
            value: ccPhoneNumberStopPropertyToHclTerraform(struct!.stop),
            isBlock: true,
            type: "struct",
...
export function ccPhoneNumberOptionalKeywordPropertyToTerraform(struct?: CcPhoneNumber.OptionalKeywordProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberOptionalKeywordPropertyToHclTerraform(struct?: CcPhoneNumber.OptionalKeywordProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberTagPropertyToTerraform(struct?: CcPhoneNumber.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberTagPropertyToHclTerraform(struct?: CcPhoneNumber.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberTwoWayPropertyToTerraform(struct?: CcPhoneNumber.TwoWayProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPhoneNumberTwoWayPropertyToHclTerraform(struct?: CcPhoneNumber.TwoWayProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcPhoneNumber {
export interface MandatoryKeywordProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#message CcPhoneNumber#message}
    */
...
export interface MandatoryKeywordsProperty {
    ...
    * A keyword is a word that you can search for on a particular phone number or pool. It is also a specific word or phrase that an end user can send to your number to elicit a response, such as an informational message or a special offer. When your number receives a message that begins with a keyword, AWS End User Messaging SMS and Voice responds with a customizable message. Keywords "HELP" and "STOP" are mandatory keywords
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#help CcPhoneNumber#help}
    */
    readonly help: MandatoryKeywordProperty;
    /**
    * A keyword is a word that you can search for on a particular phone number or pool. It is also a specific word or phrase that an end user can send to your number to elicit a response, such as an informational message or a special offer. When your number receives a message that begins with a keyword, AWS End User Messaging SMS and Voice responds with a customizable message. Keywords "HELP" and "STOP" are mandatory keywords
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#stop CcPhoneNumber#stop}
    */
...
export interface OptionalKeywordProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#action CcPhoneNumber#action}
    */
    readonly action?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#keyword CcPhoneNumber#keyword}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#key CcPhoneNumber#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#value CcPhoneNumber#value}
    */
...
export interface TwoWayProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#channel_arn CcPhoneNumber#channel_arn}
    */
    readonly channelArn?: string;
    /**
    * An optional IAM Role Arn for a service to assume, to be able to post inbound SMS messages.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#channel_role CcPhoneNumber#channel_role}
    */
    readonly channelRole?: string;
    /**
    * By default this is set to false. When set to true you can receive incoming text messages from your end recipients.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/smsvoice_phone_number#enabled CcPhoneNumber#enabled}
    */
