...
export interface CcRegistrationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/smsvoice_registration#registration_type CcRegistration#registration_type}
    */
    readonly registrationType: string;
    /**
    * An array of tags (key and value pairs) to associate with the registration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/smsvoice_registration#tags CcRegistration#tags}
    */
...
export class CcRegistration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/smsvoice_registration#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/smsvoice_registration#key CcRegistration#key}
    */
    readonly key?: string;
    /**
    * The string value associated with the key of the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/smsvoice_registration#value CcRegistration#value}
    */
