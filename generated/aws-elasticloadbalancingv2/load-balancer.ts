...
export interface CcLoadBalancerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#enable_capacity_reservation_provision_stabilize CcLoadBalancer#enable_capacity_reservation_provision_stabilize}
    */
    readonly enableCapacityReservationProvisionStabilize?: boolean | cdktn.IResolvable;
    /**
    * [Network Load Balancers with UDP listeners] Indicates whether to use an IPv6 prefix from each subnet for source NAT. The IP address type must be ``dualstack``. The default value is ``off``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#enable_prefix_for_ipv_6_source_nat CcLoadBalancer#enable_prefix_for_ipv_6_source_nat}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#enforce_security_group_inbound_rules_on_private_link_traffic CcLoadBalancer#enforce_security_group_inbound_rules_on_private_link_traffic}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#ip_address_type CcLoadBalancer#ip_address_type}
    */
    readonly ipAddressType?: string;
    /**
    * The ID of the IPv4 IPAM pool.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#ipv_4_ipam_pool_id CcLoadBalancer#ipv_4_ipam_pool_id}
    */
    readonly ipv4IpamPoolId?: string;
    /**
    * The load balancer attributes. Attributes that you do not modify retain their current values.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#load_balancer_attributes CcLoadBalancer#load_balancer_attributes}
    */
    readonly loadBalancerAttributes?: CcLoadBalancer.LoadBalancerAttributeProperty[] | cdktn.IResolvable;
    /**
    * The minimum capacity for a load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#minimum_load_balancer_capacity CcLoadBalancer#minimum_load_balancer_capacity}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#name CcLoadBalancer#name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#scheme CcLoadBalancer#scheme}
    */
    readonly scheme?: string;
    /**
    * [Application Load Balancers and Network Load Balancers] The IDs of the security groups for the load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#security_groups CcLoadBalancer#security_groups}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#subnet_mappings CcLoadBalancer#subnet_mappings}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#subnets CcLoadBalancer#subnets}
    */
    readonly subnets?: string[];
    /**
    * The tags to assign to the load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#tags CcLoadBalancer#tags}
    */
    readonly tags?: CcLoadBalancer.TagProperty[] | cdktn.IResolvable;
    /**
    * The type of load balancer. The default is ``application``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#type CcLoadBalancer#type}
    */
...
export class CcLoadBalancer extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLoadBalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _loadBalancerAttributes = new CcLoadBalancer.LoadBalancerAttributePropertyList(this, "load_balancer_attributes", true);
    public get loadBalancerAttributes() {
        return this._loadBalancerAttributes;
    }
    public putLoadBalancerAttributes(value: CcLoadBalancer.LoadBalancerAttributeProperty[] | cdktn.IResolvable) {
    ...
    private _minimumLoadBalancerCapacity = new CcLoadBalancer.MinimumLoadBalancerCapacityPropertyOutputReference(this, "minimum_load_balancer_capacity");
    public get minimumLoadBalancerCapacity() {
        return this._minimumLoadBalancerCapacity;
    }
    public putMinimumLoadBalancerCapacity(value: CcLoadBalancer.MinimumLoadBalancerCapacityProperty) {
    ...
    private _subnetMappings = new CcLoadBalancer.SubnetMappingPropertyList(this, "subnet_mappings", true);
    public get subnetMappings() {
        return this._subnetMappings;
    }
    public putSubnetMappings(value: CcLoadBalancer.SubnetMappingProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            load_balancer_attributes: cdktn.listMapper(ccLoadBalancerLoadBalancerAttributePropertyToTerraform, false)(this._loadBalancerAttributes.internalValue),
            minimum_load_balancer_capacity: ccLoadBalancerMinimumLoadBalancerCapacityPropertyToTerraform(this._minimumLoadBalancerCapacity.internalValue),
            ...
            subnet_mappings: cdktn.listMapper(ccLoadBalancerSubnetMappingPropertyToTerraform, false)(this._subnetMappings.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            load_balancer_attributes: {
                value: cdktn.listMapperHcl(ccLoadBalancerLoadBalancerAttributePropertyToHclTerraform, false)(this._loadBalancerAttributes.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLoadBalancer.LoadBalancerAttributePropertyList",
            },
            minimum_load_balancer_capacity: {
                value: ccLoadBalancerMinimumLoadBalancerCapacityPropertyToHclTerraform(this._minimumLoadBalancerCapacity.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLoadBalancer.MinimumLoadBalancerCapacityProperty",
            },
            name: {
            ...
            subnet_mappings: {
                value: cdktn.listMapperHcl(ccLoadBalancerSubnetMappingPropertyToHclTerraform, false)(this._subnetMappings.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLoadBalancer.SubnetMappingPropertyList",
            },
            subnets: {
...
export function ccLoadBalancerLoadBalancerAttributePropertyToTerraform(struct?: CcLoadBalancer.LoadBalancerAttributeProperty | cdktn.IResolvable): any {
...
export function ccLoadBalancerLoadBalancerAttributePropertyToHclTerraform(struct?: CcLoadBalancer.LoadBalancerAttributeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLoadBalancerMinimumLoadBalancerCapacityPropertyToTerraform(struct?: CcLoadBalancer.MinimumLoadBalancerCapacityProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLoadBalancerMinimumLoadBalancerCapacityPropertyToHclTerraform(struct?: CcLoadBalancer.MinimumLoadBalancerCapacityProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLoadBalancerSubnetMappingPropertyToTerraform(struct?: CcLoadBalancer.SubnetMappingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLoadBalancerSubnetMappingPropertyToHclTerraform(struct?: CcLoadBalancer.SubnetMappingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface LoadBalancerAttributeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#key CcLoadBalancer#key}
    */
    readonly key?: string;
    /**
    * The value of the attribute.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#value CcLoadBalancer#value}
    */
    readonly value?: string;
}
export class LoadBalancerAttributePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): LoadBalancerAttributeProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: LoadBalancerAttributeProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class LoadBalancerAttributePropertyList extends cdktn.ComplexList {
    public internalValue? : LoadBalancerAttributeProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): LoadBalancerAttributePropertyOutputReference {
        return new LoadBalancerAttributePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface MinimumLoadBalancerCapacityProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#capacity_units CcLoadBalancer#capacity_units}
    */
...
export class MinimumLoadBalancerCapacityPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): MinimumLoadBalancerCapacityProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: MinimumLoadBalancerCapacityProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export interface SubnetMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#allocation_id CcLoadBalancer#allocation_id}
    */
    readonly allocationId?: string;
    /**
    * [Network Load Balancers] The IPv6 address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#i_pv_6_address CcLoadBalancer#i_pv_6_address}
    */
    readonly iPv6Address?: string;
    /**
    * [Network Load Balancers] The private IPv4 address for an internal load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#private_i_pv_4_address CcLoadBalancer#private_i_pv_4_address}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#source_nat_ipv_6_prefix CcLoadBalancer#source_nat_ipv_6_prefix}
    */
    readonly sourceNatIpv6Prefix?: string;
    /**
    * The ID of the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticloadbalancingv2_load_balancer#subnet_id CcLoadBalancer#subnet_id}
    */
