...
export interface CcCloudWatchAlarmTemplateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#comparison_operator CcCloudWatchAlarmTemplate#comparison_operator}
    */
    readonly comparisonOperator: string;
    /**
    * The number of datapoints within the evaluation period that must be breaching to trigger the alarm.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#datapoints_to_alarm CcCloudWatchAlarmTemplate#datapoints_to_alarm}
    */
    readonly datapointsToAlarm?: number;
    /**
    * A resource's optional description.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#description CcCloudWatchAlarmTemplate#description}
    */
    readonly description?: string;
    /**
    * The number of periods over which data is compared to the specified threshold.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#evaluation_periods CcCloudWatchAlarmTemplate#evaluation_periods}
    */
    readonly evaluationPeriods?: number;
    /**
    * A cloudwatch alarm template group's identifier. Can be either be its id or current name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#group_identifier CcCloudWatchAlarmTemplate#group_identifier}
    */
    readonly groupIdentifier?: string;
    /**
    * The name of the metric associated with the alarm. Must be compatible with targetResourceType.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#metric_name CcCloudWatchAlarmTemplate#metric_name}
    */
    readonly metricName: string;
    /**
    * A resource's name. Names must be unique within the scope of a resource type in a specific region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#name CcCloudWatchAlarmTemplate#name}
    */
    readonly name: string;
    /**
    * The period, in seconds, over which the specified statistic is applied.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#period CcCloudWatchAlarmTemplate#period}
    */
    readonly period?: number;
    /**
    * The statistic to apply to the alarm's metric data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#statistic CcCloudWatchAlarmTemplate#statistic}
    */
    readonly statistic: string;
    /**
    * Represents the tags associated with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#tags CcCloudWatchAlarmTemplate#tags}
    */
    readonly tags?: { [key: string]: string };
    /**
    * The resource type this template should dynamically generate cloudwatch metric alarms for.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#target_resource_type CcCloudWatchAlarmTemplate#target_resource_type}
    */
    readonly targetResourceType: string;
    /**
    * The threshold value to compare with the specified statistic.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#threshold CcCloudWatchAlarmTemplate#threshold}
    */
    readonly threshold?: number;
    /**
    * Specifies how missing data points are treated when evaluating the alarm's condition.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#treat_missing_data CcCloudWatchAlarmTemplate#treat_missing_data}
    */
...
export class CcCloudWatchAlarmTemplate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCloudWatchAlarmTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_cloudwatch_alarm_template#import import section} in the documentation of this resource for the id to use
