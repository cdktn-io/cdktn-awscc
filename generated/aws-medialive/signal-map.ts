...
export interface CcSignalMapProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#cloudwatch_alarm_template_group_identifiers CcSignalMap#cloudwatch_alarm_template_group_identifiers}
    */
    readonly cloudwatchAlarmTemplateGroupIdentifiers?: string[];
    /**
    * A resource's optional description.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#description CcSignalMap#description}
    */
    readonly description?: string;
    /**
    * A top-level supported AWS resource ARN to discovery a signal map from.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#discovery_entry_point_arn CcSignalMap#discovery_entry_point_arn}
    */
    readonly discoveryEntryPointArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#event_bridge_rule_template_group_identifiers CcSignalMap#event_bridge_rule_template_group_identifiers}
    */
    readonly eventBridgeRuleTemplateGroupIdentifiers?: string[];
    /**
    * If true, will force a rediscovery of a signal map if an unchanged discoveryEntryPointArn is provided.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#force_rediscovery CcSignalMap#force_rediscovery}
    */
    readonly forceRediscovery?: boolean | cdktn.IResolvable;
    /**
    * A resource's name. Names must be unique within the scope of a resource type in a specific region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#name CcSignalMap#name}
    */
    readonly name: string;
    /**
    * Represents the tags associated with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#tags CcSignalMap#tags}
    */
...
export class CcSignalMap extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSignalMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/medialive_signal_map#import import section} in the documentation of this resource for the id to use
