...
export interface CcPermissionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/acmpca_permission#actions CcPermission#actions}
    */
    readonly actions: string[];
    /**
    * The Amazon Resource Name (ARN) of the Private Certificate Authority that grants the permission.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/acmpca_permission#certificate_authority_arn CcPermission#certificate_authority_arn}
    */
    readonly certificateAuthorityArn: string;
    /**
    * The AWS service or identity that receives the permission. At this time, the only valid principal is acm.amazonaws.com.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/acmpca_permission#principal CcPermission#principal}
    */
    readonly principal: string;
    /**
    * The ID of the calling account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/acmpca_permission#source_account CcPermission#source_account}
    */
...
export class CcPermission extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/acmpca_permission#import import section} in the documentation of this resource for the id to use
