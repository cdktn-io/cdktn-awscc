...
export interface CcEnabledControlProps extends cdktn.TerraformMetaArguments {
    ...
    * Arn of the control.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/controltower_enabled_control#control_identifier CcEnabledControl#control_identifier}
    */
    readonly controlIdentifier: string;
    /**
    * Arn for Organizational unit to which the control needs to be applied
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/controltower_enabled_control#target_identifier CcEnabledControl#target_identifier}
    */
...
export class CcEnabledControl extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnabledControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/controltower_enabled_control#import import section} in the documentation of this resource for the id to use
