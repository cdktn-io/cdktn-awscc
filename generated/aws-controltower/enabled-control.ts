...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcEnabledControlProps extends cdktn.TerraformMetaArguments {
    /**
    * Arn of the control.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control#control_identifier CcEnabledControl#control_identifier}
    */
    readonly controlIdentifier: string;
    /**
    * Arn for Organizational unit to which the control needs to be applied
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control#target_identifier CcEnabledControl#target_identifier}
    */
    readonly targetIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control awscc_controltower_enabled_control}
*/
export class CcEnabledControl extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnabledControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/controltower_enabled_control awscc_controltower_enabled_control} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcEnabledControlProps
    */
    public constructor(scope: Construct, id: string, config: CcEnabledControlProps) {
        super(scope, id, {
...
export namespace CcEnabledControl {
}
