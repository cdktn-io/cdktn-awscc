...
export interface CcAccountCustomizationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization#account_color CcAccountCustomization#account_color}
    */
    readonly accountColor?: string;
    /**
    * A list of AWS region identifiers visible to the account in the AWS Console.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization#visible_regions CcAccountCustomization#visible_regions}
    */
    readonly visibleRegions?: string[];
    /**
    * A list of AWS service identifiers visible to the account in the AWS Console.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization#visible_services CcAccountCustomization#visible_services}
    */
...
export class CcAccountCustomization extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccountCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/uxc_account_customization#import import section} in the documentation of this resource for the id to use
