...
export interface CcVolumeAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesinstances_volume_association#device CcVolumeAssociation#device}
    */
    readonly device: string;
    /**
    * Mode to use when disassociating the volume
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesinstances_volume_association#disassociate_mode CcVolumeAssociation#disassociate_mode}
    */
    readonly disassociateMode?: string;
    /**
    * ID of the volume to attach to the workspace instance
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesinstances_volume_association#volume_id CcVolumeAssociation#volume_id}
    */
    readonly volumeId: string;
    /**
    * ID of the workspace instance to associate with the volume
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesinstances_volume_association#workspace_instance_id CcVolumeAssociation#workspace_instance_id}
    */
...
export class CcVolumeAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVolumeAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/workspacesinstances_volume_association#import import section} in the documentation of this resource for the id to use
