...
export interface CcSubscriptionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pricingplanmanager_subscription#plan_family CcSubscription#plan_family}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pricingplanmanager_subscription#plan_tier CcSubscription#plan_tier}
    */
    readonly planTier: string;
    /**
    * The ARNs of resources associated with the subscription.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pricingplanmanager_subscription#resource_arns CcSubscription#resource_arns}
    */
    readonly resourceArns: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pricingplanmanager_subscription#usage_level CcSubscription#usage_level}
    */
...
export class CcSubscription extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pricingplanmanager_subscription#import import section} in the documentation of this resource for the id to use
