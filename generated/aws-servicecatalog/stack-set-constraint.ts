...
export interface CcStackSetConstraintProps extends cdktn.TerraformMetaArguments {
    ...
    * The language code.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#accept_language CcStackSetConstraint#accept_language}
    */
    readonly acceptLanguage?: string;
    /**
    * One or more AWS accounts that will have access to the provisioned product.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#account_list CcStackSetConstraint#account_list}
    */
    readonly accountList: string[];
    /**
    * AdminRole ARN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#admin_role CcStackSetConstraint#admin_role}
    */
    readonly adminRole: string;
    /**
    * The description of the constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#description CcStackSetConstraint#description}
    */
    readonly description: string;
    /**
    * ExecutionRole name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#execution_role CcStackSetConstraint#execution_role}
    */
    readonly executionRole: string;
    /**
    * The portfolio identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#portfolio_id CcStackSetConstraint#portfolio_id}
    */
    readonly portfolioId: string;
    /**
    * The product identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#product_id CcStackSetConstraint#product_id}
    */
    readonly productId: string;
    /**
    * One or more AWS Regions where the provisioned product will be available.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#region_list CcStackSetConstraint#region_list}
    */
    readonly regionList: string[];
    /**
    * Permission to create, update, and delete stack instances. Choose from ALLOWED and NOT_ALLOWED.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#stack_instance_control CcStackSetConstraint#stack_instance_control}
    */
...
export class CcStackSetConstraint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStackSetConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_stack_set_constraint#import import section} in the documentation of this resource for the id to use
