...
export interface CcLaunchRoleConstraintProps extends cdktn.TerraformMetaArguments {
    /**
    * The language code for the constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#accept_language CcLaunchRoleConstraint#accept_language}
    */
    readonly acceptLanguage?: string;
    /**
    * The description of the launch role constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#description CcLaunchRoleConstraint#description}
    */
    readonly description?: string;
    /**
    * The local IAM role name to use in the launch constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#local_role_name CcLaunchRoleConstraint#local_role_name}
    */
    readonly localRoleName?: string;
    /**
    * The ID of the portfolio to which this launch role constraint applies.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#portfolio_id CcLaunchRoleConstraint#portfolio_id}
    */
    readonly portfolioId: string;
    /**
    * The ID of the product to which this launch role constraint applies.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#product_id CcLaunchRoleConstraint#product_id}
    */
    readonly productId: string;
    /**
    * The ARN of the IAM role used for the launch constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#role_arn CcLaunchRoleConstraint#role_arn}
    */
...
export class CcLaunchRoleConstraint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLaunchRoleConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/servicecatalog_launch_role_constraint#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcLaunchRoleConstraintProps
    */
    public constructor(scope: Construct, id: string, config: CcLaunchRoleConstraintProps) {
        super(scope, id, {
...
export namespace CcLaunchRoleConstraint {
}
