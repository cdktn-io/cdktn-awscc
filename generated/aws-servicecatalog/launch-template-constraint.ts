...
export interface CcLaunchTemplateConstraintProps extends cdktn.TerraformMetaArguments {
    ...
    * The language code.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#accept_language CcLaunchTemplateConstraint#accept_language}
    */
    readonly acceptLanguage?: string;
    /**
    * The description of the constraint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#description CcLaunchTemplateConstraint#description}
    */
    readonly description?: string;
    /**
    * The portfolio identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#portfolio_id CcLaunchTemplateConstraint#portfolio_id}
    */
    readonly portfolioId: string;
    /**
    * The product identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#product_id CcLaunchTemplateConstraint#product_id}
    */
    readonly productId: string;
    /**
    * A json encoded string of the template constraint rules
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#rules CcLaunchTemplateConstraint#rules}
    */
...
export class CcLaunchTemplateConstraint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLaunchTemplateConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/servicecatalog_launch_template_constraint#import import section} in the documentation of this resource for the id to use
