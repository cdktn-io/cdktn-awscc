...
export interface CcPortfolioShareProps extends cdktn.TerraformMetaArguments {
    /**
    * The language code.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share#accept_language CcPortfolioShare#accept_language}
    */
    readonly acceptLanguage?: string;
    /**
    * The AWS account ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share#account_id CcPortfolioShare#account_id}
    */
    readonly accountId: string;
    /**
    * The portfolio identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share#portfolio_id CcPortfolioShare#portfolio_id}
    */
    readonly portfolioId: string;
    /**
    * Enables or disables TagOptions sharing when creating the portfolio share.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share#share_tag_options CcPortfolioShare#share_tag_options}
    */
...
export class CcPortfolioShare extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPortfolioShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcPortfolioShareProps
    */
    public constructor(scope: Construct, id: string, config: CcPortfolioShareProps) {
        super(scope, id, {
...
export namespace CcPortfolioShare {
}
