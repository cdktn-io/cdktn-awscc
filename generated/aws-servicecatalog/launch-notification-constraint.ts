...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcLaunchNotificationConstraintProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#accept_language CcLaunchNotificationConstraint#accept_language}
    */
    readonly acceptLanguage?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#description CcLaunchNotificationConstraint#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#notification_arns CcLaunchNotificationConstraint#notification_arns}
    */
    readonly notificationArns: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#portfolio_id CcLaunchNotificationConstraint#portfolio_id}
    */
    readonly portfolioId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#product_id CcLaunchNotificationConstraint#product_id}
    */
    readonly productId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint awscc_servicecatalog_launch_notification_constraint}
*/
export class CcLaunchNotificationConstraint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLaunchNotificationConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/servicecatalog_launch_notification_constraint awscc_servicecatalog_launch_notification_constraint} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcLaunchNotificationConstraintProps
    */
    public constructor(scope: Construct, id: string, config: CcLaunchNotificationConstraintProps) {
        super(scope, id, {
...
export namespace CcLaunchNotificationConstraint {
}
