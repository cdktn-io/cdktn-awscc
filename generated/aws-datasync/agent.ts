...
export interface CcAgentProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#activation_key CcAgent#activation_key}
    */
    readonly activationKey?: string;
    /**
    * The name configured for the agent. Text reference used to identify the agent in the console.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#agent_name CcAgent#agent_name}
    */
    readonly agentName?: string;
    /**
    * The ARNs of the security group used to protect your data transfer task subnets.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#security_group_arns CcAgent#security_group_arns}
    */
    readonly securityGroupArns?: string[];
    /**
    * The ARNs of the subnets in which DataSync will create elastic network interfaces for each data transfer task.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#subnet_arns CcAgent#subnet_arns}
    */
    readonly subnetArns?: string[];
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#tags CcAgent#tags}
    */
    readonly tags?: CcAgent.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of the VPC endpoint that the agent has access to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#vpc_endpoint_id CcAgent#vpc_endpoint_id}
    */
...
export class CcAgent extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _tags = new CcAgent.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcAgent.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccAgentTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccAgentTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcAgent.TagPropertyList",
            },
            vpc_endpoint_id: {
...
export function ccAgentTagPropertyToTerraform(struct?: CcAgent.TagProperty | cdktn.IResolvable): any {
...
export function ccAgentTagPropertyToHclTerraform(struct?: CcAgent.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#key CcAgent#key}
    */
    readonly key?: string;
    /**
    * The value for an AWS resource tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_agent#value CcAgent#value}
    */
