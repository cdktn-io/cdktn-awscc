...
export interface CcLocationSMBProps extends cdktn.TerraformMetaArguments {
    /**
    * The Amazon Resource Names (ARNs) of agents to use for a Simple Message Block (SMB) location.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#agent_arns CcLocationSMB#agent_arns}
    */
    readonly agentArns: string[];
    /**
    * The authentication mode used to determine identity of user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#authentication_type CcLocationSMB#authentication_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#cmk_secret_config CcLocationSMB#cmk_secret_config}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#custom_secret_config CcLocationSMB#custom_secret_config}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#dns_ip_addresses CcLocationSMB#dns_ip_addresses}
    */
    readonly dnsIpAddresses?: string[];
    /**
    * The name of the Windows domain that the SMB server belongs to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#domain CcLocationSMB#domain}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#kerberos_keytab CcLocationSMB#kerberos_keytab}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#kerberos_krb_5_conf CcLocationSMB#kerberos_krb_5_conf}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#kerberos_principal CcLocationSMB#kerberos_principal}
    */
    readonly kerberosPrincipal?: string;
    /**
    * The mount options used by DataSync to access the SMB server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#mount_options CcLocationSMB#mount_options}
    */
    readonly mountOptions?: CcLocationSMB.MountOptionsProperty;
    /**
    * The password of the user who can mount the share and has the permissions to access files and folders in the SMB share.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#password CcLocationSMB#password}
    */
    readonly password?: string;
    /**
    * The name of the SMB server. This value is the IP address or Domain Name Service (DNS) name of the SMB server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#server_hostname CcLocationSMB#server_hostname}
    */
    readonly serverHostname?: string;
    /**
    * The subdirectory in the SMB file system that is used to read data from the SMB source location or write data to the SMB destination
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#subdirectory CcLocationSMB#subdirectory}
    */
    readonly subdirectory?: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#tags CcLocationSMB#tags}
    */
    readonly tags?: CcLocationSMB.TagProperty[] | cdktn.IResolvable;
    /**
    * The user who can mount the share, has the permissions to access files and folders in the SMB share.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#user CcLocationSMB#user}
    */
...
export class CcLocationSMB extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLocationSMB that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcLocationSMBProps
    */
    public constructor(scope: Construct, id: string, config: CcLocationSMBProps) {
        super(scope, id, {
    ...
    private _cmkSecretConfig = new CcLocationSMB.CmkSecretConfigPropertyOutputReference(this, "cmk_secret_config");
    public get cmkSecretConfig() {
        return this._cmkSecretConfig;
    }
    public putCmkSecretConfig(value: CcLocationSMB.CmkSecretConfigProperty) {
    ...
    private _customSecretConfig = new CcLocationSMB.CustomSecretConfigPropertyOutputReference(this, "custom_secret_config");
    public get customSecretConfig() {
        return this._customSecretConfig;
    }
    public putCustomSecretConfig(value: CcLocationSMB.CustomSecretConfigProperty) {
    ...
    private _managedSecretConfig = new CcLocationSMB.ManagedSecretConfigPropertyOutputReference(this, "managed_secret_config");
    public get managedSecretConfig() {
        return this._managedSecretConfig;
    }

    // mount_options - computed: true, optional: true, required: false
    private _mountOptions = new CcLocationSMB.MountOptionsPropertyOutputReference(this, "mount_options");
    public get mountOptions() {
        return this._mountOptions;
    }
    public putMountOptions(value: CcLocationSMB.MountOptionsProperty) {
    ...
    private _tags = new CcLocationSMB.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcLocationSMB.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            cmk_secret_config: ccLocationSMBCmkSecretConfigPropertyToTerraform(this._cmkSecretConfig.internalValue),
            custom_secret_config: ccLocationSMBCustomSecretConfigPropertyToTerraform(this._customSecretConfig.internalValue),
            ...
            mount_options: ccLocationSMBMountOptionsPropertyToTerraform(this._mountOptions.internalValue),
            ...
            tags: cdktn.listMapper(ccLocationSMBTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            cmk_secret_config: {
                value: ccLocationSMBCmkSecretConfigPropertyToHclTerraform(this._cmkSecretConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLocationSMB.CmkSecretConfigProperty",
            },
            custom_secret_config: {
                value: ccLocationSMBCustomSecretConfigPropertyToHclTerraform(this._customSecretConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLocationSMB.CustomSecretConfigProperty",
            },
            dns_ip_addresses: {
            ...
            mount_options: {
                value: ccLocationSMBMountOptionsPropertyToHclTerraform(this._mountOptions.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLocationSMB.MountOptionsProperty",
            },
            password: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccLocationSMBTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLocationSMB.TagPropertyList",
            },
            user: {
...
export function ccLocationSMBCmkSecretConfigPropertyToTerraform(struct?: CcLocationSMB.CmkSecretConfigProperty | cdktn.IResolvable): any {
...
export function ccLocationSMBCmkSecretConfigPropertyToHclTerraform(struct?: CcLocationSMB.CmkSecretConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBCustomSecretConfigPropertyToTerraform(struct?: CcLocationSMB.CustomSecretConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBCustomSecretConfigPropertyToHclTerraform(struct?: CcLocationSMB.CustomSecretConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBManagedSecretConfigPropertyToTerraform(struct?: CcLocationSMB.ManagedSecretConfigProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBManagedSecretConfigPropertyToHclTerraform(struct?: CcLocationSMB.ManagedSecretConfigProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBMountOptionsPropertyToTerraform(struct?: CcLocationSMB.MountOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBMountOptionsPropertyToHclTerraform(struct?: CcLocationSMB.MountOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBTagPropertyToTerraform(struct?: CcLocationSMB.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLocationSMBTagPropertyToHclTerraform(struct?: CcLocationSMB.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcLocationSMB {
export interface CmkSecretConfigProperty {
    /**
    * Specifies the ARN for the customer-managed AWS KMS key used to encrypt the secret specified for SecretArn. DataSync provides this key to AWS Secrets Manager.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#kms_key_arn CcLocationSMB#kms_key_arn}
    */
...
export interface CustomSecretConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#secret_access_role_arn CcLocationSMB#secret_access_role_arn}
    */
    readonly secretAccessRoleArn?: string;
    /**
    * Specifies the ARN for a customer created AWS Secrets Manager secret.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#secret_arn CcLocationSMB#secret_arn}
    */
...
export interface MountOptionsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#version CcLocationSMB#version}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#key CcLocationSMB#key}
    */
    readonly key?: string;
    /**
    * The value for an AWS resource tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datasync_location_smb#value CcLocationSMB#value}
    */
