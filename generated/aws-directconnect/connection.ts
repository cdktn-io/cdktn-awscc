...
export interface CcConnectionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#bandwidth CcConnection#bandwidth}
    */
    readonly bandwidth: string;
    /**
    * The name of the connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#connection_name CcConnection#connection_name}
    */
    readonly connectionName: string;
    /**
    * The ID or ARN of the LAG to associate the connection with.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#lag_id CcConnection#lag_id}
    */
    readonly lagId?: string;
    /**
    * The location of the connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#location CcConnection#location}
    */
    readonly location: string;
    /**
    * The name of the service provider associated with the requested connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#provider_name CcConnection#provider_name}
    */
    readonly providerName?: string;
    /**
    * Indicates whether you want the connection to support MAC Security (MACsec).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#request_mac_sec CcConnection#request_mac_sec}
    */
    readonly requestMacSec?: boolean | cdktn.IResolvable;
    /**
    * The tags associated with the connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#tags CcConnection#tags}
    */
...
export class CcConnection extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#key CcConnection#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/directconnect_connection#value CcConnection#value}
    */
