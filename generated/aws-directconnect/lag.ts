...
export interface CcLagProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#connections_bandwidth CcLag#connections_bandwidth}
    */
    readonly connectionsBandwidth: string;
    /**
    * The name of the LAG.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#lag_name CcLag#lag_name}
    */
    readonly lagName: string;
    /**
    * The location for the LAG.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#location CcLag#location}
    */
    readonly location: string;
    /**
    * The minimum number of physical dedicated connections that must be operational for the LAG itself to be operational.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#minimum_links CcLag#minimum_links}
    */
    readonly minimumLinks?: number;
    /**
    * The name of the service provider associated with the requested LAG.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#provider_name CcLag#provider_name}
    */
    readonly providerName?: string;
    /**
    * Indicates whether you want the LAG to support MAC Security (MACsec).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#request_mac_sec CcLag#request_mac_sec}
    */
    readonly requestMacSec?: boolean | cdktn.IResolvable;
    /**
    * The tags associated with the LAG.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#tags CcLag#tags}
    */
...
export class CcLag extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#key CcLag#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/directconnect_lag#value CcLag#value}
    */
