...
export interface CcDirectConnectGatewayAssociationProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/directconnect_direct_connect_gateway_association#allowed_prefixes_to_direct_connect_gateway CcDirectConnectGatewayAssociation#allowed_prefixes_to_direct_connect_gateway}
    */
    readonly allowedPrefixesToDirectConnectGateway?: string[];
    /**
    * The ID or ARN of the virtual private gateway or transit gateway.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/directconnect_direct_connect_gateway_association#associated_gateway_id CcDirectConnectGatewayAssociation#associated_gateway_id}
    */
    readonly associatedGatewayId: string;
    /**
    * The ID or ARN of the Direct Connect gateway.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/directconnect_direct_connect_gateway_association#direct_connect_gateway_id CcDirectConnectGatewayAssociation#direct_connect_gateway_id}
    */
...
export class CcDirectConnectGatewayAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDirectConnectGatewayAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/directconnect_direct_connect_gateway_association#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcDirectConnectGatewayAssociationProps
    */
    public constructor(scope: Construct, id: string, config: CcDirectConnectGatewayAssociationProps) {
        super(scope, id, {
...
export namespace CcDirectConnectGatewayAssociation {
}
