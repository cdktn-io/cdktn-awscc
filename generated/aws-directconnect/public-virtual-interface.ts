...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcPublicVirtualInterfaceProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#allocate_public_virtual_interface_role_arn CcPublicVirtualInterface#allocate_public_virtual_interface_role_arn}
    */
    readonly allocatePublicVirtualInterfaceRoleArn?: string;
    /**
    * The BGP peers configured on this virtual interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#bgp_peers CcPublicVirtualInterface#bgp_peers}
    */
    readonly bgpPeers: CcPublicVirtualInterface.BgpPeerProperty[] | cdktn.IResolvable;
    /**
    * The ID or ARN of the connection or LAG.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#connection_id CcPublicVirtualInterface#connection_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#rate_limit CcPublicVirtualInterface#rate_limit}
    */
    readonly rateLimit?: string;
    /**
    * The routes to be advertised to the AWS network in this region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#route_filter_prefixes CcPublicVirtualInterface#route_filter_prefixes}
    */
    readonly routeFilterPrefixes?: string[];
    /**
    * The tags associated with the public virtual interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#tags CcPublicVirtualInterface#tags}
    */
    readonly tags?: CcPublicVirtualInterface.TagProperty[] | cdktn.IResolvable;
    /**
    * The name of the virtual interface assigned by the customer network. The name has a maximum of 100 characters. The following are valid characters: a-z, 0-9 and a hyphen (-).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#virtual_interface_name CcPublicVirtualInterface#virtual_interface_name}
    */
    readonly virtualInterfaceName: string;
    /**
    * The ID of the VLAN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#vlan CcPublicVirtualInterface#vlan}
    */
    readonly vlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface awscc_directconnect_public_virtual_interface}
*/
export class CcPublicVirtualInterface extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPublicVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface awscc_directconnect_public_virtual_interface} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcPublicVirtualInterfaceProps
    */
    public constructor(scope: Construct, id: string, config: CcPublicVirtualInterfaceProps) {
        super(scope, id, {
    ...
    private _bgpPeers = new CcPublicVirtualInterface.BgpPeerPropertyList(this, "bgp_peers", true);
    public get bgpPeers() {
        return this._bgpPeers;
    }
    public putBgpPeers(value: CcPublicVirtualInterface.BgpPeerProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcPublicVirtualInterface.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcPublicVirtualInterface.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            bgp_peers: cdktn.listMapper(ccPublicVirtualInterfaceBgpPeerPropertyToTerraform, false)(this._bgpPeers.internalValue),
            ...
            tags: cdktn.listMapper(ccPublicVirtualInterfaceTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            bgp_peers: {
                value: cdktn.listMapperHcl(ccPublicVirtualInterfaceBgpPeerPropertyToHclTerraform, false)(this._bgpPeers.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcPublicVirtualInterface.BgpPeerPropertyList",
            },
            connection_id: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccPublicVirtualInterfaceTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcPublicVirtualInterface.TagPropertyList",
            },
...
export function ccPublicVirtualInterfaceBgpPeerPropertyToTerraform(struct?: CcPublicVirtualInterface.BgpPeerProperty | cdktn.IResolvable): any {
...
export function ccPublicVirtualInterfaceBgpPeerPropertyToHclTerraform(struct?: CcPublicVirtualInterface.BgpPeerProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPublicVirtualInterfaceTagPropertyToTerraform(struct?: CcPublicVirtualInterface.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccPublicVirtualInterfaceTagPropertyToHclTerraform(struct?: CcPublicVirtualInterface.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcPublicVirtualInterface {
export interface BgpPeerProperty {
    /**
    * The address family for the BGP peer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#address_family CcPublicVirtualInterface#address_family}
    */
    readonly addressFamily: string;
    /**
    * The IP address assigned to the Amazon interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#amazon_address CcPublicVirtualInterface#amazon_address}
    */
    readonly amazonAddress?: string;
    /**
    * The autonomous system (AS) number for Border Gateway Protocol (BGP) configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#asn CcPublicVirtualInterface#asn}
    */
    readonly asn: string;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#auth_key CcPublicVirtualInterface#auth_key}
    */
    readonly authKey?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#bgp_peer_id CcPublicVirtualInterface#bgp_peer_id}
    */
    readonly bgpPeerId?: string;
    /**
    * The IP address assigned to the customer interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#customer_address CcPublicVirtualInterface#customer_address}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#key CcPublicVirtualInterface#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/directconnect_public_virtual_interface#value CcPublicVirtualInterface#value}
    */
