...
export interface CcSigningConfigurationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#rules CcSigningConfiguration#rules}
    */
...
export class CcSigningConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSigningConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#import import section} in the documentation of this resource for the id to use
...
export interface RepositoryFilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#filter CcSigningConfiguration#filter}
    */
    readonly filter?: string;
    /**
    * Type of repository filter
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#filter_type CcSigningConfiguration#filter_type}
    */
...
export interface RuleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#repository_filters CcSigningConfiguration#repository_filters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_signing_configuration#signing_profile_arn CcSigningConfiguration#signing_profile_arn}
    */
