...
export interface CcRepositoryCreationTemplateProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#applied_for CcRepositoryCreationTemplate#applied_for}
    */
    readonly appliedFor: string[];
    /**
    * The ARN of the role to be assumed by Amazon ECR. Amazon ECR will assume your supplied role when the customRoleArn is specified. When this field isn't specified, Amazon ECR will use the service-linked role for the repository creation template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#custom_role_arn CcRepositoryCreationTemplate#custom_role_arn}
    */
    readonly customRoleArn?: string;
    /**
    * The description associated with the repository creation template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#description CcRepositoryCreationTemplate#description}
    */
    readonly description?: string;
    /**
    * The encryption configuration associated with the repository creation template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#encryption_configuration CcRepositoryCreationTemplate#encryption_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#image_tag_mutability CcRepositoryCreationTemplate#image_tag_mutability}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#image_tag_mutability_exclusion_filters CcRepositoryCreationTemplate#image_tag_mutability_exclusion_filters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#lifecycle_policy CcRepositoryCreationTemplate#lifecycle_policy}
    */
    readonly lifecyclePolicy?: string;
    /**
    * The repository namespace prefix associated with the repository creation template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#prefix CcRepositoryCreationTemplate#prefix}
    */
    readonly prefix: string;
    /**
    * The repository policy to apply to repositories created using the template. A repository policy is a permissions policy associated with a repository to control access permissions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#repository_policy CcRepositoryCreationTemplate#repository_policy}
    */
    readonly repositoryPolicy?: string;
    /**
    * The metadata to apply to the repository to help you categorize and organize. Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#resource_tags CcRepositoryCreationTemplate#resource_tags}
    */
...
export class CcRepositoryCreationTemplate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRepositoryCreationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcRepositoryCreationTemplateProps
    */
    public constructor(scope: Construct, id: string, config: CcRepositoryCreationTemplateProps) {
        super(scope, id, {
    ...
    private _encryptionConfiguration = new CcRepositoryCreationTemplate.EncryptionConfigurationPropertyOutputReference(this, "encryption_configuration");
    public get encryptionConfiguration() {
        return this._encryptionConfiguration;
    }
    public putEncryptionConfiguration(value: CcRepositoryCreationTemplate.EncryptionConfigurationProperty) {
    ...
    private _imageTagMutabilityExclusionFilters = new CcRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterPropertyList(this, "image_tag_mutability_exclusion_filters", false);
    public get imageTagMutabilityExclusionFilters() {
        return this._imageTagMutabilityExclusionFilters;
    }
    public putImageTagMutabilityExclusionFilters(value: CcRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty[] | cdktn.IResolvable) {
    ...
    private _resourceTags = new CcRepositoryCreationTemplate.TagPropertyList(this, "resource_tags", true);
    public get resourceTags() {
        return this._resourceTags;
    }
    public putResourceTags(value: CcRepositoryCreationTemplate.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            encryption_configuration: ccRepositoryCreationTemplateEncryptionConfigurationPropertyToTerraform(this._encryptionConfiguration.internalValue),
            image_tag_mutability: cdktn.stringToTerraform(this._imageTagMutability),
            image_tag_mutability_exclusion_filters: cdktn.listMapper(ccRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToTerraform, false)(this._imageTagMutabilityExclusionFilters.internalValue),
            ...
            resource_tags: cdktn.listMapper(ccRepositoryCreationTemplateTagPropertyToTerraform, false)(this._resourceTags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            encryption_configuration: {
                value: ccRepositoryCreationTemplateEncryptionConfigurationPropertyToHclTerraform(this._encryptionConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcRepositoryCreationTemplate.EncryptionConfigurationProperty",
            },
            ...
            image_tag_mutability_exclusion_filters: {
                value: cdktn.listMapperHcl(ccRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToHclTerraform, false)(this._imageTagMutabilityExclusionFilters.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterPropertyList",
            },
            lifecycle_policy: {
            ...
            resource_tags: {
                value: cdktn.listMapperHcl(ccRepositoryCreationTemplateTagPropertyToHclTerraform, false)(this._resourceTags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcRepositoryCreationTemplate.TagPropertyList",
            },
        };
...
export function ccRepositoryCreationTemplateEncryptionConfigurationPropertyToTerraform(struct?: CcRepositoryCreationTemplate.EncryptionConfigurationProperty | cdktn.IResolvable): any {
...
export function ccRepositoryCreationTemplateEncryptionConfigurationPropertyToHclTerraform(struct?: CcRepositoryCreationTemplate.EncryptionConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToTerraform(struct?: CcRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToHclTerraform(struct?: CcRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryCreationTemplateTagPropertyToTerraform(struct?: CcRepositoryCreationTemplate.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryCreationTemplateTagPropertyToHclTerraform(struct?: CcRepositoryCreationTemplate.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcRepositoryCreationTemplate {
export interface EncryptionConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#encryption_type CcRepositoryCreationTemplate#encryption_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#kms_key CcRepositoryCreationTemplate#kms_key}
    */
...
export interface ImageTagMutabilityExclusionFilterProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#image_tag_mutability_exclusion_filter_type CcRepositoryCreationTemplate#image_tag_mutability_exclusion_filter_type}
    */
    readonly imageTagMutabilityExclusionFilterType?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#image_tag_mutability_exclusion_filter_value CcRepositoryCreationTemplate#image_tag_mutability_exclusion_filter_value}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#key CcRepositoryCreationTemplate#key}
    */
    readonly key?: string;
    /**
    * A ``value`` acts as a descriptor within a tag category (key).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_repository_creation_template#value CcRepositoryCreationTemplate#value}
    */
