...
export interface CcPullTimeUpdateExclusionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_pull_time_update_exclusion#principal_arn CcPullTimeUpdateExclusion#principal_arn}
    */
...
export class CcPullTimeUpdateExclusion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPullTimeUpdateExclusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ecr_pull_time_update_exclusion#import import section} in the documentation of this resource for the id to use
