...
export interface CcRegistryPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecr_registry_policy#policy_text CcRegistryPolicy#policy_text}
    */
...
export class CcRegistryPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRegistryPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ecr_registry_policy#import import section} in the documentation of this resource for the id to use
