...
export interface CcPullThroughCacheRuleProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#credential_arn CcPullThroughCacheRule#credential_arn}
    */
    readonly credentialArn?: string;
    /**
    * The ARN of the IAM role associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#custom_role_arn CcPullThroughCacheRule#custom_role_arn}
    */
    readonly customRoleArn?: string;
    /**
    * The Amazon ECR repository prefix associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#ecr_repository_prefix CcPullThroughCacheRule#ecr_repository_prefix}
    */
    readonly ecrRepositoryPrefix?: string;
    /**
    * The name of the upstream source registry associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#upstream_registry CcPullThroughCacheRule#upstream_registry}
    */
    readonly upstreamRegistry?: string;
    /**
    * The upstream registry URL associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#upstream_registry_url CcPullThroughCacheRule#upstream_registry_url}
    */
    readonly upstreamRegistryUrl?: string;
    /**
    * The upstream repository prefix associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#upstream_repository_prefix CcPullThroughCacheRule#upstream_repository_prefix}
    */
...
export class CcPullThroughCacheRule extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPullThroughCacheRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ecr_pull_through_cache_rule#import import section} in the documentation of this resource for the id to use
