...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcPullThroughCacheRuleProps extends cdktn.TerraformMetaArguments {
    /**
    * The ARN of the Secrets Manager secret associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#credential_arn CcPullThroughCacheRule#credential_arn}
    */
    readonly credentialArn?: string;
    /**
    * The ARN of the IAM role associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#custom_role_arn CcPullThroughCacheRule#custom_role_arn}
    */
    readonly customRoleArn?: string;
    /**
    * The Amazon ECR repository prefix associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#ecr_repository_prefix CcPullThroughCacheRule#ecr_repository_prefix}
    */
    readonly ecrRepositoryPrefix?: string;
    /**
    * The name of the upstream source registry associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#upstream_registry CcPullThroughCacheRule#upstream_registry}
    */
    readonly upstreamRegistry?: string;
    /**
    * The upstream registry URL associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#upstream_registry_url CcPullThroughCacheRule#upstream_registry_url}
    */
    readonly upstreamRegistryUrl?: string;
    /**
    * The upstream repository prefix associated with the pull through cache rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#upstream_repository_prefix CcPullThroughCacheRule#upstream_repository_prefix}
    */
    readonly upstreamRepositoryPrefix?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule awscc_ecr_pull_through_cache_rule}
*/
export class CcPullThroughCacheRule extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcPullThroughCacheRule resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcPullThroughCacheRule to import
    * @param importFromId The id of the existing CcPullThroughCacheRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcPullThroughCacheRule to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ecr_pull_through_cache_rule awscc_ecr_pull_through_cache_rule} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcPullThroughCacheRuleProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcPullThroughCacheRuleProps = {}) {
        super(scope, id, {
...
export namespace CcPullThroughCacheRule {
}
