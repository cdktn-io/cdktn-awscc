...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate
...
export interface CcCertificateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#certificate_authority_arn CcCertificate#certificate_authority_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#certificate_export CcCertificate#certificate_export}
    */
    readonly certificateExport?: string;
    /**
    * You can opt out of certificate transparency logging by specifying the DISABLED option. Opt in by specifying ENABLED.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#certificate_transparency_logging_preference CcCertificate#certificate_transparency_logging_preference}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#domain_name CcCertificate#domain_name}
    */
    readonly domainName: string;
    /**
    * Domain information that domain name registrars use to verify your identity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#domain_validation_options CcCertificate#domain_validation_options}
    */
    readonly domainValidationOptions?: CcCertificate.DomainValidationOptionProperty[] | cdktn.IResolvable;
    /**
    * Specifies the algorithm of the public and private key pair that your certificate uses to encrypt data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#key_algorithm CcCertificate#key_algorithm}
    */
    readonly keyAlgorithm?: string;
    /**
    * Additional FQDNs to be included in the Subject Alternative Name extension of the ACM certificate.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#subject_alternative_names CcCertificate#subject_alternative_names}
    */
    readonly subjectAlternativeNames?: string[];
    /**
    * Key-value pairs that can identify the certificate.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#tags CcCertificate#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#validation_method CcCertificate#validation_method}
    */
    readonly validationMethod?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate awscc_certificatemanager_certificate}
*/
export class CcCertificate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate awscc_certificatemanager_certificate} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _domainValidationOptions = new CcCertificate.DomainValidationOptionPropertyList(this, "domain_validation_options", false);
    public get domainValidationOptions() {
        return this._domainValidationOptions;
    }
    public putDomainValidationOptions(value: CcCertificate.DomainValidationOptionProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcCertificate.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcCertificate.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            domain_validation_options: cdktn.listMapper(ccCertificateDomainValidationOptionPropertyToTerraform, false)(this._domainValidationOptions.internalValue),
            ...
            tags: cdktn.listMapper(ccCertificateTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            domain_validation_options: {
                value: cdktn.listMapperHcl(ccCertificateDomainValidationOptionPropertyToHclTerraform, false)(this._domainValidationOptions.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCertificate.DomainValidationOptionPropertyList",
            },
            key_algorithm: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccCertificateTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcCertificate.TagPropertyList",
            },
            validation_method: {
...
export function ccCertificateDomainValidationOptionPropertyToTerraform(struct?: CcCertificate.DomainValidationOptionProperty | cdktn.IResolvable): any {
...
export function ccCertificateDomainValidationOptionPropertyToHclTerraform(struct?: CcCertificate.DomainValidationOptionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCertificateTagPropertyToTerraform(struct?: CcCertificate.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccCertificateTagPropertyToHclTerraform(struct?: CcCertificate.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface DomainValidationOptionProperty {
    ...
    */
    readonly domainName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#hosted_zone_id CcCertificate#hosted_zone_id}
    */
    readonly hostedZoneId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#validation_domain CcCertificate#validation_domain}
    */
    readonly validationDomain?: string;
}
export class DomainValidationOptionPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): DomainValidationOptionProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: DomainValidationOptionProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class DomainValidationOptionPropertyList extends cdktn.ComplexList {
    public internalValue? : DomainValidationOptionProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): DomainValidationOptionPropertyOutputReference {
        return new DomainValidationOptionPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface TagProperty {
    ...
    * The tag's key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#key CcCertificate#key}
    */
    readonly key?: string;
    /**
    * The tag's value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/certificatemanager_certificate#value CcCertificate#value}
    */
