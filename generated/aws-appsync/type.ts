...
export interface CcTypeProps extends cdktn.TerraformMetaArguments {
    ...
    * The API ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/appsync_type#api_id CcType#api_id}
    */
    readonly apiId: string;
    /**
    * The type definition, in GraphQL Schema Definition Language (SDL) format.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/appsync_type#definition CcType#definition}
    */
    readonly definition: string;
    /**
    * The type format: SDL or JSON.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/appsync_type#format CcType#format}
    */
...
export class CcType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/appsync_type#import import section} in the documentation of this resource for the id to use
