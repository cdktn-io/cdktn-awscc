...
export interface CcResolverProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#api_id CcResolver#api_id}
    */
    readonly apiId: string;
    /**
    * The caching configuration for the resolver.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#caching_config CcResolver#caching_config}
    */
    readonly cachingConfig?: CcResolver.CachingConfigProperty;
    /**
    * The ``resolver`` code that contains the request and response functions. When code is used, the ``runtime`` is required. The runtime value must be ``APPSYNC_JS``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#code CcResolver#code}
    */
    readonly code?: string;
    /**
    * The Amazon S3 endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#code_s3_location CcResolver#code_s3_location}
    */
    readonly codeS3Location?: string;
    /**
    * The resolver data source name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#data_source_name CcResolver#data_source_name}
    */
    readonly dataSourceName?: string;
    /**
    * The GraphQL field on a type that invokes the resolver.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#field_name CcResolver#field_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#kind CcResolver#kind}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#max_batch_size CcResolver#max_batch_size}
    */
    readonly maxBatchSize?: number;
    /**
    * Enables or disables enhanced resolver metrics for specified resolvers. Note that ``MetricsConfig`` won't be used unless the ``resolverLevelMetricsBehavior`` value is set to ``PER_RESOLVER_METRICS``. If the ``resolverLevelMetricsBehavior`` is set to ``FULL_REQUEST_RESOLVER_METRICS`` instead, ``MetricsConfig`` will be ignored. However, you can still set its value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#metrics_config CcResolver#metrics_config}
    */
    readonly metricsConfig?: string;
    /**
    * Functions linked with the pipeline resolver.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#pipeline_config CcResolver#pipeline_config}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#request_mapping_template CcResolver#request_mapping_template}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#request_mapping_template_s3_location CcResolver#request_mapping_template_s3_location}
    */
    readonly requestMappingTemplateS3Location?: string;
    /**
    * The response mapping template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#response_mapping_template CcResolver#response_mapping_template}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#response_mapping_template_s3_location CcResolver#response_mapping_template_s3_location}
    */
    readonly responseMappingTemplateS3Location?: string;
    /**
    * Describes a runtime used by an APSYlong resolver or APSYlong function. Specifies the name and version of the runtime to use. Note that if a runtime is specified, code must also be specified.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#runtime CcResolver#runtime}
    */
    readonly runtime?: CcResolver.AppSyncRuntimeProperty;
    /**
    * The ``SyncConfig`` for a resolver attached to a versioned data source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#sync_config CcResolver#sync_config}
    */
    readonly syncConfig?: CcResolver.SyncConfigProperty;
    /**
    * The GraphQL type that invokes this resolver.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#type_name CcResolver#type_name}
    */
...
export class CcResolver extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResolver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#import import section} in the documentation of this resource for the id to use
...
export interface CachingConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#caching_keys CcResolver#caching_keys}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#ttl CcResolver#ttl}
    */
    readonly ttl?: number;
}
...
export interface PipelineConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#functions CcResolver#functions}
    */
...
export interface AppSyncRuntimeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#name CcResolver#name}
    */
    readonly name?: string;
    /**
    * The ``version`` of the runtime to use. Currently, the only allowed version is ``1.0.0``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#runtime_version CcResolver#runtime_version}
    */
...
export interface LambdaConflictHandlerConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#lambda_conflict_handler_arn CcResolver#lambda_conflict_handler_arn}
    */
...
export interface SyncConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#conflict_detection CcResolver#conflict_detection}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#conflict_handler CcResolver#conflict_handler}
    */
    readonly conflictHandler?: string;
    /**
    * The ``LambdaConflictHandlerConfig`` when configuring ``LAMBDA`` as the Conflict Handler.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appsync_resolver#lambda_conflict_handler_config CcResolver#lambda_conflict_handler_config}
    */
