...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point
...
export interface CcAccessPointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#access_point_tags CcAccessPoint#access_point_tags}
    */
    readonly accessPointTags?: CcAccessPoint.AccessPointTagProperty[] | cdktn.IResolvable;
    /**
    * The opaque string specified in the request to ensure idempotent creation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#client_token CcAccessPoint#client_token}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#file_system_id CcAccessPoint#file_system_id}
    */
    readonly fileSystemId: string;
    /**
    * The full POSIX identity, including the user ID, group ID, and secondary group IDs on the access point that is used for all file operations by NFS clients using the access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#posix_user CcAccessPoint#posix_user}
    */
    readonly posixUser?: CcAccessPoint.PosixUserProperty;
    /**
    * The directory on the EFS file system that the access point exposes as the root directory to NFS clients using the access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#root_directory CcAccessPoint#root_directory}
    */
    readonly rootDirectory?: CcAccessPoint.RootDirectoryProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point awscc_efs_access_point}
*/
export class CcAccessPoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point awscc_efs_access_point} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _accessPointTags = new CcAccessPoint.AccessPointTagPropertyList(this, "access_point_tags", true);
    public get accessPointTags() {
        return this._accessPointTags;
    }
    public putAccessPointTags(value: CcAccessPoint.AccessPointTagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            access_point_tags: cdktn.listMapper(ccAccessPointAccessPointTagPropertyToTerraform, false)(this._accessPointTags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            access_point_tags: {
                value: cdktn.listMapperHcl(ccAccessPointAccessPointTagPropertyToHclTerraform, false)(this._accessPointTags.internalValue),
                isBlock: true,
                type: "set",
...
export function ccAccessPointCreationInfoPropertyToTerraform(struct?: CcAccessPoint.CreationInfoProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointCreationInfoPropertyToHclTerraform(struct?: CcAccessPoint.CreationInfoProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointRootDirectoryPropertyToTerraform(struct?: CcAccessPoint.RootDirectoryProperty | cdktn.IResolvable): any {
    ...
    return {
        creation_info: ccAccessPointCreationInfoPropertyToTerraform(struct!.creationInfo),
...
export function ccAccessPointRootDirectoryPropertyToHclTerraform(struct?: CcAccessPoint.RootDirectoryProperty | cdktn.IResolvable): any {
    ...
    const attrs = {
        creation_info: {
            value: ccAccessPointCreationInfoPropertyToHclTerraform(struct!.creationInfo),
            isBlock: true,
            type: "struct",
            storageClassType: "CreationInfoProperty",
        },
        path: {
...
export interface AccessPointTagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#key CcAccessPoint#key}
    */
    readonly key?: string;
    /**
    * The value of the tag key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#value CcAccessPoint#value}
    */
...
export interface PosixUserProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#gid CcAccessPoint#gid}
    */
    readonly gid?: string;
    /**
    * Secondary POSIX group IDs used for all file system operations using this access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#secondary_gids CcAccessPoint#secondary_gids}
    */
    readonly secondaryGids?: string[];
    /**
    * The POSIX user ID used for all file system operations using this access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#uid CcAccessPoint#uid}
    */
    readonly uid?: string;
}
...
export interface CreationInfoProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#owner_gid CcAccessPoint#owner_gid}
    */
    readonly ownerGid?: string;
    /**
    * Specifies the POSIX user ID to apply to the ``RootDirectory``. Accepts values from 0 to 2^32 (4294967295).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#owner_uid CcAccessPoint#owner_uid}
    */
    readonly ownerUid?: string;
    /**
    * Specifies the POSIX permissions to apply to the ``RootDirectory``, in the format of an octal number representing the file's mode bits.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#permissions CcAccessPoint#permissions}
    */
...
export class CreationInfoPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): CreationInfoProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: CreationInfoProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export interface RootDirectoryProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#creation_info CcAccessPoint#creation_info}
    */
    readonly creationInfo?: CreationInfoProperty;
    /**
    * Specifies the path on the EFS file system to expose as the root directory to NFS clients using the access point to access the EFS file system. A path can have up to four subdirectories. If the specified path does not exist, you are required to provide the ``CreationInfo``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/efs_access_point#path CcAccessPoint#path}
    */
