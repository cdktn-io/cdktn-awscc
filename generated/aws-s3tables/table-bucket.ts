...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket
...
export interface CcTableBucketProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#encryption_configuration CcTableBucket#encryption_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#metrics_configuration CcTableBucket#metrics_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#replication_configuration CcTableBucket#replication_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#storage_class_configuration CcTableBucket#storage_class_configuration}
    */
    readonly storageClassConfiguration?: CcTableBucket.StorageClassConfigurationProperty;
    /**
    * A name for the table bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#table_bucket_name CcTableBucket#table_bucket_name}
    */
    readonly tableBucketName: string;
    /**
    * User tags (key-value pairs) to associate with the table bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#tags CcTableBucket#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#unreferenced_file_removal CcTableBucket#unreferenced_file_removal}
    */
    readonly unreferencedFileRemoval?: CcTableBucket.UnreferencedFileRemovalProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket awscc_s3tables_table_bucket}
*/
export class CcTableBucket extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTableBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket awscc_s3tables_table_bucket} Resource
    *
    * @param scope The scope in which to define this construct
...
export interface EncryptionConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#kms_key_arn CcTableBucket#kms_key_arn}
    */
    readonly kmsKeyArn?: string;
    /**
    * Server-side encryption algorithm
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#sse_algorithm CcTableBucket#sse_algorithm}
    */
...
export interface MetricsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#status CcTableBucket#status}
    */
...
export interface ReplicationDestinationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#destination_table_bucket_arn CcTableBucket#destination_table_bucket_arn}
    */
...
export interface ReplicationRuleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#destinations CcTableBucket#destinations}
    */
...
export interface ReplicationConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#role CcTableBucket#role}
    */
    readonly role?: string;
    /**
    * List of replication rules
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#rules CcTableBucket#rules}
    */
...
export interface StorageClassConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#storage_class CcTableBucket#storage_class}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#key CcTableBucket#key}
    */
    readonly key?: string;
    /**
    * Tag value must be between 0 to 256 characters in length. Tag value can only contain alphanumeric characters, spaces, _, ., /, =, +, -, and @.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#value CcTableBucket#value}
    */
...
export interface UnreferencedFileRemovalProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#noncurrent_days CcTableBucket#noncurrent_days}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3tables_table_bucket#unreferenced_days CcTableBucket#unreferenced_days}
    */
