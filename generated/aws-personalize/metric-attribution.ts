...
export interface CcMetricAttributionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#dataset_group_arn CcMetricAttribution#dataset_group_arn}
    */
    readonly datasetGroupArn: string;
    /**
    * A list of metric attributes for the metric attribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#metrics CcMetricAttribution#metrics}
    */
    readonly metrics: CcMetricAttribution.MetricAttributeProperty[] | cdktn.IResolvable;
    /**
    * The output configuration details for the metric attribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#metrics_output_config CcMetricAttribution#metrics_output_config}
    */
    readonly metricsOutputConfig: CcMetricAttribution.MetricsOutputConfigProperty;
    /**
    * The name of the metric attribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#name CcMetricAttribution#name}
    */
...
export class CcMetricAttribution extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMetricAttribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#import import section} in the documentation of this resource for the id to use
...
export interface MetricAttributeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#event_type CcMetricAttribution#event_type}
    */
    readonly eventType: string;
    /**
    * The attribute's expression.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#expression CcMetricAttribution#expression}
    */
    readonly expression: string;
    /**
    * The metric's name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#metric_name CcMetricAttribution#metric_name}
    */
...
export interface S3DataDestinationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#kms_key_arn CcMetricAttribution#kms_key_arn}
    */
    readonly kmsKeyArn?: string;
    /**
    * The file path of the Amazon S3 bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#path CcMetricAttribution#path}
    */
...
export interface MetricsOutputConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#role_arn CcMetricAttribution#role_arn}
    */
    readonly roleArn: string;
    /**
    * The configuration details of an Amazon S3 output bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/personalize_metric_attribution#s3_data_destination CcMetricAttribution#s3_data_destination}
    */
