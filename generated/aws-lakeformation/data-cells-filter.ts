...
export interface CcDataCellsFilterProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#column_names CcDataCellsFilter#column_names}
    */
    readonly columnNames?: string[];
    /**
    * An object representing the Data Cells Filter's Columns. Either Column Names or a Wildcard is required
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#column_wildcard CcDataCellsFilter#column_wildcard}
    */
    readonly columnWildcard?: CcDataCellsFilter.ColumnWildcardProperty;
    /**
    * The name of the Database that the Table resides in.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#database_name CcDataCellsFilter#database_name}
    */
    readonly databaseName: string;
    /**
    * The desired name of the Data Cells Filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#name CcDataCellsFilter#name}
    */
    readonly name: string;
    /**
    * An object representing the Data Cells Filter's Row Filter. Either a Filter Expression or a Wildcard is required
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#row_filter CcDataCellsFilter#row_filter}
    */
    readonly rowFilter?: CcDataCellsFilter.RowFilterProperty;
    /**
    * The Catalog Id of the Table on which to create a Data Cells Filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#table_catalog_id CcDataCellsFilter#table_catalog_id}
    */
    readonly tableCatalogId: string;
    /**
    * The name of the Table to create a Data Cells Filter for.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#table_name CcDataCellsFilter#table_name}
    */
...
export class CcDataCellsFilter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDataCellsFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#import import section} in the documentation of this resource for the id to use
...
export interface ColumnWildcardProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#excluded_column_names CcDataCellsFilter#excluded_column_names}
    */
...
export interface RowFilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#all_rows_wildcard CcDataCellsFilter#all_rows_wildcard}
    */
    readonly allRowsWildcard?: string;
    /**
    * A PartiQL predicate.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lakeformation_data_cells_filter#filter_expression CcDataCellsFilter#filter_expression}
    */
