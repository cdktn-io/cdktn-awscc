...
export interface CcVpcConnectionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#authentication CcVpcConnection#authentication}
    */
    readonly authentication: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#client_subnets CcVpcConnection#client_subnets}
    */
    readonly clientSubnets: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#security_groups CcVpcConnection#security_groups}
    */
    readonly securityGroups: string[];
    /**
    * A key-value pair to associate with a resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#tags CcVpcConnection#tags}
    */
    readonly tags?: { [key: string]: string };
    /**
    * The Amazon Resource Name (ARN) of the target cluster
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#target_cluster_arn CcVpcConnection#target_cluster_arn}
    */
    readonly targetClusterArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#vpc_id CcVpcConnection#vpc_id}
    */
...
export class CcVpcConnection extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_vpc_connection#import import section} in the documentation of this resource for the id to use
