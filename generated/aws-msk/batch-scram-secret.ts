...
export interface CcBatchScramSecretProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_batch_scram_secret#cluster_arn CcBatchScramSecret#cluster_arn}
    */
    readonly clusterArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_batch_scram_secret#secret_arn_list CcBatchScramSecret#secret_arn_list}
    */
...
export class CcBatchScramSecret extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcBatchScramSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_batch_scram_secret#import import section} in the documentation of this resource for the id to use
