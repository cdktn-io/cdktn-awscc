...
export interface CcTopicProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#cluster_arn CcTopic#cluster_arn}
    */
    readonly clusterArn: string;
    /**
    * Base64 encoded configuration properties of the topic
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#configs CcTopic#configs}
    */
    readonly configs?: string;
    /**
    * The number of partitions for the topic
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#partition_count CcTopic#partition_count}
    */
    readonly partitionCount: number;
    /**
    * The replication factor for the topic
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#replication_factor CcTopic#replication_factor}
    */
    readonly replicationFactor: number;
    /**
    * The name of the topic
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#topic_name CcTopic#topic_name}
    */
...
export class CcTopic extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/msk_topic#import import section} in the documentation of this resource for the id to use
