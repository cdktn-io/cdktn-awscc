...
export interface CcAccessPointPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3objectlambda_access_point_policy#object_lambda_access_point CcAccessPointPolicy#object_lambda_access_point}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3objectlambda_access_point_policy#policy_document CcAccessPointPolicy#policy_document}
    */
...
export class CcAccessPointPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccessPointPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3objectlambda_access_point_policy#import import section} in the documentation of this resource for the id to use
