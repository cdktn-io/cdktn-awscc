...
export interface CcDeploymentProps extends cdktn.TerraformMetaArguments {
    ...
    * The application ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/m2_deployment#application_id CcDeployment#application_id}
    */
    readonly applicationId: string;
    /**
    * The version number of the application to deploy
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/m2_deployment#application_version CcDeployment#application_version}
    */
    readonly applicationVersion: number;
    /**
    * The environment ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/m2_deployment#environment_id CcDeployment#environment_id}
    */
...
export class CcDeployment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/m2_deployment#import import section} in the documentation of this resource for the id to use
