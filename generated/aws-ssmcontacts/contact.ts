...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcContactProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#alias CcContact#alias}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#display_name CcContact#display_name}
    */
    readonly displayName: string;
    /**
    * The stages that an escalation plan or engagement plan engages contacts and contact methods in.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#plan CcContact#plan}
    */
    readonly plan?: CcContact.StageProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#tags CcContact#tags}
    */
    readonly tags?: CcContact.TagProperty[] | cdktn.IResolvable;
    /**
    * Contact type, which specify type of contact. Currently supported values: ?PERSONAL?, ?SHARED?, ?OTHER?.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#type CcContact#type}
    */
    readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact awscc_ssmcontacts_contact}
*/
export class CcContact extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcContact resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcContact to import
    * @param importFromId The id of the existing CcContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcContact to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact awscc_ssmcontacts_contact} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcContactProps
    */
    public constructor(scope: Construct, id: string, config: CcContactProps) {
        super(scope, id, {
    ...
    private _plan = new CcContact.StagePropertyList(this, "plan", false);
    public get plan() {
        return this._plan;
    }
    public putPlan(value: CcContact.StageProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcContact.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcContact.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            plan: cdktn.listMapper(ccContactStagePropertyToTerraform, false)(this._plan.internalValue),
            tags: cdktn.listMapper(ccContactTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            plan: {
                value: cdktn.listMapperHcl(ccContactStagePropertyToHclTerraform, false)(this._plan.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcContact.StagePropertyList",
            },
            tags: {
                value: cdktn.listMapperHcl(ccContactTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcContact.TagPropertyList",
            },
            type: {
...
export function ccContactChannelTargetInfoPropertyToTerraform(struct?: CcContact.ChannelTargetInfoProperty | cdktn.IResolvable): any {
...
export function ccContactChannelTargetInfoPropertyToHclTerraform(struct?: CcContact.ChannelTargetInfoProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccContactContactTargetInfoPropertyToTerraform(struct?: CcContact.ContactTargetInfoProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccContactContactTargetInfoPropertyToHclTerraform(struct?: CcContact.ContactTargetInfoProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccContactTargetsPropertyToTerraform(struct?: CcContact.TargetsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        channel_target_info: ccContactChannelTargetInfoPropertyToTerraform(struct!.channelTargetInfo),
        contact_target_info: ccContactContactTargetInfoPropertyToTerraform(struct!.contactTargetInfo),
    }
}


export function ccContactTargetsPropertyToHclTerraform(struct?: CcContact.TargetsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        channel_target_info: {
            value: ccContactChannelTargetInfoPropertyToHclTerraform(struct!.channelTargetInfo),
            isBlock: true,
            type: "struct",
            storageClassType: "ChannelTargetInfoProperty",
        },
        contact_target_info: {
            value: ccContactContactTargetInfoPropertyToHclTerraform(struct!.contactTargetInfo),
            isBlock: true,
            type: "struct",
...
export function ccContactStagePropertyToTerraform(struct?: CcContact.StageProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        targets: cdktn.listMapper(ccContactTargetsPropertyToTerraform, false)(struct!.targets),
    }
}


export function ccContactStagePropertyToHclTerraform(struct?: CcContact.StageProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        targets: {
            value: cdktn.listMapperHcl(ccContactTargetsPropertyToHclTerraform, false)(struct!.targets),
            isBlock: true,
            type: "list",
...
export function ccContactTagPropertyToTerraform(struct?: CcContact.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccContactTagPropertyToHclTerraform(struct?: CcContact.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcContact {
export interface ChannelTargetInfoProperty {
    /**
    * The Amazon Resource Name (ARN) of the contact channel.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#channel_id CcContact#channel_id}
    */
    readonly channelId?: string;
    /**
    * The number of minutes to wait to retry sending engagement in the case the engagement initially fails.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#retry_interval_in_minutes CcContact#retry_interval_in_minutes}
    */
...
export interface ContactTargetInfoProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#contact_id CcContact#contact_id}
    */
    readonly contactId?: string;
    /**
    * A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#is_essential CcContact#is_essential}
    */
...
export interface TargetsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#channel_target_info CcContact#channel_target_info}
    */
    readonly channelTargetInfo?: ChannelTargetInfoProperty;
    /**
    * The contact that SSM Incident Manager is engaging during an incident.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#contact_target_info CcContact#contact_target_info}
    */
...
export interface StageProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#duration_in_minutes CcContact#duration_in_minutes}
    */
    readonly durationInMinutes?: number;
    /**
    * List of Rotation Ids to associate with Contact
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#rotation_ids CcContact#rotation_ids}
    */
    readonly rotationIds?: string[];
    /**
    * The contacts or contact methods that the escalation plan or engagement plan is engaging.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#targets CcContact#targets}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#key CcContact#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ssmcontacts_contact#value CcContact#value}
    */
