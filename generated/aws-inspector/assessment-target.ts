...
export interface CcAssessmentTargetProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/inspector_assessment_target#assessment_target_name CcAssessmentTarget#assessment_target_name}
    */
    readonly assessmentTargetName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/inspector_assessment_target#resource_group_arn CcAssessmentTarget#resource_group_arn}
    */
...
export class CcAssessmentTarget extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAssessmentTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/inspector_assessment_target#import import section} in the documentation of this resource for the id to use
