...
export interface CcServicePrincipalNameProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcaconnectorad_service_principal_name#connector_arn CcServicePrincipalName#connector_arn}
    */
    readonly connectorArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcaconnectorad_service_principal_name#directory_registration_arn CcServicePrincipalName#directory_registration_arn}
    */
...
export class CcServicePrincipalName extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcServicePrincipalName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/pcaconnectorad_service_principal_name#import import section} in the documentation of this resource for the id to use
