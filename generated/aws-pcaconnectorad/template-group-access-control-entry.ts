...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcTemplateGroupAccessControlEntryProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#access_rights CcTemplateGroupAccessControlEntry#access_rights}
    */
    readonly accessRights: CcTemplateGroupAccessControlEntry.AccessRightsProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#group_display_name CcTemplateGroupAccessControlEntry#group_display_name}
    */
    readonly groupDisplayName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#group_security_identifier CcTemplateGroupAccessControlEntry#group_security_identifier}
    */
    readonly groupSecurityIdentifier: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#template_arn CcTemplateGroupAccessControlEntry#template_arn}
    */
    readonly templateArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry awscc_pcaconnectorad_template_group_access_control_entry}
*/
export class CcTemplateGroupAccessControlEntry extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTemplateGroupAccessControlEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry awscc_pcaconnectorad_template_group_access_control_entry} Resource
    *
    * @param scope The scope in which to define this construct
...
export interface AccessRightsProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#auto_enroll CcTemplateGroupAccessControlEntry#auto_enroll}
    */
    readonly autoEnroll?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/pcaconnectorad_template_group_access_control_entry#enroll CcTemplateGroupAccessControlEntry#enroll}
    */
