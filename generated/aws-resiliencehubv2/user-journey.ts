...
export interface CcUserJourneyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/resiliencehubv2_user_journey#description CcUserJourney#description}
    */
    readonly description?: string;
    /**
    * The name of the user journey.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/resiliencehubv2_user_journey#name CcUserJourney#name}
    */
    readonly name: string;
    /**
    * The ARN of the resilience policy to associate with this user journey.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/resiliencehubv2_user_journey#policy_arn CcUserJourney#policy_arn}
    */
    readonly policyArn?: string;
    /**
    * The system ARN or system ID that owns this user journey.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/resiliencehubv2_user_journey#system_identifier CcUserJourney#system_identifier}
    */
...
export class CcUserJourney extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUserJourney that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/resiliencehubv2_user_journey#import import section} in the documentation of this resource for the id to use
