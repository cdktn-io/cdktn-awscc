...
export interface CcServerProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#associate_public_ip_address CcServer#associate_public_ip_address}
    */
    readonly associatePublicIpAddress?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#backup_id CcServer#backup_id}
    */
    readonly backupId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#backup_retention_count CcServer#backup_retention_count}
    */
    readonly backupRetentionCount?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#custom_certificate CcServer#custom_certificate}
    */
    readonly customCertificate?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#custom_domain CcServer#custom_domain}
    */
    readonly customDomain?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#custom_private_key CcServer#custom_private_key}
    */
    readonly customPrivateKey?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#disable_automated_backup CcServer#disable_automated_backup}
    */
    readonly disableAutomatedBackup?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#engine CcServer#engine}
    */
    readonly engine?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#engine_attributes CcServer#engine_attributes}
    */
    readonly engineAttributes?: CcServer.EngineAttributeProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#engine_model CcServer#engine_model}
    */
    readonly engineModel?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#engine_version CcServer#engine_version}
    */
    readonly engineVersion?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#instance_profile_arn CcServer#instance_profile_arn}
    */
    readonly instanceProfileArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#instance_type CcServer#instance_type}
    */
    readonly instanceType: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#key_pair CcServer#key_pair}
    */
    readonly keyPair?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#preferred_backup_window CcServer#preferred_backup_window}
    */
    readonly preferredBackupWindow?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#preferred_maintenance_window CcServer#preferred_maintenance_window}
    */
    readonly preferredMaintenanceWindow?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#security_group_ids CcServer#security_group_ids}
    */
    readonly securityGroupIds?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#server_name CcServer#server_name}
    */
    readonly serverName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#service_role_arn CcServer#service_role_arn}
    */
    readonly serviceRoleArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#subnet_ids CcServer#subnet_ids}
    */
    readonly subnetIds?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#tags CcServer#tags}
    */
...
export class CcServer extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _engineAttributes = new CcServer.EngineAttributePropertyList(this, "engine_attributes", false);
    public get engineAttributes() {
        return this._engineAttributes;
    }
    public putEngineAttributes(value: CcServer.EngineAttributeProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            engine_attributes: cdktn.listMapper(ccServerEngineAttributePropertyToTerraform, false)(this._engineAttributes.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            engine_attributes: {
                value: cdktn.listMapperHcl(ccServerEngineAttributePropertyToHclTerraform, false)(this._engineAttributes.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcServer.EngineAttributePropertyList",
            },
            engine_model: {
...
export function ccServerEngineAttributePropertyToTerraform(struct?: CcServer.EngineAttributeProperty | cdktn.IResolvable): any {
...
export function ccServerEngineAttributePropertyToHclTerraform(struct?: CcServer.EngineAttributeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface EngineAttributeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#name CcServer#name}
    */
    readonly name?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#value CcServer#value}
    */
    readonly value?: string;
}
export class EngineAttributePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): EngineAttributeProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: EngineAttributeProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class EngineAttributePropertyList extends cdktn.ComplexList {
    public internalValue? : EngineAttributeProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): EngineAttributePropertyOutputReference {
        return new EngineAttributePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#key CcServer#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opsworkscm_server#value CcServer#value}
