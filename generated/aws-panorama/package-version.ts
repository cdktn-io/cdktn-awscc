...
export interface CcPackageVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * Whether to mark the new version as the latest version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#mark_latest CcPackageVersion#mark_latest}
    */
    readonly markLatest?: boolean | cdktn.IResolvable;
    /**
    * An owner account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#owner_account CcPackageVersion#owner_account}
    */
    readonly ownerAccount?: string;
    /**
    * A package ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#package_id CcPackageVersion#package_id}
    */
    readonly packageId: string;
    /**
    * A package version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#package_version CcPackageVersion#package_version}
    */
    readonly packageVersion: string;
    /**
    * A patch version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#patch_version CcPackageVersion#patch_version}
    */
    readonly patchVersion: string;
    /**
    * If the version was marked latest, the new version to maker as latest.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#updated_latest_patch_version CcPackageVersion#updated_latest_patch_version}
    */
...
export class CcPackageVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/panorama_package_version#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcPackageVersionProps
    */
    public constructor(scope: Construct, id: string, config: CcPackageVersionProps) {
        super(scope, id, {
...
export namespace CcPackageVersion {
}
