...
export interface CcDirectConnectGatewayAttachmentProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#core_network_id CcDirectConnectGatewayAttachment#core_network_id}
    */
    readonly coreNetworkId: string;
    /**
    * The ARN of the Direct Connect Gateway.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#direct_connect_gateway_arn CcDirectConnectGatewayAttachment#direct_connect_gateway_arn}
    */
    readonly directConnectGatewayArn: string;
    /**
    * The Regions where the edges are located.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#edge_locations CcDirectConnectGatewayAttachment#edge_locations}
    */
    readonly edgeLocations: string[];
    /**
    * Routing policy label
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#routing_policy_label CcDirectConnectGatewayAttachment#routing_policy_label}
    */
    readonly routingPolicyLabel?: string;
    /**
    * Tags for the attachment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#tags CcDirectConnectGatewayAttachment#tags}
    */
...
export class CcDirectConnectGatewayAttachment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDirectConnectGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#import import section} in the documentation of this resource for the id to use
...
export function ccDirectConnectGatewayAttachmentTagPropertyToTerraform(struct?: CcDirectConnectGatewayAttachment.TagProperty): any {
...
export function ccDirectConnectGatewayAttachmentTagPropertyToHclTerraform(struct?: CcDirectConnectGatewayAttachment.TagProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangePropertyToTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedNetworkFunctionGroupChangeProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangePropertyToHclTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedNetworkFunctionGroupChangeProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedSegmentChangeTagsPropertyToTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedSegmentChangeTagsProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedSegmentChangeTagsPropertyToHclTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedSegmentChangeTagsProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedSegmentChangePropertyToTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedSegmentChangeProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDirectConnectGatewayAttachmentProposedSegmentChangePropertyToHclTerraform(struct?: CcDirectConnectGatewayAttachment.ProposedSegmentChangeProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#key CcDirectConnectGatewayAttachment#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/networkmanager_direct_connect_gateway_attachment#value CcDirectConnectGatewayAttachment#value}
    */
