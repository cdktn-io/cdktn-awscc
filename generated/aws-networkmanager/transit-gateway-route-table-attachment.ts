...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcTransitGatewayRouteTableAttachmentProps extends cdktn.TerraformMetaArguments {
    /**
    * The name of the network function group attachment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#network_function_group_name CcTransitGatewayRouteTableAttachment#network_function_group_name}
    */
    readonly networkFunctionGroupName?: string;
    /**
    * The Id of peering between transit gateway and core network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#peering_id CcTransitGatewayRouteTableAttachment#peering_id}
    */
    readonly peeringId: string;
    /**
    * The attachment to move from one network function group to another.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#proposed_network_function_group_change CcTransitGatewayRouteTableAttachment#proposed_network_function_group_change}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#proposed_segment_change CcTransitGatewayRouteTableAttachment#proposed_segment_change}
    */
    readonly proposedSegmentChange?: CcTransitGatewayRouteTableAttachment.ProposedSegmentChangeProperty;
    /**
    * Routing policy label
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#routing_policy_label CcTransitGatewayRouteTableAttachment#routing_policy_label}
    */
    readonly routingPolicyLabel?: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#tags CcTransitGatewayRouteTableAttachment#tags}
    */
    readonly tags?: CcTransitGatewayRouteTableAttachment.TagsProperty[] | cdktn.IResolvable;
    /**
    * The Arn of transit gateway route table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#transit_gateway_route_table_arn CcTransitGatewayRouteTableAttachment#transit_gateway_route_table_arn}
    */
    readonly transitGatewayRouteTableArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment awscc_networkmanager_transit_gateway_route_table_attachment}
*/
export class CcTransitGatewayRouteTableAttachment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTransitGatewayRouteTableAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment awscc_networkmanager_transit_gateway_route_table_attachment} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcTransitGatewayRouteTableAttachmentProps
    */
    public constructor(scope: Construct, id: string, config: CcTransitGatewayRouteTableAttachmentProps) {
        super(scope, id, {
    ...
    private _tags = new CcTransitGatewayRouteTableAttachment.TagsPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcTransitGatewayRouteTableAttachment.TagsProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccTransitGatewayRouteTableAttachmentTagsPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcTransitGatewayRouteTableAttachment.TagsPropertyList",
            },
...
export function ccTransitGatewayRouteTableAttachmentTagsPropertyToTerraform(struct?: CcTransitGatewayRouteTableAttachment.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTransitGatewayRouteTableAttachmentTagsPropertyToHclTerraform(struct?: CcTransitGatewayRouteTableAttachment.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#key CcTransitGatewayRouteTableAttachment#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#value CcTransitGatewayRouteTableAttachment#value}
    */
...
export interface ProposedNetworkFunctionGroupChangeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#attachment_policy_rule_number CcTransitGatewayRouteTableAttachment#attachment_policy_rule_number}
    */
...
export interface ProposedSegmentChangeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/networkmanager_transit_gateway_route_table_attachment#segment_name CcTransitGatewayRouteTableAttachment#segment_name}
    */
