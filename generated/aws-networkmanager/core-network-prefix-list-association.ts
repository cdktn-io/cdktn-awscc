...
export interface CcCoreNetworkPrefixListAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/networkmanager_core_network_prefix_list_association#core_network_id CcCoreNetworkPrefixListAssociation#core_network_id}
    */
    readonly coreNetworkId: string;
    /**
    * The alias of the prefix list
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/networkmanager_core_network_prefix_list_association#prefix_list_alias CcCoreNetworkPrefixListAssociation#prefix_list_alias}
    */
    readonly prefixListAlias: string;
    /**
    * The Amazon Resource Name (ARN) of the prefix list.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/networkmanager_core_network_prefix_list_association#prefix_list_arn CcCoreNetworkPrefixListAssociation#prefix_list_arn}
    */
