...
export interface CcCustomEntityTypeProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_custom_entity_type#context_words CcCustomEntityType#context_words}
    */
    readonly contextWords?: string[];
    /**
    * The name of the custom entity type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_custom_entity_type#name CcCustomEntityType#name}
    */
    readonly name?: string;
    /**
    * A regular expression string that is used for detecting sensitive data in a custom pattern.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_custom_entity_type#regex_string CcCustomEntityType#regex_string}
    */
    readonly regexString?: string;
    /**
    * Tags to associate with the custom entity type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_custom_entity_type#tags CcCustomEntityType#tags}
    */
...
export class CcCustomEntityType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCustomEntityType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_custom_entity_type#import import section} in the documentation of this resource for the id to use
