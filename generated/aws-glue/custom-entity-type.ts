...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcCustomEntityTypeProps extends cdktn.TerraformMetaArguments {
    /**
    * A list of context words.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type#context_words CcCustomEntityType#context_words}
    */
    readonly contextWords?: string[];
    /**
    * The name of the custom entity type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type#name CcCustomEntityType#name}
    */
    readonly name?: string;
    /**
    * A regular expression string that is used for detecting sensitive data in a custom pattern.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type#regex_string CcCustomEntityType#regex_string}
    */
    readonly regexString?: string;
    /**
    * Tags to associate with the custom entity type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type#tags CcCustomEntityType#tags}
    */
    readonly tags?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type awscc_glue_custom_entity_type}
*/
export class CcCustomEntityType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCustomEntityType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_custom_entity_type awscc_glue_custom_entity_type} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcCustomEntityTypeProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcCustomEntityTypeProps = {}) {
        super(scope, id, {
...
export namespace CcCustomEntityType {
}
