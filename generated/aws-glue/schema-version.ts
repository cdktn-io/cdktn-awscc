...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version
...
export interface CcSchemaVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#schema CcSchemaVersion#schema}
    */
    readonly schema: CcSchemaVersion.SchemaProperty;
    /**
    * Complete definition of the schema in plain-text.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#schema_definition CcSchemaVersion#schema_definition}
    */
...
export class CcSchemaVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSchemaVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#import import section} in the documentation of this resource for the id to use
...
export interface SchemaProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#registry_name CcSchemaVersion#registry_name}
    */
    readonly registryName?: string;
    /**
    * Amazon Resource Name for the Schema. This attribute can be used to uniquely represent the Schema.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#schema_arn CcSchemaVersion#schema_arn}
    */
    readonly schemaArn?: string;
    /**
    * Name of the schema. This parameter requires RegistryName to be provided.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/glue_schema_version#schema_name CcSchemaVersion#schema_name}
    */
