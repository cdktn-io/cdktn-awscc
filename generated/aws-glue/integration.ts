...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration
...
export interface CcIntegrationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#additional_encryption_context CcIntegration#additional_encryption_context}
    */
    readonly additionalEncryptionContext?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#data_filter CcIntegration#data_filter}
    */
    readonly dataFilter?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#description CcIntegration#description}
    */
    readonly description?: string;
    /**
    * The configuration settings for the integration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#integration_config CcIntegration#integration_config}
    */
    readonly integrationConfig?: CcIntegration.IntegrationConfigProperty;
    /**
    * The name of the integration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#integration_name CcIntegration#integration_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#kms_key_id CcIntegration#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * The Amazon Resource Name (ARN) of the database to use as the source for replication
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#source_arn CcIntegration#source_arn}
    */
    readonly sourceArn: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#tags CcIntegration#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#target_arn CcIntegration#target_arn}
    */
    readonly targetArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration awscc_glue_integration}
*/
export class CcIntegration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration awscc_glue_integration} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _integrationConfig = new CcIntegration.IntegrationConfigPropertyOutputReference(this, "integration_config");
    public get integrationConfig() {
        return this._integrationConfig;
    }
    public putIntegrationConfig(value: CcIntegration.IntegrationConfigProperty) {
    ...
    private _tags = new CcIntegration.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            integration_config: ccIntegrationIntegrationConfigPropertyToTerraform(this._integrationConfig.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            integration_config: {
                value: ccIntegrationIntegrationConfigPropertyToHclTerraform(this._integrationConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcIntegration.IntegrationConfigProperty",
            },
            integration_name: {
...
export function ccIntegrationIntegrationConfigPropertyToTerraform(struct?: CcIntegration.IntegrationConfigProperty | cdktn.IResolvable): any {
...
export function ccIntegrationIntegrationConfigPropertyToHclTerraform(struct?: CcIntegration.IntegrationConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface IntegrationConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#continuous_sync CcIntegration#continuous_sync}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#refresh_interval CcIntegration#refresh_interval}
    */
    readonly refreshInterval?: string;
    /**
    * A collection of key-value pairs that specify additional properties for the integration source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#source_properties CcIntegration#source_properties}
    */
    readonly sourceProperties?: { [key: string]: string };
}
export class IntegrationConfigPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): IntegrationConfigProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: IntegrationConfigProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#key CcIntegration#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/glue_integration#value CcIntegration#value}
    */
