...
export interface CcProfileResourceAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53profiles_profile_resource_association#name CcProfileResourceAssociation#name}
    */
    readonly name: string;
    /**
    * The ID of the  profile that you associated the resource to that is specified by ResourceArn.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53profiles_profile_resource_association#profile_id CcProfileResourceAssociation#profile_id}
    */
    readonly profileId: string;
    /**
    * The arn of the resource that you associated to the  Profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53profiles_profile_resource_association#resource_arn CcProfileResourceAssociation#resource_arn}
    */
    readonly resourceArn: string;
    /**
    * A JSON-formatted string with key-value pairs specifying the properties of the associated resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53profiles_profile_resource_association#resource_properties CcProfileResourceAssociation#resource_properties}
    */
...
export class CcProfileResourceAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcProfileResourceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53profiles_profile_resource_association#import import section} in the documentation of this resource for the id to use
