...
export interface CcRouterNetworkInterfaceProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#configuration CcRouterNetworkInterface#configuration}
    */
    readonly configuration: CcRouterNetworkInterface.RouterNetworkInterfaceConfigurationProperty;
    /**
    * The name of the router network interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#name CcRouterNetworkInterface#name}
    */
    readonly name: string;
    /**
    * The AWS Region for the router network interface. Defaults to the current region if not specified.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#region_name CcRouterNetworkInterface#region_name}
    */
    readonly regionName?: string;
    /**
    * Key-value pairs that can be used to tag and organize this router network interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#tags CcRouterNetworkInterface#tags}
    */
...
export class CcRouterNetworkInterface extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRouterNetworkInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#import import section} in the documentation of this resource for the id to use
...
export interface PublicRouterNetworkInterfaceRuleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#cidr CcRouterNetworkInterface#cidr}
    */
...
export interface PublicRouterNetworkInterfaceConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#allow_rules CcRouterNetworkInterface#allow_rules}
    */
...
export interface VpcRouterNetworkInterfaceConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#security_group_ids CcRouterNetworkInterface#security_group_ids}
    */
    readonly securityGroupIds?: string[];
    /**
    * The ID of the subnet within the VPC to associate the router network interface with.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#subnet_id CcRouterNetworkInterface#subnet_id}
    */
...
export interface RouterNetworkInterfaceConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#public CcRouterNetworkInterface#public}
    */
    readonly public?: PublicRouterNetworkInterfaceConfigurationProperty;
    /**
    * The configuration settings for a router network interface within a VPC, including the security group IDs and subnet ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#vpc CcRouterNetworkInterface#vpc}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#key CcRouterNetworkInterface#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediaconnect_router_network_interface#value CcRouterNetworkInterface#value}
    */
