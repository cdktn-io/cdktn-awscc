...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcFlowSourceProps extends cdktn.TerraformMetaArguments {
    /**
    * The type of encryption that is used on the content ingested from this source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#decryption CcFlowSource#decryption}
    */
    readonly decryption?: CcFlowSource.EncryptionProperty;
    /**
    * A description for the source. This value is not used or seen outside of the current AWS Elemental MediaConnect account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#description CcFlowSource#description}
    */
    readonly description: string;
    /**
    * The ARN of the entitlement that allows you to subscribe to content that comes from another AWS account. The entitlement is set by the content originator and the ARN is generated as part of the originator's flow.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#entitlement_arn CcFlowSource#entitlement_arn}
    */
    readonly entitlementArn?: string;
    /**
    * The ARN of the flow.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#flow_arn CcFlowSource#flow_arn}
    */
    readonly flowArn: string;
    /**
    * The source configuration for cloud flows receiving a stream from a bridge.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#gateway_bridge_source CcFlowSource#gateway_bridge_source}
    */
    readonly gatewayBridgeSource?: CcFlowSource.GatewayBridgeSourceProperty;
    /**
    * The port that the flow will be listening on for incoming content.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#ingest_port CcFlowSource#ingest_port}
    */
    readonly ingestPort?: number;
    /**
    * The smoothing max bitrate for RIST, RTP, and RTP-FEC streams.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#max_bitrate CcFlowSource#max_bitrate}
    */
    readonly maxBitrate?: number;
    /**
    * The maximum latency in milliseconds. This parameter applies only to RIST-based and Zixi-based streams.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#max_latency CcFlowSource#max_latency}
    */
    readonly maxLatency?: number;
    /**
    * The minimum latency in milliseconds.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#min_latency CcFlowSource#min_latency}
    */
    readonly minLatency?: number;
    /**
    * The name of the source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#name CcFlowSource#name}
    */
    readonly name: string;
    /**
    * The protocol that is used by the source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#protocol CcFlowSource#protocol}
    */
    readonly protocol?: string;
    /**
    * The port that the flow uses to send outbound requests to initiate connection with the sender for fujitsu-qos protocol.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#sender_control_port CcFlowSource#sender_control_port}
    */
    readonly senderControlPort?: number;
    /**
    * The IP address that the flow communicates with to initiate connection with the sender for fujitsu-qos protocol.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#sender_ip_address CcFlowSource#sender_ip_address}
    */
    readonly senderIpAddress?: string;
    /**
    * Source IP or domain name for SRT-caller protocol.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#source_listener_address CcFlowSource#source_listener_address}
    */
    readonly sourceListenerAddress?: string;
    /**
    * Source port for SRT-caller protocol.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#source_listener_port CcFlowSource#source_listener_port}
    */
    readonly sourceListenerPort?: number;
    /**
    * The stream ID that you want to use for this transport. This parameter applies only to Zixi-based streams.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#stream_id CcFlowSource#stream_id}
    */
    readonly streamId?: string;
    /**
    * Key-value pairs that can be used to tag and organize this flow source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#tags CcFlowSource#tags}
    */
    readonly tags?: CcFlowSource.TagProperty[] | cdktn.IResolvable;
    /**
    * The name of the VPC Interface this Source is configured with.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#vpc_interface_name CcFlowSource#vpc_interface_name}
    */
    readonly vpcInterfaceName?: string;
    /**
    * The range of IP addresses that should be allowed to contribute content to your source. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#whitelist_cidr CcFlowSource#whitelist_cidr}
    */
    readonly whitelistCidr?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source awscc_mediaconnect_flow_source}
*/
export class CcFlowSource extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcFlowSource resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcFlowSource to import
    * @param importFromId The id of the existing CcFlowSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcFlowSource to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source awscc_mediaconnect_flow_source} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcFlowSourceProps
    */
    public constructor(scope: Construct, id: string, config: CcFlowSourceProps) {
        super(scope, id, {
    ...
    private _decryption = new CcFlowSource.EncryptionPropertyOutputReference(this, "decryption");
    public get decryption() {
        return this._decryption;
    }
    public putDecryption(value: CcFlowSource.EncryptionProperty) {
    ...
    private _gatewayBridgeSource = new CcFlowSource.GatewayBridgeSourcePropertyOutputReference(this, "gateway_bridge_source");
    public get gatewayBridgeSource() {
        return this._gatewayBridgeSource;
    }
    public putGatewayBridgeSource(value: CcFlowSource.GatewayBridgeSourceProperty) {
    ...
    private _tags = new CcFlowSource.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcFlowSource.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            decryption: ccFlowSourceEncryptionPropertyToTerraform(this._decryption.internalValue),
            description: cdktn.stringToTerraform(this._description),
            entitlement_arn: cdktn.stringToTerraform(this._entitlementArn),
            flow_arn: cdktn.stringToTerraform(this._flowArn),
            gateway_bridge_source: ccFlowSourceGatewayBridgeSourcePropertyToTerraform(this._gatewayBridgeSource.internalValue),
            ...
            tags: cdktn.listMapper(ccFlowSourceTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            decryption: {
                value: ccFlowSourceEncryptionPropertyToHclTerraform(this._decryption.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcFlowSource.EncryptionProperty",
            },
            description: {
            ...
            gateway_bridge_source: {
                value: ccFlowSourceGatewayBridgeSourcePropertyToHclTerraform(this._gatewayBridgeSource.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcFlowSource.GatewayBridgeSourceProperty",
            },
            ingest_port: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccFlowSourceTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcFlowSource.TagPropertyList",
            },
            vpc_interface_name: {
...
export function ccFlowSourceEncryptionPropertyToTerraform(struct?: CcFlowSource.EncryptionProperty | cdktn.IResolvable): any {
...
export function ccFlowSourceEncryptionPropertyToHclTerraform(struct?: CcFlowSource.EncryptionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFlowSourceVpcInterfaceAttachmentPropertyToTerraform(struct?: CcFlowSource.VpcInterfaceAttachmentProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFlowSourceVpcInterfaceAttachmentPropertyToHclTerraform(struct?: CcFlowSource.VpcInterfaceAttachmentProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFlowSourceGatewayBridgeSourcePropertyToTerraform(struct?: CcFlowSource.GatewayBridgeSourceProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        vpc_interface_attachment: ccFlowSourceVpcInterfaceAttachmentPropertyToTerraform(struct!.vpcInterfaceAttachment),
    }
}


export function ccFlowSourceGatewayBridgeSourcePropertyToHclTerraform(struct?: CcFlowSource.GatewayBridgeSourceProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        vpc_interface_attachment: {
            value: ccFlowSourceVpcInterfaceAttachmentPropertyToHclTerraform(struct!.vpcInterfaceAttachment),
            isBlock: true,
            type: "struct",
...
export function ccFlowSourceTagPropertyToTerraform(struct?: CcFlowSource.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFlowSourceTagPropertyToHclTerraform(struct?: CcFlowSource.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcFlowSource {
export interface EncryptionProperty {
    /**
    * The type of algorithm that is used for the encryption (such as aes128, aes192, or aes256).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#algorithm CcFlowSource#algorithm}
    */
    readonly algorithm?: string;
    /**
    * A 128-bit, 16-byte hex value represented by a 32-character string, to be used with the key for encrypting content. This parameter is not valid for static key encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#constant_initialization_vector CcFlowSource#constant_initialization_vector}
    */
    readonly constantInitializationVector?: string;
    /**
    * The value of one of the devices that you configured with your digital rights management (DRM) platform key provider. This parameter is required for SPEKE encryption and is not valid for static key encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#device_id CcFlowSource#device_id}
    */
    readonly deviceId?: string;
    /**
    * The type of key that is used for the encryption. If no keyType is provided, the service will use the default setting (static-key).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#key_type CcFlowSource#key_type}
    */
    readonly keyType?: string;
    /**
    * The AWS Region that the API Gateway proxy endpoint was created in. This parameter is required for SPEKE encryption and is not valid for static key encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#region CcFlowSource#region}
    */
    readonly region?: string;
    /**
    * An identifier for the content. The service sends this value to the key server to identify the current endpoint. The resource ID is also known as the content ID. This parameter is required for SPEKE encryption and is not valid for static key encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#resource_id CcFlowSource#resource_id}
    */
    readonly resourceId?: string;
    /**
    * The ARN of the role that you created during setup (when you set up AWS Elemental MediaConnect as a trusted entity).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#role_arn CcFlowSource#role_arn}
    */
    readonly roleArn?: string;
    /**
    *  The ARN of the secret that you created in AWS Secrets Manager to store the encryption key. This parameter is required for static key encryption and is not valid for SPEKE encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#secret_arn CcFlowSource#secret_arn}
    */
    readonly secretArn?: string;
    /**
    * The URL from the API Gateway proxy that you set up to talk to your key server. This parameter is required for SPEKE encryption and is not valid for static key encryption.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#url CcFlowSource#url}
    */
    readonly url?: string;
}
...
export interface GatewayBridgeSourceProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#bridge_arn CcFlowSource#bridge_arn}
    */
    readonly bridgeArn?: string;
    /**
    * The name of the VPC interface attachment to use for this bridge source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#vpc_interface_attachment CcFlowSource#vpc_interface_attachment}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#key CcFlowSource#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediaconnect_flow_source#value CcFlowSource#value}
    */
