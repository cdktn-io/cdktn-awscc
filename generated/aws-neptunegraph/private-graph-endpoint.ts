...
export interface CcPrivateGraphEndpointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_private_graph_endpoint#graph_identifier CcPrivateGraphEndpoint#graph_identifier}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_private_graph_endpoint#security_group_ids CcPrivateGraphEndpoint#security_group_ids}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_private_graph_endpoint#subnet_ids CcPrivateGraphEndpoint#subnet_ids}
    */
    readonly subnetIds?: string[];
    /**
    * The VPC where you want the private graph endpoint to be created, ie, the graph will be reachable from within the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_private_graph_endpoint#vpc_id CcPrivateGraphEndpoint#vpc_id}
    */
...
export class CcPrivateGraphEndpoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPrivateGraphEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/neptunegraph_private_graph_endpoint#import import section} in the documentation of this resource for the id to use
