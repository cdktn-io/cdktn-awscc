...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile
...
export interface CcProfileProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#profile_description CcProfile#profile_description}
    */
    readonly profileDescription: string;
    /**
    * The name of the profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#profile_name CcProfile#profile_name}
    */
    readonly profileName: string;
    /**
    * The profile questions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#profile_questions CcProfile#profile_questions}
    */
    readonly profileQuestions: CcProfile.ProfileQuestionUpdateProperty[] | cdktn.IResolvable;
    /**
    * The tags assigned to the profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#tags CcProfile#tags}
    */
    readonly tags?: CcProfile.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile awscc_wellarchitected_profile}
*/
export class CcProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile awscc_wellarchitected_profile} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _profileQuestions = new CcProfile.ProfileQuestionUpdatePropertyList(this, "profile_questions", false);
    public get profileQuestions() {
        return this._profileQuestions;
    }
    public putProfileQuestions(value: CcProfile.ProfileQuestionUpdateProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            profile_questions: cdktn.listMapper(ccProfileProfileQuestionUpdatePropertyToTerraform, false)(this._profileQuestions.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            profile_questions: {
                value: cdktn.listMapperHcl(ccProfileProfileQuestionUpdatePropertyToHclTerraform, false)(this._profileQuestions.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcProfile.ProfileQuestionUpdatePropertyList",
            },
            tags: {
...
export function ccProfileProfileQuestionUpdatePropertyToTerraform(struct?: CcProfile.ProfileQuestionUpdateProperty | cdktn.IResolvable): any {
...
export function ccProfileProfileQuestionUpdatePropertyToHclTerraform(struct?: CcProfile.ProfileQuestionUpdateProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface ProfileQuestionUpdateProperty {
    /**
    * The ID of the question.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#question_id CcProfile#question_id}
    */
    readonly questionId?: string;
    /**
    * The selected choices.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#selected_choice_ids CcProfile#selected_choice_ids}
    */
    readonly selectedChoiceIds?: string[];
}
export class ProfileQuestionUpdatePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): ProfileQuestionUpdateProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: ProfileQuestionUpdateProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class ProfileQuestionUpdatePropertyList extends cdktn.ComplexList {
    public internalValue? : ProfileQuestionUpdateProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): ProfileQuestionUpdatePropertyOutputReference {
        return new ProfileQuestionUpdatePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#key CcProfile#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wellarchitected_profile#value CcProfile#value}
    */
