...
export interface CcCustomDBEngineVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#database_installation_files CcCustomDBEngineVersion#database_installation_files}
    */
    readonly databaseInstallationFiles?: string[];
    /**
    * The name of an Amazon S3 bucket that contains database installation files for your CEV. For example, a valid bucket name is ``my-custom-installation-files``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#database_installation_files_s3_bucket_name CcCustomDBEngineVersion#database_installation_files_s3_bucket_name}
    */
    readonly databaseInstallationFilesS3BucketName?: string;
    /**
    * The Amazon S3 directory that contains the database installation files for your CEV. For example, a valid bucket name is ``123456789012/cev1``. If this setting isn't specified, no prefix is assumed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#database_installation_files_s3_prefix CcCustomDBEngineVersion#database_installation_files_s3_prefix}
    */
    readonly databaseInstallationFilesS3Prefix?: string;
    /**
    * An optional description of your CEV.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#description CcCustomDBEngineVersion#description}
    */
    ...
    *   +   ``sqlserver-se``
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#engine CcCustomDBEngineVersion#engine}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#engine_version CcCustomDBEngineVersion#engine_version}
    */
    readonly engineVersion: string;
    /**
    * A value that indicates the ID of the AMI.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#image_id CcCustomDBEngineVersion#image_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#kms_key_id CcCustomDBEngineVersion#kms_key_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#manifest CcCustomDBEngineVersion#manifest}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#source_custom_db_engine_version_identifier CcCustomDBEngineVersion#source_custom_db_engine_version_identifier}
    */
    readonly sourceCustomDbEngineVersionIdentifier?: string;
    /**
    * A value that indicates the status of a custom engine version (CEV).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#status CcCustomDBEngineVersion#status}
    */
    readonly status?: string;
    /**
    * A list of tags. For more information, see [Tagging Amazon RDS Resources](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.html) in the *Amazon RDS User Guide.*
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#tags CcCustomDBEngineVersion#tags}
    */
    readonly tags?: CcCustomDBEngineVersion.TagProperty[] | cdktn.IResolvable;
    /**
    * Specifies whether to use the latest service-provided Amazon Machine Image (AMI) for the CEV. If you specify ``UseAwsProvidedLatestImage``, you can't also specify ``ImageId``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#use_aws_provided_latest_image CcCustomDBEngineVersion#use_aws_provided_latest_image}
    */
...
export class CcCustomDBEngineVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCustomDBEngineVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#key CcCustomDBEngineVersion#key}
    */
    readonly key?: string;
    /**
    * A value is the optional value of the tag. The string value can be from 1 to 256 Unicode characters in length and can't be prefixed with ``aws:`` or ``rds:``. The string can only contain only the set of Unicode letters, digits, white-space, '_', '.', ':', '/', '=', '+', '-', '@' (Java regex: "^([\\p{L}\\p{Z}\\p{N}_.:/=+\\-@]*)$").
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_custom_db_engine_version#value CcCustomDBEngineVersion#value}
    */
