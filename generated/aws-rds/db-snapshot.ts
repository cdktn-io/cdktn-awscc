...
export interface CcDBSnapshotProps extends cdktn.TerraformMetaArguments {
    /**
    * The identifier of the DB instance that you want to create the snapshot of.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#db_instance_identifier CcDBSnapshot#db_instance_identifier}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#db_snapshot_identifier CcDBSnapshot#db_snapshot_identifier}
    */
    readonly dbSnapshotIdentifier: string;
    /**
    * The tags to be assigned to the DB snapshot.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#tags CcDBSnapshot#tags}
    */
...
export class CcDBSnapshot extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDBSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcDBSnapshotProps
    */
    public constructor(scope: Construct, id: string, config: CcDBSnapshotProps) {
        super(scope, id, {
    ...
    private _tags = new CcDBSnapshot.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDBSnapshot.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccDBSnapshotTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDBSnapshotTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDBSnapshot.TagPropertyList",
            },
        };
...
export function ccDBSnapshotTagPropertyToTerraform(struct?: CcDBSnapshot.TagProperty | cdktn.IResolvable): any {
...
export function ccDBSnapshotTagPropertyToHclTerraform(struct?: CcDBSnapshot.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcDBSnapshot {
export interface TagProperty {
    /**
    * The key name of the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#key CcDBSnapshot#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/rds_db_snapshot#value CcDBSnapshot#value}
    */
