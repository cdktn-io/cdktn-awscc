...
export interface CcTapePoolProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#pool_name CcTapePool#pool_name}
    */
    readonly poolName: string;
    /**
    * Tape retention lock time in days (up to 36,500 days / 100 years).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#retention_lock_time_in_days CcTapePool#retention_lock_time_in_days}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#retention_lock_type CcTapePool#retention_lock_type}
    */
    readonly retentionLockType?: string;
    /**
    * The storage class associated with the custom pool (S3 Glacier or S3 Glacier Deep Archive).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#storage_class CcTapePool#storage_class}
    */
    readonly storageClass: string;
    /**
    * A list of up to 50 tags for the tape pool.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#tags CcTapePool#tags}
    */
...
export class CcTapePool extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTapePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    * The tag key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#key CcTapePool#key}
    */
    readonly key?: string;
    /**
    * The tag value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/storagegateway_tape_pool#value CcTapePool#value}
    */
