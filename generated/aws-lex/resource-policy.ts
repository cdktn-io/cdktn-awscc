...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy
...
export interface CcResourcePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy#policy CcResourcePolicy#policy}
    */
    readonly policy: string;
    /**
    * The Amazon Resource Name (ARN) of the bot or bot alias that the resource policy is attached to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy#resource_arn CcResourcePolicy#resource_arn}
    */
    readonly resourceArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy awscc_lex_resource_policy}
*/
export class CcResourcePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lex_resource_policy awscc_lex_resource_policy} Resource
    *
    * @param scope The scope in which to define this construct
