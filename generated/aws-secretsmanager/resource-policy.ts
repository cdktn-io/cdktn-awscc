...
export interface CcResourcePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/secretsmanager_resource_policy#block_public_policy CcResourcePolicy#block_public_policy}
    */
    readonly blockPublicPolicy?: boolean | cdktn.IResolvable;
    /**
    * A JSON-formatted string for an AWS resource-based policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/secretsmanager_resource_policy#resource_policy CcResourcePolicy#resource_policy}
    */
    readonly resourcePolicy: string;
    /**
    * The ARN or name of the secret to attach the resource-based policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/secretsmanager_resource_policy#secret_id CcResourcePolicy#secret_id}
    */
...
export class CcResourcePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/secretsmanager_resource_policy#import import section} in the documentation of this resource for the id to use
