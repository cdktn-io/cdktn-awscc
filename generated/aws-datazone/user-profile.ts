...
export interface CcUserProfileProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#domain_identifier CcUserProfile#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The session name of the user profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#session_name CcUserProfile#session_name}
    */
    readonly sessionName?: string;
    /**
    * The status of the user profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#status CcUserProfile#status}
    */
    readonly status?: string;
    /**
    * The ID of the user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#user_identifier CcUserProfile#user_identifier}
    */
    readonly userIdentifier: string;
    /**
    * The type of the user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#user_type CcUserProfile#user_type}
    */
...
export class CcUserProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_user_profile#import import section} in the documentation of this resource for the id to use
