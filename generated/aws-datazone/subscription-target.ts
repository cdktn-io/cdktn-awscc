...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcSubscriptionTargetProps extends cdktn.TerraformMetaArguments {
    /**
    * The asset types that can be included in the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#applicable_asset_types CcSubscriptionTarget#applicable_asset_types}
    */
    readonly applicableAssetTypes: string[];
    /**
    * The authorized principals of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#authorized_principals CcSubscriptionTarget#authorized_principals}
    */
    readonly authorizedPrincipals: string[];
    /**
    * The ID of the Amazon DataZone domain in which subscription target would be created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#domain_identifier CcSubscriptionTarget#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the environment in which subscription target would be created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#environment_identifier CcSubscriptionTarget#environment_identifier}
    */
    readonly environmentIdentifier: string;
    /**
    * The manage access role that is used to create the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#manage_access_role CcSubscriptionTarget#manage_access_role}
    */
    readonly manageAccessRole?: string;
    /**
    * The name of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#name CcSubscriptionTarget#name}
    */
    readonly name: string;
    /**
    * The provider of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#provider_name CcSubscriptionTarget#provider_name}
    */
    readonly providerName?: string;
    /**
    * The configuration of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#subscription_target_config CcSubscriptionTarget#subscription_target_config}
    */
    readonly subscriptionTargetConfig: CcSubscriptionTarget.SubscriptionTargetFormProperty[] | cdktn.IResolvable;
    /**
    * The type of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#type CcSubscriptionTarget#type}
    */
    readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target awscc_datazone_subscription_target}
*/
export class CcSubscriptionTarget extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubscriptionTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target awscc_datazone_subscription_target} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcSubscriptionTargetProps
    */
    public constructor(scope: Construct, id: string, config: CcSubscriptionTargetProps) {
        super(scope, id, {
    ...
    private _subscriptionTargetConfig = new CcSubscriptionTarget.SubscriptionTargetFormPropertyList(this, "subscription_target_config", false);
    public get subscriptionTargetConfig() {
        return this._subscriptionTargetConfig;
    }
    public putSubscriptionTargetConfig(value: CcSubscriptionTarget.SubscriptionTargetFormProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            subscription_target_config: cdktn.listMapper(ccSubscriptionTargetSubscriptionTargetFormPropertyToTerraform, false)(this._subscriptionTargetConfig.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            subscription_target_config: {
                value: cdktn.listMapperHcl(ccSubscriptionTargetSubscriptionTargetFormPropertyToHclTerraform, false)(this._subscriptionTargetConfig.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSubscriptionTarget.SubscriptionTargetFormPropertyList",
            },
            type: {
...
export function ccSubscriptionTargetSubscriptionTargetFormPropertyToTerraform(struct?: CcSubscriptionTarget.SubscriptionTargetFormProperty | cdktn.IResolvable): any {
...
export function ccSubscriptionTargetSubscriptionTargetFormPropertyToHclTerraform(struct?: CcSubscriptionTarget.SubscriptionTargetFormProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcSubscriptionTarget {
export interface SubscriptionTargetFormProperty {
    /**
    * The content of the subscription target configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#content CcSubscriptionTarget#content}
    */
    readonly content: string;
    /**
    * The form name included in the subscription target configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_subscription_target#form_name CcSubscriptionTarget#form_name}
    */
    readonly formName: string;
}
export class SubscriptionTargetFormPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): SubscriptionTargetFormProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: SubscriptionTargetFormProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class SubscriptionTargetFormPropertyList extends cdktn.ComplexList {
    public internalValue? : SubscriptionTargetFormProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): SubscriptionTargetFormPropertyOutputReference {
        return new SubscriptionTargetFormPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
}
