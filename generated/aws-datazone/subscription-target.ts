...
export interface CcSubscriptionTargetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#applicable_asset_types CcSubscriptionTarget#applicable_asset_types}
    */
    readonly applicableAssetTypes: string[];
    /**
    * The authorized principals of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#authorized_principals CcSubscriptionTarget#authorized_principals}
    */
    readonly authorizedPrincipals: string[];
    /**
    * The ID of the Amazon DataZone domain in which subscription target would be created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#domain_identifier CcSubscriptionTarget#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the environment in which subscription target would be created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#environment_identifier CcSubscriptionTarget#environment_identifier}
    */
    readonly environmentIdentifier: string;
    /**
    * The manage access role that is used to create the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#manage_access_role CcSubscriptionTarget#manage_access_role}
    */
    readonly manageAccessRole?: string;
    /**
    * The name of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#name CcSubscriptionTarget#name}
    */
    readonly name: string;
    /**
    * The provider of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#provider_name CcSubscriptionTarget#provider_name}
    */
    readonly providerName?: string;
    /**
    * The configuration of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#subscription_target_config CcSubscriptionTarget#subscription_target_config}
    */
    readonly subscriptionTargetConfig: CcSubscriptionTarget.SubscriptionTargetFormProperty[] | cdktn.IResolvable;
    /**
    * The type of the subscription target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#type CcSubscriptionTarget#type}
    */
...
export class CcSubscriptionTarget extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubscriptionTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#import import section} in the documentation of this resource for the id to use
...
export interface SubscriptionTargetFormProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#content CcSubscriptionTarget#content}
    */
    readonly content: string;
    /**
    * The form name included in the subscription target configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_subscription_target#form_name CcSubscriptionTarget#form_name}
    */
