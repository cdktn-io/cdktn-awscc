...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner
...
export interface CcOwnerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#domain_identifier CcOwner#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the entity to which you want to add an owner.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#entity_identifier CcOwner#entity_identifier}
    */
    readonly entityIdentifier: string;
    /**
    * The type of an entity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#entity_type CcOwner#entity_type}
    */
    readonly entityType: string;
    /**
    * The owner that you want to add to the entity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#owner CcOwner#owner}
    */
...
export class CcOwner extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#import import section} in the documentation of this resource for the id to use
...
export interface OwnerGroupPropertiesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#group_identifier CcOwner#group_identifier}
    */
...
export interface OwnerUserPropertiesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#user_identifier CcOwner#user_identifier}
    */
...
export interface OwnerPropertiesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#group CcOwner#group}
    */
    readonly group?: OwnerGroupPropertiesProperty;
    /**
    * The properties of the owner user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_owner#user CcOwner#user}
    */
