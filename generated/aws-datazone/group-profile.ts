...
export interface CcGroupProfileProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#domain_identifier CcGroupProfile#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#group_identifier CcGroupProfile#group_identifier}
    */
    readonly groupIdentifier?: string;
    /**
    * The type of the group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#group_type CcGroupProfile#group_type}
    */
    readonly groupType?: string;
    /**
    * The ARN of the role principal for the group profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#role_principal_arn CcGroupProfile#role_principal_arn}
    */
    readonly rolePrincipalArn?: string;
    /**
    * The status of the group profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#status CcGroupProfile#status}
    */
...
export class CcGroupProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGroupProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_group_profile#import import section} in the documentation of this resource for the id to use
