...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcFormTypeProps extends cdktn.TerraformMetaArguments {
    /**
    * The description of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#description CcFormType#description}
    */
    readonly description?: string;
    /**
    * The ID of the Amazon DataZone domain in which this metadata form type is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#domain_identifier CcFormType#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The model of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#model CcFormType#model}
    */
    readonly model: CcFormType.ModelProperty;
    /**
    * The name of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#name CcFormType#name}
    */
    readonly name: string;
    /**
    * The ID of the Amazon DataZone project that owns this metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#owning_project_identifier CcFormType#owning_project_identifier}
    */
    readonly owningProjectIdentifier: string;
    /**
    * The status of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#status CcFormType#status}
    */
    readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type awscc_datazone_form_type}
*/
export class CcFormType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcFormType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type awscc_datazone_form_type} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcFormTypeProps
    */
    public constructor(scope: Construct, id: string, config: CcFormTypeProps) {
        super(scope, id, {
    ...
    private _model = new CcFormType.ModelPropertyOutputReference(this, "model");
    public get model() {
        return this._model;
    }
    public putModel(value: CcFormType.ModelProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            model: ccFormTypeModelPropertyToTerraform(this._model.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            model: {
                value: ccFormTypeModelPropertyToHclTerraform(this._model.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcFormType.ModelProperty",
            },
            name: {
...
export function ccFormTypeModelPropertyToTerraform(struct?: CcFormType.ModelProperty | cdktn.IResolvable): any {
...
export function ccFormTypeModelPropertyToHclTerraform(struct?: CcFormType.ModelProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface ModelProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_form_type#smithy CcFormType#smithy}
    */
