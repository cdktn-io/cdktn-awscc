...
export interface CcFormTypeProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#description CcFormType#description}
    */
    readonly description?: string;
    /**
    * The ID of the Amazon DataZone domain in which this metadata form type is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#domain_identifier CcFormType#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The model of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#model CcFormType#model}
    */
    readonly model: CcFormType.ModelProperty;
    /**
    * The name of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#name CcFormType#name}
    */
    readonly name: string;
    /**
    * The ID of the Amazon DataZone project that owns this metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#owning_project_identifier CcFormType#owning_project_identifier}
    */
    readonly owningProjectIdentifier: string;
    /**
    * The status of this Amazon DataZone metadata form type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#status CcFormType#status}
    */
...
export class CcFormType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcFormType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#import import section} in the documentation of this resource for the id to use
...
export interface ModelProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_form_type#smithy CcFormType#smithy}
    */
