...
export interface CcEnvironmentProfileProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#aws_account_id CcEnvironmentProfile#aws_account_id}
    */
    readonly awsAccountId: string;
    /**
    * The AWS region in which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#aws_account_region CcEnvironmentProfile#aws_account_region}
    */
    readonly awsAccountRegion: string;
    /**
    * The description of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#description CcEnvironmentProfile#description}
    */
    readonly description?: string;
    /**
    * The ID of the Amazon DataZone domain in which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#domain_identifier CcEnvironmentProfile#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the blueprint with which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#environment_blueprint_identifier CcEnvironmentProfile#environment_blueprint_identifier}
    */
    readonly environmentBlueprintIdentifier: string;
    /**
    * The name of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#name CcEnvironmentProfile#name}
    */
    readonly name: string;
    /**
    * The identifier of the project in which to create the environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#project_identifier CcEnvironmentProfile#project_identifier}
    */
    readonly projectIdentifier: string;
    /**
    * The user parameters of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#user_parameters CcEnvironmentProfile#user_parameters}
    */
...
export class CcEnvironmentProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnvironmentProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#import import section} in the documentation of this resource for the id to use
...
export interface EnvironmentParameterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/datazone_environment_profile#value CcEnvironmentProfile#value}
    */
