...
export interface CcEnvironmentProfileProps extends cdktn.TerraformMetaArguments {
    /**
    * The AWS account in which the Amazon DataZone environment is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#aws_account_id CcEnvironmentProfile#aws_account_id}
    */
    readonly awsAccountId: string;
    /**
    * The AWS region in which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#aws_account_region CcEnvironmentProfile#aws_account_region}
    */
    readonly awsAccountRegion: string;
    /**
    * The description of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#description CcEnvironmentProfile#description}
    */
    readonly description?: string;
    /**
    * The ID of the Amazon DataZone domain in which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#domain_identifier CcEnvironmentProfile#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The ID of the blueprint with which this environment profile is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#environment_blueprint_identifier CcEnvironmentProfile#environment_blueprint_identifier}
    */
    readonly environmentBlueprintIdentifier: string;
    /**
    * The name of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#name CcEnvironmentProfile#name}
    */
    readonly name: string;
    /**
    * The identifier of the project in which to create the environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#project_identifier CcEnvironmentProfile#project_identifier}
    */
    readonly projectIdentifier: string;
    /**
    * The user parameters of this Amazon DataZone environment profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#user_parameters CcEnvironmentProfile#user_parameters}
    */
...
export class CcEnvironmentProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnvironmentProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcEnvironmentProfileProps
    */
    public constructor(scope: Construct, id: string, config: CcEnvironmentProfileProps) {
        super(scope, id, {
    ...
    private _userParameters = new CcEnvironmentProfile.EnvironmentParameterPropertyList(this, "user_parameters", false);
    public get userParameters() {
        return this._userParameters;
    }
    public putUserParameters(value: CcEnvironmentProfile.EnvironmentParameterProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            user_parameters: cdktn.listMapper(ccEnvironmentProfileEnvironmentParameterPropertyToTerraform, false)(this._userParameters.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            user_parameters: {
                value: cdktn.listMapperHcl(ccEnvironmentProfileEnvironmentParameterPropertyToHclTerraform, false)(this._userParameters.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcEnvironmentProfile.EnvironmentParameterPropertyList",
            },
        };
...
export function ccEnvironmentProfileEnvironmentParameterPropertyToTerraform(struct?: CcEnvironmentProfile.EnvironmentParameterProperty | cdktn.IResolvable): any {
...
export function ccEnvironmentProfileEnvironmentParameterPropertyToHclTerraform(struct?: CcEnvironmentProfile.EnvironmentParameterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcEnvironmentProfile {
export interface EnvironmentParameterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_environment_profile#value CcEnvironmentProfile#value}
    */
