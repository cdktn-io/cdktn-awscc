...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit
...
export interface CcDomainUnitProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit#description CcDomainUnit#description}
    */
    readonly description?: string;
    /**
    * The ID of the domain where you want to create a domain unit.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit#domain_identifier CcDomainUnit#domain_identifier}
    */
    readonly domainIdentifier: string;
    /**
    * The name of the domain unit.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit#name CcDomainUnit#name}
    */
    readonly name: string;
    /**
    * The ID of the parent domain unit.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit#parent_domain_unit_identifier CcDomainUnit#parent_domain_unit_identifier}
    */
...
export class CcDomainUnit extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDomainUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/datazone_domain_unit#import import section} in the documentation of this resource for the id to use
