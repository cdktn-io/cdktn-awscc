...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain
...
export interface CcDomainProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#description CcDomain#description}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#domain_execution_role CcDomain#domain_execution_role}
    */
    readonly domainExecutionRole?: string;
    /**
    * The version of the domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#domain_version CcDomain#domain_version}
    */
    readonly domainVersion?: string;
    /**
    * The identifier of the AWS Key Management Service (KMS) key that is used to encrypt the Amazon DataZone domain, metadata, and reporting data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#kms_key_identifier CcDomain#kms_key_identifier}
    */
    readonly kmsKeyIdentifier?: string;
    /**
    * The name of the Amazon DataZone domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#name CcDomain#name}
    */
    readonly name: string;
    /**
    * The service role of the domain that is created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#service_role CcDomain#service_role}
    */
    readonly serviceRole?: string;
    /**
    * The single-sign on configuration of the Amazon DataZone domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#single_sign_on CcDomain#single_sign_on}
    */
    readonly singleSignOn?: CcDomain.SingleSignOnProperty;
    /**
    * The tags specified for the Amazon DataZone domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#tags CcDomain#tags}
    */
    readonly tags?: CcDomain.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain awscc_datazone_domain}
*/
export class CcDomain extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain awscc_datazone_domain} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _singleSignOn = new CcDomain.SingleSignOnPropertyOutputReference(this, "single_sign_on");
    public get singleSignOn() {
        return this._singleSignOn;
    }
    public putSingleSignOn(value: CcDomain.SingleSignOnProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            single_sign_on: ccDomainSingleSignOnPropertyToTerraform(this._singleSignOn.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            single_sign_on: {
                value: ccDomainSingleSignOnPropertyToHclTerraform(this._singleSignOn.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcDomain.SingleSignOnProperty",
            },
            tags: {
...
export function ccDomainSingleSignOnPropertyToTerraform(struct?: CcDomain.SingleSignOnProperty | cdktn.IResolvable): any {
...
export function ccDomainSingleSignOnPropertyToHclTerraform(struct?: CcDomain.SingleSignOnProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface SingleSignOnProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#idc_instance_arn CcDomain#idc_instance_arn}
    */
    readonly idcInstanceArn?: string;
    /**
    * The type of single sign-on in Amazon DataZone.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#type CcDomain#type}
    */
    readonly type?: string;
    /**
    * The single sign-on user assignment in Amazon DataZone.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#user_assignment CcDomain#user_assignment}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#key CcDomain#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/datazone_domain#value CcDomain#value}
    */
