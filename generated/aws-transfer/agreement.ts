...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcAgreementProps extends cdktn.TerraformMetaArguments {
    /**
    * Specifies the access role for the agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#access_role CcAgreement#access_role}
    */
    readonly accessRole: string;
    /**
    * Specifies the base directory for the agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#base_directory CcAgreement#base_directory}
    */
    readonly baseDirectory?: string;
    /**
    * Specifies a separate directory for each type of file to store for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#custom_directories CcAgreement#custom_directories}
    */
    readonly customDirectories?: CcAgreement.CustomDirectoriesProperty;
    /**
    * A textual description for the agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#description CcAgreement#description}
    */
    readonly description?: string;
    /**
    * Specifies whether to enforce an AS2 message is signed for this agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#enforce_message_signing CcAgreement#enforce_message_signing}
    */
    readonly enforceMessageSigning?: string;
    /**
    * A unique identifier for the local profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#local_profile_id CcAgreement#local_profile_id}
    */
    readonly localProfileId: string;
    /**
    * A unique identifier for the partner profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#partner_profile_id CcAgreement#partner_profile_id}
    */
    readonly partnerProfileId: string;
    /**
    * Specifies whether to preserve the filename received for this agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#preserve_filename CcAgreement#preserve_filename}
    */
    readonly preserveFilename?: string;
    /**
    * A unique identifier for the server.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#server_id CcAgreement#server_id}
    */
    readonly serverId: string;
    /**
    * Specifies the status of the agreement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#status CcAgreement#status}
    */
    readonly status?: string;
    /**
    * Key-value pairs that can be used to group and search for agreements. Tags are metadata attached to agreements for any purpose.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#tags CcAgreement#tags}
    */
...
export class CcAgreement extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcAgreementProps
    */
    public constructor(scope: Construct, id: string, config: CcAgreementProps) {
        super(scope, id, {
    ...
    private _customDirectories = new CcAgreement.CustomDirectoriesPropertyOutputReference(this, "custom_directories");
    public get customDirectories() {
        return this._customDirectories;
    }
    public putCustomDirectories(value: CcAgreement.CustomDirectoriesProperty) {
    ...
    private _tags = new CcAgreement.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcAgreement.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            custom_directories: ccAgreementCustomDirectoriesPropertyToTerraform(this._customDirectories.internalValue),
            ...
            tags: cdktn.listMapper(ccAgreementTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            custom_directories: {
                value: ccAgreementCustomDirectoriesPropertyToHclTerraform(this._customDirectories.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcAgreement.CustomDirectoriesProperty",
            },
            description: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccAgreementTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcAgreement.TagPropertyList",
            },
        };
...
export function ccAgreementCustomDirectoriesPropertyToTerraform(struct?: CcAgreement.CustomDirectoriesProperty | cdktn.IResolvable): any {
...
export function ccAgreementCustomDirectoriesPropertyToHclTerraform(struct?: CcAgreement.CustomDirectoriesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAgreementTagPropertyToTerraform(struct?: CcAgreement.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAgreementTagPropertyToHclTerraform(struct?: CcAgreement.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcAgreement {
export interface CustomDirectoriesProperty {
    /**
    * Specifies a location to store the failed files for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#failed_files_directory CcAgreement#failed_files_directory}
    */
    readonly failedFilesDirectory?: string;
    /**
    * Specifies a location to store the MDN file for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#mdn_files_directory CcAgreement#mdn_files_directory}
    */
    readonly mdnFilesDirectory?: string;
    /**
    * Specifies a location to store the payload file for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#payload_files_directory CcAgreement#payload_files_directory}
    */
    readonly payloadFilesDirectory?: string;
    /**
    * Specifies a location to store the status file for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#status_files_directory CcAgreement#status_files_directory}
    */
    readonly statusFilesDirectory?: string;
    /**
    * Specifies a location to store the temporary processing file for an AS2 message.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#temporary_files_directory CcAgreement#temporary_files_directory}
    */
    readonly temporaryFilesDirectory?: string;
}
export class CustomDirectoriesPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): CustomDirectoriesProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: CustomDirectoriesProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#key CcAgreement#key}
    */
    readonly key?: string;
    /**
    * Contains one or more values that you assigned to the key name you create.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transfer_agreement#value CcAgreement#value}
    */
