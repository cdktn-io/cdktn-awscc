...
export interface CcRepositoryProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#code CcRepository#code}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#kms_key_id CcRepository#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * A comment or description about the new repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#repository_description CcRepository#repository_description}
    */
    readonly repositoryDescription?: string;
    /**
    * The name of the new repository to be created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#repository_name CcRepository#repository_name}
    */
    readonly repositoryName: string;
    /**
    * One or more tag key-value pairs to use when tagging this repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#tags CcRepository#tags}
    */
    readonly tags?: CcRepository.TagProperty[] | cdktn.IResolvable;
    /**
    * Information about a trigger for a repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#triggers CcRepository#triggers}
    */
...
export class CcRepository extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _code = new CcRepository.CodePropertyOutputReference(this, "code");
    public get code() {
        return this._code;
    }
    public putCode(value: CcRepository.CodeProperty) {
    ...
    private _tags = new CcRepository.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    ...
    private _triggers = new CcRepository.RepositoryTriggerPropertyList(this, "triggers", false);
    public get triggers() {
        return this._triggers;
    }
    public putTriggers(value: CcRepository.RepositoryTriggerProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            code: ccRepositoryCodePropertyToTerraform(this._code.internalValue),
            ...
            triggers: cdktn.listMapper(ccRepositoryRepositoryTriggerPropertyToTerraform, false)(this._triggers.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            code: {
                value: ccRepositoryCodePropertyToHclTerraform(this._code.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcRepository.CodeProperty",
            },
            kms_key_id: {
            ...
            triggers: {
                value: cdktn.listMapperHcl(ccRepositoryRepositoryTriggerPropertyToHclTerraform, false)(this._triggers.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcRepository.RepositoryTriggerPropertyList",
            },
        };
...
export function ccRepositoryS3PropertyToTerraform(struct?: CcRepository.S3Property | cdktn.IResolvable): any {
...
export function ccRepositoryS3PropertyToHclTerraform(struct?: CcRepository.S3Property | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryCodePropertyToTerraform(struct?: CcRepository.CodeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        s3: ccRepositoryS3PropertyToTerraform(struct!.s3),
    }
}


export function ccRepositoryCodePropertyToHclTerraform(struct?: CcRepository.CodeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        s3: {
            value: ccRepositoryS3PropertyToHclTerraform(struct!.s3),
            isBlock: true,
            type: "struct",
...
export function ccRepositoryRepositoryTriggerPropertyToTerraform(struct?: CcRepository.RepositoryTriggerProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccRepositoryRepositoryTriggerPropertyToHclTerraform(struct?: CcRepository.RepositoryTriggerProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface S3Property {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#bucket CcRepository#bucket}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#key CcRepository#key}
    */
    readonly key?: string;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#object_version CcRepository#object_version}
    */
...
export interface CodeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#branch_name CcRepository#branch_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#s3 CcRepository#s3}
    */
...
export interface TagProperty {
    ...
    * The tag's value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#value CcRepository#value}
    */
...
export interface RepositoryTriggerProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#branches CcRepository#branches}
    */
    readonly branches?: string[];
    /**
    * Any custom data associated with the trigger to be included in the information sent to the target of the trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#custom_data CcRepository#custom_data}
    */
    readonly customData?: string;
    /**
    * The ARN of the resource that is the target for a trigger (for example, the ARN of a topic in Amazon SNS).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#destination_arn CcRepository#destination_arn}
    */
    readonly destinationArn?: string;
    /**
    * The repository events that cause the trigger to run actions in another service, such as sending a notification through Amazon SNS.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#events CcRepository#events}
    */
    readonly events?: string[];
    /**
    * The name of the trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codecommit_repository#name CcRepository#name}
    */
    readonly name?: string;
}
export class RepositoryTriggerPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): RepositoryTriggerProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: RepositoryTriggerProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export class RepositoryTriggerPropertyList extends cdktn.ComplexList {
    public internalValue? : RepositoryTriggerProperty[] | cdktn.IResolvable
    ...
    * @param index the index of the item to return
    */
    public get(index: number): RepositoryTriggerPropertyOutputReference {
        return new RepositoryTriggerPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
}
