...
export interface CcVocabularyFilterProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#data_access_role_arn CcVocabularyFilter#data_access_role_arn}
    */
    readonly dataAccessRoleArn?: string;
    /**
    * The language code that represents the language of the entries in your vocabulary filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#language_code CcVocabularyFilter#language_code}
    */
    readonly languageCode: string;
    /**
    * Tags associated with the vocabulary filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#tags CcVocabularyFilter#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#vocabulary_filter_file_uri CcVocabularyFilter#vocabulary_filter_file_uri}
    */
    readonly vocabularyFilterFileUri?: string;
    /**
    * A unique name, chosen by you, for your custom vocabulary filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#vocabulary_filter_name CcVocabularyFilter#vocabulary_filter_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#words CcVocabularyFilter#words}
    */
...
export class CcVocabularyFilter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVocabularyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcVocabularyFilterProps
    */
    public constructor(scope: Construct, id: string, config: CcVocabularyFilterProps) {
        super(scope, id, {
    ...
    private _tags = new CcVocabularyFilter.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcVocabularyFilter.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccVocabularyFilterTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccVocabularyFilterTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcVocabularyFilter.TagPropertyList",
            },
...
export function ccVocabularyFilterTagPropertyToTerraform(struct?: CcVocabularyFilter.TagProperty | cdktn.IResolvable): any {
...
export function ccVocabularyFilterTagPropertyToHclTerraform(struct?: CcVocabularyFilter.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcVocabularyFilter {
export interface TagProperty {
    /**
    * The key of the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#key CcVocabularyFilter#key}
    */
    readonly key?: string;
    /**
    * The value of the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/transcribe_vocabulary_filter#value CcVocabularyFilter#value}
    */
