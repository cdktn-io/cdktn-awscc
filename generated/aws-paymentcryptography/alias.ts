...
// https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/paymentcryptography_alias

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcAliasProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/paymentcryptography_alias#alias_name CcAlias#alias_name}
    */
    readonly aliasName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/paymentcryptography_alias#key_arn CcAlias#key_arn}
    */
...
export class CcAlias extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/paymentcryptography_alias#import import section} in the documentation of this resource for the id to use
