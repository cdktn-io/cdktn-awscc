...
export interface CcKeyProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#derive_key_usage CcKey#derive_key_usage}
    */
    readonly deriveKeyUsage?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#enabled CcKey#enabled}
    */
    readonly enabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#exportable CcKey#exportable}
    */
    readonly exportable: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_attributes CcKey#key_attributes}
    */
    readonly keyAttributes: CcKey.KeyAttributesProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_check_value_algorithm CcKey#key_check_value_algorithm}
    */
    readonly keyCheckValueAlgorithm?: string;
    /**
    * The resource-based policy attached to the key, in JSON format.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#policy CcKey#policy}
    */
    readonly policy?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#replication_regions CcKey#replication_regions}
    */
    readonly replicationRegions?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#tags CcKey#tags}
    */
...
export class CcKey extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcKeyProps
    */
    public constructor(scope: Construct, id: string, config: CcKeyProps) {
        super(scope, id, {
    ...
    private _keyAttributes = new CcKey.KeyAttributesPropertyOutputReference(this, "key_attributes");
    public get keyAttributes() {
        return this._keyAttributes;
    }
    public putKeyAttributes(value: CcKey.KeyAttributesProperty) {
    ...
    private _replicationStatus = new CcKey.ReplicationStatusPropertyMap(this, "replication_status");
    public get replicationStatus() {
        return this._replicationStatus;
    }

    // tags - computed: true, optional: true, required: false
    private _tags = new CcKey.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcKey.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            key_attributes: ccKeyKeyAttributesPropertyToTerraform(this._keyAttributes.internalValue),
            ...
            tags: cdktn.listMapper(ccKeyTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            key_attributes: {
                value: ccKeyKeyAttributesPropertyToHclTerraform(this._keyAttributes.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcKey.KeyAttributesProperty",
            },
            ...
            tags: {
                value: cdktn.listMapperHcl(ccKeyTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcKey.TagPropertyList",
            },
        };
...
export function ccKeyKeyModesOfUsePropertyToTerraform(struct?: CcKey.KeyModesOfUseProperty | cdktn.IResolvable): any {
...
export function ccKeyKeyModesOfUsePropertyToHclTerraform(struct?: CcKey.KeyModesOfUseProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKeyKeyAttributesPropertyToTerraform(struct?: CcKey.KeyAttributesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        key_modes_of_use: ccKeyKeyModesOfUsePropertyToTerraform(struct!.keyModesOfUse),
        key_usage: cdktn.stringToTerraform(struct!.keyUsage),
    }
}


export function ccKeyKeyAttributesPropertyToHclTerraform(struct?: CcKey.KeyAttributesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        key_modes_of_use: {
            value: ccKeyKeyModesOfUsePropertyToHclTerraform(struct!.keyModesOfUse),
            isBlock: true,
            type: "struct",
            storageClassType: "KeyModesOfUseProperty",
        },
        key_usage: {
...
export function ccKeyReplicationStatusPropertyToTerraform(struct?: CcKey.ReplicationStatusProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKeyReplicationStatusPropertyToHclTerraform(struct?: CcKey.ReplicationStatusProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKeyTagPropertyToTerraform(struct?: CcKey.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKeyTagPropertyToHclTerraform(struct?: CcKey.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface KeyModesOfUseProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#decrypt CcKey#decrypt}
    */
    readonly decrypt?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#derive_key CcKey#derive_key}
    */
    readonly deriveKey?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#encrypt CcKey#encrypt}
    */
    readonly encrypt?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#generate CcKey#generate}
    */
    readonly generate?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#no_restrictions CcKey#no_restrictions}
    */
    readonly noRestrictions?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#sign CcKey#sign}
    */
    readonly sign?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#unwrap CcKey#unwrap}
    */
    readonly unwrap?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#verify CcKey#verify}
    */
    readonly verify?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#wrap CcKey#wrap}
    */
...
export interface KeyAttributesProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_algorithm CcKey#key_algorithm}
    */
    readonly keyAlgorithm: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_class CcKey#key_class}
    */
    readonly keyClass: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_modes_of_use CcKey#key_modes_of_use}
    */
    readonly keyModesOfUse: KeyModesOfUseProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key_usage CcKey#key_usage}
    */
...
export class KeyAttributesPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    private _keyModesOfUse = new KeyModesOfUsePropertyOutputReference(this, "key_modes_of_use");
    public get keyModesOfUse() {
        return this._keyModesOfUse;
    }
    public putKeyModesOfUse(value: KeyModesOfUseProperty) {
...
export interface ReplicationStatusProperty {
}
export class ReplicationStatusPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    ...
    */
    ...
    public get internalValue(): ReplicationStatusProperty | undefined {
        let hasAnyValues = this.isEmptyObject;
        const internalValueResult: any = {};
        return hasAnyValues ? internalValueResult : undefined;
    }

    public set internalValue(value: ReplicationStatusProperty | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
        }
        else {
...
export class ReplicationStatusPropertyMap extends cdktn.ComplexMap {
    ...
    */
    public get(key: string): ReplicationStatusPropertyOutputReference {
        return new ReplicationStatusPropertyOutputReference(this.terraformResource, this.terraformAttribute, key);
    }
}
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#key CcKey#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/paymentcryptography_key#value CcKey#value}
    */
