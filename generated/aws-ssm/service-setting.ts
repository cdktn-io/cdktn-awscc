...
export interface CcServiceSettingProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ssm_service_setting#setting_id CcServiceSetting#setting_id}
    */
    readonly settingId: string;
    /**
    * The value of the service setting.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ssm_service_setting#setting_value CcServiceSetting#setting_value}
    */
...
export class CcServiceSetting extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcServiceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ssm_service_setting#import import section} in the documentation of this resource for the id to use
