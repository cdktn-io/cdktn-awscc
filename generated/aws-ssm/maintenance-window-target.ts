...
export interface CcMaintenanceWindowTargetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#description CcMaintenanceWindowTarget#description}
    */
    readonly description?: string;
    /**
    * The name for the maintenance window target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#name CcMaintenanceWindowTarget#name}
    */
    readonly name?: string;
    /**
    * A user-provided value that will be included in any Amazon CloudWatch Events events that are raised while running tasks for these targets in this maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#owner_information CcMaintenanceWindowTarget#owner_information}
    */
    readonly ownerInformation?: string;
    /**
    * The type of target that is being registered with the maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#resource_type CcMaintenanceWindowTarget#resource_type}
    */
    readonly resourceType: string;
    /**
    * The targets to register with the maintenance window.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#targets CcMaintenanceWindowTarget#targets}
    */
    readonly targets: CcMaintenanceWindowTarget.TargetsProperty[] | cdktn.IResolvable;
    /**
    * The ID of the maintenance window to register the target with.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#window_id CcMaintenanceWindowTarget#window_id}
    */
...
export class CcMaintenanceWindowTarget extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMaintenanceWindowTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#import import section} in the documentation of this resource for the id to use
...
export interface TargetsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#key CcMaintenanceWindowTarget#key}
    */
    readonly key: string;
    /**
    * User-defined criteria that maps to Key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ssm_maintenance_window_target#values CcMaintenanceWindowTarget#values}
    */
