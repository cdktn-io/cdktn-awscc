...
export interface CcPreferencesProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#connection_recording_preferences CcPreferences#connection_recording_preferences}
    */
...
export class CcPreferences extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#import import section} in the documentation of this resource for the id to use
...
export interface S3BucketProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#bucket_name CcPreferences#bucket_name}
    */
    readonly bucketName?: string;
    /**
    * The AWS account number that owns the S3 bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#bucket_owner CcPreferences#bucket_owner}
    */
...
export interface RecordingDestinationsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#s3_buckets CcPreferences#s3_buckets}
    */
...
export interface ConnectionRecordingPreferencesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#kms_key_arn CcPreferences#kms_key_arn}
    */
    readonly kmsKeyArn?: string;
    /**
    * Determines where recordings of RDP connections are stored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ssmguiconnect_preferences#recording_destinations CcPreferences#recording_destinations}
    */
