...
export interface CcReceiptFilterProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#filter CcReceiptFilter#filter}
    */
...
export class CcReceiptFilter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcReceiptFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#import import section} in the documentation of this resource for the id to use
...
export interface IpFilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#cidr CcReceiptFilter#cidr}
    */
    readonly cidr: string;
    /**
    * Indicates whether to block or allow incoming mail from the specified IP addresses.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#policy CcReceiptFilter#policy}
    */
...
export interface FilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#ip_filter CcReceiptFilter#ip_filter}
    */
    readonly ipFilter: IpFilterProperty;
    /**
    * The name of the IP address filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_receipt_filter#name CcReceiptFilter#name}
    */
