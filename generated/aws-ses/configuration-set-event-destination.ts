...
export interface CcConfigurationSetEventDestinationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#configuration_set_name CcConfigurationSetEventDestination#configuration_set_name}
    */
    readonly configurationSetName: string;
    /**
    * The event destination object.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#event_destination CcConfigurationSetEventDestination#event_destination}
    */
...
export interface DimensionConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#default_dimension_value CcConfigurationSetEventDestination#default_dimension_value}
    */
    readonly defaultDimensionValue?: string;
    /**
    * The name of an Amazon CloudWatch dimension associated with an email sending metric.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#dimension_name CcConfigurationSetEventDestination#dimension_name}
    */
    readonly dimensionName?: string;
    /**
    * The place where Amazon SES finds the value of a dimension to publish to Amazon CloudWatch. To use the message tags that you specify using an X-SES-MESSAGE-TAGS header or a parameter to the SendEmail/SendRawEmail API, specify messageTag. To use your own email headers, specify emailHeader. To put a custom tag on any link included in your email, specify linkTag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#dimension_value_source CcConfigurationSetEventDestination#dimension_value_source}
    */
...
export interface CloudWatchDestinationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#dimension_configurations CcConfigurationSetEventDestination#dimension_configurations}
    */
...
export interface EventBridgeDestinationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#event_bus_arn CcConfigurationSetEventDestination#event_bus_arn}
    */
...
export interface KinesisFirehoseDestinationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#delivery_stream_arn CcConfigurationSetEventDestination#delivery_stream_arn}
    */
    readonly deliveryStreamArn?: string;
    /**
    * The ARN of the IAM role under which Amazon SES publishes email sending events to the Amazon Kinesis Firehose stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#iam_role_arn CcConfigurationSetEventDestination#iam_role_arn}
    */
...
export interface SnsDestinationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#topic_arn CcConfigurationSetEventDestination#topic_arn}
    */
...
export interface EventDestinationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#cloudwatch_destination CcConfigurationSetEventDestination#cloudwatch_destination}
    */
    readonly cloudwatchDestination?: CloudWatchDestinationProperty;
    /**
    * Sets whether Amazon SES publishes events to this destination when you send an email with the associated configuration set. Set to true to enable publishing to this destination; set to false to prevent publishing to this destination. The default value is false.   
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#enabled CcConfigurationSetEventDestination#enabled}
    */
    readonly enabled?: boolean | cdktn.IResolvable;
    /**
    * An object that contains Event bus ARN associated with the event bridge destination.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#event_bridge_destination CcConfigurationSetEventDestination#event_bridge_destination}
    */
    readonly eventBridgeDestination?: EventBridgeDestinationProperty;
    /**
    * An object that contains the delivery stream ARN and the IAM role ARN associated with an Amazon Kinesis Firehose event destination.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#kinesis_firehose_destination CcConfigurationSetEventDestination#kinesis_firehose_destination}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#matching_event_types CcConfigurationSetEventDestination#matching_event_types}
    */
    readonly matchingEventTypes: string[];
    /**
    * The name of the event destination set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#name CcConfigurationSetEventDestination#name}
    */
    readonly name?: string;
    /**
    * An object that contains SNS topic ARN associated event destination.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_configuration_set_event_destination#sns_destination CcConfigurationSetEventDestination#sns_destination}
    */
