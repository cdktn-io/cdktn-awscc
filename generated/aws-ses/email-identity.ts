...
export interface CcEmailIdentityProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#configuration_set_attributes CcEmailIdentity#configuration_set_attributes}
    */
    readonly configurationSetAttributes?: CcEmailIdentity.ConfigurationSetAttributesProperty;
    /**
    * Used to enable or disable DKIM authentication for an email identity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#dkim_attributes CcEmailIdentity#dkim_attributes}
    */
    readonly dkimAttributes?: CcEmailIdentity.DkimAttributesProperty;
    /**
    * If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for Easy DKIM.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#dkim_signing_attributes CcEmailIdentity#dkim_signing_attributes}
    */
    readonly dkimSigningAttributes?: CcEmailIdentity.DkimSigningAttributesProperty;
    /**
    * The email address or domain to verify.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#email_identity CcEmailIdentity#email_identity}
    */
    readonly emailIdentity: string;
    /**
    * Used to enable or disable feedback forwarding for an identity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#feedback_attributes CcEmailIdentity#feedback_attributes}
    */
    readonly feedbackAttributes?: CcEmailIdentity.FeedbackAttributesProperty;
    /**
    * Used to enable or disable the custom Mail-From domain configuration for an email identity.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#mail_from_attributes CcEmailIdentity#mail_from_attributes}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#tags CcEmailIdentity#tags}
    */
...
export class CcEmailIdentity extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#import import section} in the documentation of this resource for the id to use
...
export interface ConfigurationSetAttributesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#configuration_set_name CcEmailIdentity#configuration_set_name}
    */
...
export interface DkimAttributesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#signing_enabled CcEmailIdentity#signing_enabled}
    */
...
export interface DkimSigningAttributesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#domain_signing_private_key CcEmailIdentity#domain_signing_private_key}
    */
    readonly domainSigningPrivateKey?: string;
    /**
    * [Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#domain_signing_selector CcEmailIdentity#domain_signing_selector}
    */
    readonly domainSigningSelector?: string;
    /**
    * [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#next_signing_key_length CcEmailIdentity#next_signing_key_length}
    */
...
export interface FeedbackAttributesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#email_forwarding_enabled CcEmailIdentity#email_forwarding_enabled}
    */
...
export interface MailFromAttributesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#behavior_on_mx_failure CcEmailIdentity#behavior_on_mx_failure}
    */
    readonly behaviorOnMxFailure?: string;
    /**
    * The custom MAIL FROM domain that you want the verified identity to use
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#mail_from_domain CcEmailIdentity#mail_from_domain}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#key CcEmailIdentity#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ses_email_identity#value CcEmailIdentity#value}
    */
