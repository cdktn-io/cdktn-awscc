...
export interface CcReceiptRuleSetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ses_receipt_rule_set#rule_set_name CcReceiptRuleSet#rule_set_name}
    */
...
export class CcReceiptRuleSet extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcReceiptRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ses_receipt_rule_set#import import section} in the documentation of this resource for the id to use
