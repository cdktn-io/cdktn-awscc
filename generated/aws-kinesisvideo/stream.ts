...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream
...
export interface CcStreamProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#data_retention_in_hours CcStream#data_retention_in_hours}
    */
    readonly dataRetentionInHours?: number;
    /**
    * The name of the device that is writing to the stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#device_name CcStream#device_name}
    */
    readonly deviceName?: string;
    /**
    * AWS KMS key ID that Kinesis Video Streams uses to encrypt stream data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#kms_key_id CcStream#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * The media type of the stream. Consumers of the stream can use this information when processing the stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#media_type CcStream#media_type}
    */
    readonly mediaType?: string;
    /**
    * The name of the Kinesis Video stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#name CcStream#name}
    */
    readonly name?: string;
    /**
    * Configuration for the storage tier of the Kinesis Video Stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#stream_storage_configuration CcStream#stream_storage_configuration}
    */
    readonly streamStorageConfiguration?: CcStream.StreamStorageConfigurationProperty;
    /**
    * An array of key-value pairs associated with the Kinesis Video Stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#tags CcStream#tags}
    */
    readonly tags?: CcStream.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream awscc_kinesisvideo_stream}
*/
export class CcStream extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream awscc_kinesisvideo_stream} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _streamStorageConfiguration = new CcStream.StreamStorageConfigurationPropertyOutputReference(this, "stream_storage_configuration");
    public get streamStorageConfiguration() {
        return this._streamStorageConfiguration;
    }
    public putStreamStorageConfiguration(value: CcStream.StreamStorageConfigurationProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            stream_storage_configuration: ccStreamStreamStorageConfigurationPropertyToTerraform(this._streamStorageConfiguration.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            stream_storage_configuration: {
                value: ccStreamStreamStorageConfigurationPropertyToHclTerraform(this._streamStorageConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcStream.StreamStorageConfigurationProperty",
            },
            tags: {
...
export function ccStreamStreamStorageConfigurationPropertyToTerraform(struct?: CcStream.StreamStorageConfigurationProperty | cdktn.IResolvable): any {
...
export function ccStreamStreamStorageConfigurationPropertyToHclTerraform(struct?: CcStream.StreamStorageConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface StreamStorageConfigurationProperty {
    /**
    * The storage tier for the Kinesis Video Stream. Determines the storage class used for stream data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#default_storage_tier CcStream#default_storage_tier}
    */
    readonly defaultStorageTier?: string;
}
export class StreamStorageConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): StreamStorageConfigurationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: StreamStorageConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#key CcStream#key}
    */
    readonly key?: string;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/kinesisvideo_stream#value CcStream#value}
    */
