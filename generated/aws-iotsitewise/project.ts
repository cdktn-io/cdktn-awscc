...
export interface CcProjectProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#asset_ids CcProject#asset_ids}
    */
    readonly assetIds?: string[];
    /**
    * The ID of the portal in which to create the project.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#portal_id CcProject#portal_id}
    */
    readonly portalId: string;
    /**
    * A description for the project.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#project_description CcProject#project_description}
    */
    readonly projectDescription?: string;
    /**
    * A friendly name for the project.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#project_name CcProject#project_name}
    */
    readonly projectName: string;
    /**
    * A list of key-value pairs that contain metadata for the project.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#tags CcProject#tags}
    */
...
export class CcProject extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#key CcProject#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/iotsitewise_project#value CcProject#value}
    */
