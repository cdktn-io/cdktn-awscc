...
export class CcLogAnomalyDetectionIntegration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLogAnomalyDetectionIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsguru_log_anomaly_detection_integration#import import section} in the documentation of this resource for the id to use
