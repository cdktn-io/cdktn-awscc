...
export interface CcRuntimeEndpointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#agent_runtime_id CcRuntimeEndpoint#agent_runtime_id}
    */
    readonly agentRuntimeId: string;
    /**
    * The version of the AgentCore Runtime to use for the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#agent_runtime_version CcRuntimeEndpoint#agent_runtime_version}
    */
    readonly agentRuntimeVersion?: string;
    /**
    * The description of the AgentCore Runtime endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#description CcRuntimeEndpoint#description}
    */
    readonly description?: string;
    /**
    * The name of the Agent Runtime Endpoint
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#name CcRuntimeEndpoint#name}
    */
    readonly name: string;
    /**
    * A map of tag keys and values
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#tags CcRuntimeEndpoint#tags}
    */
...
export class CcRuntimeEndpoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRuntimeEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrockagentcore_runtime_endpoint#import import section} in the documentation of this resource for the id to use
