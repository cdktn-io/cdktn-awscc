...
export interface CcWorkloadIdentityProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#allowed_resource_oauth_2_return_urls CcWorkloadIdentity#allowed_resource_oauth_2_return_urls}
    */
    readonly allowedResourceOauth2ReturnUrls?: string[];
    /**
    * The name of the workload identity. The name must be unique within your account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#name CcWorkloadIdentity#name}
    */
    readonly name: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#tags CcWorkloadIdentity#tags}
    */
...
export class CcWorkloadIdentity extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcWorkloadIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#key CcWorkloadIdentity#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrockagentcore_workload_identity#value CcWorkloadIdentity#value}
    */
