...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcDataTableAttributeProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#data_table_arn CcDataTableAttribute#data_table_arn}
    */
    readonly dataTableArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#description CcDataTableAttribute#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#instance_arn CcDataTableAttribute#instance_arn}
    */
    readonly instanceArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#name CcDataTableAttribute#name}
    */
    readonly name: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#primary CcDataTableAttribute#primary}
    */
    readonly primary?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#validation CcDataTableAttribute#validation}
    */
    readonly validation?: CcDataTableAttribute.ValidationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#value_type CcDataTableAttribute#value_type}
    */
    readonly valueType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute awscc_connect_data_table_attribute}
*/
export class CcDataTableAttribute extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDataTableAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute awscc_connect_data_table_attribute} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcDataTableAttributeProps
    */
    public constructor(scope: Construct, id: string, config: CcDataTableAttributeProps) {
        super(scope, id, {
    ...
    private _lockVersion = new CcDataTableAttribute.LockVersionPropertyOutputReference(this, "lock_version");
    ...
    private _validation = new CcDataTableAttribute.ValidationPropertyOutputReference(this, "validation");
    public get validation() {
        return this._validation;
    }
    public putValidation(value: CcDataTableAttribute.ValidationProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            validation: ccDataTableAttributeValidationPropertyToTerraform(this._validation.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            validation: {
                value: ccDataTableAttributeValidationPropertyToHclTerraform(this._validation.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcDataTableAttribute.ValidationProperty",
            },
            value_type: {
...
export function ccDataTableAttributeLockVersionPropertyToTerraform(struct?: CcDataTableAttribute.LockVersionProperty): any {
...
export function ccDataTableAttributeLockVersionPropertyToHclTerraform(struct?: CcDataTableAttribute.LockVersionProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDataTableAttributeEnumPropertyToTerraform(struct?: CcDataTableAttribute.EnumProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDataTableAttributeEnumPropertyToHclTerraform(struct?: CcDataTableAttribute.EnumProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccDataTableAttributeValidationPropertyToTerraform(struct?: CcDataTableAttribute.ValidationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        enum: ccDataTableAttributeEnumPropertyToTerraform(struct!.enum),
...
export function ccDataTableAttributeValidationPropertyToHclTerraform(struct?: CcDataTableAttribute.ValidationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        enum: {
            value: ccDataTableAttributeEnumPropertyToHclTerraform(struct!.enum),
            isBlock: true,
            type: "struct",
            storageClassType: "EnumProperty",
        },
        exclusive_maximum: {
...
export namespace CcDataTableAttribute {
export interface LockVersionProperty {
}
export class LockVersionPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): LockVersionProperty | undefined {
        let hasAnyValues = this.isEmptyObject;
        const internalValueResult: any = {};
        return hasAnyValues ? internalValueResult : undefined;
    }

    public set internalValue(value: LockVersionProperty | undefined) {
        if (value === undefined) {
...
export interface EnumProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#strict CcDataTableAttribute#strict}
    */
    readonly strict?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#values CcDataTableAttribute#values}
    */
...
export class EnumPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): EnumProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: EnumProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
...
export interface ValidationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#enum CcDataTableAttribute#enum}
    */
    readonly enum?: EnumProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#exclusive_maximum CcDataTableAttribute#exclusive_maximum}
    */
    readonly exclusiveMaximum?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#exclusive_minimum CcDataTableAttribute#exclusive_minimum}
    */
    readonly exclusiveMinimum?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#max_length CcDataTableAttribute#max_length}
    */
    readonly maxLength?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#max_values CcDataTableAttribute#max_values}
    */
    readonly maxValues?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#maximum CcDataTableAttribute#maximum}
    */
    readonly maximum?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#min_length CcDataTableAttribute#min_length}
    */
    readonly minLength?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#min_values CcDataTableAttribute#min_values}
    */
    readonly minValues?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#minimum CcDataTableAttribute#minimum}
    */
    readonly minimum?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/connect_data_table_attribute#multiple_of CcDataTableAttribute#multiple_of}
    */
