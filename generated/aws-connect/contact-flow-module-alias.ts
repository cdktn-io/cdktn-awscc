...
export interface CcContactFlowModuleAliasProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_contact_flow_module_alias#contact_flow_module_id CcContactFlowModuleAlias#contact_flow_module_id}
    */
    readonly contactFlowModuleId: string;
    /**
    * The version number of the contact flow module this alias points to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_contact_flow_module_alias#contact_flow_module_version CcContactFlowModuleAlias#contact_flow_module_version}
    */
    readonly contactFlowModuleVersion: number;
    /**
    * The description of the alias.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_contact_flow_module_alias#description CcContactFlowModuleAlias#description}
    */
    readonly description?: string;
    /**
    * The name of the alias.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_contact_flow_module_alias#name CcContactFlowModuleAlias#name}
    */
...
export class CcContactFlowModuleAlias extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcContactFlowModuleAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_contact_flow_module_alias#import import section} in the documentation of this resource for the id to use
