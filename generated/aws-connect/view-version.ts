...
export interface CcViewVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_view_version#version_description CcViewVersion#version_description}
    */
    readonly versionDescription?: string;
    /**
    * The Amazon Resource Name (ARN) of the view for which a version is being created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_view_version#view_arn CcViewVersion#view_arn}
    */
    readonly viewArn: string;
    /**
    * The view content hash to be checked.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_view_version#view_content_sha_256 CcViewVersion#view_content_sha_256}
    */
...
export class CcViewVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcViewVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_view_version#import import section} in the documentation of this resource for the id to use
