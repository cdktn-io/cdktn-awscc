...
export interface CcApprovedOriginProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/connect_approved_origin#instance_id CcApprovedOrigin#instance_id}
    */
    readonly instanceId: string;
    /**
    * Domain name to be added to the allowlist of instance
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/connect_approved_origin#origin CcApprovedOrigin#origin}
    */
...
export class CcApprovedOrigin extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcApprovedOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/connect_approved_origin#import import section} in the documentation of this resource for the id to use
