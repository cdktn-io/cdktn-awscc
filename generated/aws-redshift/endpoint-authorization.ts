...
export interface CcEndpointAuthorizationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_authorization#account CcEndpointAuthorization#account}
    */
    readonly account: string;
    /**
    * The cluster identifier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_authorization#cluster_identifier CcEndpointAuthorization#cluster_identifier}
    */
    readonly clusterIdentifier: string;
    /**
    *  Indicates whether to force the revoke action. If true, the Redshift-managed VPC endpoints associated with the endpoint authorization are also deleted.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_authorization#force CcEndpointAuthorization#force}
    */
    readonly force?: boolean | cdktn.IResolvable;
    /**
    * The virtual private cloud (VPC) identifiers to grant or revoke access to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_authorization#vpc_ids CcEndpointAuthorization#vpc_ids}
    */
...
export class CcEndpointAuthorization extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEndpointAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_authorization#import import section} in the documentation of this resource for the id to use
