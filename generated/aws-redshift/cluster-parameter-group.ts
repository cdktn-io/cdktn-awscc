...
export interface CcClusterParameterGroupProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#description CcClusterParameterGroup#description}
    */
    readonly description: string;
    /**
    * The Amazon Redshift engine version to which the cluster parameter group applies. The cluster engine version determines the set of parameters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#parameter_group_family CcClusterParameterGroup#parameter_group_family}
    */
    readonly parameterGroupFamily: string;
    /**
    * The name of the cluster parameter group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#parameter_group_name CcClusterParameterGroup#parameter_group_name}
    */
    readonly parameterGroupName?: string;
    /**
    * An array of parameters to be modified. A maximum of 20 parameters can be modified in a single request.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#parameters CcClusterParameterGroup#parameters}
    */
    readonly parameters?: CcClusterParameterGroup.ParameterProperty[] | cdktn.IResolvable;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#tags CcClusterParameterGroup#tags}
    */
...
export class CcClusterParameterGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcClusterParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#import import section} in the documentation of this resource for the id to use
...
export interface ParameterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#parameter_name CcClusterParameterGroup#parameter_name}
    */
    readonly parameterName?: string;
    /**
    * The value of the parameter. If `ParameterName` is `wlm_json_configuration`, then the maximum size of `ParameterValue` is 8000 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#parameter_value CcClusterParameterGroup#parameter_value}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#key CcClusterParameterGroup#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/redshift_cluster_parameter_group#value CcClusterParameterGroup#value}
    */
