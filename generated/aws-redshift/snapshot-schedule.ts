...
export interface CcSnapshotScheduleProps extends cdktn.TerraformMetaArguments {
    /**
    * The definition of the snapshot schedule. The definition is made up of schedule expressions, for example "cron(30 12 *)" or "rate(12 hours)".
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#schedule_definitions CcSnapshotSchedule#schedule_definitions}
    */
    readonly scheduleDefinitions: string[];
    /**
    * The description of the snapshot schedule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#schedule_description CcSnapshotSchedule#schedule_description}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#schedule_identifier CcSnapshotSchedule#schedule_identifier}
    */
    readonly scheduleIdentifier: string;
    /**
    * An optional set of tags for the snapshot schedule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#tags CcSnapshotSchedule#tags}
    */
...
export class CcSnapshotSchedule extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSnapshotSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSnapshotScheduleProps
    */
    public constructor(scope: Construct, id: string, config: CcSnapshotScheduleProps) {
        super(scope, id, {
    ...
    private _tags = new CcSnapshotSchedule.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcSnapshotSchedule.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccSnapshotScheduleTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccSnapshotScheduleTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSnapshotSchedule.TagPropertyList",
            },
        };
...
export function ccSnapshotScheduleTagPropertyToTerraform(struct?: CcSnapshotSchedule.TagProperty | cdktn.IResolvable): any {
...
export function ccSnapshotScheduleTagPropertyToHclTerraform(struct?: CcSnapshotSchedule.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcSnapshotSchedule {
export interface TagProperty {
    /**
    * The key, or name, for the resource tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#key CcSnapshotSchedule#key}
    */
    readonly key?: string;
    /**
    * The value for the resource tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_snapshot_schedule#value CcSnapshotSchedule#value}
    */
