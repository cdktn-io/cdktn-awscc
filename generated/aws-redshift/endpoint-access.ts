...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access
...
export interface CcEndpointAccessProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#cluster_identifier CcEndpointAccess#cluster_identifier}
    */
    readonly clusterIdentifier: string;
    /**
    * The name of the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#endpoint_name CcEndpointAccess#endpoint_name}
    */
    readonly endpointName: string;
    /**
    * The AWS account ID of the owner of the cluster.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#resource_owner CcEndpointAccess#resource_owner}
    */
    readonly resourceOwner?: string;
    /**
    * The subnet group name where Amazon Redshift chooses to deploy the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#subnet_group_name CcEndpointAccess#subnet_group_name}
    */
    readonly subnetGroupName: string;
    /**
    * A list of vpc security group ids to apply to the created endpoint access.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#vpc_security_group_ids CcEndpointAccess#vpc_security_group_ids}
    */
...
export class CcEndpointAccess extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEndpointAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/redshift_endpoint_access#import import section} in the documentation of this resource for the id to use
