...
export interface CcScheduledActionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#enable CcScheduledAction#enable}
    */
    readonly enable?: boolean | cdktn.IResolvable;
    /**
    * The end time in UTC of the scheduled action. After this time, the scheduled action does not trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#end_time CcScheduledAction#end_time}
    */
    readonly endTime?: string;
    /**
    * The IAM role to assume to run the target action.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#iam_role CcScheduledAction#iam_role}
    */
    readonly iamRole?: string;
    /**
    * The schedule in `at( )` or `cron( )` format.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#schedule CcScheduledAction#schedule}
    */
    readonly schedule?: string;
    /**
    * The description of the scheduled action.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#scheduled_action_description CcScheduledAction#scheduled_action_description}
    */
    readonly scheduledActionDescription?: string;
    /**
    * The name of the scheduled action. The name must be unique within an account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#scheduled_action_name CcScheduledAction#scheduled_action_name}
    */
    readonly scheduledActionName: string;
    /**
    * The start time in UTC of the scheduled action. Before this time, the scheduled action does not trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#start_time CcScheduledAction#start_time}
    */
    readonly startTime?: string;
    /**
    * A JSON format string of the Amazon Redshift API operation with input parameters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#target_action CcScheduledAction#target_action}
    */
...
export class CcScheduledAction extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcScheduledAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#import import section} in the documentation of this resource for the id to use
...
export interface PauseClusterMessageProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#cluster_identifier CcScheduledAction#cluster_identifier}
    */
...
export interface ResizeClusterMessageProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#classic CcScheduledAction#classic}
    */
    ...
    */
    readonly clusterIdentifier?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#cluster_type CcScheduledAction#cluster_type}
    */
    readonly clusterType?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#node_type CcScheduledAction#node_type}
    */
    readonly nodeType?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#number_of_nodes CcScheduledAction#number_of_nodes}
    */
...
export interface ScheduledActionTypeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#pause_cluster CcScheduledAction#pause_cluster}
    */
    readonly pauseCluster?: PauseClusterMessageProperty;
    /**
    * Describes a resize cluster operation. For example, a scheduled action to run the `ResizeCluster` API operation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#resize_cluster CcScheduledAction#resize_cluster}
    */
    readonly resizeCluster?: ResizeClusterMessageProperty;
    /**
    * Describes a resume cluster operation. For example, a scheduled action to run the `ResumeCluster` API operation.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/redshift_scheduled_action#resume_cluster CcScheduledAction#resume_cluster}
    */
