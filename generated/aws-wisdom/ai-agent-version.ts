...
export interface CcAIAgentVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wisdom_ai_agent_version#ai_agent_id CcAIAgentVersion#ai_agent_id}
    */
    readonly aiAgentId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wisdom_ai_agent_version#assistant_id CcAIAgentVersion#assistant_id}
    */
    readonly assistantId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wisdom_ai_agent_version#modified_time_seconds CcAIAgentVersion#modified_time_seconds}
    */
...
export class CcAIAgentVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAIAgentVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wisdom_ai_agent_version#import import section} in the documentation of this resource for the id to use
