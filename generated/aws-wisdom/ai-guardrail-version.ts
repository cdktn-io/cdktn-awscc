...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_ai_guardrail_version

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcAIGuardrailVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_ai_guardrail_version#ai_guardrail_id CcAIGuardrailVersion#ai_guardrail_id}
    */
    readonly aiGuardrailId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_ai_guardrail_version#assistant_id CcAIGuardrailVersion#assistant_id}
    */
    readonly assistantId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_ai_guardrail_version#modified_time_seconds CcAIGuardrailVersion#modified_time_seconds}
    */
...
export class CcAIGuardrailVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAIGuardrailVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_ai_guardrail_version#import import section} in the documentation of this resource for the id to use
