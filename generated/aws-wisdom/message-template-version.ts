...
export interface CcMessageTemplateVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_message_template_version#message_template_arn CcMessageTemplateVersion#message_template_arn}
    */
    readonly messageTemplateArn: string;
    /**
    * The content SHA256 of the message template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_message_template_version#message_template_content_sha_256 CcMessageTemplateVersion#message_template_content_sha_256}
    */
...
export class CcMessageTemplateVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMessageTemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/wisdom_message_template_version#import import section} in the documentation of this resource for the id to use
