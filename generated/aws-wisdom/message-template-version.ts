...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcMessageTemplateVersionProps extends cdktn.TerraformMetaArguments {
    /**
    * The unqualified Amazon Resource Name (ARN) of the message template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version#message_template_arn CcMessageTemplateVersion#message_template_arn}
    */
    readonly messageTemplateArn: string;
    /**
    * The content SHA256 of the message template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version#message_template_content_sha_256 CcMessageTemplateVersion#message_template_content_sha_256}
    */
    readonly messageTemplateContentSha256?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version awscc_wisdom_message_template_version}
*/
export class CcMessageTemplateVersion extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcMessageTemplateVersion resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcMessageTemplateVersion to import
    * @param importFromId The id of the existing CcMessageTemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcMessageTemplateVersion to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/wisdom_message_template_version awscc_wisdom_message_template_version} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcMessageTemplateVersionProps
    */
    public constructor(scope: Construct, id: string, config: CcMessageTemplateVersionProps) {
        super(scope, id, {
...
export namespace CcMessageTemplateVersion {
}
