...
export interface CcLambdaHookProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#alias CcLambdaHook#alias}
    */
    readonly alias: string;
    /**
    * Whether to automatically update the extension in this account and Region when a new minor version is published by the extension publisher.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#auto_update CcLambdaHook#auto_update}
    */
    readonly autoUpdate?: boolean | cdktn.IResolvable;
    /**
    * The execution role ARN assumed by Hooks to invoke Lambda.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#execution_role CcLambdaHook#execution_role}
    */
    readonly executionRole: string;
    /**
    * Attribute to specify CloudFormation behavior on hook failure.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#failure_mode CcLambdaHook#failure_mode}
    */
    readonly failureMode: string;
    /**
    * Attribute to specify which stacks this hook applies to or should get invoked for
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#hook_status CcLambdaHook#hook_status}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#lambda_function CcLambdaHook#lambda_function}
    */
    readonly lambdaFunction: string;
    /**
    * Contains logging configuration information for the hook.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#logging_config CcLambdaHook#logging_config}
    */
    readonly loggingConfig?: CcLambdaHook.LoggingConfigProperty;
    /**
    * Filters to allow hooks to target specific stack attributes
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#stack_filters CcLambdaHook#stack_filters}
    */
    readonly stackFilters?: CcLambdaHook.StackFiltersProperty;
    /**
    * Attribute to specify which targets should invoke the hook
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#target_filters CcLambdaHook#target_filters}
    */
    readonly targetFilters?: CcLambdaHook.TargetFiltersProperty;
    /**
    * Which operations should this Hook run against? Resource changes, stacks or change sets.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#target_operations CcLambdaHook#target_operations}
    */
...
export class CcLambdaHook extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLambdaHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#import import section} in the documentation of this resource for the id to use
...
export interface LoggingConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#log_group_name CcLambdaHook#log_group_name}
    */
    readonly logGroupName?: string;
    /**
    * The ARN of the role that CloudFormation should assume when sending log entries to CloudWatch Logs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#log_role_arn CcLambdaHook#log_role_arn}
    */
...
export interface StackNamesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#exclude CcLambdaHook#exclude}
    */
    readonly exclude?: string[];
    /**
    * List of stack names that the hook is going to target
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#include CcLambdaHook#include}
    */
...
export interface StackFiltersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#filtering_criteria CcLambdaHook#filtering_criteria}
    */
    readonly filteringCriteria?: string;
    /**
    * List of stack names as filters
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#stack_names CcLambdaHook#stack_names}
    */
    readonly stackNames?: StackNamesProperty;
    /**
    * List of stack roles that are performing the stack operations.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#stack_roles CcLambdaHook#stack_roles}
    */
...
export interface HookTargetProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#action CcLambdaHook#action}
    */
    readonly action?: string;
    /**
    * Invocation points are the point in provisioning workflow where hooks will be executed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#invocation_point CcLambdaHook#invocation_point}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#target_name CcLambdaHook#target_name}
    */
...
export interface TargetFiltersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#actions CcLambdaHook#actions}
    */
    readonly actions?: string[];
    /**
    * List of invocation points that the hook is going to target
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#invocation_points CcLambdaHook#invocation_points}
    */
    readonly invocationPoints?: string[];
    /**
    * List of type names that the hook is going to target
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#target_names CcLambdaHook#target_names}
    */
    readonly targetNames?: string[];
    /**
    * List of hook targets
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_lambda_hook#targets CcLambdaHook#targets}
    */
