...
export interface CcPublicTypeVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#arn CcPublicTypeVersion#arn}
    */
    readonly arn?: string;
    /**
    * A url to the S3 bucket where logs for the testType run will be available
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#log_delivery_bucket CcPublicTypeVersion#log_delivery_bucket}
    */
    readonly logDeliveryBucket?: string;
    /**
    * The version number of a public third-party extension
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#public_version_number CcPublicTypeVersion#public_version_number}
    */
    readonly publicVersionNumber?: string;
    /**
    * The kind of extension
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#type CcPublicTypeVersion#type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#type_name CcPublicTypeVersion#type_name}
    */
...
export class CcPublicTypeVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPublicTypeVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_public_type_version#import import section} in the documentation of this resource for the id to use
