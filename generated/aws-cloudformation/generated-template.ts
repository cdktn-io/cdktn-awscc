...
export interface CcGeneratedTemplateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_generated_template#generated_template_name CcGeneratedTemplate#generated_template_name}
    */
    readonly generatedTemplateName: string;
    /**
    * The configuration details of the generated template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_generated_template#template_configuration CcGeneratedTemplate#template_configuration}
    */
...
export class CcGeneratedTemplate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGeneratedTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_generated_template#import import section} in the documentation of this resource for the id to use
...
export interface TemplateConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_generated_template#deletion_policy CcGeneratedTemplate#deletion_policy}
    */
    readonly deletionPolicy?: string;
    /**
    * The UpdateReplacePolicy assigned to resources in the generated template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudformation_generated_template#update_replace_policy CcGeneratedTemplate#update_replace_policy}
    */
