...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config
...
export interface CcHookTypeConfigProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config#configuration CcHookTypeConfig#configuration}
    */
    readonly configuration?: string;
    /**
    * An alias by which to refer to this extension configuration data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config#configuration_alias CcHookTypeConfig#configuration_alias}
    */
    readonly configurationAlias?: string;
    /**
    * The Amazon Resource Name (ARN) of the type without version number.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config#type_arn CcHookTypeConfig#type_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config#type_name CcHookTypeConfig#type_name}
    */
...
export class CcHookTypeConfig extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcHookTypeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudformation_hook_type_config#import import section} in the documentation of this resource for the id to use
