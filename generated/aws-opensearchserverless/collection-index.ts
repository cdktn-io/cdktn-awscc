...
export interface CcCollectionIndexProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/opensearchserverless_collection_index#collection_index_id CcCollectionIndex#collection_index_id}
    */
    readonly collectionIndexId: string;
    /**
    * The name of the collection index
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/opensearchserverless_collection_index#index_name CcCollectionIndex#index_name}
    */
    readonly indexName: string;
    /**
    * The Mappings for the collection index
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/opensearchserverless_collection_index#index_schema CcCollectionIndex#index_schema}
    */
...
export class CcCollectionIndex extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCollectionIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/opensearchserverless_collection_index#import import section} in the documentation of this resource for the id to use
