...
export interface CcTopicInlinePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#policy_document CcTopicInlinePolicy#policy_document}
    */
    readonly policyDocument: string;
    /**
    * The Amazon Resource Name (ARN) of the topic to which you want to add the policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#topic_arn CcTopicInlinePolicy#topic_arn}
    */
...
export class CcTopicInlinePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTopicInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sns_topic_inline_policy#import import section} in the documentation of this resource for the id to use
