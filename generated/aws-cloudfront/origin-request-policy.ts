...
export interface CcOriginRequestPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#origin_request_policy_config CcOriginRequestPolicy#origin_request_policy_config}
    */
...
export class CcOriginRequestPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcOriginRequestPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#import import section} in the documentation of this resource for the id to use
...
export interface CookiesConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#cookie_behavior CcOriginRequestPolicy#cookie_behavior}
    */
    readonly cookieBehavior: string;
    /**
    * Contains a list of cookie names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#cookies CcOriginRequestPolicy#cookies}
    */
...
export interface HeadersConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#header_behavior CcOriginRequestPolicy#header_behavior}
    */
    readonly headerBehavior: string;
    /**
    * Contains a list of HTTP header names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#headers CcOriginRequestPolicy#headers}
    */
...
export interface QueryStringsConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#query_string_behavior CcOriginRequestPolicy#query_string_behavior}
    */
    readonly queryStringBehavior: string;
    /**
    * Contains a list of query string names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#query_strings CcOriginRequestPolicy#query_strings}
    */
...
export interface OriginRequestPolicyConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#comment CcOriginRequestPolicy#comment}
    */
    readonly comment?: string;
    /**
    * The cookies from viewer requests to include in origin requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#cookies_config CcOriginRequestPolicy#cookies_config}
    */
    readonly cookiesConfig: CookiesConfigProperty;
    /**
    * The HTTP headers to include in origin requests. These can include headers from viewer requests and additional headers added by CloudFront.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#headers_config CcOriginRequestPolicy#headers_config}
    */
    readonly headersConfig: HeadersConfigProperty;
    /**
    * A unique name to identify the origin request policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#name CcOriginRequestPolicy#name}
    */
    readonly name: string;
    /**
    * The URL query strings from viewer requests to include in origin requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudfront_origin_request_policy#query_strings_config CcOriginRequestPolicy#query_strings_config}
    */
