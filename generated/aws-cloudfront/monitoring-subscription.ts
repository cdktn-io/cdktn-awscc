...
export interface CcMonitoringSubscriptionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_monitoring_subscription#distribution_id CcMonitoringSubscription#distribution_id}
    */
    readonly distributionId: string;
    /**
    * A subscription configuration for additional CloudWatch metrics.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_monitoring_subscription#monitoring_subscription CcMonitoringSubscription#monitoring_subscription}
    */
...
export class CcMonitoringSubscription extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMonitoringSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_monitoring_subscription#import import section} in the documentation of this resource for the id to use
...
export interface RealtimeMetricsSubscriptionConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_monitoring_subscription#realtime_metrics_subscription_status CcMonitoringSubscription#realtime_metrics_subscription_status}
    */
...
export interface MonitoringSubscriptionProperty {
    ...
    * A subscription configuration for additional CloudWatch metrics.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_monitoring_subscription#realtime_metrics_subscription_config CcMonitoringSubscription#realtime_metrics_subscription_config}
    */
