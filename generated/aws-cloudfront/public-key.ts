...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcPublicKeyProps extends cdktn.TerraformMetaArguments {
    /**
    * Configuration information about a public key that you can use with [signed URLs and signed cookies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html), or with [field-level encryption](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/field-level-encryption.html).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#public_key_config CcPublicKey#public_key_config}
    */
...
export class CcPublicKey extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcPublicKeyProps
    */
    public constructor(scope: Construct, id: string, config: CcPublicKeyProps) {
        super(scope, id, {
    ...
    private _publicKeyConfig = new CcPublicKey.PublicKeyConfigPropertyOutputReference(this, "public_key_config");
    public get publicKeyConfig() {
        return this._publicKeyConfig;
    }
    public putPublicKeyConfig(value: CcPublicKey.PublicKeyConfigProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            public_key_config: ccPublicKeyPublicKeyConfigPropertyToTerraform(this._publicKeyConfig.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            public_key_config: {
                value: ccPublicKeyPublicKeyConfigPropertyToHclTerraform(this._publicKeyConfig.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcPublicKey.PublicKeyConfigProperty",
            },
        };
...
export function ccPublicKeyPublicKeyConfigPropertyToTerraform(struct?: CcPublicKey.PublicKeyConfigProperty | cdktn.IResolvable): any {
...
export function ccPublicKeyPublicKeyConfigPropertyToHclTerraform(struct?: CcPublicKey.PublicKeyConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface PublicKeyConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#caller_reference CcPublicKey#caller_reference}
    */
    readonly callerReference: string;
    /**
    * A comment to describe the public key. The comment cannot be longer than 128 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#comment CcPublicKey#comment}
    */
    readonly comment?: string;
    /**
    * The public key that you can use with [signed URLs and signed cookies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html), or with [field-level encryption](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/field-level-encryption.html).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#encoded_key CcPublicKey#encoded_key}
    */
    readonly encodedKey: string;
    /**
    * A name to help identify the public key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cloudfront_public_key#name CcPublicKey#name}
    */
    readonly name: string;
}
export class PublicKeyConfigPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): PublicKeyConfigProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: PublicKeyConfigProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
