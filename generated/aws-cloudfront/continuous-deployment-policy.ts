...
export interface CcContinuousDeploymentPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#continuous_deployment_policy_config CcContinuousDeploymentPolicy#continuous_deployment_policy_config}
    */
...
export class CcContinuousDeploymentPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcContinuousDeploymentPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#import import section} in the documentation of this resource for the id to use
...
export interface SingleHeaderPolicyConfigProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#header CcContinuousDeploymentPolicy#header}
    */
    readonly header?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#value CcContinuousDeploymentPolicy#value}
    */
...
export interface SessionStickinessConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#idle_ttl CcContinuousDeploymentPolicy#idle_ttl}
    */
    readonly idleTtl?: number;
    /**
    * The maximum amount of time to consider requests from the viewer as being part of the same session. Allowed values are 300?3600 seconds (5?60 minutes).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#maximum_ttl CcContinuousDeploymentPolicy#maximum_ttl}
    */
...
export interface SingleWeightPolicyConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#session_stickiness_config CcContinuousDeploymentPolicy#session_stickiness_config}
    */
    readonly sessionStickinessConfig?: SessionStickinessConfigProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#weight CcContinuousDeploymentPolicy#weight}
    */
...
export interface TrafficConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#single_header_config CcContinuousDeploymentPolicy#single_header_config}
    */
    readonly singleHeaderConfig?: SingleHeaderConfigProperty;
    /**
    * Contains the percentage of traffic to send to the staging distribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#single_weight_config CcContinuousDeploymentPolicy#single_weight_config}
    */
    readonly singleWeightConfig?: SingleWeightConfigProperty;
    /**
    * The type of traffic configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#type CcContinuousDeploymentPolicy#type}
    */
...
export interface ContinuousDeploymentPolicyConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#enabled CcContinuousDeploymentPolicy#enabled}
    */
    readonly enabled: boolean | cdktn.IResolvable;
    /**
    * This configuration determines which HTTP requests are sent to the staging distribution. If the HTTP request contains a header and value that matches what you specify here, the request is sent to the staging distribution. Otherwise the request is sent to the primary distribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#single_header_policy_config CcContinuousDeploymentPolicy#single_header_policy_config}
    */
    readonly singleHeaderPolicyConfig?: SingleHeaderPolicyConfigProperty;
    /**
    * This configuration determines the percentage of HTTP requests that are sent to the staging distribution.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#single_weight_policy_config CcContinuousDeploymentPolicy#single_weight_policy_config}
    */
    readonly singleWeightPolicyConfig?: SingleWeightPolicyConfigProperty;
    /**
    * The CloudFront domain name of the staging distribution. For example: ``d111111abcdef8.cloudfront.net``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#staging_distribution_dns_names CcContinuousDeploymentPolicy#staging_distribution_dns_names}
    */
    readonly stagingDistributionDnsNames: string[];
    /**
    * Contains the parameters for routing production traffic from your primary to staging distributions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_continuous_deployment_policy#traffic_config CcContinuousDeploymentPolicy#traffic_config}
    */
