...
// https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy
...
export interface CcCachePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#cache_policy_config CcCachePolicy#cache_policy_config}
    */
...
export class CcCachePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCachePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#import import section} in the documentation of this resource for the id to use
...
export interface CookiesConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#cookie_behavior CcCachePolicy#cookie_behavior}
    */
    readonly cookieBehavior: string;
    /**
    * Contains a list of cookie names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#cookies CcCachePolicy#cookies}
    */
...
export interface HeadersConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#header_behavior CcCachePolicy#header_behavior}
    */
    readonly headerBehavior: string;
    /**
    * Contains a list of HTTP header names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#headers CcCachePolicy#headers}
    */
...
export interface QueryStringsConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#query_string_behavior CcCachePolicy#query_string_behavior}
    */
    readonly queryStringBehavior: string;
    /**
    * Contains a list of query string names.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#query_strings CcCachePolicy#query_strings}
    */
...
export interface ParametersInCacheKeyAndForwardedToOriginProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#cookies_config CcCachePolicy#cookies_config}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#enable_accept_encoding_brotli CcCachePolicy#enable_accept_encoding_brotli}
    */
    ...
    *  If both of these fields are ``false``, then CloudFront treats the ``Accept-Encoding`` header the same as any other HTTP header in the viewer request. By default, it's not included in the cache key and it's not included in origin requests. In this case, you can manually add ``Accept-Encoding`` to the headers whitelist like any other HTTP header.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#enable_accept_encoding_gzip CcCachePolicy#enable_accept_encoding_gzip}
    */
    readonly enableAcceptEncodingGzip: boolean | cdktn.IResolvable;
    /**
    * An object that determines whether any HTTP headers (and if so, which headers) are included in the cache key and in requests that CloudFront sends to the origin.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#headers_config CcCachePolicy#headers_config}
    */
    readonly headersConfig: HeadersConfigProperty;
    /**
    * An object that determines whether any URL query strings in viewer requests (and if so, which query strings) are included in the cache key and in requests that CloudFront sends to the origin.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#query_strings_config CcCachePolicy#query_strings_config}
    */
...
export interface CachePolicyConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#comment CcCachePolicy#comment}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#default_ttl CcCachePolicy#default_ttl}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#max_ttl CcCachePolicy#max_ttl}
    */
    readonly maxTtl: number;
    /**
    * The minimum amount of time, in seconds, that you want objects to stay in the CloudFront cache before CloudFront sends another request to the origin to see if the object has been updated. For more information, see [Managing How Long Content Stays in an Edge Cache (Expiration)](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Expiration.html) in the *Amazon CloudFront Developer Guide*.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#min_ttl CcCachePolicy#min_ttl}
    */
    readonly minTtl: number;
    /**
    * A unique name to identify the cache policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#name CcCachePolicy#name}
    */
    readonly name: string;
    /**
    * The HTTP headers, cookies, and URL query strings to include in the cache key. The values included in the cache key are also included in requests that CloudFront sends to the origin.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cloudfront_cache_policy#parameters_in_cache_key_and_forwarded_to_origin CcCachePolicy#parameters_in_cache_key_and_forwarded_to_origin}
    */
