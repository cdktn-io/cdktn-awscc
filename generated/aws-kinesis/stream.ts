...
export interface CcStreamProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#desired_shard_level_metrics CcStream#desired_shard_level_metrics}
    */
    readonly desiredShardLevelMetrics?: string[];
    /**
    * Maximum size of a data record in KiB allowed to be put into Kinesis stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#max_record_size_in_ki_b CcStream#max_record_size_in_ki_b}
    */
    readonly maxRecordSizeInKiB?: number;
    /**
    * The name of the Kinesis stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#name CcStream#name}
    */
    readonly name?: string;
    /**
    * The number of hours for the data records that are stored in shards to remain accessible.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#retention_period_hours CcStream#retention_period_hours}
    */
    readonly retentionPeriodHours?: number;
    /**
    * The number of shards that the stream uses. Required when StreamMode = PROVISIONED is passed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#shard_count CcStream#shard_count}
    */
    readonly shardCount?: number;
    /**
    * When specified, enables or updates server-side encryption using an AWS KMS key for a specified stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#stream_encryption CcStream#stream_encryption}
    */
    readonly streamEncryption?: CcStream.StreamEncryptionProperty;
    /**
    * The mode in which the stream is running.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#stream_mode_details CcStream#stream_mode_details}
    */
    readonly streamModeDetails?: CcStream.StreamModeDetailsProperty;
    /**
    * An arbitrary set of tags (key-value pairs) to associate with the Kinesis stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#tags CcStream#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#warm_throughput_mi_bps CcStream#warm_throughput_mi_bps}
    */
...
export class CcStream extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#import import section} in the documentation of this resource for the id to use
...
export interface StreamEncryptionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#encryption_type CcStream#encryption_type}
    */
    readonly encryptionType?: string;
    /**
    * The GUID for the customer-managed AWS KMS key to use for encryption. This value can be a globally unique identifier, a fully specified Amazon Resource Name (ARN) to either an alias or a key, or an alias name prefixed by "alias/".You can also use a master key owned by Kinesis Data Streams by specifying the alias aws/kinesis.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#key_id CcStream#key_id}
    */
...
export interface StreamModeDetailsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#stream_mode CcStream#stream_mode}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#key CcStream#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/kinesis_stream#value CcStream#value}
    */
