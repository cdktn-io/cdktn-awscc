...
export interface CcNetworkProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wickr_network#access_level CcNetwork#access_level}
    */
    readonly accessLevel: string;
    /**
    * The name of the network. Must be between 1 and 20 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wickr_network#network_name CcNetwork#network_name}
    */
...
export class CcNetwork extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wickr_network#import import section} in the documentation of this resource for the id to use
