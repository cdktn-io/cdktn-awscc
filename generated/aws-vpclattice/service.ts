...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcServiceProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#auth_type CcService#auth_type}
    */
    readonly authType?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#certificate_arn CcService#certificate_arn}
    */
    readonly certificateArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#custom_domain_name CcService#custom_domain_name}
    */
    readonly customDomainName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#dns_entry CcService#dns_entry}
    */
    readonly dnsEntry?: CcService.DnsEntryProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#idle_timeout_seconds CcService#idle_timeout_seconds}
    */
    readonly idleTimeoutSeconds?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#name CcService#name}
    */
    readonly name?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#tags CcService#tags}
    */
    readonly tags?: CcService.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service awscc_vpclattice_service}
*/
export class CcService extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service awscc_vpclattice_service} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _dnsEntry = new CcService.DnsEntryPropertyOutputReference(this, "dns_entry");
    public get dnsEntry() {
        return this._dnsEntry;
    }
    public putDnsEntry(value: CcService.DnsEntryProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            dns_entry: ccServiceDnsEntryPropertyToTerraform(this._dnsEntry.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            dns_entry: {
                value: ccServiceDnsEntryPropertyToHclTerraform(this._dnsEntry.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcService.DnsEntryProperty",
            },
...
export function ccServiceDnsEntryPropertyToTerraform(struct?: CcService.DnsEntryProperty | cdktn.IResolvable): any {
...
export function ccServiceDnsEntryPropertyToHclTerraform(struct?: CcService.DnsEntryProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#key CcService#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/vpclattice_service#value CcService#value}
    */
