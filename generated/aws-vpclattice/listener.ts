...
export interface CcListenerProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#default_action CcListener#default_action}
    */
    readonly defaultAction: CcListener.DefaultActionProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#name CcListener#name}
    */
    readonly name?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#port CcListener#port}
    */
    readonly port?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#protocol CcListener#protocol}
    */
    readonly protocol: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#service_identifier CcListener#service_identifier}
    */
    readonly serviceIdentifier?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#tags CcListener#tags}
    */
...
export class CcListener extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _defaultAction = new CcListener.DefaultActionPropertyOutputReference(this, "default_action");
    public get defaultAction() {
        return this._defaultAction;
    }
    public putDefaultAction(value: CcListener.DefaultActionProperty) {
    ...
    private _tags = new CcListener.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            default_action: ccListenerDefaultActionPropertyToTerraform(this._defaultAction.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            default_action: {
                value: ccListenerDefaultActionPropertyToHclTerraform(this._defaultAction.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcListener.DefaultActionProperty",
            },
            name: {
...
export function ccListenerFixedResponsePropertyToTerraform(struct?: CcListener.FixedResponseProperty | cdktn.IResolvable): any {
...
export function ccListenerFixedResponsePropertyToHclTerraform(struct?: CcListener.FixedResponseProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccListenerWeightedTargetGroupPropertyToTerraform(struct?: CcListener.WeightedTargetGroupProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccListenerWeightedTargetGroupPropertyToHclTerraform(struct?: CcListener.WeightedTargetGroupProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccListenerForwardPropertyToTerraform(struct?: CcListener.ForwardProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        target_groups: cdktn.listMapper(ccListenerWeightedTargetGroupPropertyToTerraform, false)(struct!.targetGroups),
    }
}


export function ccListenerForwardPropertyToHclTerraform(struct?: CcListener.ForwardProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        target_groups: {
            value: cdktn.listMapperHcl(ccListenerWeightedTargetGroupPropertyToHclTerraform, false)(struct!.targetGroups),
            isBlock: true,
            type: "list",
...
export function ccListenerDefaultActionPropertyToTerraform(struct?: CcListener.DefaultActionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        fixed_response: ccListenerFixedResponsePropertyToTerraform(struct!.fixedResponse),
        forward: ccListenerForwardPropertyToTerraform(struct!.forward),
    }
}


export function ccListenerDefaultActionPropertyToHclTerraform(struct?: CcListener.DefaultActionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        fixed_response: {
            value: ccListenerFixedResponsePropertyToHclTerraform(struct!.fixedResponse),
            isBlock: true,
            type: "struct",
            storageClassType: "FixedResponseProperty",
        },
        forward: {
            value: ccListenerForwardPropertyToHclTerraform(struct!.forward),
            isBlock: true,
            type: "struct",
...
export interface FixedResponseProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#status_code CcListener#status_code}
    */
...
export interface WeightedTargetGroupProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#target_group_identifier CcListener#target_group_identifier}
    */
    readonly targetGroupIdentifier?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#weight CcListener#weight}
    */
...
export interface ForwardProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#target_groups CcListener#target_groups}
    */
...
export interface DefaultActionProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#fixed_response CcListener#fixed_response}
    */
    readonly fixedResponse?: FixedResponseProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#forward CcListener#forward}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#key CcListener#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_listener#value CcListener#value}
    */
