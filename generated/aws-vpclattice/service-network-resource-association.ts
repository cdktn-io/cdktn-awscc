...
export interface CcServiceNetworkResourceAssociationProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#private_dns_enabled CcServiceNetworkResourceAssociation#private_dns_enabled}
    */
    readonly privateDnsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#resource_configuration_id CcServiceNetworkResourceAssociation#resource_configuration_id}
    */
    readonly resourceConfigurationId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#service_network_id CcServiceNetworkResourceAssociation#service_network_id}
    */
    readonly serviceNetworkId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#tags CcServiceNetworkResourceAssociation#tags}
    */
...
export class CcServiceNetworkResourceAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcServiceNetworkResourceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcServiceNetworkResourceAssociationProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcServiceNetworkResourceAssociationProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcServiceNetworkResourceAssociation.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcServiceNetworkResourceAssociation.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccServiceNetworkResourceAssociationTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccServiceNetworkResourceAssociationTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcServiceNetworkResourceAssociation.TagPropertyList",
            },
        };
...
export function ccServiceNetworkResourceAssociationTagPropertyToTerraform(struct?: CcServiceNetworkResourceAssociation.TagProperty | cdktn.IResolvable): any {
...
export function ccServiceNetworkResourceAssociationTagPropertyToHclTerraform(struct?: CcServiceNetworkResourceAssociation.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#key CcServiceNetworkResourceAssociation#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/vpclattice_service_network_resource_association#value CcServiceNetworkResourceAssociation#value}
    */
