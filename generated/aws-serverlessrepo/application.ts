...
export interface CcApplicationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#author CcApplication#author}
    */
    readonly author: string;
    /**
    * The description of the application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#description CcApplication#description}
    */
    readonly description: string;
    /**
    * A URL with more information about the application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#home_page_url CcApplication#home_page_url}
    */
    readonly homePageUrl?: string;
    /**
    * Labels to improve discovery of apps in search results.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#labels CcApplication#labels}
    */
    readonly labels?: string[];
    /**
    * A local text file that contains the license of the app.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#license_body CcApplication#license_body}
    */
    readonly licenseBody?: string;
    /**
    * The name of the application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#name CcApplication#name}
    */
    readonly name: string;
    /**
    * A text readme file in Markdown language that contains a more detailed description of the application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#readme_body CcApplication#readme_body}
    */
    readonly readmeBody?: string;
    /**
    * The semantic version of the application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#semantic_version CcApplication#semantic_version}
    */
    readonly semanticVersion?: string;
    /**
    * A link to a public repository for the source code of your application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#source_code_url CcApplication#source_code_url}
    */
    readonly sourceCodeUrl?: string;
    /**
    * A valid identifier from https://spdx.org/licenses/.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#spdx_license_id CcApplication#spdx_license_id}
    */
    readonly spdxLicenseId?: string;
    /**
    * The local raw packaged AWS SAM template file of your application.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#template_body CcApplication#template_body}
    */
...
export class CcApplication extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/serverlessrepo_application#import import section} in the documentation of this resource for the id to use
