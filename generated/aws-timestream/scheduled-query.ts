...
export interface CcScheduledQueryProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#client_token CcScheduledQuery#client_token}
    */
    readonly clientToken?: string;
    /**
    * Configuration for error reporting. Error reports will be generated when a problem is encountered when writing the query results.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#error_report_configuration CcScheduledQuery#error_report_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#kms_key_id CcScheduledQuery#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * Notification configuration for the scheduled query. A notification is sent by Timestream when a query run finishes, when the state is updated or when you delete it.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#notification_configuration CcScheduledQuery#notification_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#query_string CcScheduledQuery#query_string}
    */
    readonly queryString: string;
    /**
    * Configuration for when the scheduled query is executed.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#schedule_configuration CcScheduledQuery#schedule_configuration}
    */
    readonly scheduleConfiguration: CcScheduledQuery.ScheduleConfigurationProperty;
    /**
    * The ARN for the IAM role that Timestream will assume when running the scheduled query.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#scheduled_query_execution_role_arn CcScheduledQuery#scheduled_query_execution_role_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#scheduled_query_name CcScheduledQuery#scheduled_query_name}
    */
    readonly scheduledQueryName?: string;
    /**
    * A list of key-value pairs to label the scheduled query.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#tags CcScheduledQuery#tags}
    */
    readonly tags?: CcScheduledQuery.TagProperty[] | cdktn.IResolvable;
    /**
    * Configuration of target store where scheduled query results are written to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#target_configuration CcScheduledQuery#target_configuration}
    */
...
export class CcScheduledQuery extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcScheduledQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#import import section} in the documentation of this resource for the id to use
...
export interface S3ConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#bucket_name CcScheduledQuery#bucket_name}
    */
    readonly bucketName: string;
    /**
    * Encryption at rest options for the error reports. If no encryption option is specified, Timestream will choose SSE_S3 as default.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#encryption_option CcScheduledQuery#encryption_option}
    */
    readonly encryptionOption?: string;
    /**
    * Prefix for error report keys.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#object_key_prefix CcScheduledQuery#object_key_prefix}
    */
...
export interface ErrorReportConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#s3_configuration CcScheduledQuery#s3_configuration}
    */
...
export interface SnsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#topic_arn CcScheduledQuery#topic_arn}
    */
...
export interface NotificationConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#sns_configuration CcScheduledQuery#sns_configuration}
    */
...
export interface ScheduleConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#schedule_expression CcScheduledQuery#schedule_expression}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#key CcScheduledQuery#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#value CcScheduledQuery#value}
    */
...
export interface DimensionMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#dimension_value_type CcScheduledQuery#dimension_value_type}
    */
    readonly dimensionValueType?: string;
    /**
    * Column name from query result.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#name CcScheduledQuery#name}
    */
...
export interface MultiMeasureAttributeMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#measure_value_type CcScheduledQuery#measure_value_type}
    */
    readonly measureValueType?: string;
    /**
    * Source measure value column in the query result where the attribute value is to be read.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#source_column CcScheduledQuery#source_column}
    */
    readonly sourceColumn?: string;
    /**
    * Custom name to be used for attribute name in derived table. If not provided, source column name would be used.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#target_multi_measure_attribute_name CcScheduledQuery#target_multi_measure_attribute_name}
    */
...
export interface MixedMeasureMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#measure_name CcScheduledQuery#measure_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#multi_measure_attribute_mappings CcScheduledQuery#multi_measure_attribute_mappings}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#target_measure_name CcScheduledQuery#target_measure_name}
    */
...
export interface MultiMeasureMappingsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#target_multi_measure_name CcScheduledQuery#target_multi_measure_name}
    */
...
export interface TimestreamConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#database_name CcScheduledQuery#database_name}
    */
    readonly databaseName?: string;
    /**
    * This is to allow mapping column(s) from the query result to the dimension in the destination table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#dimension_mappings CcScheduledQuery#dimension_mappings}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#measure_name_column CcScheduledQuery#measure_name_column}
    */
    readonly measureNameColumn?: string;
    /**
    * Specifies how to map measures to multi-measure records.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#mixed_measure_mappings CcScheduledQuery#mixed_measure_mappings}
    */
    readonly mixedMeasureMappings?: MixedMeasureMappingProperty[] | cdktn.IResolvable;
    /**
    * Only one of MixedMeasureMappings or MultiMeasureMappings is to be provided. MultiMeasureMappings can be used to ingest data as multi measures in the derived table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#multi_measure_mappings CcScheduledQuery#multi_measure_mappings}
    */
    readonly multiMeasureMappings?: MultiMeasureMappingsProperty;
    /**
    * Name of Timestream table that the query result will be written to. The table should be within the same database that is provided in Timestream configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#table_name CcScheduledQuery#table_name}
    */
    readonly tableName?: string;
    /**
    * Column from query result that should be used as the time column in destination table. Column type for this should be TIMESTAMP.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#time_column CcScheduledQuery#time_column}
    */
...
export interface TargetConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/timestream_scheduled_query#timestream_configuration CcScheduledQuery#timestream_configuration}
    */
