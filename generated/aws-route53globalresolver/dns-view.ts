...
export interface CcDnsViewProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#client_token CcDnsView#client_token}
    */
    readonly clientToken?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#description CcDnsView#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#dnssec_validation CcDnsView#dnssec_validation}
    */
    readonly dnssecValidation?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#edns_client_subnet CcDnsView#edns_client_subnet}
    */
    readonly ednsClientSubnet?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#firewall_rules_fail_open CcDnsView#firewall_rules_fail_open}
    */
    readonly firewallRulesFailOpen?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#global_resolver_id CcDnsView#global_resolver_id}
    */
    readonly globalResolverId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#name CcDnsView#name}
    */
    readonly name: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#tags CcDnsView#tags}
    */
...
export class CcDnsView extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDnsView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcDnsViewProps
    */
    public constructor(scope: Construct, id: string, config: CcDnsViewProps) {
        super(scope, id, {
    ...
    private _tags = new CcDnsView.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDnsView.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccDnsViewTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDnsViewTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDnsView.TagPropertyList",
            },
        };
...
export function ccDnsViewTagPropertyToTerraform(struct?: CcDnsView.TagProperty | cdktn.IResolvable): any {
...
export function ccDnsViewTagPropertyToHclTerraform(struct?: CcDnsView.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#key CcDnsView#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53globalresolver_dns_view#value CcDnsView#value}
    */
