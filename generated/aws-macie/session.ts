...
export interface CcSessionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/macie_session#finding_publishing_frequency CcSession#finding_publishing_frequency}
    */
    readonly findingPublishingFrequency?: string;
    /**
    * A enumeration value that specifies the status of the Macie Session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/macie_session#status CcSession#status}
    */
...
export class CcSession extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/macie_session#import import section} in the documentation of this resource for the id to use
