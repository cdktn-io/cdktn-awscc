...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule
...
export interface CcLinkRoutingRuleProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#conditions CcLinkRoutingRule#conditions}
    */
    readonly conditions: CcLinkRoutingRule.RuleConditionProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#gateway_id CcLinkRoutingRule#gateway_id}
    */
    readonly gatewayId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#link_id CcLinkRoutingRule#link_id}
    */
    readonly linkId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#priority CcLinkRoutingRule#priority}
    */
    readonly priority: number;
    /**
    * Tags to assign to the LinkRoutingRule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#tags CcLinkRoutingRule#tags}
    */
    readonly tags?: CcLinkRoutingRule.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule awscc_rtbfabric_link_routing_rule}
*/
export class CcLinkRoutingRule extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLinkRoutingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule awscc_rtbfabric_link_routing_rule} Resource
    *
    * @param scope The scope in which to define this construct
...
export interface QueryStringKeyValuePairProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#key CcLinkRoutingRule#key}
    */
    readonly key?: string;
    /**
    * Query string value ? RFC 3986 unreserved characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#value CcLinkRoutingRule#value}
    */
...
export interface RuleConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#host_header CcLinkRoutingRule#host_header}
    */
    readonly hostHeader?: string;
    /**
    * Wildcard host pattern (e.g., *.example.com) ? RFC 3986 unreserved characters plus *. Mutually exclusive with HostHeader.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#host_header_wildcard CcLinkRoutingRule#host_header_wildcard}
    */
    readonly hostHeaderWildcard?: string;
    /**
    * Exact path match ? must start with /. Mutually exclusive with PathPrefix.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#path_exact CcLinkRoutingRule#path_exact}
    */
    readonly pathExact?: string;
    /**
    * Path prefix matching ? strict starts-with, must start with /. Mutually exclusive with PathExact.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#path_prefix CcLinkRoutingRule#path_prefix}
    */
    readonly pathPrefix?: string;
    /**
    * Query string key=value pair match (single pair).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#query_string_equals CcLinkRoutingRule#query_string_equals}
    */
    readonly queryStringEquals?: QueryStringKeyValuePairProperty;
    /**
    * Query string key presence check (any value accepted).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_link_routing_rule#query_string_exists CcLinkRoutingRule#query_string_exists}
    */
