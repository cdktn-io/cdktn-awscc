...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcOutboundExternalLinkProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#gateway_id CcOutboundExternalLink#gateway_id}
    */
    readonly gatewayId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#link_attributes CcOutboundExternalLink#link_attributes}
    */
    readonly linkAttributes?: CcOutboundExternalLink.LinkAttributesProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#link_log_settings CcOutboundExternalLink#link_log_settings}
    */
    readonly linkLogSettings: CcOutboundExternalLink.LinkLogSettingsProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#public_endpoint CcOutboundExternalLink#public_endpoint}
    */
    readonly publicEndpoint: string;
    /**
    * Tags to assign to the Link.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#tags CcOutboundExternalLink#tags}
    */
    readonly tags?: CcOutboundExternalLink.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link awscc_rtbfabric_outbound_external_link}
*/
export class CcOutboundExternalLink extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcOutboundExternalLink resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcOutboundExternalLink to import
    * @param importFromId The id of the existing CcOutboundExternalLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcOutboundExternalLink to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link awscc_rtbfabric_outbound_external_link} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcOutboundExternalLinkProps
    */
    public constructor(scope: Construct, id: string, config: CcOutboundExternalLinkProps) {
        super(scope, id, {
    ...
    private _linkAttributes = new CcOutboundExternalLink.LinkAttributesPropertyOutputReference(this, "link_attributes");
    public get linkAttributes() {
        return this._linkAttributes;
    }
    public putLinkAttributes(value: CcOutboundExternalLink.LinkAttributesProperty) {
    ...
    private _linkLogSettings = new CcOutboundExternalLink.LinkLogSettingsPropertyOutputReference(this, "link_log_settings");
    public get linkLogSettings() {
        return this._linkLogSettings;
    }
    public putLinkLogSettings(value: CcOutboundExternalLink.LinkLogSettingsProperty) {
    ...
    private _tags = new CcOutboundExternalLink.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcOutboundExternalLink.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            link_attributes: ccOutboundExternalLinkLinkAttributesPropertyToTerraform(this._linkAttributes.internalValue),
            link_log_settings: ccOutboundExternalLinkLinkLogSettingsPropertyToTerraform(this._linkLogSettings.internalValue),
            public_endpoint: cdktn.stringToTerraform(this._publicEndpoint),
            tags: cdktn.listMapper(ccOutboundExternalLinkTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            link_attributes: {
                value: ccOutboundExternalLinkLinkAttributesPropertyToHclTerraform(this._linkAttributes.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcOutboundExternalLink.LinkAttributesProperty",
            },
            link_log_settings: {
                value: ccOutboundExternalLinkLinkLogSettingsPropertyToHclTerraform(this._linkLogSettings.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcOutboundExternalLink.LinkLogSettingsProperty",
            },
            public_endpoint: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccOutboundExternalLinkTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcOutboundExternalLink.TagPropertyList",
            },
        };
...
export function ccOutboundExternalLinkResponderErrorMaskingForHttpCodePropertyToTerraform(struct?: CcOutboundExternalLink.ResponderErrorMaskingForHttpCodeProperty | cdktn.IResolvable): any {
...
export function ccOutboundExternalLinkResponderErrorMaskingForHttpCodePropertyToHclTerraform(struct?: CcOutboundExternalLink.ResponderErrorMaskingForHttpCodeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccOutboundExternalLinkLinkAttributesPropertyToTerraform(struct?: CcOutboundExternalLink.LinkAttributesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        responder_error_masking: cdktn.listMapper(ccOutboundExternalLinkResponderErrorMaskingForHttpCodePropertyToTerraform, false)(struct!.responderErrorMasking),
    }
}


export function ccOutboundExternalLinkLinkAttributesPropertyToHclTerraform(struct?: CcOutboundExternalLink.LinkAttributesProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        responder_error_masking: {
            value: cdktn.listMapperHcl(ccOutboundExternalLinkResponderErrorMaskingForHttpCodePropertyToHclTerraform, false)(struct!.responderErrorMasking),
            isBlock: true,
            type: "list",
...
export function ccOutboundExternalLinkLinkApplicationLogSamplingPropertyToTerraform(struct?: CcOutboundExternalLink.LinkApplicationLogSamplingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccOutboundExternalLinkLinkApplicationLogSamplingPropertyToHclTerraform(struct?: CcOutboundExternalLink.LinkApplicationLogSamplingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccOutboundExternalLinkApplicationLogsPropertyToTerraform(struct?: CcOutboundExternalLink.ApplicationLogsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        link_application_log_sampling: ccOutboundExternalLinkLinkApplicationLogSamplingPropertyToTerraform(struct!.linkApplicationLogSampling),
    }
}


export function ccOutboundExternalLinkApplicationLogsPropertyToHclTerraform(struct?: CcOutboundExternalLink.ApplicationLogsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        link_application_log_sampling: {
            value: ccOutboundExternalLinkLinkApplicationLogSamplingPropertyToHclTerraform(struct!.linkApplicationLogSampling),
            isBlock: true,
            type: "struct",
...
export function ccOutboundExternalLinkLinkLogSettingsPropertyToTerraform(struct?: CcOutboundExternalLink.LinkLogSettingsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        application_logs: ccOutboundExternalLinkApplicationLogsPropertyToTerraform(struct!.applicationLogs),
    }
}


export function ccOutboundExternalLinkLinkLogSettingsPropertyToHclTerraform(struct?: CcOutboundExternalLink.LinkLogSettingsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        application_logs: {
            value: ccOutboundExternalLinkApplicationLogsPropertyToHclTerraform(struct!.applicationLogs),
            isBlock: true,
            type: "struct",
...
export function ccOutboundExternalLinkTagPropertyToTerraform(struct?: CcOutboundExternalLink.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccOutboundExternalLinkTagPropertyToHclTerraform(struct?: CcOutboundExternalLink.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcOutboundExternalLink {
export interface ResponderErrorMaskingForHttpCodeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#action CcOutboundExternalLink#action}
    */
    readonly action?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#http_code CcOutboundExternalLink#http_code}
    */
    readonly httpCode?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#logging_types CcOutboundExternalLink#logging_types}
    */
    readonly loggingTypes?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#response_logging_percentage CcOutboundExternalLink#response_logging_percentage}
    */
...
export interface LinkAttributesProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#customer_provided_id CcOutboundExternalLink#customer_provided_id}
    */
    readonly customerProvidedId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#responder_error_masking CcOutboundExternalLink#responder_error_masking}
    */
...
export interface LinkApplicationLogSamplingProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#error_log CcOutboundExternalLink#error_log}
    */
    readonly errorLog: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#filter_log CcOutboundExternalLink#filter_log}
    */
...
export interface ApplicationLogsProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#link_application_log_sampling CcOutboundExternalLink#link_application_log_sampling}
    */
...
export interface LinkLogSettingsProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#application_logs CcOutboundExternalLink#application_logs}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#key CcOutboundExternalLink#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/rtbfabric_outbound_external_link#value CcOutboundExternalLink#value}
    */
