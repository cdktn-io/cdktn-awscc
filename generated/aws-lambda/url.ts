...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcUrlProps extends cdktn.TerraformMetaArguments {
    /**
    * Can be either AWS_IAM if the requests are authorized via IAM, or NONE if no authorization is configured on the Function URL.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#auth_type CcUrl#auth_type}
    */
    readonly authType: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#cors CcUrl#cors}
    */
    readonly cors?: CcUrl.CorsProperty;
    /**
    * The invocation mode for the function's URL. Set to BUFFERED if you want to buffer responses before returning them to the client. Set to RESPONSE_STREAM if you want to stream responses, allowing faster time to first byte and larger response payload sizes. If not set, defaults to BUFFERED.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#invoke_mode CcUrl#invoke_mode}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#qualifier CcUrl#qualifier}
    */
    readonly qualifier?: string;
    /**
    * The Amazon Resource Name (ARN) of the function associated with the Function URL.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#target_function_arn CcUrl#target_function_arn}
    */
    readonly targetFunctionArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url awscc_lambda_url}
*/
export class CcUrl extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url awscc_lambda_url} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcUrlProps
    */
    public constructor(scope: Construct, id: string, config: CcUrlProps) {
        super(scope, id, {
    ...
    private _cors = new CcUrl.CorsPropertyOutputReference(this, "cors");
    public get cors() {
        return this._cors;
    }
    public putCors(value: CcUrl.CorsProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            cors: ccUrlCorsPropertyToTerraform(this._cors.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            cors: {
                value: ccUrlCorsPropertyToHclTerraform(this._cors.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcUrl.CorsProperty",
            },
            invoke_mode: {
...
export function ccUrlCorsPropertyToTerraform(struct?: CcUrl.CorsProperty | cdktn.IResolvable): any {
...
export function ccUrlCorsPropertyToHclTerraform(struct?: CcUrl.CorsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcUrl {
export interface CorsProperty {
    /**
    * Specifies whether credentials are included in the CORS request.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#allow_credentials CcUrl#allow_credentials}
    */
    readonly allowCredentials?: boolean | cdktn.IResolvable;
    /**
    * Represents a collection of allowed headers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#allow_headers CcUrl#allow_headers}
    */
    readonly allowHeaders?: string[];
    /**
    * Represents a collection of allowed HTTP methods.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#allow_methods CcUrl#allow_methods}
    */
    readonly allowMethods?: string[];
    /**
    * Represents a collection of allowed origins.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#allow_origins CcUrl#allow_origins}
    */
    readonly allowOrigins?: string[];
    /**
    * Represents a collection of exposed headers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#expose_headers CcUrl#expose_headers}
    */
    readonly exposeHeaders?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/lambda_url#max_age CcUrl#max_age}
    */
