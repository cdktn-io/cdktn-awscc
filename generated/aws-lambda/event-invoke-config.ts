...
export interface CcEventInvokeConfigProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#destination_config CcEventInvokeConfig#destination_config}
    */
    readonly destinationConfig?: CcEventInvokeConfig.DestinationConfigProperty;
    /**
    * The name of the Lambda function.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#function_name CcEventInvokeConfig#function_name}
    */
    readonly functionName: string;
    /**
    * The maximum age of a request that Lambda sends to a function for processing.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#maximum_event_age_in_seconds CcEventInvokeConfig#maximum_event_age_in_seconds}
    */
    readonly maximumEventAgeInSeconds?: number;
    /**
    * The maximum number of times to retry when the function returns an error.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#maximum_retry_attempts CcEventInvokeConfig#maximum_retry_attempts}
    */
    readonly maximumRetryAttempts?: number;
    /**
    * The identifier of a version or alias.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#qualifier CcEventInvokeConfig#qualifier}
    */
...
export class CcEventInvokeConfig extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEventInvokeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#import import section} in the documentation of this resource for the id to use
...
export interface OnFailureProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#destination CcEventInvokeConfig#destination}
    */
...
export interface DestinationConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#on_failure CcEventInvokeConfig#on_failure}
    */
    readonly onFailure?: OnFailureProperty;
    /**
    * The destination configuration for successful invocations.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lambda_event_invoke_config#on_success CcEventInvokeConfig#on_success}
    */
