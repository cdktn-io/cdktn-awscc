...
export interface CcIntelligentPromptRouterProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#description CcIntelligentPromptRouter#description}
    */
    readonly description?: string;
    /**
    * Model configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#fallback_model CcIntelligentPromptRouter#fallback_model}
    */
    readonly fallbackModel: CcIntelligentPromptRouter.PromptRouterTargetModelProperty;
    /**
    * List of model configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#models CcIntelligentPromptRouter#models}
    */
    readonly models: CcIntelligentPromptRouter.ModelsProperty[] | cdktn.IResolvable;
    /**
    * Name of the Prompt Router.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#prompt_router_name CcIntelligentPromptRouter#prompt_router_name}
    */
    readonly promptRouterName: string;
    /**
    * Represents the criteria used for routing requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#routing_criteria CcIntelligentPromptRouter#routing_criteria}
    */
    readonly routingCriteria: CcIntelligentPromptRouter.RoutingCriteriaProperty;
    /**
    * List of Tags
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#tags CcIntelligentPromptRouter#tags}
    */
...
export class CcIntelligentPromptRouter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcIntelligentPromptRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#import import section} in the documentation of this resource for the id to use
...
export interface PromptRouterTargetModelProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#model_arn CcIntelligentPromptRouter#model_arn}
    */
...
export interface RoutingCriteriaProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#response_quality_difference CcIntelligentPromptRouter#response_quality_difference}
    */
...
export interface TagProperty {
    ...
    * Tag Key
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#key CcIntelligentPromptRouter#key}
    */
    readonly key?: string;
    /**
    * Tag Value
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_intelligent_prompt_router#value CcIntelligentPromptRouter#value}
    */
