...
export interface CcApplicationInferenceProfileProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#description CcApplicationInferenceProfile#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#inference_profile_name CcApplicationInferenceProfile#inference_profile_name}
    */
    readonly inferenceProfileName: string;
    /**
    * Various ways to encode a list of models in a CreateInferenceProfile request
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#model_source CcApplicationInferenceProfile#model_source}
    */
    readonly modelSource?: CcApplicationInferenceProfile.InferenceProfileModelSourceProperty;
    /**
    * List of Tags
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#tags CcApplicationInferenceProfile#tags}
    */
...
export class CcApplicationInferenceProfile extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcApplicationInferenceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#import import section} in the documentation of this resource for the id to use
...
export interface InferenceProfileModelSourceProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#copy_from CcApplicationInferenceProfile#copy_from}
    */
...
export interface TagProperty {
    ...
    * Tag Key
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#key CcApplicationInferenceProfile#key}
    */
    readonly key?: string;
    /**
    * Tag Value
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_application_inference_profile#value CcApplicationInferenceProfile#value}
    */
