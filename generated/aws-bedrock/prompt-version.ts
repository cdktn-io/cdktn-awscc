...
export interface CcPromptVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_prompt_version#description CcPromptVersion#description}
    */
    readonly description?: string;
    /**
    * ARN of a prompt resource possibly with a version
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_prompt_version#prompt_arn CcPromptVersion#prompt_arn}
    */
    readonly promptArn: string;
    /**
    * A map of tag keys and values
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_prompt_version#tags CcPromptVersion#tags}
    */
...
export class CcPromptVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPromptVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/bedrock_prompt_version#import import section} in the documentation of this resource for the id to use
