...
export interface CcFlowVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_flow_version#description CcFlowVersion#description}
    */
    readonly description?: string;
    /**
    * Arn representation of the Flow
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_flow_version#flow_arn CcFlowVersion#flow_arn}
    */
...
export class CcFlowVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcFlowVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_flow_version#import import section} in the documentation of this resource for the id to use
