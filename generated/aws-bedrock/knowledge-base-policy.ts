...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcKnowledgeBasePolicyProps extends cdktn.TerraformMetaArguments {
    /**
    * The unique identifier of the knowledge base
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy#knowledge_base_id CcKnowledgeBasePolicy#knowledge_base_id}
    */
    readonly knowledgeBaseId: string;
    /**
    * The IAM policy document defining access permissions for the knowledge base
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy#policy_document CcKnowledgeBasePolicy#policy_document}
    */
    readonly policyDocument: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy awscc_bedrock_knowledge_base_policy}
*/
export class CcKnowledgeBasePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcKnowledgeBasePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/bedrock_knowledge_base_policy awscc_bedrock_knowledge_base_policy} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcKnowledgeBasePolicyProps
    */
    public constructor(scope: Construct, id: string, config: CcKnowledgeBasePolicyProps) {
        super(scope, id, {
...
export namespace CcKnowledgeBasePolicy {
}
