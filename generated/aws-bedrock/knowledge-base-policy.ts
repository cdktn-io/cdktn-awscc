...
export interface CcKnowledgeBasePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base_policy#knowledge_base_id CcKnowledgeBasePolicy#knowledge_base_id}
    */
    readonly knowledgeBaseId: string;
    /**
    * The IAM policy document defining access permissions for the knowledge base
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base_policy#policy_document CcKnowledgeBasePolicy#policy_document}
    */
...
export class CcKnowledgeBasePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcKnowledgeBasePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base_policy#import import section} in the documentation of this resource for the id to use
