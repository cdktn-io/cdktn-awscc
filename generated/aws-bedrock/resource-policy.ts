...
export interface CcResourcePolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_resource_policy#policy_document CcResourcePolicy#policy_document}
    */
    readonly policyDocument: string;
    /**
    * The ARN of the Bedrock Guardrail or Guardrail Profile resource
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_resource_policy#resource_arn CcResourcePolicy#resource_arn}
    */
...
export class CcResourcePolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/bedrock_resource_policy#import import section} in the documentation of this resource for the id to use
