...
export interface CcKnowledgeBaseProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#description CcKnowledgeBase#description}
    */
    readonly description?: string;
    /**
    * Contains details about the embeddings model used for the knowledge base.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#knowledge_base_configuration CcKnowledgeBase#knowledge_base_configuration}
    */
    readonly knowledgeBaseConfiguration: CcKnowledgeBase.KnowledgeBaseConfigurationProperty;
    /**
    * The name of the knowledge base.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#name CcKnowledgeBase#name}
    */
    readonly name: string;
    /**
    * The ARN of the IAM role with permissions to invoke API operations on the knowledge base. The ARN must begin with AmazonBedrockExecutionRoleForKnowledgeBase_
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#role_arn CcKnowledgeBase#role_arn}
    */
    readonly roleArn: string;
    /**
    * The vector store service in which the knowledge base is stored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#storage_configuration CcKnowledgeBase#storage_configuration}
    */
    readonly storageConfiguration?: CcKnowledgeBase.StorageConfigurationProperty;
    /**
    * A map of tag keys and values
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#tags CcKnowledgeBase#tags}
    */
...
export class CcKnowledgeBase extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcKnowledgeBase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#import import section} in the documentation of this resource for the id to use
...
export function ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyToTerraform(struct?: CcKnowledgeBase.KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyToHclTerraform(struct?: CcKnowledgeBase.KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccKnowledgeBaseSupplementalDataStorageLocationsPropertyToTerraform(struct?: CcKnowledgeBase.SupplementalDataStorageLocationsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        s3_location: ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyToTerraform(struct!.s3Location),
        supplemental_data_storage_location_type: cdktn.stringToTerraform(struct!.supplementalDataStorageLocationType),
    }
}


export function ccKnowledgeBaseSupplementalDataStorageLocationsPropertyToHclTerraform(struct?: CcKnowledgeBase.SupplementalDataStorageLocationsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        s3_location: {
            value: ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyToHclTerraform(struct!.s3Location),
            isBlock: true,
            type: "struct",
            storageClassType: "KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty",
        },
...
export function ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyToTerraform(struct?: CcKnowledgeBase.KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        supplemental_data_storage_locations: cdktn.listMapper(ccKnowledgeBaseSupplementalDataStorageLocationsPropertyToTerraform, false)(struct!.supplementalDataStorageLocations),
    }
}


export function ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyToHclTerraform(struct?: CcKnowledgeBase.KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        supplemental_data_storage_locations: {
            value: cdktn.listMapperHcl(ccKnowledgeBaseSupplementalDataStorageLocationsPropertyToHclTerraform, false)(struct!.supplementalDataStorageLocations),
            isBlock: true,
            type: "list",
            storageClassType: "SupplementalDataStorageLocationsPropertyList",
        },
    };
...
export function ccKnowledgeBaseManagedKnowledgeBaseConfigurationPropertyToTerraform(struct?: CcKnowledgeBase.ManagedKnowledgeBaseConfigurationProperty | cdktn.IResolvable): any {
    ...
    return {
        ...
        supplemental_data_storage_configuration: ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyToTerraform(struct!.supplementalDataStorageConfiguration),
    }
}
...
export function ccKnowledgeBaseManagedKnowledgeBaseConfigurationPropertyToHclTerraform(struct?: CcKnowledgeBase.ManagedKnowledgeBaseConfigurationProperty | cdktn.IResolvable): any {
    ...
    const attrs = {
        ...
        supplemental_data_storage_configuration: {
            value: ccKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyToHclTerraform(struct!.supplementalDataStorageConfiguration),
            isBlock: true,
            type: "struct",
            storageClassType: "KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty",
        },
    };
...
export interface KendraKnowledgeBaseConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#kendra_index_arn CcKnowledgeBase#kendra_index_arn}
    */
...
export interface AudioSegmentationConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#fixed_length_duration CcKnowledgeBase#fixed_length_duration}
    */
...
export interface AudioConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#segmentation_configuration CcKnowledgeBase#segmentation_configuration}
    */
...
export interface BedrockEmbeddingModelConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#audio CcKnowledgeBase#audio}
    */
    readonly audio?: AudioConfigurationProperty[] | cdktn.IResolvable;
    /**
    * The dimensions details for the vector configuration used on the Bedrock embeddings model.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#dimensions CcKnowledgeBase#dimensions}
    */
    readonly dimensions?: number;
    /**
    * The data type for the vectors when using a model to convert text into vector embeddings.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#embedding_data_type CcKnowledgeBase#embedding_data_type}
    */
    readonly embeddingDataType?: string;
    /**
    * Model-specific configuration for the embedding model.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#model_configuration CcKnowledgeBase#model_configuration}
    */
    readonly modelConfiguration?: string;
    /**
    * List of video configurations for multi modal ingestion.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#video CcKnowledgeBase#video}
    */
...
export interface EmbeddingModelConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#bedrock_embedding_model_configuration CcKnowledgeBase#bedrock_embedding_model_configuration}
    */
...
export interface ManagedKnowledgeBaseServerSideEncryptionConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#kms_key_arn CcKnowledgeBase#kms_key_arn}
    */
...
export interface KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty {
    /**
    * The location's URI
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#uri CcKnowledgeBase#uri}
    */
    readonly uri?: string;
}
export class KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
            this._uri = undefined;
...
export interface SupplementalDataStorageLocationsProperty {
    /**
    * An Amazon S3 location.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#s3_location CcKnowledgeBase#s3_location}
    */
    readonly s3Location?: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty;
    /**
    * Supplemental data storage location type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#supplemental_data_storage_location_type CcKnowledgeBase#supplemental_data_storage_location_type}
    */
    readonly supplementalDataStorageLocationType?: string;
}
export class SupplementalDataStorageLocationsPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): SupplementalDataStorageLocationsProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: SupplementalDataStorageLocationsProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
    ...
    private _s3Location = new KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationPropertyOutputReference(this, "s3_location");
    public get s3Location() {
        return this._s3Location;
    }
    public putS3Location(value: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationSupplementalDataStorageLocationsS3LocationProperty) {
...
export class SupplementalDataStorageLocationsPropertyList extends cdktn.ComplexList {
    public internalValue? : SupplementalDataStorageLocationsProperty[] | cdktn.IResolvable
    ...
    * @param index the index of the item to return
    */
    public get(index: number): SupplementalDataStorageLocationsPropertyOutputReference {
        return new SupplementalDataStorageLocationsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty {
    /**
    * List of supplemental data storage locations.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#supplemental_data_storage_locations CcKnowledgeBase#supplemental_data_storage_locations}
    */
    readonly supplementalDataStorageLocations?: SupplementalDataStorageLocationsProperty[] | cdktn.IResolvable;
}
export class KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
    ...
    private _supplementalDataStorageLocations = new SupplementalDataStorageLocationsPropertyList(this, "supplemental_data_storage_locations", false);
    public get supplementalDataStorageLocations() {
        return this._supplementalDataStorageLocations;
    }
    public putSupplementalDataStorageLocations(value: SupplementalDataStorageLocationsProperty[] | cdktn.IResolvable) {
...
export interface ManagedKnowledgeBaseConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#embedding_model_arn CcKnowledgeBase#embedding_model_arn}
    */
    readonly embeddingModelArn?: string;
    /**
    * The embeddings model configuration details for the vector model used in Knowledge Base.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#embedding_model_configuration CcKnowledgeBase#embedding_model_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#embedding_model_type CcKnowledgeBase#embedding_model_type}
    */
    readonly embeddingModelType?: string;
    /**
    * Contains details about the server-side encryption for the managed knowledge base.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#server_side_encryption_configuration CcKnowledgeBase#server_side_encryption_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#supplemental_data_storage_configuration CcKnowledgeBase#supplemental_data_storage_configuration}
    */
    readonly supplementalDataStorageConfiguration?: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty;
}
export class ManagedKnowledgeBaseConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    private _supplementalDataStorageConfiguration = new KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationPropertyOutputReference(this, "supplemental_data_storage_configuration");
    public get supplementalDataStorageConfiguration() {
        return this._supplementalDataStorageConfiguration;
    }
    public putSupplementalDataStorageConfiguration(value: KnowledgeBaseConfigurationManagedKnowledgeBaseConfigurationSupplementalDataStorageConfigurationProperty) {
...
export interface RedshiftProvisionedAuthConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#database_user CcKnowledgeBase#database_user}
    */
    readonly databaseUser?: string;
    /**
    * Provisioned Redshift auth type
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#type CcKnowledgeBase#type}
    */
    readonly type?: string;
    /**
    * Arn of a SecretsManager Secret
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#username_password_secret_arn CcKnowledgeBase#username_password_secret_arn}
    */
...
export interface RedshiftProvisionedConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#auth_configuration CcKnowledgeBase#auth_configuration}
    */
    readonly authConfiguration?: RedshiftProvisionedAuthConfigurationProperty;
    /**
    * Redshift cluster identifier
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#cluster_identifier CcKnowledgeBase#cluster_identifier}
    */
...
export interface RedshiftServerlessConfigurationProperty {
    ...
    * Workgroup arn
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#workgroup_arn CcKnowledgeBase#workgroup_arn}
    */
...
export interface RedshiftQueryEngineConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#provisioned_configuration CcKnowledgeBase#provisioned_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#serverless_configuration CcKnowledgeBase#serverless_configuration}
    */
...
export interface CuratedQueryProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#natural_language CcKnowledgeBase#natural_language}
    */
    readonly naturalLanguage?: string;
    /**
    * Answer for the curated query
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#sql CcKnowledgeBase#sql}
    */
    readonly sql?: string;
}
...
export interface QueryGenerationColumnProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#inclusion CcKnowledgeBase#inclusion}
    */
...
export interface QueryGenerationTableProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#columns CcKnowledgeBase#columns}
    */
...
export interface QueryGenerationContextProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#curated_queries CcKnowledgeBase#curated_queries}
    */
    readonly curatedQueries?: CuratedQueryProperty[] | cdktn.IResolvable;
    /**
    * List of tables used for Redshift query generation context
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#tables CcKnowledgeBase#tables}
    */
...
export interface QueryGenerationConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#execution_timeout_seconds CcKnowledgeBase#execution_timeout_seconds}
    */
    readonly executionTimeoutSeconds?: number;
    /**
    * Context used to improve query generation
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#generation_context CcKnowledgeBase#generation_context}
    */
...
export interface RedshiftQueryEngineAwsDataCatalogStorageConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#table_names CcKnowledgeBase#table_names}
    */
...
export interface RedshiftQueryEngineRedshiftStorageConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#database_name CcKnowledgeBase#database_name}
    */
...
export interface RedshiftQueryEngineStorageConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#aws_data_catalog_configuration CcKnowledgeBase#aws_data_catalog_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#redshift_configuration CcKnowledgeBase#redshift_configuration}
    */
...
export interface RedshiftConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#query_engine_configuration CcKnowledgeBase#query_engine_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#query_generation_configuration CcKnowledgeBase#query_generation_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#storage_configurations CcKnowledgeBase#storage_configurations}
    */
...
export interface KnowledgeBaseConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#kendra_knowledge_base_configuration CcKnowledgeBase#kendra_knowledge_base_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#managed_knowledge_base_configuration CcKnowledgeBase#managed_knowledge_base_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#sql_knowledge_base_configuration CcKnowledgeBase#sql_knowledge_base_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#vector_knowledge_base_configuration CcKnowledgeBase#vector_knowledge_base_configuration}
    */
...
export interface MongoDbAtlasFieldMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#metadata_field CcKnowledgeBase#metadata_field}
    */
    readonly metadataField?: string;
    /**
    * The name of the field in which Amazon Bedrock stores the raw text from your data. The text is split according to the chunking strategy you choose.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#text_field CcKnowledgeBase#text_field}
    */
    readonly textField?: string;
    /**
    * The name of the field in which Amazon Bedrock stores the vector embeddings for your data sources.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#vector_field CcKnowledgeBase#vector_field}
    */
...
export interface MongoDbAtlasConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#collection_name CcKnowledgeBase#collection_name}
    */
    readonly collectionName?: string;
    /**
    * The ARN of the secret that you created in AWS Secrets Manager that is linked to your Amazon Mongo database.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#credentials_secret_arn CcKnowledgeBase#credentials_secret_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#endpoint CcKnowledgeBase#endpoint}
    */
    readonly endpoint?: string;
    /**
    * MongoDB Atlas endpoint service name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#endpoint_service_name CcKnowledgeBase#endpoint_service_name}
    */
    readonly endpointServiceName?: string;
    /**
    * Contains the names of the fields to which to map information about the vector store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#field_mapping CcKnowledgeBase#field_mapping}
    */
    readonly fieldMapping?: MongoDbAtlasFieldMappingProperty;
    /**
    * Name of a MongoDB Atlas text index.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#text_index_name CcKnowledgeBase#text_index_name}
    */
    readonly textIndexName?: string;
    /**
    * Name of a MongoDB Atlas index.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#vector_index_name CcKnowledgeBase#vector_index_name}
    */
...
export interface NeptuneAnalyticsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#graph_arn CcKnowledgeBase#graph_arn}
    */
...
export interface OpenSearchManagedClusterConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#domain_arn CcKnowledgeBase#domain_arn}
    */
    readonly domainArn?: string;
    /**
    * The endpoint URL the OpenSearch domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#domain_endpoint CcKnowledgeBase#domain_endpoint}
    */
...
export interface OpenSearchServerlessConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#collection_arn CcKnowledgeBase#collection_arn}
    */
...
export interface PineconeConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#connection_string CcKnowledgeBase#connection_string}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#namespace CcKnowledgeBase#namespace}
    */
...
export interface RdsFieldMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#custom_metadata_field CcKnowledgeBase#custom_metadata_field}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#primary_key_field CcKnowledgeBase#primary_key_field}
    */
...
export interface RdsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#resource_arn CcKnowledgeBase#resource_arn}
    */
    readonly resourceArn?: string;
    /**
    * The name of the table in the database.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#table_name CcKnowledgeBase#table_name}
    */
...
export interface S3VectorsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#index_arn CcKnowledgeBase#index_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#index_name CcKnowledgeBase#index_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#vector_bucket_arn CcKnowledgeBase#vector_bucket_arn}
    */
...
export interface StorageConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#mongo_db_atlas_configuration CcKnowledgeBase#mongo_db_atlas_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#neptune_analytics_configuration CcKnowledgeBase#neptune_analytics_configuration}
    */
    readonly neptuneAnalyticsConfiguration?: NeptuneAnalyticsConfigurationProperty;
    /**
    * Contains the storage configuration of the knowledge base in Amazon OpenSearch Service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#opensearch_managed_cluster_configuration CcKnowledgeBase#opensearch_managed_cluster_configuration}
    */
    readonly opensearchManagedClusterConfiguration?: OpenSearchManagedClusterConfigurationProperty;
    /**
    * Contains the storage configuration of the knowledge base in Amazon OpenSearch Service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#opensearch_serverless_configuration CcKnowledgeBase#opensearch_serverless_configuration}
    */
    readonly opensearchServerlessConfiguration?: OpenSearchServerlessConfigurationProperty;
    /**
    * Contains the storage configuration of the knowledge base in Pinecone.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#pinecone_configuration CcKnowledgeBase#pinecone_configuration}
    */
    readonly pineconeConfiguration?: PineconeConfigurationProperty;
    /**
    * Contains details about the storage configuration of the knowledge base in Amazon RDS. For more information, see Create a vector index in Amazon RDS.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#rds_configuration CcKnowledgeBase#rds_configuration}
    */
    readonly rdsConfiguration?: RdsConfigurationProperty;
    /**
    * Contains the storage configuration of the knowledge base for S3 vectors.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/bedrock_knowledge_base#s3_vectors_configuration CcKnowledgeBase#s3_vectors_configuration}
    */
