...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point
...
export interface CcAccessPointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#bucket CcAccessPoint#bucket}
    */
    readonly bucket: string;
    /**
    * The AWS account ID associated with the S3 bucket associated with this access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#bucket_account_id CcAccessPoint#bucket_account_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#name CcAccessPoint#name}
    */
    readonly name?: string;
    /**
    * The Access Point Policy you want to apply to this access point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#policy CcAccessPoint#policy}
    */
    readonly policy?: string;
    /**
    * The PublicAccessBlock configuration that you want to apply to this Access Point.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#public_access_block_configuration CcAccessPoint#public_access_block_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#scope CcAccessPoint#scope}
    */
    readonly scope?: CcAccessPoint.ScopeProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#tags CcAccessPoint#tags}
    */
    readonly tags?: CcAccessPoint.TagProperty[] | cdktn.IResolvable;
    /**
    * If you include this field, Amazon S3 restricts access to this Access Point to requests from the specified Virtual Private Cloud (VPC).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#vpc_configuration CcAccessPoint#vpc_configuration}
    */
    readonly vpcConfiguration?: CcAccessPoint.VpcConfigurationProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point awscc_s3express_access_point}
*/
export class CcAccessPoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point awscc_s3express_access_point} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    public putPublicAccessBlockConfiguration(value: CcAccessPoint.PublicAccessBlockConfigurationProperty) {
    ...
    private _scope = new CcAccessPoint.ScopePropertyOutputReference(this, "scope");
    public get scope() {
        return this._scope;
    }
    public putScope(value: CcAccessPoint.ScopeProperty) {
    ...
    private _tags = new CcAccessPoint.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcAccessPoint.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            public_access_block_configuration: ccAccessPointPublicAccessBlockConfigurationPropertyToTerraform(this._publicAccessBlockConfiguration.internalValue),
            scope: ccAccessPointScopePropertyToTerraform(this._scope.internalValue),
            tags: cdktn.listMapper(ccAccessPointTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            public_access_block_configuration: {
                value: ccAccessPointPublicAccessBlockConfigurationPropertyToHclTerraform(this._publicAccessBlockConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcAccessPoint.PublicAccessBlockConfigurationProperty",
            },
            scope: {
                value: ccAccessPointScopePropertyToHclTerraform(this._scope.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcAccessPoint.ScopeProperty",
            },
            tags: {
                value: cdktn.listMapperHcl(ccAccessPointTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcAccessPoint.TagPropertyList",
            },
            vpc_configuration: {
...
export function ccAccessPointPublicAccessBlockConfigurationPropertyToTerraform(struct?: CcAccessPoint.PublicAccessBlockConfigurationProperty | cdktn.IResolvable): any {
...
export function ccAccessPointPublicAccessBlockConfigurationPropertyToHclTerraform(struct?: CcAccessPoint.PublicAccessBlockConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointScopePropertyToTerraform(struct?: CcAccessPoint.ScopeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointScopePropertyToHclTerraform(struct?: CcAccessPoint.ScopeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointTagPropertyToTerraform(struct?: CcAccessPoint.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccAccessPointTagPropertyToHclTerraform(struct?: CcAccessPoint.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface PublicAccessBlockConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#block_public_acls CcAccessPoint#block_public_acls}
    */
    readonly blockPublicAcls?: boolean | cdktn.IResolvable;
    /**
    * Specifies whether Amazon S3 should block public bucket policies for buckets in this account. Setting this element to TRUE causes Amazon S3 to reject calls to PUT Bucket policy if the specified bucket policy allows public access. Enabling this setting doesn't affect existing bucket policies.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#block_public_policy CcAccessPoint#block_public_policy}
    */
    readonly blockPublicPolicy?: boolean | cdktn.IResolvable;
    /**
    * Specifies whether Amazon S3 should ignore public ACLs for buckets in this account. Setting this element to TRUE causes Amazon S3 to ignore all public ACLs on buckets in this account and any objects that they contain. Enabling this setting doesn't affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#ignore_public_acls CcAccessPoint#ignore_public_acls}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#restrict_public_buckets CcAccessPoint#restrict_public_buckets}
    */
...
export interface ScopeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#permissions CcAccessPoint#permissions}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#prefixes CcAccessPoint#prefixes}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#key CcAccessPoint#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#value CcAccessPoint#value}
    */
...
export interface VpcConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/s3express_access_point#vpc_id CcAccessPoint#vpc_id}
    */
