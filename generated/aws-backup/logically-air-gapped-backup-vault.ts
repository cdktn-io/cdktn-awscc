...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcLogicallyAirGappedBackupVaultProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#access_policy CcLogicallyAirGappedBackupVault#access_policy}
    */
    readonly accessPolicy?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#backup_vault_name CcLogicallyAirGappedBackupVault#backup_vault_name}
    */
    readonly backupVaultName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#backup_vault_tags CcLogicallyAirGappedBackupVault#backup_vault_tags}
    */
    readonly backupVaultTags?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#encryption_key_arn CcLogicallyAirGappedBackupVault#encryption_key_arn}
    */
    readonly encryptionKeyArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#max_retention_days CcLogicallyAirGappedBackupVault#max_retention_days}
    */
    readonly maxRetentionDays: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#min_retention_days CcLogicallyAirGappedBackupVault#min_retention_days}
    */
    readonly minRetentionDays: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#mpa_approval_team_arn CcLogicallyAirGappedBackupVault#mpa_approval_team_arn}
    */
    readonly mpaApprovalTeamArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#notifications CcLogicallyAirGappedBackupVault#notifications}
    */
    readonly notifications?: CcLogicallyAirGappedBackupVault.NotificationObjectTypeProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault awscc_backup_logically_air_gapped_backup_vault}
*/
export class CcLogicallyAirGappedBackupVault extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLogicallyAirGappedBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault awscc_backup_logically_air_gapped_backup_vault} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcLogicallyAirGappedBackupVaultProps
    */
    public constructor(scope: Construct, id: string, config: CcLogicallyAirGappedBackupVaultProps) {
        super(scope, id, {
    ...
    private _notifications = new CcLogicallyAirGappedBackupVault.NotificationObjectTypePropertyOutputReference(this, "notifications");
    public get notifications() {
        return this._notifications;
    }
    public putNotifications(value: CcLogicallyAirGappedBackupVault.NotificationObjectTypeProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            notifications: ccLogicallyAirGappedBackupVaultNotificationObjectTypePropertyToTerraform(this._notifications.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            notifications: {
                value: ccLogicallyAirGappedBackupVaultNotificationObjectTypePropertyToHclTerraform(this._notifications.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLogicallyAirGappedBackupVault.NotificationObjectTypeProperty",
            },
        };
...
export function ccLogicallyAirGappedBackupVaultNotificationObjectTypePropertyToTerraform(struct?: CcLogicallyAirGappedBackupVault.NotificationObjectTypeProperty | cdktn.IResolvable): any {
...
export function ccLogicallyAirGappedBackupVaultNotificationObjectTypePropertyToHclTerraform(struct?: CcLogicallyAirGappedBackupVault.NotificationObjectTypeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface NotificationObjectTypeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#backup_vault_events CcLogicallyAirGappedBackupVault#backup_vault_events}
    */
    readonly backupVaultEvents?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/backup_logically_air_gapped_backup_vault#sns_topic_arn CcLogicallyAirGappedBackupVault#sns_topic_arn}
    */
