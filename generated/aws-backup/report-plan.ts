...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan
...
export interface CcReportPlanProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_delivery_channel CcReportPlan#report_delivery_channel}
    */
    readonly reportDeliveryChannel: CcReportPlan.ReportDeliveryChannelProperty;
    /**
    * An optional description of the report plan with a maximum of 1,024 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_plan_description CcReportPlan#report_plan_description}
    */
    readonly reportPlanDescription?: string;
    /**
    * The unique name of the report plan. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_plan_name CcReportPlan#report_plan_name}
    */
    readonly reportPlanName?: string;
    /**
    * Metadata that you can assign to help organize the report plans that you create. Each tag is a key-value pair.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_plan_tags CcReportPlan#report_plan_tags}
    */
    readonly reportPlanTags?: CcReportPlan.TagProperty[] | cdktn.IResolvable;
    /**
    * Identifies the report template for the report. Reports are built using a report template.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_setting CcReportPlan#report_setting}
    */
...
export class CcReportPlan extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcReportPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#import import section} in the documentation of this resource for the id to use
...
export interface ReportDeliveryChannelProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#formats CcReportPlan#formats}
    */
    readonly formats?: string[];
    /**
    * The unique name of the S3 bucket that receives your reports.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#s3_bucket_name CcReportPlan#s3_bucket_name}
    */
    readonly s3BucketName: string;
    /**
    * The prefix for where AWS Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name. If not specified, there is no prefix.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#s3_key_prefix CcReportPlan#s3_key_prefix}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#key CcReportPlan#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#value CcReportPlan#value}
    */
...
export interface ReportSettingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#accounts CcReportPlan#accounts}
    */
    readonly accounts?: string[];
    /**
    * The Amazon Resource Names (ARNs) of the frameworks a report covers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#framework_arns CcReportPlan#framework_arns}
    */
    readonly frameworkArns?: string[];
    /**
    * The list of AWS organization units that a report covers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#organization_units CcReportPlan#organization_units}
    */
    readonly organizationUnits?: string[];
    /**
    * The list of AWS regions that a report covers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#regions CcReportPlan#regions}
    */
    readonly regions?: string[];
    /**
    * Identifies the report template for the report. Reports are built using a report template. The report templates are: `BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT`
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/backup_report_plan#report_template CcReportPlan#report_template}
    */
