...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcAnomalyMonitorProps extends cdktn.TerraformMetaArguments {
    /**
    * The dimensions to evaluate
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#monitor_dimension CcAnomalyMonitor#monitor_dimension}
    */
    readonly monitorDimension?: string;
    /**
    * The name of the monitor.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#monitor_name CcAnomalyMonitor#monitor_name}
    */
    readonly monitorName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#monitor_specification CcAnomalyMonitor#monitor_specification}
    */
    readonly monitorSpecification?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#monitor_type CcAnomalyMonitor#monitor_type}
    */
    readonly monitorType: string;
    /**
    * Tags to assign to monitor.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#resource_tags CcAnomalyMonitor#resource_tags}
    */
    readonly resourceTags?: CcAnomalyMonitor.ResourceTagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor awscc_ce_anomaly_monitor}
*/
export class CcAnomalyMonitor extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAnomalyMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor awscc_ce_anomaly_monitor} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcAnomalyMonitorProps
    */
    public constructor(scope: Construct, id: string, config: CcAnomalyMonitorProps) {
        super(scope, id, {
    ...
    private _resourceTags = new CcAnomalyMonitor.ResourceTagPropertyList(this, "resource_tags", false);
    public get resourceTags() {
        return this._resourceTags;
    }
    public putResourceTags(value: CcAnomalyMonitor.ResourceTagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            resource_tags: cdktn.listMapper(ccAnomalyMonitorResourceTagPropertyToTerraform, false)(this._resourceTags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            resource_tags: {
                value: cdktn.listMapperHcl(ccAnomalyMonitorResourceTagPropertyToHclTerraform, false)(this._resourceTags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcAnomalyMonitor.ResourceTagPropertyList",
            },
        };
...
export function ccAnomalyMonitorResourceTagPropertyToTerraform(struct?: CcAnomalyMonitor.ResourceTagProperty | cdktn.IResolvable): any {
...
export function ccAnomalyMonitorResourceTagPropertyToHclTerraform(struct?: CcAnomalyMonitor.ResourceTagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcAnomalyMonitor {
export interface ResourceTagProperty {
    /**
    * The key name for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#key CcAnomalyMonitor#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ce_anomaly_monitor#value CcAnomalyMonitor#value}
    */
