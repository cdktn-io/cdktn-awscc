...
export interface CcGroupProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group#description CcGroup#description}
    */
    readonly description?: string;
    /**
    * A string containing the name of the group. This value is commonly displayed when the group is referenced.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group#display_name CcGroup#display_name}
    */
    readonly displayName: string;
    /**
    * The globally unique identifier for the identity store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group#identity_store_id CcGroup#identity_store_id}
    */
...
export class CcGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/identitystore_group#import import section} in the documentation of this resource for the id to use
