...
export interface CcSequenceStoreProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#access_log_location CcSequenceStore#access_log_location}
    */
    readonly accessLogLocation?: string;
    /**
    * A description for the store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#description CcSequenceStore#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#e_tag_algorithm_family CcSequenceStore#e_tag_algorithm_family}
    */
    readonly eTagAlgorithmFamily?: string;
    /**
    * An S3 location that is used to store files that have failed a direct upload.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#fallback_location CcSequenceStore#fallback_location}
    */
    readonly fallbackLocation?: string;
    /**
    * A name for the store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#name CcSequenceStore#name}
    */
    readonly name: string;
    /**
    * The tags keys to propagate to the S3 objects associated with read sets in the sequence store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#propagated_set_level_tags CcSequenceStore#propagated_set_level_tags}
    */
    readonly propagatedSetLevelTags?: string[];
    /**
    * The resource policy that controls S3 access on the store
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#s3_access_policy CcSequenceStore#s3_access_policy}
    */
    readonly s3AccessPolicy?: string;
    /**
    * Server-side encryption (SSE) settings for a store.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#sse_config CcSequenceStore#sse_config}
    */
    readonly sseConfig?: CcSequenceStore.SseConfigProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#tags CcSequenceStore#tags}
    */
...
export class CcSequenceStore extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSequenceStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#import import section} in the documentation of this resource for the id to use
...
export interface SseConfigProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#key_arn CcSequenceStore#key_arn}
    */
    readonly keyArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_sequence_store#type CcSequenceStore#type}
    */
