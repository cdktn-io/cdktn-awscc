...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set
...
export interface CcDataSetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#asset_type CcDataSet#asset_type}
    */
    readonly assetType: string;
    /**
    * A description for the data set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#description CcDataSet#description}
    */
    readonly description: string;
    /**
    * The name of the data set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#name CcDataSet#name}
    */
    readonly name: string;
    /**
    * Tags for the data set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#tags CcDataSet#tags}
    */
...
export class CcDataSet extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDataSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#key CcDataSet#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/dataexchange_data_set#value CcDataSet#value}
    */
