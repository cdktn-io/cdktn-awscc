...
export interface CcMeteredProductProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/deadline_metered_product#license_endpoint_id CcMeteredProduct#license_endpoint_id}
    */
    readonly licenseEndpointId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/deadline_metered_product#product_id CcMeteredProduct#product_id}
    */
...
export class CcMeteredProduct extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMeteredProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/deadline_metered_product#import import section} in the documentation of this resource for the id to use
