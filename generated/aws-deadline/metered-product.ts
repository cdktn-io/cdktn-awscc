...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcMeteredProductProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product#license_endpoint_id CcMeteredProduct#license_endpoint_id}
    */
    readonly licenseEndpointId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product#product_id CcMeteredProduct#product_id}
    */
    readonly productId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product awscc_deadline_metered_product}
*/
export class CcMeteredProduct extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMeteredProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/deadline_metered_product awscc_deadline_metered_product} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcMeteredProductProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcMeteredProductProps = {}) {
        super(scope, id, {
...
export namespace CcMeteredProduct {
}
