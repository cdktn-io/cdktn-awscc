...
export interface CcTypeProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#fields CcType#fields}
    */
    readonly fields: CcType.FieldProperty[] | cdktn.IResolvable;
    /**
    * Name of the Keyspace which contains the User-Defined Type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#keyspace_name CcType#keyspace_name}
    */
    readonly keyspaceName: string;
    /**
    * Name of the User-Defined Type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#type_name CcType#type_name}
    */
...
export class CcType extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#import import section} in the documentation of this resource for the id to use
...
export interface FieldProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#field_name CcType#field_name}
    */
    readonly fieldName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cassandra_type#field_type CcType#field_type}
    */
