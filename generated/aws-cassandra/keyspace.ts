...
export interface CcKeyspaceProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#client_side_timestamps_enabled CcKeyspace#client_side_timestamps_enabled}
    */
    readonly clientSideTimestampsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Name for Cassandra keyspace
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#keyspace_name CcKeyspace#keyspace_name}
    */
    readonly keyspaceName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#replication_specification CcKeyspace#replication_specification}
    */
    readonly replicationSpecification?: CcKeyspace.ReplicationSpecificationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#tags CcKeyspace#tags}
    */
...
export class CcKeyspace extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#import import section} in the documentation of this resource for the id to use
...
export interface ReplicationSpecificationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#region_list CcKeyspace#region_list}
    */
    readonly regionList?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#replication_strategy CcKeyspace#replication_strategy}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#key CcKeyspace#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/cassandra_keyspace#value CcKeyspace#value}
    */
