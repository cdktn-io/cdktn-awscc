...
export interface CcEnvironmentAccountConnectionProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#codebuild_role_arn CcEnvironmentAccountConnection#codebuild_role_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#component_role_arn CcEnvironmentAccountConnection#component_role_arn}
    */
    readonly componentRoleArn?: string;
    /**
    * The environment account that's connected to the environment account connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#environment_account_id CcEnvironmentAccountConnection#environment_account_id}
    */
    readonly environmentAccountId?: string;
    /**
    * The name of the AWS Proton environment that's created in the associated management account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#environment_name CcEnvironmentAccountConnection#environment_name}
    */
    readonly environmentName?: string;
    /**
    * The ID of the management account that accepts or rejects the environment account connection. You create an manage the AWS Proton environment in this account. If the management account accepts the environment account connection, AWS Proton can use the associated IAM role to provision environment infrastructure resources in the associated environment account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#management_account_id CcEnvironmentAccountConnection#management_account_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#role_arn CcEnvironmentAccountConnection#role_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#tags CcEnvironmentAccountConnection#tags}
    */
...
export class CcEnvironmentAccountConnection extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnvironmentAccountConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcEnvironmentAccountConnectionProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcEnvironmentAccountConnectionProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcEnvironmentAccountConnection.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcEnvironmentAccountConnection.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccEnvironmentAccountConnectionTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccEnvironmentAccountConnectionTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcEnvironmentAccountConnection.TagPropertyList",
            },
        };
...
export function ccEnvironmentAccountConnectionTagPropertyToTerraform(struct?: CcEnvironmentAccountConnection.TagProperty | cdktn.IResolvable): any {
...
export function ccEnvironmentAccountConnectionTagPropertyToHclTerraform(struct?: CcEnvironmentAccountConnection.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcEnvironmentAccountConnection {
export interface TagProperty {
    /**
    * <p>The key of the resource tag.</p>
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#key CcEnvironmentAccountConnection#key}
    */
    readonly key?: string;
    /**
    * <p>The value of the resource tag.</p>
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/proton_environment_account_connection#value CcEnvironmentAccountConnection#value}
    */
