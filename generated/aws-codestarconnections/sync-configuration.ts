...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcSyncConfigurationProps extends cdktn.TerraformMetaArguments {
    /**
    * The name of the branch of the repository from which resources are to be synchronized,
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#branch CcSyncConfiguration#branch}
    */
    readonly branch: string;
    /**
    * The source provider repository path of the sync configuration file of the respective SyncType.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#config_file CcSyncConfiguration#config_file}
    */
    readonly configFile: string;
    /**
    * Whether to enable or disable publishing of deployment status to source providers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#publish_deployment_status CcSyncConfiguration#publish_deployment_status}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#repository_link_id CcSyncConfiguration#repository_link_id}
    */
    readonly repositoryLinkId: string;
    /**
    * The name of the resource that is being synchronized to the repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#resource_name CcSyncConfiguration#resource_name}
    */
    readonly resourceName: string;
    /**
    * The IAM Role that allows AWS to update CloudFormation stacks based on content in the specified repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#role_arn CcSyncConfiguration#role_arn}
    */
    readonly roleArn: string;
    /**
    * The type of resource synchronization service that is to be configured, for example, CFN_STACK_SYNC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#sync_type CcSyncConfiguration#sync_type}
    */
    readonly syncType: string;
    /**
    * When to trigger Git sync to begin the stack update.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#trigger_resource_update_on CcSyncConfiguration#trigger_resource_update_on}
    */
...
export class CcSyncConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSyncConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/codestarconnections_sync_configuration#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSyncConfigurationProps
    */
    public constructor(scope: Construct, id: string, config: CcSyncConfigurationProps) {
        super(scope, id, {
...
export namespace CcSyncConfiguration {
}
