...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group
...
export interface CcGroupProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#filter_expression CcGroup#filter_expression}
    */
    readonly filterExpression?: string;
    /**
    * The case-sensitive name of the new group. Names must be unique.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#group_name CcGroup#group_name}
    */
    readonly groupName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#insights_configuration CcGroup#insights_configuration}
    */
    readonly insightsConfiguration?: CcGroup.InsightsConfigurationProperty;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#tags CcGroup#tags}
    */
    readonly tags?: CcGroup.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group awscc_xray_group}
*/
export class CcGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group awscc_xray_group} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _insightsConfiguration = new CcGroup.InsightsConfigurationPropertyOutputReference(this, "insights_configuration");
    public get insightsConfiguration() {
        return this._insightsConfiguration;
    }
    public putInsightsConfiguration(value: CcGroup.InsightsConfigurationProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            insights_configuration: ccGroupInsightsConfigurationPropertyToTerraform(this._insightsConfiguration.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            insights_configuration: {
                value: ccGroupInsightsConfigurationPropertyToHclTerraform(this._insightsConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcGroup.InsightsConfigurationProperty",
            },
            tags: {
...
export function ccGroupInsightsConfigurationPropertyToTerraform(struct?: CcGroup.InsightsConfigurationProperty | cdktn.IResolvable): any {
...
export function ccGroupInsightsConfigurationPropertyToHclTerraform(struct?: CcGroup.InsightsConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface InsightsConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#insights_enabled CcGroup#insights_enabled}
    */
    readonly insightsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Set the NotificationsEnabled value to true to enable insights notifications. Notifications can only be enabled on a group with InsightsEnabled set to true.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#notifications_enabled CcGroup#notifications_enabled}
    */
...
export class InsightsConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): InsightsConfigurationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: InsightsConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#key CcGroup#key}
    */
    readonly key?: string;
    /**
    * The value for the tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/xray_group#value CcGroup#value}
    */
