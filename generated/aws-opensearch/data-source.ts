...
export interface CcDataSourceProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#data_source_type CcDataSource#data_source_type}
    */
    readonly dataSourceType: CcDataSource.DataSourceTypeProperty;
    /**
    * A description of the data source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#description CcDataSource#description}
    */
    readonly description?: string;
    /**
    * The name of the OpenSearch Service domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#domain_name CcDataSource#domain_name}
    */
    readonly domainName: string;
    /**
    * The name of the data source.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#name CcDataSource#name}
    */
...
export class CcDataSource extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#import import section} in the documentation of this resource for the id to use
...
export interface S3GlueDataCatalogProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#role_arn CcDataSource#role_arn}
    */
...
export interface DataSourceTypeProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/opensearch_data_source#s3_glue_data_catalog CcDataSource#s3_glue_data_catalog}
    */
