...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/route53_dnssec
...
export interface CcDNSSECProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/route53_dnssec#hosted_zone_id CcDNSSEC#hosted_zone_id}
    */
    readonly hostedZoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/route53_dnssec awscc_route53_dnssec}
*/
export class CcDNSSEC extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDNSSEC that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/route53_dnssec#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/route53_dnssec awscc_route53_dnssec} Resource
    *
    * @param scope The scope in which to define this construct
