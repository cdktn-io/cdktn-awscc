...
export interface CcDNSSECProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53_dnssec#hosted_zone_id CcDNSSEC#hosted_zone_id}
    */
...
export class CcDNSSEC extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDNSSEC that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53_dnssec#import import section} in the documentation of this resource for the id to use
