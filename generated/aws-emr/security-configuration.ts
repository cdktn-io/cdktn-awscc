...
export interface CcSecurityConfigurationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_security_configuration#name CcSecurityConfiguration#name}
    */
    readonly name?: string;
    /**
    * The security configuration details in JSON format.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_security_configuration#security_configuration CcSecurityConfiguration#security_configuration}
    */
...
export class CcSecurityConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSecurityConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_security_configuration#import import section} in the documentation of this resource for the id to use
