...
export interface CcStepProps extends cdktn.TerraformMetaArguments {
    /**
    * This specifies what action to take when the cluster step fails. Possible values are CANCEL_AND_WAIT and CONTINUE.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#action_on_failure CcStep#action_on_failure}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#encryption_key_arn CcStep#encryption_key_arn}
    */
    readonly encryptionKeyArn?: string;
    /**
    * The HadoopJarStepConfig property type specifies a job flow step consisting of a JAR file whose main function will be executed. The main function submits a job for the cluster to execute as a step on the master node, and then waits for the job to finish or fail before executing subsequent steps.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#hadoop_jar_step CcStep#hadoop_jar_step}
    */
    readonly hadoopJarStep: CcStep.HadoopJarStepConfigProperty;
    /**
    * A string that uniquely identifies the cluster (job flow).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#job_flow_id CcStep#job_flow_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#log_uri CcStep#log_uri}
    */
    readonly logUri?: string;
    /**
    * The name of the cluster step.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#name CcStep#name}
    */
...
export class CcStep extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcStepProps
    */
    public constructor(scope: Construct, id: string, config: CcStepProps) {
        super(scope, id, {
    ...
    private _hadoopJarStep = new CcStep.HadoopJarStepConfigPropertyOutputReference(this, "hadoop_jar_step");
    public get hadoopJarStep() {
        return this._hadoopJarStep;
    }
    public putHadoopJarStep(value: CcStep.HadoopJarStepConfigProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            hadoop_jar_step: ccStepHadoopJarStepConfigPropertyToTerraform(this._hadoopJarStep.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            hadoop_jar_step: {
                value: ccStepHadoopJarStepConfigPropertyToHclTerraform(this._hadoopJarStep.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcStep.HadoopJarStepConfigProperty",
            },
            job_flow_id: {
...
export function ccStepKeyValuePropertyToTerraform(struct?: CcStep.KeyValueProperty | cdktn.IResolvable): any {
...
export function ccStepKeyValuePropertyToHclTerraform(struct?: CcStep.KeyValueProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStepHadoopJarStepConfigPropertyToTerraform(struct?: CcStep.HadoopJarStepConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        step_properties: cdktn.listMapper(ccStepKeyValuePropertyToTerraform, false)(struct!.stepProperties),
    }
}


export function ccStepHadoopJarStepConfigPropertyToHclTerraform(struct?: CcStep.HadoopJarStepConfigProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        step_properties: {
            value: cdktn.listMapperHcl(ccStepKeyValuePropertyToHclTerraform, false)(struct!.stepProperties),
            isBlock: true,
            type: "list",
...
export interface KeyValueProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#key CcStep#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#value CcStep#value}
    */
...
export interface HadoopJarStepConfigProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#args CcStep#args}
    */
    readonly args?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#jar CcStep#jar}
    */
    readonly jar: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#main_class CcStep#main_class}
    */
    readonly mainClass?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_step#step_properties CcStep#step_properties}
    */
    readonly stepProperties?: KeyValueProperty[] | cdktn.IResolvable;
}
export class HadoopJarStepConfigPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): HadoopJarStepConfigProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: HadoopJarStepConfigProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
    ...
    private _stepProperties = new KeyValuePropertyList(this, "step_properties", false);
    public get stepProperties() {
        return this._stepProperties;
    }
    public putStepProperties(value: KeyValueProperty[] | cdktn.IResolvable) {
