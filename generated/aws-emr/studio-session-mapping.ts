...
export interface CcStudioSessionMappingProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_studio_session_mapping#identity_name CcStudioSessionMapping#identity_name}
    */
    readonly identityName: string;
    /**
    * Specifies whether the identity to map to the Studio is a user or a group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_studio_session_mapping#identity_type CcStudioSessionMapping#identity_type}
    */
    readonly identityType: string;
    /**
    * The Amazon Resource Name (ARN) for the session policy that will be applied to the user or group. Session policies refine Studio user permissions without the need to use multiple IAM user roles.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_studio_session_mapping#session_policy_arn CcStudioSessionMapping#session_policy_arn}
    */
    readonly sessionPolicyArn: string;
    /**
    * The ID of the Amazon EMR Studio to which the user or group will be mapped.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_studio_session_mapping#studio_id CcStudioSessionMapping#studio_id}
    */
...
export class CcStudioSessionMapping extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStudioSessionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
