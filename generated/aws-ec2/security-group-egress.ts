...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcSecurityGroupEgressProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#cidr_ip CcSecurityGroupEgress#cidr_ip}
    */
    ...
    *  For examples of rules that you can add to security groups for specific access scenarios, see [Security group rules for different use cases](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/security-group-rules-reference.html) in the *User Guide*.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#cidr_ipv_6 CcSecurityGroupEgress#cidr_ipv_6}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#description CcSecurityGroupEgress#description}
    */
    ...
    *  You must specify exactly one of the following: ``CidrIp``, ``CidrIpv6``, ``DestinationPrefixListId``, or ``DestinationSecurityGroupId``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#destination_prefix_list_id CcSecurityGroupEgress#destination_prefix_list_id}
    */
    ...
    *  You must specify exactly one of the following: ``CidrIp``, ``CidrIpv6``, ``DestinationPrefixListId``, or ``DestinationSecurityGroupId``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#destination_security_group_id CcSecurityGroupEgress#destination_security_group_id}
    */
    readonly destinationSecurityGroupId?: string;
    /**
    * If the protocol is TCP or UDP, this is the start of the port range. If the protocol is ICMP or ICMPv6, this is the ICMP type or -1 (all ICMP types).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#from_port CcSecurityGroupEgress#from_port}
    */
    readonly fromPort?: number;
    /**
    * The ID of the security group. You must specify either the security group ID or the security group name in the request. For security groups in a nondefault VPC, you must specify the security group ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#group_id CcSecurityGroupEgress#group_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#ip_protocol CcSecurityGroupEgress#ip_protocol}
    */
    readonly ipProtocol: string;
    /**
    * If the protocol is TCP or UDP, this is the end of the port range. If the protocol is ICMP or ICMPv6, this is the ICMP code or -1 (all ICMP codes). If the start port is -1 (all ICMP types), then the end port must be -1 (all ICMP codes).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#to_port CcSecurityGroupEgress#to_port}
    */
...
export class CcSecurityGroupEgress extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSecurityGroupEgress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group_egress#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSecurityGroupEgressProps
    */
    public constructor(scope: Construct, id: string, config: CcSecurityGroupEgressProps) {
        super(scope, id, {
...
export namespace CcSecurityGroupEgress {
}
