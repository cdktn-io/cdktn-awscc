...
export interface CcVPCEndpointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#dns_options CcVPCEndpoint#dns_options}
    */
    readonly dnsOptions?: CcVPCEndpoint.DnsOptionsSpecificationProperty;
    /**
    * The supported IP address types.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#ip_address_type CcVPCEndpoint#ip_address_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#policy_document CcVPCEndpoint#policy_document}
    */
    ...
    *  Default: ``false``
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#private_dns_enabled CcVPCEndpoint#private_dns_enabled}
    */
    readonly privateDnsEnabled?: boolean | cdktn.IResolvable;
    /**
    * The Amazon Resource Name (ARN) of the resource configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#resource_configuration_arn CcVPCEndpoint#resource_configuration_arn}
    */
    readonly resourceConfigurationArn?: string;
    /**
    * The IDs of the route tables. Routing is supported only for gateway endpoints.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#route_table_ids CcVPCEndpoint#route_table_ids}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#security_group_ids CcVPCEndpoint#security_group_ids}
    */
    readonly securityGroupIds?: string[];
    /**
    * The name of the endpoint service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#service_name CcVPCEndpoint#service_name}
    */
    readonly serviceName?: string;
    /**
    * The Amazon Resource Name (ARN) of the service network.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#service_network_arn CcVPCEndpoint#service_network_arn}
    */
    readonly serviceNetworkArn?: string;
    /**
    * Describes a Region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#service_region CcVPCEndpoint#service_region}
    */
    readonly serviceRegion?: string;
    /**
    * The IDs of the subnets in which to create endpoint network interfaces. You must specify this property for an interface endpoint or a Gateway Load Balancer endpoint. You can't specify this property for a gateway endpoint. For a Gateway Load Balancer endpoint, you can specify only one subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#subnet_ids CcVPCEndpoint#subnet_ids}
    */
    readonly subnetIds?: string[];
    /**
    * The tags to associate with the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#tags CcVPCEndpoint#tags}
    */
    ...
    *  Default: Gateway
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#vpc_endpoint_type CcVPCEndpoint#vpc_endpoint_type}
    */
    readonly vpcEndpointType?: string;
    /**
    * The ID of the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#vpc_id CcVPCEndpoint#vpc_id}
    */
...
export class CcVPCEndpoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _dnsOptions = new CcVPCEndpoint.DnsOptionsSpecificationPropertyOutputReference(this, "dns_options");
    public get dnsOptions() {
        return this._dnsOptions;
    }
    public putDnsOptions(value: CcVPCEndpoint.DnsOptionsSpecificationProperty) {
    ...
    private _tags = new CcVPCEndpoint.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcVPCEndpoint.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            dns_options: ccVPCEndpointDnsOptionsSpecificationPropertyToTerraform(this._dnsOptions.internalValue),
            ...
            tags: cdktn.listMapper(ccVPCEndpointTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            dns_options: {
                value: ccVPCEndpointDnsOptionsSpecificationPropertyToHclTerraform(this._dnsOptions.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcVPCEndpoint.DnsOptionsSpecificationProperty",
            },
            ip_address_type: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccVPCEndpointTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcVPCEndpoint.TagPropertyList",
            },
            vpc_endpoint_type: {
...
export function ccVPCEndpointDnsOptionsSpecificationPropertyToTerraform(struct?: CcVPCEndpoint.DnsOptionsSpecificationProperty | cdktn.IResolvable): any {
...
export function ccVPCEndpointDnsOptionsSpecificationPropertyToHclTerraform(struct?: CcVPCEndpoint.DnsOptionsSpecificationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccVPCEndpointTagPropertyToTerraform(struct?: CcVPCEndpoint.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccVPCEndpointTagPropertyToHclTerraform(struct?: CcVPCEndpoint.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface DnsOptionsSpecificationProperty {
    /**
    * The DNS records created for the endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#dns_record_ip_type CcVPCEndpoint#dns_record_ip_type}
    */
    readonly dnsRecordIpType?: string;
    /**
    * Indicates whether to enable private DNS only for inbound endpoints. This option is available only for services that support both gateway and interface endpoints. It routes traffic that originates from the VPC to the gateway endpoint and traffic that originates from on-premises to the interface endpoint.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#private_dns_only_for_inbound_resolver_endpoint CcVPCEndpoint#private_dns_only_for_inbound_resolver_endpoint}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#private_dns_preference CcVPCEndpoint#private_dns_preference}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#private_dns_specified_domains CcVPCEndpoint#private_dns_specified_domains}
    */
    readonly privateDnsSpecifiedDomains?: string[];
}
export class DnsOptionsSpecificationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): DnsOptionsSpecificationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: DnsOptionsSpecificationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#key CcVPCEndpoint#key}
    */
    readonly key?: string;
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_endpoint#value CcVPCEndpoint#value}
    */
