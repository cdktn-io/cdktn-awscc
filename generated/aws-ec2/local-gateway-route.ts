...
export interface CcLocalGatewayRouteProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_route#destination_cidr_block CcLocalGatewayRoute#destination_cidr_block}
    */
    readonly destinationCidrBlock?: string;
    /**
    * The ID of the local gateway route table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_route#local_gateway_route_table_id CcLocalGatewayRoute#local_gateway_route_table_id}
    */
    readonly localGatewayRouteTableId?: string;
    /**
    * The ID of the virtual interface group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_route#local_gateway_virtual_interface_group_id CcLocalGatewayRoute#local_gateway_virtual_interface_group_id}
    */
    readonly localGatewayVirtualInterfaceGroupId?: string;
    /**
    * The ID of the network interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_route#network_interface_id CcLocalGatewayRoute#network_interface_id}
    */
...
export class CcLocalGatewayRoute extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLocalGatewayRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_route#import import section} in the documentation of this resource for the id to use
