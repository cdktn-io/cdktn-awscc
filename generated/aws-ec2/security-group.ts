...
export interface CcSecurityGroupProps extends cdktn.TerraformMetaArguments {
    /**
    * A description for the security group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#group_description CcSecurityGroup#group_description}
    */
    readonly groupDescription: string;
    /**
    * The name of the security group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#group_name CcSecurityGroup#group_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#security_group_egress CcSecurityGroup#security_group_egress}
    */
    readonly securityGroupEgress?: CcSecurityGroup.EgressProperty[] | cdktn.IResolvable;
    /**
    * The inbound rules associated with the security group. There is a short interruption during which you cannot connect to the security group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#security_group_ingress CcSecurityGroup#security_group_ingress}
    */
    readonly securityGroupIngress?: CcSecurityGroup.IngressProperty[] | cdktn.IResolvable;
    /**
    * Any tags assigned to the security group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#tags CcSecurityGroup#tags}
    */
    readonly tags?: CcSecurityGroup.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of the VPC for the security group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#vpc_id CcSecurityGroup#vpc_id}
    */
...
export class CcSecurityGroup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSecurityGroupProps
    */
    public constructor(scope: Construct, id: string, config: CcSecurityGroupProps) {
        super(scope, id, {
    ...
    private _securityGroupEgress = new CcSecurityGroup.EgressPropertyList(this, "security_group_egress", false);
    public get securityGroupEgress() {
        return this._securityGroupEgress;
    }
    public putSecurityGroupEgress(value: CcSecurityGroup.EgressProperty[] | cdktn.IResolvable) {
    ...
    private _securityGroupIngress = new CcSecurityGroup.IngressPropertyList(this, "security_group_ingress", false);
    public get securityGroupIngress() {
        return this._securityGroupIngress;
    }
    public putSecurityGroupIngress(value: CcSecurityGroup.IngressProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcSecurityGroup.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcSecurityGroup.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            security_group_egress: cdktn.listMapper(ccSecurityGroupEgressPropertyToTerraform, false)(this._securityGroupEgress.internalValue),
            security_group_ingress: cdktn.listMapper(ccSecurityGroupIngressPropertyToTerraform, false)(this._securityGroupIngress.internalValue),
            tags: cdktn.listMapper(ccSecurityGroupTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            security_group_egress: {
                value: cdktn.listMapperHcl(ccSecurityGroupEgressPropertyToHclTerraform, false)(this._securityGroupEgress.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSecurityGroup.EgressPropertyList",
            },
            security_group_ingress: {
                value: cdktn.listMapperHcl(ccSecurityGroupIngressPropertyToHclTerraform, false)(this._securityGroupIngress.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSecurityGroup.IngressPropertyList",
            },
            tags: {
                value: cdktn.listMapperHcl(ccSecurityGroupTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSecurityGroup.TagPropertyList",
            },
            vpc_id: {
...
export function ccSecurityGroupEgressPropertyToTerraform(struct?: CcSecurityGroup.EgressProperty | cdktn.IResolvable): any {
...
export function ccSecurityGroupEgressPropertyToHclTerraform(struct?: CcSecurityGroup.EgressProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSecurityGroupIngressPropertyToTerraform(struct?: CcSecurityGroup.IngressProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSecurityGroupIngressPropertyToHclTerraform(struct?: CcSecurityGroup.IngressProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSecurityGroupTagPropertyToTerraform(struct?: CcSecurityGroup.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSecurityGroupTagPropertyToHclTerraform(struct?: CcSecurityGroup.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface EgressProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#cidr_ip CcSecurityGroup#cidr_ip}
    */
    readonly cidrIp?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#cidr_ipv_6 CcSecurityGroup#cidr_ipv_6}
    */
    readonly cidrIpv6?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#description CcSecurityGroup#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#destination_prefix_list_id CcSecurityGroup#destination_prefix_list_id}
    */
    readonly destinationPrefixListId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#destination_security_group_id CcSecurityGroup#destination_security_group_id}
    */
    readonly destinationSecurityGroupId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#from_port CcSecurityGroup#from_port}
    */
    readonly fromPort?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#ip_protocol CcSecurityGroup#ip_protocol}
    */
    readonly ipProtocol?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#to_port CcSecurityGroup#to_port}
    */
...
export interface IngressProperty {
    ...
    */
    readonly ipProtocol?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#source_prefix_list_id CcSecurityGroup#source_prefix_list_id}
    */
    readonly sourcePrefixListId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#source_security_group_id CcSecurityGroup#source_security_group_id}
    */
    readonly sourceSecurityGroupId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#source_security_group_name CcSecurityGroup#source_security_group_name}
    */
    readonly sourceSecurityGroupName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#source_security_group_owner_id CcSecurityGroup#source_security_group_owner_id}
    */
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#key CcSecurityGroup#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_security_group#value CcSecurityGroup#value}
    */
