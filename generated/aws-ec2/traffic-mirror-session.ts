...
export interface CcTrafficMirrorSessionProps extends cdktn.TerraformMetaArguments {
    /**
    * The description of the Traffic Mirror session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#description CcTrafficMirrorSession#description}
    */
    readonly description?: string;
    /**
    * The ID of the source network interface.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#network_interface_id CcTrafficMirrorSession#network_interface_id}
    */
    readonly networkInterfaceId: string;
    /**
    * The ID of the account that owns the Traffic Mirror session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#owner_id CcTrafficMirrorSession#owner_id}
    */
    readonly ownerId?: string;
    /**
    * The number of bytes in each packet to mirror.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#packet_length CcTrafficMirrorSession#packet_length}
    */
    readonly packetLength?: number;
    /**
    * The session number determines the order in which sessions are evaluated when an interface is used by multiple sessions. The first session with a matching filter is the one that mirrors the packets.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#session_number CcTrafficMirrorSession#session_number}
    */
    readonly sessionNumber: number;
    /**
    * The tags assigned to the Traffic Mirror session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#tags CcTrafficMirrorSession#tags}
    */
    readonly tags?: CcTrafficMirrorSession.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of a Traffic Mirror filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#traffic_mirror_filter_id CcTrafficMirrorSession#traffic_mirror_filter_id}
    */
    readonly trafficMirrorFilterId: string;
    /**
    * The ID of a Traffic Mirror target.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#traffic_mirror_target_id CcTrafficMirrorSession#traffic_mirror_target_id}
    */
    readonly trafficMirrorTargetId: string;
    /**
    * The VXLAN ID for the Traffic Mirror session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#virtual_network_id CcTrafficMirrorSession#virtual_network_id}
    */
...
export class CcTrafficMirrorSession extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTrafficMirrorSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcTrafficMirrorSessionProps
    */
    public constructor(scope: Construct, id: string, config: CcTrafficMirrorSessionProps) {
        super(scope, id, {
    ...
    private _tags = new CcTrafficMirrorSession.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcTrafficMirrorSession.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccTrafficMirrorSessionTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccTrafficMirrorSessionTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcTrafficMirrorSession.TagPropertyList",
            },
...
export function ccTrafficMirrorSessionTagPropertyToTerraform(struct?: CcTrafficMirrorSession.TagProperty | cdktn.IResolvable): any {
...
export function ccTrafficMirrorSessionTagPropertyToHclTerraform(struct?: CcTrafficMirrorSession.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#key CcTrafficMirrorSession#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_traffic_mirror_session#value CcTrafficMirrorSession#value}
    */
