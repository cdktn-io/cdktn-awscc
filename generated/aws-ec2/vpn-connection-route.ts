...
export interface CcVPNConnectionRouteProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpn_connection_route#destination_cidr_block CcVPNConnectionRoute#destination_cidr_block}
    */
    readonly destinationCidrBlock: string;
    /**
    * The ID of the VPN connection.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpn_connection_route#vpn_connection_id CcVPNConnectionRoute#vpn_connection_id}
    */
...
export class CcVPNConnectionRoute extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPNConnectionRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpn_connection_route#import import section} in the documentation of this resource for the id to use
