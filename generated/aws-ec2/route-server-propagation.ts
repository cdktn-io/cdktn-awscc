...
export interface CcRouteServerPropagationProps extends cdktn.TerraformMetaArguments {
    ...
    * Route Server ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ec2_route_server_propagation#route_server_id CcRouteServerPropagation#route_server_id}
    */
    readonly routeServerId: string;
    /**
    * Route Table ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ec2_route_server_propagation#route_table_id CcRouteServerPropagation#route_table_id}
    */
...
export class CcRouteServerPropagation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRouteServerPropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/ec2_route_server_propagation#import import section} in the documentation of this resource for the id to use
