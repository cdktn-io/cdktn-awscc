...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcSubnetProps extends cdktn.TerraformMetaArguments {
    /**
    * Indicates whether a network interface created in this subnet receives an IPv6 address. The default value is ``false``.
    *  If you specify ``AssignIpv6AddressOnCreation``, you must also specify an IPv6 CIDR block.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#assign_ipv_6_address_on_creation CcSubnet#assign_ipv_6_address_on_creation}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#availability_zone CcSubnet#availability_zone}
    */
    readonly availabilityZone?: string;
    /**
    * The AZ ID of the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#availability_zone_id CcSubnet#availability_zone_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#cidr_block CcSubnet#cidr_block}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#enable_dns_64 CcSubnet#enable_dns_64}
    */
    readonly enableDns64?: boolean | cdktn.IResolvable;
    /**
    * Indicates the device position for local network interfaces in this subnet. For example, ``1`` indicates local network interfaces in this subnet are the secondary network interface (eth1).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#enable_lni_at_device_index CcSubnet#enable_lni_at_device_index}
    */
    readonly enableLniAtDeviceIndex?: number;
    /**
    * An IPv4 IPAM pool ID for the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_4_ipam_pool_id CcSubnet#ipv_4_ipam_pool_id}
    */
    readonly ipv4IpamPoolId?: string;
    /**
    * An IPv4 netmask length for the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_4_netmask_length CcSubnet#ipv_4_netmask_length}
    */
    ...
    *  If you specify ``AssignIpv6AddressOnCreation``, you must also specify an IPv6 CIDR block.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_6_cidr_block CcSubnet#ipv_6_cidr_block}
    */
    readonly ipv6CidrBlock?: string;
    /**
    * An IPv6 IPAM pool ID for the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_6_ipam_pool_id CcSubnet#ipv_6_ipam_pool_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_6_native CcSubnet#ipv_6_native}
    */
    readonly ipv6Native?: boolean | cdktn.IResolvable;
    /**
    * An IPv6 netmask length for the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#ipv_6_netmask_length CcSubnet#ipv_6_netmask_length}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#map_public_ip_on_launch CcSubnet#map_public_ip_on_launch}
    */
    readonly mapPublicIpOnLaunch?: boolean | cdktn.IResolvable;
    /**
    * The Amazon Resource Name (ARN) of the Outpost.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#outpost_arn CcSubnet#outpost_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#private_dns_name_options_on_launch CcSubnet#private_dns_name_options_on_launch}
    */
    readonly privateDnsNameOptionsOnLaunch?: CcSubnet.PrivateDnsNameOptionsOnLaunchProperty;
    /**
    * Any tags assigned to the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#tags CcSubnet#tags}
    */
    ...
    *  If you update this property, you must also update the ``CidrBlock`` property.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#vpc_id CcSubnet#vpc_id}
    */
...
export class CcSubnet extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSubnetProps
    */
    public constructor(scope: Construct, id: string, config: CcSubnetProps) {
        super(scope, id, {
    ...
    private _blockPublicAccessStates = new CcSubnet.BlockPublicAccessStatesPropertyOutputReference(this, "block_public_access_states");
    ...
    private _privateDnsNameOptionsOnLaunch = new CcSubnet.PrivateDnsNameOptionsOnLaunchPropertyOutputReference(this, "private_dns_name_options_on_launch");
    public get privateDnsNameOptionsOnLaunch() {
        return this._privateDnsNameOptionsOnLaunch;
    }
    public putPrivateDnsNameOptionsOnLaunch(value: CcSubnet.PrivateDnsNameOptionsOnLaunchProperty) {
    ...
    private _tags = new CcSubnet.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcSubnet.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            private_dns_name_options_on_launch: ccSubnetPrivateDnsNameOptionsOnLaunchPropertyToTerraform(this._privateDnsNameOptionsOnLaunch.internalValue),
            tags: cdktn.listMapper(ccSubnetTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            private_dns_name_options_on_launch: {
                value: ccSubnetPrivateDnsNameOptionsOnLaunchPropertyToHclTerraform(this._privateDnsNameOptionsOnLaunch.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcSubnet.PrivateDnsNameOptionsOnLaunchProperty",
            },
            tags: {
                value: cdktn.listMapperHcl(ccSubnetTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcSubnet.TagPropertyList",
            },
            vpc_id: {
...
export function ccSubnetBlockPublicAccessStatesPropertyToTerraform(struct?: CcSubnet.BlockPublicAccessStatesProperty): any {
...
export function ccSubnetBlockPublicAccessStatesPropertyToHclTerraform(struct?: CcSubnet.BlockPublicAccessStatesProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSubnetPrivateDnsNameOptionsOnLaunchPropertyToTerraform(struct?: CcSubnet.PrivateDnsNameOptionsOnLaunchProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSubnetPrivateDnsNameOptionsOnLaunchPropertyToHclTerraform(struct?: CcSubnet.PrivateDnsNameOptionsOnLaunchProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSubnetTagPropertyToTerraform(struct?: CcSubnet.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccSubnetTagPropertyToHclTerraform(struct?: CcSubnet.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcSubnet {
export interface BlockPublicAccessStatesProperty {
}
export class BlockPublicAccessStatesPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): BlockPublicAccessStatesProperty | undefined {
        let hasAnyValues = this.isEmptyObject;
        const internalValueResult: any = {};
        return hasAnyValues ? internalValueResult : undefined;
    }

    public set internalValue(value: BlockPublicAccessStatesProperty | undefined) {
        if (value === undefined) {
...
export interface PrivateDnsNameOptionsOnLaunchProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#enable_resource_name_dns_a_record CcSubnet#enable_resource_name_dns_a_record}
    */
    readonly enableResourceNameDnsARecord?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#enable_resource_name_dns_aaaa_record CcSubnet#enable_resource_name_dns_aaaa_record}
    */
    readonly enableResourceNameDnsAaaaRecord?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#hostname_type CcSubnet#hostname_type}
    */
    readonly hostnameType?: string;
}
export class PrivateDnsNameOptionsOnLaunchPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    ...
    */
    ...
    public get internalValue(): PrivateDnsNameOptionsOnLaunchProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: PrivateDnsNameOptionsOnLaunchProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
...
export interface TagProperty {
    ...
    * The tag key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#key CcSubnet#key}
    */
    readonly key?: string;
    /**
    * The tag value.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_subnet#value CcSubnet#value}
    */
