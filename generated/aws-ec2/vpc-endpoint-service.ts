...
export interface CcVPCEndpointServiceProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#acceptance_required CcVPCEndpointService#acceptance_required}
    */
    readonly acceptanceRequired?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#contributor_insights_enabled CcVPCEndpointService#contributor_insights_enabled}
    */
    readonly contributorInsightsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#gateway_load_balancer_arns CcVPCEndpointService#gateway_load_balancer_arns}
    */
    readonly gatewayLoadBalancerArns?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#network_load_balancer_arns CcVPCEndpointService#network_load_balancer_arns}
    */
    readonly networkLoadBalancerArns?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#payer_responsibility CcVPCEndpointService#payer_responsibility}
    */
    readonly payerResponsibility?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#private_dns_name CcVPCEndpointService#private_dns_name}
    */
    readonly privateDnsName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#private_dns_name_configuration CcVPCEndpointService#private_dns_name_configuration}
    */
    readonly privateDnsNameConfiguration?: CcVPCEndpointService.PrivateDnsNameConfigurationProperty;
    /**
    * Specify which Ip Address types are supported for VPC endpoint service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#supported_ip_address_types CcVPCEndpointService#supported_ip_address_types}
    */
    readonly supportedIpAddressTypes?: string[];
    /**
    * The Regions from which service consumers can access the service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#supported_regions CcVPCEndpointService#supported_regions}
    */
    readonly supportedRegions?: string[];
    /**
    * The tags to add to the VPC endpoint service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#tags CcVPCEndpointService#tags}
    */
    readonly tags?: CcVPCEndpointService.TagProperty[] | cdktn.IResolvable;
}
...
*/
export class CcVPCEndpointService extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcVPCEndpointService resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcVPCEndpointService to import
    * @param importFromId The id of the existing CcVPCEndpointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcVPCEndpointService to import is found
    */
    ...
    * @param options CcVPCEndpointServiceProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcVPCEndpointServiceProps = {}) {
        super(scope, id, {
    ...
    private _privateDnsNameConfiguration = new CcVPCEndpointService.PrivateDnsNameConfigurationPropertyOutputReference(this, "private_dns_name_configuration");
    public get privateDnsNameConfiguration() {
        return this._privateDnsNameConfiguration;
    }
    public putPrivateDnsNameConfiguration(value: CcVPCEndpointService.PrivateDnsNameConfigurationProperty) {
    ...
    private _tags = new CcVPCEndpointService.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcVPCEndpointService.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            private_dns_name_configuration: ccVPCEndpointServicePrivateDnsNameConfigurationPropertyToTerraform(this._privateDnsNameConfiguration.internalValue),
            ...
            tags: cdktn.listMapper(ccVPCEndpointServiceTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            private_dns_name_configuration: {
                value: ccVPCEndpointServicePrivateDnsNameConfigurationPropertyToHclTerraform(this._privateDnsNameConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcVPCEndpointService.PrivateDnsNameConfigurationProperty",
            },
            ...
            tags: {
                value: cdktn.listMapperHcl(ccVPCEndpointServiceTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcVPCEndpointService.TagPropertyList",
            },
        };
...
export function ccVPCEndpointServicePrivateDnsNameConfigurationPropertyToTerraform(struct?: CcVPCEndpointService.PrivateDnsNameConfigurationProperty | cdktn.IResolvable): any {
...
export function ccVPCEndpointServicePrivateDnsNameConfigurationPropertyToHclTerraform(struct?: CcVPCEndpointService.PrivateDnsNameConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccVPCEndpointServiceTagPropertyToTerraform(struct?: CcVPCEndpointService.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccVPCEndpointServiceTagPropertyToHclTerraform(struct?: CcVPCEndpointService.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcVPCEndpointService {
...
export class PrivateDnsNameConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): PrivateDnsNameConfigurationProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: PrivateDnsNameConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#key CcVPCEndpointService#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_endpoint_service#value CcVPCEndpointService#value}
    */
