...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcVPCEndpointServiceProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#acceptance_required CcVPCEndpointService#acceptance_required}
    */
    readonly acceptanceRequired?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#contributor_insights_enabled CcVPCEndpointService#contributor_insights_enabled}
    */
    readonly contributorInsightsEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#gateway_load_balancer_arns CcVPCEndpointService#gateway_load_balancer_arns}
    */
    readonly gatewayLoadBalancerArns?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#network_load_balancer_arns CcVPCEndpointService#network_load_balancer_arns}
    */
    readonly networkLoadBalancerArns?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#payer_responsibility CcVPCEndpointService#payer_responsibility}
    */
    readonly payerResponsibility?: string;
    /**
    * Specify which Ip Address types are supported for VPC endpoint service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#supported_ip_address_types CcVPCEndpointService#supported_ip_address_types}
    */
    readonly supportedIpAddressTypes?: string[];
    /**
    * The Regions from which service consumers can access the service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#supported_regions CcVPCEndpointService#supported_regions}
    */
    readonly supportedRegions?: string[];
    /**
    * The tags to add to the VPC endpoint service.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#tags CcVPCEndpointService#tags}
    */
    readonly tags?: CcVPCEndpointService.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service awscc_ec2_vpc_endpoint_service}
*/
export class CcVPCEndpointService extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCEndpointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service awscc_ec2_vpc_endpoint_service} Resource
    *
    * @param scope The scope in which to define this construct
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#key CcVPCEndpointService#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_vpc_endpoint_service#value CcVPCEndpointService#value}
    */
