...
export interface CcTransitGatewayMulticastGroupMemberProps extends cdktn.TerraformMetaArguments {
    /**
    * The IP address assigned to the transit gateway multicast group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_multicast_group_member#group_ip_address CcTransitGatewayMulticastGroupMember#group_ip_address}
    */
    readonly groupIpAddress: string;
    /**
    * The ID of the transit gateway attachment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_multicast_group_member#network_interface_id CcTransitGatewayMulticastGroupMember#network_interface_id}
    */
    readonly networkInterfaceId: string;
    /**
    * The ID of the transit gateway multicast domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_multicast_group_member#transit_gateway_multicast_domain_id CcTransitGatewayMulticastGroupMember#transit_gateway_multicast_domain_id}
    */
...
export class CcTransitGatewayMulticastGroupMember extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTransitGatewayMulticastGroupMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_multicast_group_member#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcTransitGatewayMulticastGroupMemberProps
    */
    public constructor(scope: Construct, id: string, config: CcTransitGatewayMulticastGroupMemberProps) {
        super(scope, id, {
...
export namespace CcTransitGatewayMulticastGroupMember {
}
