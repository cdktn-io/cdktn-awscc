...
export interface CcRouteServerAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    * Route Server ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_route_server_association#route_server_id CcRouteServerAssociation#route_server_id}
    */
    readonly routeServerId: string;
    /**
    * VPC ID
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_route_server_association#vpc_id CcRouteServerAssociation#vpc_id}
    */
...
export class CcRouteServerAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRouteServerAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_route_server_association#import import section} in the documentation of this resource for the id to use
