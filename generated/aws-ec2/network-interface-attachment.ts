...
export interface CcNetworkInterfaceAttachmentProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#delete_on_termination CcNetworkInterfaceAttachment#delete_on_termination}
    */
    readonly deleteOnTermination?: boolean | cdktn.IResolvable;
    /**
    * The network interface's position in the attachment order. For example, the first attached network interface has a ``DeviceIndex`` of 0.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#device_index CcNetworkInterfaceAttachment#device_index}
    */
    readonly deviceIndex: string;
    /**
    * The number of ENA queues created with the instance.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#ena_queue_count CcNetworkInterfaceAttachment#ena_queue_count}
    */
    readonly enaQueueCount?: number;
    /**
    * Configures ENA Express for the network interface that this action attaches to the instance.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#ena_srd_specification CcNetworkInterfaceAttachment#ena_srd_specification}
    */
    readonly enaSrdSpecification?: CcNetworkInterfaceAttachment.EnaSrdSpecificationProperty;
    /**
    * The ID of the instance to which you will attach the ENI.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#instance_id CcNetworkInterfaceAttachment#instance_id}
    */
    readonly instanceId: string;
    /**
    * The ID of the ENI that you want to attach.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#network_interface_id CcNetworkInterfaceAttachment#network_interface_id}
    */
...
export class CcNetworkInterfaceAttachment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcNetworkInterfaceAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#import import section} in the documentation of this resource for the id to use
...
export interface EnaSrdUdpSpecificationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#ena_srd_udp_enabled CcNetworkInterfaceAttachment#ena_srd_udp_enabled}
    */
...
export interface EnaSrdSpecificationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#ena_srd_enabled CcNetworkInterfaceAttachment#ena_srd_enabled}
    */
    readonly enaSrdEnabled?: boolean | cdktn.IResolvable;
    /**
    * Configures ENA Express for UDP network traffic.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_network_interface_attachment#ena_srd_udp_specification CcNetworkInterfaceAttachment#ena_srd_udp_specification}
    */
