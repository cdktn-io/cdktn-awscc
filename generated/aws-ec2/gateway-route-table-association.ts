...
export interface CcGatewayRouteTableAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_gateway_route_table_association#gateway_id CcGatewayRouteTableAssociation#gateway_id}
    */
    readonly gatewayId: string;
    /**
    * The ID of the route table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_gateway_route_table_association#route_table_id CcGatewayRouteTableAssociation#route_table_id}
    */
...
export class CcGatewayRouteTableAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGatewayRouteTableAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_gateway_route_table_association#import import section} in the documentation of this resource for the id to use
