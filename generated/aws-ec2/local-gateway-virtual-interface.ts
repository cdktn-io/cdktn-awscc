...
export interface CcLocalGatewayVirtualInterfaceProps extends cdktn.TerraformMetaArguments {
    /**
    * The local address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#local_address CcLocalGatewayVirtualInterface#local_address}
    */
    readonly localAddress: string;
    /**
    * The ID of the virtual interface group
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#local_gateway_virtual_interface_group_id CcLocalGatewayVirtualInterface#local_gateway_virtual_interface_group_id}
    */
    readonly localGatewayVirtualInterfaceGroupId: string;
    /**
    * The Outpost LAG ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#outpost_lag_id CcLocalGatewayVirtualInterface#outpost_lag_id}
    */
    readonly outpostLagId: string;
    /**
    * The peer address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#peer_address CcLocalGatewayVirtualInterface#peer_address}
    */
    readonly peerAddress: string;
    /**
    * The peer BGP ASN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#peer_bgp_asn CcLocalGatewayVirtualInterface#peer_bgp_asn}
    */
    readonly peerBgpAsn?: number;
    /**
    * The extended 32-bit ASN of the BGP peer for use with larger ASN values.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#peer_bgp_asn_extended CcLocalGatewayVirtualInterface#peer_bgp_asn_extended}
    */
    readonly peerBgpAsnExtended?: number;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#tags CcLocalGatewayVirtualInterface#tags}
    */
    readonly tags?: CcLocalGatewayVirtualInterface.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of the VLAN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#vlan CcLocalGatewayVirtualInterface#vlan}
    */
...
export class CcLocalGatewayVirtualInterface extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLocalGatewayVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcLocalGatewayVirtualInterfaceProps
    */
    public constructor(scope: Construct, id: string, config: CcLocalGatewayVirtualInterfaceProps) {
        super(scope, id, {
    ...
    private _tags = new CcLocalGatewayVirtualInterface.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcLocalGatewayVirtualInterface.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccLocalGatewayVirtualInterfaceTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccLocalGatewayVirtualInterfaceTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLocalGatewayVirtualInterface.TagPropertyList",
            },
            vlan: {
...
export function ccLocalGatewayVirtualInterfaceTagPropertyToTerraform(struct?: CcLocalGatewayVirtualInterface.TagProperty | cdktn.IResolvable): any {
...
export function ccLocalGatewayVirtualInterfaceTagPropertyToHclTerraform(struct?: CcLocalGatewayVirtualInterface.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcLocalGatewayVirtualInterface {
export interface TagProperty {
    /**
    * The key name of the tag. You can specify a value that is 1 to 128 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#key CcLocalGatewayVirtualInterface#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_local_gateway_virtual_interface#value CcLocalGatewayVirtualInterface#value}
    */
