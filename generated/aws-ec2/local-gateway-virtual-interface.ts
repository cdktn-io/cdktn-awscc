...
export interface CcLocalGatewayVirtualInterfaceProps extends cdktn.TerraformMetaArguments {
    ...
    * The local address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#local_address CcLocalGatewayVirtualInterface#local_address}
    */
    readonly localAddress: string;
    /**
    * The ID of the virtual interface group
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#local_gateway_virtual_interface_group_id CcLocalGatewayVirtualInterface#local_gateway_virtual_interface_group_id}
    */
    readonly localGatewayVirtualInterfaceGroupId: string;
    /**
    * The Outpost LAG ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#outpost_lag_id CcLocalGatewayVirtualInterface#outpost_lag_id}
    */
    readonly outpostLagId: string;
    /**
    * The peer address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#peer_address CcLocalGatewayVirtualInterface#peer_address}
    */
    readonly peerAddress: string;
    /**
    * The peer BGP ASN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#peer_bgp_asn CcLocalGatewayVirtualInterface#peer_bgp_asn}
    */
    readonly peerBgpAsn?: number;
    /**
    * The extended 32-bit ASN of the BGP peer for use with larger ASN values.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#peer_bgp_asn_extended CcLocalGatewayVirtualInterface#peer_bgp_asn_extended}
    */
    readonly peerBgpAsnExtended?: number;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#tags CcLocalGatewayVirtualInterface#tags}
    */
    readonly tags?: CcLocalGatewayVirtualInterface.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of the VLAN.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#vlan CcLocalGatewayVirtualInterface#vlan}
    */
...
export class CcLocalGatewayVirtualInterface extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLocalGatewayVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#key CcLocalGatewayVirtualInterface#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_local_gateway_virtual_interface#value CcLocalGatewayVirtualInterface#value}
    */
