...
export interface CcVPCBlockPublicAccessOptionsProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_block_public_access_options#internet_gateway_block_mode CcVPCBlockPublicAccessOptions#internet_gateway_block_mode}
    */
...
export class CcVPCBlockPublicAccessOptions extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCBlockPublicAccessOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_vpc_block_public_access_options#import import section} in the documentation of this resource for the id to use
