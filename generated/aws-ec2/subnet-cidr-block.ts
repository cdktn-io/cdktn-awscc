...
export interface CcSubnetCidrBlockProps extends cdktn.TerraformMetaArguments {
    /**
    * The IPv6 network range for the subnet, in CIDR notation. The subnet size must use a /64 prefix length
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_subnet_cidr_block#ipv_6_cidr_block CcSubnetCidrBlock#ipv_6_cidr_block}
    */
    readonly ipv6CidrBlock?: string;
    /**
    * The ID of an IPv6 Amazon VPC IP Address Manager (IPAM) pool from which to allocate, to get the subnet's CIDR
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_subnet_cidr_block#ipv_6_ipam_pool_id CcSubnetCidrBlock#ipv_6_ipam_pool_id}
    */
    readonly ipv6IpamPoolId?: string;
    /**
    * The netmask length of the IPv6 CIDR to allocate to the subnet from an IPAM pool
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_subnet_cidr_block#ipv_6_netmask_length CcSubnetCidrBlock#ipv_6_netmask_length}
    */
    readonly ipv6NetmaskLength?: number;
    /**
    * The ID of the subnet
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_subnet_cidr_block#subnet_id CcSubnetCidrBlock#subnet_id}
    */
...
export class CcSubnetCidrBlock extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubnetCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/ec2_subnet_cidr_block#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSubnetCidrBlockProps
    */
    public constructor(scope: Construct, id: string, config: CcSubnetCidrBlockProps) {
        super(scope, id, {
...
export namespace CcSubnetCidrBlock {
}
