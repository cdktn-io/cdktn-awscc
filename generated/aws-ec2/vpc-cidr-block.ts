...
export interface CcVPCCidrBlockProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#amazon_provided_ipv_6_cidr_block CcVPCCidrBlock#amazon_provided_ipv_6_cidr_block}
    */
    readonly amazonProvidedIpv6CidrBlock?: boolean | cdktn.IResolvable;
    /**
    * An IPv4 CIDR block to associate with the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#cidr_block CcVPCCidrBlock#cidr_block}
    */
    readonly cidrBlock?: string;
    /**
    * The ID of the IPv4 IPAM pool to Associate a CIDR from to a VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_4_ipam_pool_id CcVPCCidrBlock#ipv_4_ipam_pool_id}
    */
    readonly ipv4IpamPoolId?: string;
    /**
    * The netmask length of the IPv4 CIDR you would like to associate from an Amazon VPC IP Address Manager (IPAM) pool.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_4_netmask_length CcVPCCidrBlock#ipv_4_netmask_length}
    */
    readonly ipv4NetmaskLength?: number;
    /**
    * An IPv6 CIDR block from the IPv6 address pool.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_6_cidr_block CcVPCCidrBlock#ipv_6_cidr_block}
    */
    readonly ipv6CidrBlock?: string;
    /**
    * The name of the location from which we advertise the IPV6 CIDR block.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_6_cidr_block_network_border_group CcVPCCidrBlock#ipv_6_cidr_block_network_border_group}
    */
    readonly ipv6CidrBlockNetworkBorderGroup?: string;
    /**
    * The ID of the IPv6 IPAM pool to Associate a CIDR from to a VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_6_ipam_pool_id CcVPCCidrBlock#ipv_6_ipam_pool_id}
    */
    readonly ipv6IpamPoolId?: string;
    /**
    * The netmask length of the IPv6 CIDR you would like to associate from an Amazon VPC IP Address Manager (IPAM) pool.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_6_netmask_length CcVPCCidrBlock#ipv_6_netmask_length}
    */
    readonly ipv6NetmaskLength?: number;
    /**
    * The ID of an IPv6 address pool from which to allocate the IPv6 CIDR block.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#ipv_6_pool CcVPCCidrBlock#ipv_6_pool}
    */
    readonly ipv6Pool?: string;
    /**
    * The ID of the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#vpc_id CcVPCCidrBlock#vpc_id}
    */
...
export class CcVPCCidrBlock extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_cidr_block#import import section} in the documentation of this resource for the id to use
