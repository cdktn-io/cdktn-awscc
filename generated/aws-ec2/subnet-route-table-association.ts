...
export interface CcSubnetRouteTableAssociationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_subnet_route_table_association#route_table_id CcSubnetRouteTableAssociation#route_table_id}
    */
    readonly routeTableId: string;
    /**
    * The ID of the subnet.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_subnet_route_table_association#subnet_id CcSubnetRouteTableAssociation#subnet_id}
    */
...
export class CcSubnetRouteTableAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubnetRouteTableAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_subnet_route_table_association#import import section} in the documentation of this resource for the id to use
