...
export interface CcVPCGatewayAttachmentProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_gateway_attachment#internet_gateway_id CcVPCGatewayAttachment#internet_gateway_id}
    */
    readonly internetGatewayId?: string;
    /**
    * The ID of the VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_gateway_attachment#vpc_id CcVPCGatewayAttachment#vpc_id}
    */
    readonly vpcId: string;
    /**
    * The ID of the virtual private gateway. You must specify either InternetGatewayId or VpnGatewayId, but not both.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_gateway_attachment#vpn_gateway_id CcVPCGatewayAttachment#vpn_gateway_id}
    */
...
export class CcVPCGatewayAttachment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/ec2_vpc_gateway_attachment#import import section} in the documentation of this resource for the id to use
