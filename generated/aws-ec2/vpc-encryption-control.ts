...
export interface CcVPCEncryptionControlProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#egress_only_internet_gateway_exclusion_input CcVPCEncryptionControl#egress_only_internet_gateway_exclusion_input}
    */
    readonly egressOnlyInternetGatewayExclusionInput?: string;
    /**
    * Used to enable or disable EFS exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#elastic_file_system_exclusion_input CcVPCEncryptionControl#elastic_file_system_exclusion_input}
    */
    readonly elasticFileSystemExclusionInput?: string;
    /**
    * Used to enable or disable IGW exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#internet_gateway_exclusion_input CcVPCEncryptionControl#internet_gateway_exclusion_input}
    */
    readonly internetGatewayExclusionInput?: string;
    /**
    * Used to enable or disable Lambda exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#lambda_exclusion_input CcVPCEncryptionControl#lambda_exclusion_input}
    */
    readonly lambdaExclusionInput?: string;
    /**
    * The VPC encryption control mode, either monitor or enforce.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#mode CcVPCEncryptionControl#mode}
    */
    readonly mode?: string;
    /**
    * Used to enable or disable Nat gateway exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#nat_gateway_exclusion_input CcVPCEncryptionControl#nat_gateway_exclusion_input}
    */
    readonly natGatewayExclusionInput?: string;
    /**
    * The tags to assign to the VPC encryption control.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#tags CcVPCEncryptionControl#tags}
    */
    readonly tags?: CcVPCEncryptionControl.TagProperty[] | cdktn.IResolvable;
    /**
    * Used to enable or disable VGW exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#virtual_private_gateway_exclusion_input CcVPCEncryptionControl#virtual_private_gateway_exclusion_input}
    */
    readonly virtualPrivateGatewayExclusionInput?: string;
    /**
    * The VPC on which this VPC encryption control is applied.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#vpc_id CcVPCEncryptionControl#vpc_id}
    */
    readonly vpcId?: string;
    /**
    * Used to enable or disable Vpc Lattice exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#vpc_lattice_exclusion_input CcVPCEncryptionControl#vpc_lattice_exclusion_input}
    */
    readonly vpcLatticeExclusionInput?: string;
    /**
    * Used to enable or disable VPC peering exclusion
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#vpc_peering_exclusion_input CcVPCEncryptionControl#vpc_peering_exclusion_input}
    */
...
export class CcVPCEncryptionControl extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcVPCEncryptionControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#key CcVPCEncryptionControl#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_vpc_encryption_control#value CcVPCEncryptionControl#value}
    */
