...
export interface CcTransitGatewayPolicyTableEntryProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#policy_rule CcTransitGatewayPolicyTableEntry#policy_rule}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#policy_rule_number CcTransitGatewayPolicyTableEntry#policy_rule_number}
    */
    readonly policyRuleNumber: string;
    /**
    * The ID of the target route table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#target_route_table_id CcTransitGatewayPolicyTableEntry#target_route_table_id}
    */
    readonly targetRouteTableId: string;
    /**
    * The ID of the transit gateway policy table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#transit_gateway_policy_table_id CcTransitGatewayPolicyTableEntry#transit_gateway_policy_table_id}
    */
...
export class CcTransitGatewayPolicyTableEntry extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTransitGatewayPolicyTableEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#import import section} in the documentation of this resource for the id to use
...
export interface TransitGatewayPolicyRuleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#destination_cidr_block CcTransitGatewayPolicyTableEntry#destination_cidr_block}
    */
    readonly destinationCidrBlock?: string;
    /**
    * The destination port range for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#destination_port_range CcTransitGatewayPolicyTableEntry#destination_port_range}
    */
    readonly destinationPortRange?: string;
    /**
    * The protocol for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#protocol CcTransitGatewayPolicyTableEntry#protocol}
    */
    readonly protocol?: string;
    /**
    * The source CIDR block for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#source_cidr_block CcTransitGatewayPolicyTableEntry#source_cidr_block}
    */
    readonly sourceCidrBlock?: string;
    /**
    * The source port range for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/ec2_transit_gateway_policy_table_entry#source_port_range CcTransitGatewayPolicyTableEntry#source_port_range}
    */
