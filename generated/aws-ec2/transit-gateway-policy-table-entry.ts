...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcTransitGatewayPolicyTableEntryProps extends cdktn.TerraformMetaArguments {
    /**
    * The policy rule associated with the entry.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#policy_rule CcTransitGatewayPolicyTableEntry#policy_rule}
    */
    readonly policyRule: CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRuleProperty;
    /**
    * The rule number for the policy table entry.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#policy_rule_number CcTransitGatewayPolicyTableEntry#policy_rule_number}
    */
    readonly policyRuleNumber: string;
    /**
    * The ID of the target route table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#target_route_table_id CcTransitGatewayPolicyTableEntry#target_route_table_id}
    */
    readonly targetRouteTableId: string;
    /**
    * The ID of the transit gateway policy table.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#transit_gateway_policy_table_id CcTransitGatewayPolicyTableEntry#transit_gateway_policy_table_id}
    */
    readonly transitGatewayPolicyTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry awscc_ec2_transit_gateway_policy_table_entry}
*/
export class CcTransitGatewayPolicyTableEntry extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcTransitGatewayPolicyTableEntry resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcTransitGatewayPolicyTableEntry to import
    * @param importFromId The id of the existing CcTransitGatewayPolicyTableEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcTransitGatewayPolicyTableEntry to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry awscc_ec2_transit_gateway_policy_table_entry} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcTransitGatewayPolicyTableEntryProps
    */
    public constructor(scope: Construct, id: string, config: CcTransitGatewayPolicyTableEntryProps) {
        super(scope, id, {
    ...
    private _policyRule = new CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRulePropertyOutputReference(this, "policy_rule");
    public get policyRule() {
        return this._policyRule;
    }
    public putPolicyRule(value: CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRuleProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            policy_rule: ccTransitGatewayPolicyTableEntryTransitGatewayPolicyRulePropertyToTerraform(this._policyRule.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            policy_rule: {
                value: ccTransitGatewayPolicyTableEntryTransitGatewayPolicyRulePropertyToHclTerraform(this._policyRule.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRuleProperty",
            },
            policy_rule_number: {
...
export function ccTransitGatewayPolicyTableEntryTransitGatewayPolicyRulePropertyToTerraform(struct?: CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRuleProperty | cdktn.IResolvable): any {
...
export function ccTransitGatewayPolicyTableEntryTransitGatewayPolicyRulePropertyToHclTerraform(struct?: CcTransitGatewayPolicyTableEntry.TransitGatewayPolicyRuleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcTransitGatewayPolicyTableEntry {
export interface TransitGatewayPolicyRuleProperty {
    /**
    * The destination CIDR block for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#destination_cidr_block CcTransitGatewayPolicyTableEntry#destination_cidr_block}
    */
    readonly destinationCidrBlock?: string;
    /**
    * The destination port range for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#destination_port_range CcTransitGatewayPolicyTableEntry#destination_port_range}
    */
    readonly destinationPortRange?: string;
    /**
    * The protocol for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#protocol CcTransitGatewayPolicyTableEntry#protocol}
    */
    readonly protocol?: string;
    /**
    * The source CIDR block for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#source_cidr_block CcTransitGatewayPolicyTableEntry#source_cidr_block}
    */
    readonly sourceCidrBlock?: string;
    /**
    * The source port range for the transit gateway policy rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_transit_gateway_policy_table_entry#source_port_range CcTransitGatewayPolicyTableEntry#source_port_range}
    */
    readonly sourcePortRange?: string;
}
export class TransitGatewayPolicyRulePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): TransitGatewayPolicyRuleProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: TransitGatewayPolicyRuleProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
