...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcDHCPOptionsProps extends cdktn.TerraformMetaArguments {
    /**
    * This value is used to complete unqualified DNS hostnames.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#domain_name CcDHCPOptions#domain_name}
    */
    readonly domainName?: string;
    /**
    * The IPv4 addresses of up to four domain name servers, or AmazonProvidedDNS.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#domain_name_servers CcDHCPOptions#domain_name_servers}
    */
    readonly domainNameServers?: string[];
    /**
    * The preferred Lease Time for ipV6 address in seconds.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#ipv_6_address_preferred_lease_time CcDHCPOptions#ipv_6_address_preferred_lease_time}
    */
    readonly ipv6AddressPreferredLeaseTime?: number;
    /**
    * The IPv4 addresses of up to four NetBIOS name servers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#netbios_name_servers CcDHCPOptions#netbios_name_servers}
    */
    readonly netbiosNameServers?: string[];
    /**
    * The NetBIOS node type (1, 2, 4, or 8).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#netbios_node_type CcDHCPOptions#netbios_node_type}
    */
    readonly netbiosNodeType?: number;
    /**
    * The IPv4 addresses of up to four Network Time Protocol (NTP) servers.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#ntp_servers CcDHCPOptions#ntp_servers}
    */
    readonly ntpServers?: string[];
    /**
    * Any tags assigned to the DHCP options set.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#tags CcDHCPOptions#tags}
    */
    readonly tags?: CcDHCPOptions.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options awscc_ec2_dhcp_options}
*/
export class CcDHCPOptions extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDHCPOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options awscc_ec2_dhcp_options} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcDHCPOptionsProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcDHCPOptionsProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcDHCPOptions.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDHCPOptions.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccDHCPOptionsTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDHCPOptionsTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDHCPOptions.TagPropertyList",
            },
        };
...
export function ccDHCPOptionsTagPropertyToTerraform(struct?: CcDHCPOptions.TagProperty | cdktn.IResolvable): any {
...
export function ccDHCPOptionsTagPropertyToHclTerraform(struct?: CcDHCPOptions.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#key CcDHCPOptions#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/ec2_dhcp_options#value CcDHCPOptions#value}
    */
