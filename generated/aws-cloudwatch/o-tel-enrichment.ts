...
export class CcOTelEnrichment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcOTelEnrichment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_otel_enrichment#import import section} in the documentation of this resource for the id to use
