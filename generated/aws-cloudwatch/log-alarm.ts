...
export interface CcLogAlarmProps extends cdktn.TerraformMetaArguments {
    /**
    * The number of log lines to include in alarm notifications. Valid values are 0 to 50.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#action_log_line_count CcLogAlarm#action_log_line_count}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#action_log_line_role_arn CcLogAlarm#action_log_line_role_arn}
    */
    readonly actionLogLineRoleArn?: string;
    /**
    * Indicates whether actions should be executed during any changes to the alarm state. The default is TRUE.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#actions_enabled CcLogAlarm#actions_enabled}
    */
    readonly actionsEnabled?: boolean | cdktn.IResolvable;
    /**
    * The list of actions to execute when this alarm transitions into an ALARM state from any other state.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#alarm_actions CcLogAlarm#alarm_actions}
    */
    readonly alarmActions?: string[];
    /**
    * The description of the log alarm.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#alarm_description CcLogAlarm#alarm_description}
    */
    readonly alarmDescription?: string;
    /**
    * The name of the log alarm.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#alarm_name CcLogAlarm#alarm_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#comparison_operator CcLogAlarm#comparison_operator}
    */
    readonly comparisonOperator: string;
    /**
    * The actions to execute when this alarm transitions to the INSUFFICIENT_DATA state from any other state.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#insufficient_data_actions CcLogAlarm#insufficient_data_actions}
    */
    readonly insufficientDataActions?: string[];
    /**
    * The actions to execute when this alarm transitions to the OK state from any other state.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#ok_actions CcLogAlarm#ok_actions}
    */
    readonly okActions?: string[];
    /**
    * The number of query results that must be breaching to trigger the alarm.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#query_results_to_alarm CcLogAlarm#query_results_to_alarm}
    */
    readonly queryResultsToAlarm: number;
    /**
    * The number of query results over which data is compared to the specified threshold.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#query_results_to_evaluate CcLogAlarm#query_results_to_evaluate}
    */
    readonly queryResultsToEvaluate: number;
    /**
    * The scheduled query configuration for the log alarm.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#scheduled_query_configuration CcLogAlarm#scheduled_query_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#tags CcLogAlarm#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#threshold CcLogAlarm#threshold}
    */
    readonly threshold: number;
    /**
    * Sets how this alarm is to handle missing data points. Valid values are breaching, notBreaching, ignore, and missing.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#treat_missing_data CcLogAlarm#treat_missing_data}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#warm_up_configuration CcLogAlarm#warm_up_configuration}
    */
...
export class CcLogAlarm extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLogAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcLogAlarmProps
    */
    public constructor(scope: Construct, id: string, config: CcLogAlarmProps) {
        super(scope, id, {
    ...
    private _scheduledQueryConfiguration = new CcLogAlarm.ScheduledQueryConfigurationPropertyOutputReference(this, "scheduled_query_configuration");
    public get scheduledQueryConfiguration() {
        return this._scheduledQueryConfiguration;
    }
    public putScheduledQueryConfiguration(value: CcLogAlarm.ScheduledQueryConfigurationProperty) {
    ...
    private _tags = new CcLogAlarm.TagsPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcLogAlarm.TagsProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            scheduled_query_configuration: ccLogAlarmScheduledQueryConfigurationPropertyToTerraform(this._scheduledQueryConfiguration.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            scheduled_query_configuration: {
                value: ccLogAlarmScheduledQueryConfigurationPropertyToHclTerraform(this._scheduledQueryConfiguration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLogAlarm.ScheduledQueryConfigurationProperty",
            },
            tags: {
                value: cdktn.listMapperHcl(ccLogAlarmTagsPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLogAlarm.TagsPropertyList",
            },
            threshold: {
...
export function ccLogAlarmScheduleConfigurationPropertyToTerraform(struct?: CcLogAlarm.ScheduleConfigurationProperty | cdktn.IResolvable): any {
...
export function ccLogAlarmScheduleConfigurationPropertyToHclTerraform(struct?: CcLogAlarm.ScheduleConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLogAlarmTagPropertyToTerraform(struct?: CcLogAlarm.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLogAlarmTagPropertyToHclTerraform(struct?: CcLogAlarm.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLogAlarmScheduledQueryConfigurationPropertyToTerraform(struct?: CcLogAlarm.ScheduledQueryConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        schedule_configuration: ccLogAlarmScheduleConfigurationPropertyToTerraform(struct!.scheduleConfiguration),
        scheduled_query_role_arn: cdktn.stringToTerraform(struct!.scheduledQueryRoleArn),
        tags: cdktn.listMapper(ccLogAlarmTagPropertyToTerraform, false)(struct!.tags),
    }
}


export function ccLogAlarmScheduledQueryConfigurationPropertyToHclTerraform(struct?: CcLogAlarm.ScheduledQueryConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        schedule_configuration: {
            value: ccLogAlarmScheduleConfigurationPropertyToHclTerraform(struct!.scheduleConfiguration),
            isBlock: true,
            type: "struct",
            storageClassType: "ScheduleConfigurationProperty",
        },
        ...
        tags: {
            value: cdktn.listMapperHcl(ccLogAlarmTagPropertyToHclTerraform, false)(struct!.tags),
            isBlock: true,
            type: "set",
...
export function ccLogAlarmTagsPropertyToTerraform(struct?: CcLogAlarm.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLogAlarmTagsPropertyToHclTerraform(struct?: CcLogAlarm.TagsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface ScheduleConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#end_time_offset CcLogAlarm#end_time_offset}
    */
    readonly endTimeOffset?: number;
    /**
    * The expression that defines when the scheduled query runs, e.g. rate(1 minute).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#schedule_expression CcLogAlarm#schedule_expression}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#start_time_offset CcLogAlarm#start_time_offset}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#key CcLogAlarm#key}
    */
    readonly key?: string;
    /**
    * The value for the specified tag key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#value CcLogAlarm#value}
    */
...
export interface ScheduledQueryConfigurationProperty {
    /**
    * The aggregation expression for the scheduled query, e.g. count(*) or avg(latency) by host.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#aggregation_expression CcLogAlarm#aggregation_expression}
    */
    readonly aggregationExpression: string;
    /**
    * The log groups to query.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#log_group_identifiers CcLogAlarm#log_group_identifiers}
    */
    readonly logGroupIdentifiers?: string[];
    /**
    * The query string to execute against the specified log groups.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#query_string CcLogAlarm#query_string}
    */
    readonly queryString: string;
    /**
    * The schedule configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#schedule_configuration CcLogAlarm#schedule_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#scheduled_query_role_arn CcLogAlarm#scheduled_query_role_arn}
    */
...
export class ScheduledQueryConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): ScheduledQueryConfigurationProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: ScheduledQueryConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
    ...
    private _scheduleConfiguration = new ScheduleConfigurationPropertyOutputReference(this, "schedule_configuration");
    public get scheduleConfiguration() {
        return this._scheduleConfiguration;
    }
    public putScheduleConfiguration(value: ScheduleConfigurationProperty) {
...
export interface WarmUpConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#only_start_evaluating_after_warm_up_period_ends CcLogAlarm#only_start_evaluating_after_warm_up_period_ends}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cloudwatch_log_alarm#warm_up_period_duration_in_minutes CcLogAlarm#warm_up_period_duration_in_minutes}
    */
