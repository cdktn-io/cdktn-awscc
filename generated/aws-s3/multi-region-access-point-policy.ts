...
export interface CcMultiRegionAccessPointPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_multi_region_access_point_policy#mrap_name CcMultiRegionAccessPointPolicy#mrap_name}
    */
    readonly mrapName: string;
    /**
    * Policy document to apply to a Multi Region Access Point
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_multi_region_access_point_policy#policy CcMultiRegionAccessPointPolicy#policy}
    */
...
export class CcMultiRegionAccessPointPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMultiRegionAccessPointPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/s3_multi_region_access_point_policy#import import section} in the documentation of this resource for the id to use
