...
export interface CcProactiveEngagementProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#emergency_contact_list CcProactiveEngagement#emergency_contact_list}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#proactive_engagement_status CcProactiveEngagement#proactive_engagement_status}
    */
...
export class CcProactiveEngagement extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcProactiveEngagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#import import section} in the documentation of this resource for the id to use
...
export interface EmergencyContactProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#contact_notes CcProactiveEngagement#contact_notes}
    */
    readonly contactNotes?: string;
    /**
    * The email address for the contact.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#email_address CcProactiveEngagement#email_address}
    */
    readonly emailAddress: string;
    /**
    * The phone number for the contact
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/shield_proactive_engagement#phone_number CcProactiveEngagement#phone_number}
    */
