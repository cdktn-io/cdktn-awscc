...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcTelemetryRuleProps extends cdktn.TerraformMetaArguments {
    /**
    * The telemetry rule
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#rule CcTelemetryRule#rule}
    */
    readonly rule: CcTelemetryRule.TelemetryRuleProperty;
    /**
    * The name of the telemetry rule
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#rule_name CcTelemetryRule#rule_name}
    */
    readonly ruleName: string;
    /**
    * An array of key-value pairs to apply to this resource
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#tags CcTelemetryRule#tags}
    */
    readonly tags?: CcTelemetryRule.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule awscc_observabilityadmin_telemetry_rule}
*/
export class CcTelemetryRule extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTelemetryRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule awscc_observabilityadmin_telemetry_rule} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcTelemetryRuleProps
    */
    public constructor(scope: Construct, id: string, config: CcTelemetryRuleProps) {
        super(scope, id, {
    ...
    private _regionStatuses = new CcTelemetryRule.RegionStatusesPropertyList(this, "region_statuses", false);
    public get regionStatuses() {
        return this._regionStatuses;
    }

    // rule - computed: false, optional: false, required: true
    private _rule = new CcTelemetryRule.TelemetryRulePropertyOutputReference(this, "rule");
    public get rule() {
        return this._rule;
    }
    public putRule(value: CcTelemetryRule.TelemetryRuleProperty) {
    ...
    private _tags = new CcTelemetryRule.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcTelemetryRule.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            rule: ccTelemetryRuleTelemetryRulePropertyToTerraform(this._rule.internalValue),
            rule_name: cdktn.stringToTerraform(this._ruleName),
            tags: cdktn.listMapper(ccTelemetryRuleTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            rule: {
                value: ccTelemetryRuleTelemetryRulePropertyToHclTerraform(this._rule.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcTelemetryRule.TelemetryRuleProperty",
            },
            rule_name: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccTelemetryRuleTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcTelemetryRule.TagPropertyList",
            },
        };
...
export function ccTelemetryRuleRegionStatusesPropertyToTerraform(struct?: CcTelemetryRule.RegionStatusesProperty): any {
...
export function ccTelemetryRuleRegionStatusesPropertyToHclTerraform(struct?: CcTelemetryRule.RegionStatusesProperty): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleAdvancedFieldSelectorPropertyToTerraform(struct?: CcTelemetryRule.AdvancedFieldSelectorProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleAdvancedFieldSelectorPropertyToHclTerraform(struct?: CcTelemetryRule.AdvancedFieldSelectorProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleAdvancedEventSelectorPropertyToTerraform(struct?: CcTelemetryRule.AdvancedEventSelectorProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        field_selectors: cdktn.listMapper(ccTelemetryRuleAdvancedFieldSelectorPropertyToTerraform, false)(struct!.fieldSelectors),
        name: cdktn.stringToTerraform(struct!.name),
    }
}


export function ccTelemetryRuleAdvancedEventSelectorPropertyToHclTerraform(struct?: CcTelemetryRule.AdvancedEventSelectorProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        field_selectors: {
            value: cdktn.listMapperHcl(ccTelemetryRuleAdvancedFieldSelectorPropertyToHclTerraform, false)(struct!.fieldSelectors),
            isBlock: true,
            type: "set",
...
export function ccTelemetryRuleCloudtrailParametersPropertyToTerraform(struct?: CcTelemetryRule.CloudtrailParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        advanced_event_selectors: cdktn.listMapper(ccTelemetryRuleAdvancedEventSelectorPropertyToTerraform, false)(struct!.advancedEventSelectors),
    }
}


export function ccTelemetryRuleCloudtrailParametersPropertyToHclTerraform(struct?: CcTelemetryRule.CloudtrailParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        advanced_event_selectors: {
            value: cdktn.listMapperHcl(ccTelemetryRuleAdvancedEventSelectorPropertyToHclTerraform, false)(struct!.advancedEventSelectors),
            isBlock: true,
            type: "set",
...
export function ccTelemetryRuleELBLoadBalancerLoggingParametersPropertyToTerraform(struct?: CcTelemetryRule.ELBLoadBalancerLoggingParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleELBLoadBalancerLoggingParametersPropertyToHclTerraform(struct?: CcTelemetryRule.ELBLoadBalancerLoggingParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleLogDeliveryParametersPropertyToTerraform(struct?: CcTelemetryRule.LogDeliveryParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleLogDeliveryParametersPropertyToHclTerraform(struct?: CcTelemetryRule.LogDeliveryParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleVPCFlowLogParametersPropertyToTerraform(struct?: CcTelemetryRule.VPCFlowLogParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleVPCFlowLogParametersPropertyToHclTerraform(struct?: CcTelemetryRule.VPCFlowLogParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleActionConditionPropertyToTerraform(struct?: CcTelemetryRule.ActionConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleActionConditionPropertyToHclTerraform(struct?: CcTelemetryRule.ActionConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleLabelNameConditionPropertyToTerraform(struct?: CcTelemetryRule.LabelNameConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleLabelNameConditionPropertyToHclTerraform(struct?: CcTelemetryRule.LabelNameConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleConditionPropertyToTerraform(struct?: CcTelemetryRule.ConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        action_condition: ccTelemetryRuleActionConditionPropertyToTerraform(struct!.actionCondition),
        label_name_condition: ccTelemetryRuleLabelNameConditionPropertyToTerraform(struct!.labelNameCondition),
    }
}


export function ccTelemetryRuleConditionPropertyToHclTerraform(struct?: CcTelemetryRule.ConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        action_condition: {
            value: ccTelemetryRuleActionConditionPropertyToHclTerraform(struct!.actionCondition),
            isBlock: true,
            type: "struct",
            storageClassType: "ActionConditionProperty",
        },
        label_name_condition: {
            value: ccTelemetryRuleLabelNameConditionPropertyToHclTerraform(struct!.labelNameCondition),
            isBlock: true,
            type: "struct",
...
export function ccTelemetryRuleFilterPropertyToTerraform(struct?: CcTelemetryRule.FilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        conditions: cdktn.listMapper(ccTelemetryRuleConditionPropertyToTerraform, false)(struct!.conditions),
        requirement: cdktn.stringToTerraform(struct!.requirement),
    }
}


export function ccTelemetryRuleFilterPropertyToHclTerraform(struct?: CcTelemetryRule.FilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        conditions: {
            value: cdktn.listMapperHcl(ccTelemetryRuleConditionPropertyToHclTerraform, false)(struct!.conditions),
            isBlock: true,
            type: "set",
...
export function ccTelemetryRuleLoggingFilterPropertyToTerraform(struct?: CcTelemetryRule.LoggingFilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        filters: cdktn.listMapper(ccTelemetryRuleFilterPropertyToTerraform, false)(struct!.filters),
    }
}


export function ccTelemetryRuleLoggingFilterPropertyToHclTerraform(struct?: CcTelemetryRule.LoggingFilterProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        filters: {
            value: cdktn.listMapperHcl(ccTelemetryRuleFilterPropertyToHclTerraform, false)(struct!.filters),
            isBlock: true,
            type: "set",
...
export function ccTelemetryRuleSingleHeaderPropertyToTerraform(struct?: CcTelemetryRule.SingleHeaderProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleSingleHeaderPropertyToHclTerraform(struct?: CcTelemetryRule.SingleHeaderProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleFieldToMatchPropertyToTerraform(struct?: CcTelemetryRule.FieldToMatchProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        single_header: ccTelemetryRuleSingleHeaderPropertyToTerraform(struct!.singleHeader),
        uri_path: cdktn.stringToTerraform(struct!.uriPath),
    }
}


export function ccTelemetryRuleFieldToMatchPropertyToHclTerraform(struct?: CcTelemetryRule.FieldToMatchProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        single_header: {
            value: ccTelemetryRuleSingleHeaderPropertyToHclTerraform(struct!.singleHeader),
            isBlock: true,
            type: "struct",
...
export function ccTelemetryRuleWAFLoggingParametersPropertyToTerraform(struct?: CcTelemetryRule.WAFLoggingParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        logging_filter: ccTelemetryRuleLoggingFilterPropertyToTerraform(struct!.loggingFilter),
        redacted_fields: cdktn.listMapper(ccTelemetryRuleFieldToMatchPropertyToTerraform, false)(struct!.redactedFields),
    }
}


export function ccTelemetryRuleWAFLoggingParametersPropertyToHclTerraform(struct?: CcTelemetryRule.WAFLoggingParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        logging_filter: {
            value: ccTelemetryRuleLoggingFilterPropertyToHclTerraform(struct!.loggingFilter),
            isBlock: true,
            type: "struct",
            storageClassType: "LoggingFilterProperty",
        },
        redacted_fields: {
            value: cdktn.listMapperHcl(ccTelemetryRuleFieldToMatchPropertyToHclTerraform, false)(struct!.redactedFields),
            isBlock: true,
            type: "set",
...
export function ccTelemetryRuleTelemetryDestinationConfigurationPropertyToTerraform(struct?: CcTelemetryRule.TelemetryDestinationConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        cloudtrail_parameters: ccTelemetryRuleCloudtrailParametersPropertyToTerraform(struct!.cloudtrailParameters),
...
export function ccTelemetryRuleTelemetryDestinationConfigurationPropertyToHclTerraform(struct?: CcTelemetryRule.TelemetryDestinationConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        cloudtrail_parameters: {
            value: ccTelemetryRuleCloudtrailParametersPropertyToHclTerraform(struct!.cloudtrailParameters),
            isBlock: true,
            type: "struct",
        ...
        elb_load_balancer_logging_parameters: {
            value: ccTelemetryRuleELBLoadBalancerLoggingParametersPropertyToHclTerraform(struct!.elbLoadBalancerLoggingParameters),
            isBlock: true,
            type: "struct",
        ...
        log_delivery_parameters: {
            value: ccTelemetryRuleLogDeliveryParametersPropertyToHclTerraform(struct!.logDeliveryParameters),
            isBlock: true,
            type: "struct",
        ...
        vpc_flow_log_parameters: {
            value: ccTelemetryRuleVPCFlowLogParametersPropertyToHclTerraform(struct!.vpcFlowLogParameters),
            isBlock: true,
            type: "struct",
            storageClassType: "VPCFlowLogParametersProperty",
        },
        waf_logging_parameters: {
            value: ccTelemetryRuleWAFLoggingParametersPropertyToHclTerraform(struct!.wafLoggingParameters),
            isBlock: true,
            type: "struct",
...
export function ccTelemetryRuleTelemetryRulePropertyToTerraform(struct?: CcTelemetryRule.TelemetryRuleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        destination_configuration: ccTelemetryRuleTelemetryDestinationConfigurationPropertyToTerraform(struct!.destinationConfiguration),
...
export function ccTelemetryRuleTelemetryRulePropertyToHclTerraform(struct?: CcTelemetryRule.TelemetryRuleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        destination_configuration: {
            value: ccTelemetryRuleTelemetryDestinationConfigurationPropertyToHclTerraform(struct!.destinationConfiguration),
            isBlock: true,
            type: "struct",
...
export function ccTelemetryRuleTagPropertyToTerraform(struct?: CcTelemetryRule.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTelemetryRuleTagPropertyToHclTerraform(struct?: CcTelemetryRule.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcTelemetryRule {
...
export interface AdvancedFieldSelectorProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#ends_with CcTelemetryRule#ends_with}
    */
    readonly endsWith?: string[];
    /**
    * An operator that includes events that match the exact value of the event record field specified as the value of Field.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#equals CcTelemetryRule#equals}
    */
    readonly equalTo?: string[];
    /**
    * A field in a CloudTrail event record on which to filter events to be logged
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#field CcTelemetryRule#field}
    */
    readonly field?: string;
    /**
    * An operator that excludes events that match the last few characters of the event record field specified as the value of Field.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#not_ends_with CcTelemetryRule#not_ends_with}
    */
    readonly notEndsWith?: string[];
    /**
    * An operator that excludes events that match the exact value of the event record field specified as the value of Field.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#not_equals CcTelemetryRule#not_equals}
    */
    readonly notEquals?: string[];
    /**
    * An operator that excludes events that match the first few characters of the event record field specified as the value of Field.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#not_starts_with CcTelemetryRule#not_starts_with}
    */
    readonly notStartsWith?: string[];
    /**
    * An operator that includes events that match the first few characters of the event record field specified as the value of Field.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#starts_with CcTelemetryRule#starts_with}
    */
...
export interface AdvancedEventSelectorProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#field_selectors CcTelemetryRule#field_selectors}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#name CcTelemetryRule#name}
    */
...
export interface CloudtrailParametersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#advanced_event_selectors CcTelemetryRule#advanced_event_selectors}
    */
...
export interface ELBLoadBalancerLoggingParametersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#field_delimiter CcTelemetryRule#field_delimiter}
    */
    readonly fieldDelimiter?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#output_format CcTelemetryRule#output_format}
    */
...
export interface LogDeliveryParametersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#log_types CcTelemetryRule#log_types}
    */
...
export interface VPCFlowLogParametersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#log_format CcTelemetryRule#log_format}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#max_aggregation_interval CcTelemetryRule#max_aggregation_interval}
    */
    readonly maxAggregationInterval?: number;
    /**
    * The type of traffic captured for the flow log. Default is ALL
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#traffic_type CcTelemetryRule#traffic_type}
    */
...
export interface ActionConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#action CcTelemetryRule#action}
    */
...
export interface LabelNameConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#label_name CcTelemetryRule#label_name}
    */
...
export interface ConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#action_condition CcTelemetryRule#action_condition}
    */
    readonly actionCondition?: ActionConditionProperty;
    /**
    * The label name of the condition.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#label_name_condition CcTelemetryRule#label_name_condition}
    */
...
export interface FilterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#behavior CcTelemetryRule#behavior}
    */
    readonly behavior?: string;
    /**
    * A list of conditions for a filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#conditions CcTelemetryRule#conditions}
    */
    readonly conditions?: ConditionProperty[] | cdktn.IResolvable;
    /**
    * The requirement portion of the filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#requirement CcTelemetryRule#requirement}
    */
...
export interface LoggingFilterProperty {
    ...
    * The behavior required of the filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#default_behavior CcTelemetryRule#default_behavior}
    */
    readonly defaultBehavior?: string;
    /**
    * A list of filters to be applied.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#filters CcTelemetryRule#filters}
    */
...
export interface FieldToMatchProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#method CcTelemetryRule#method}
    */
    readonly method?: string;
    /**
    * The query string to find the resource to match this field to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#query_string CcTelemetryRule#query_string}
    */
    readonly queryString?: string;
    /**
    * Header for the field to match.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#single_header CcTelemetryRule#single_header}
    */
    readonly singleHeader?: SingleHeaderProperty;
    /**
    * This is the URI path to match this rule to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#uri_path CcTelemetryRule#uri_path}
    */
...
export interface WAFLoggingParametersProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#log_type CcTelemetryRule#log_type}
    */
    readonly logType?: string;
    /**
    * Default handling for logs that don't match any of the specified filtering conditions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#logging_filter CcTelemetryRule#logging_filter}
    */
    readonly loggingFilter?: LoggingFilterProperty;
    /**
    * Fields not to be included in the logs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#redacted_fields CcTelemetryRule#redacted_fields}
    */
...
export interface TelemetryDestinationConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#cloudtrail_parameters CcTelemetryRule#cloudtrail_parameters}
    */
    readonly cloudtrailParameters?: CloudtrailParametersProperty;
    /**
    * Pattern for telemetry data destination
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#destination_pattern CcTelemetryRule#destination_pattern}
    */
    readonly destinationPattern?: string;
    /**
    * Type of telemetry destination
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#destination_type CcTelemetryRule#destination_type}
    */
    readonly destinationType?: string;
    /**
    * Telemetry parameters for ELB/NLB Load Balancer Logs
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#elb_load_balancer_logging_parameters CcTelemetryRule#elb_load_balancer_logging_parameters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#kms_key_arn CcTelemetryRule#kms_key_arn}
    */
    readonly kmsKeyArn?: string;
    /**
    * Parameters for log delivery configuration
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#log_delivery_parameters CcTelemetryRule#log_delivery_parameters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#retention_in_days CcTelemetryRule#retention_in_days}
    */
    readonly retentionInDays?: number;
    /**
    * Telemetry parameters for VPC Flow logs
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#vpc_flow_log_parameters CcTelemetryRule#vpc_flow_log_parameters}
    */
    readonly vpcFlowLogParameters?: VPCFlowLogParametersProperty;
    /**
    * Telemetry parameters for WAF v2 Web ACL
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#waf_logging_parameters CcTelemetryRule#waf_logging_parameters}
    */
...
export interface TelemetryRuleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#all_regions CcTelemetryRule#all_regions}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#allow_field_updates CcTelemetryRule#allow_field_updates}
    */
    readonly allowFieldUpdates?: boolean | cdktn.IResolvable;
    /**
    * The destination configuration for telemetry data
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#destination_configuration CcTelemetryRule#destination_configuration}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#regions CcTelemetryRule#regions}
    */
    readonly regions?: string[];
    /**
    * Resource Type associated with the Telemetry Rule
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#resource_type CcTelemetryRule#resource_type}
    */
    readonly resourceType: string;
    /**
    * Selection Criteria on resource level for rule application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#selection_criteria CcTelemetryRule#selection_criteria}
    */
    readonly selectionCriteria?: string;
    /**
    * The telemetry source types for a telemetry rule.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#telemetry_source_types CcTelemetryRule#telemetry_source_types}
    */
    readonly telemetrySourceTypes?: string[];
    /**
    * Telemetry Type associated with the Telemetry Rule
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#telemetry_type CcTelemetryRule#telemetry_type}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#key CcTelemetryRule#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/observabilityadmin_telemetry_rule#value CcTelemetryRule#value}
    */
