...
export interface CcLoadBalancerTlsCertificateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#certificate_alternative_names CcLoadBalancerTlsCertificate#certificate_alternative_names}
    */
    readonly certificateAlternativeNames?: string[];
    /**
    * The domain name (e.g., example.com ) for your SSL/TLS certificate.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#certificate_domain_name CcLoadBalancerTlsCertificate#certificate_domain_name}
    */
    readonly certificateDomainName: string;
    /**
    * The SSL/TLS certificate name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#certificate_name CcLoadBalancerTlsCertificate#certificate_name}
    */
    readonly certificateName: string;
    /**
    * A Boolean value that indicates whether HTTPS redirection is enabled for the load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#https_redirection_enabled CcLoadBalancerTlsCertificate#https_redirection_enabled}
    */
    readonly httpsRedirectionEnabled?: boolean | cdktn.IResolvable;
    /**
    * When true, the SSL/TLS certificate is attached to the Lightsail load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#is_attached CcLoadBalancerTlsCertificate#is_attached}
    */
    readonly isAttached?: boolean | cdktn.IResolvable;
    /**
    * The name of your load balancer.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#load_balancer_name CcLoadBalancerTlsCertificate#load_balancer_name}
    */
...
export class CcLoadBalancerTlsCertificate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLoadBalancerTlsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_load_balancer_tls_certificate#import import section} in the documentation of this resource for the id to use
