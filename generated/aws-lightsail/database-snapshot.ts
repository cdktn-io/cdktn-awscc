...
export interface CcDatabaseSnapshotProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#relational_database_name CcDatabaseSnapshot#relational_database_name}
    */
    readonly relationalDatabaseName: string;
    /**
    * The name for your new database snapshot.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#relational_database_snapshot_name CcDatabaseSnapshot#relational_database_snapshot_name}
    */
    readonly relationalDatabaseSnapshotName: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#tags CcDatabaseSnapshot#tags}
    */
...
export class CcDatabaseSnapshot extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDatabaseSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#key CcDatabaseSnapshot#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_database_snapshot#value CcDatabaseSnapshot#value}
    */
