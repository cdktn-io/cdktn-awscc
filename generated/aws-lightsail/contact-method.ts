...
export interface CcContactMethodProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#contact_endpoint CcContactMethod#contact_endpoint}
    */
    readonly contactEndpoint: string;
    /**
    * The protocol of the contact method, such as Email or SMS (text messaging).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#protocol CcContactMethod#protocol}
    */
...
export class CcContactMethod extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lightsail_contact_method#import import section} in the documentation of this resource for the id to use
