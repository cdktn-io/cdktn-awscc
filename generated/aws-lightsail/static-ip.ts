...
export interface CcStaticIpProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_static_ip#attached_to CcStaticIp#attached_to}
    */
    readonly attachedTo?: string;
    /**
    * The name of the static IP address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_static_ip#static_ip_name CcStaticIp#static_ip_name}
    */
...
export class CcStaticIp extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStaticIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/lightsail_static_ip#import import section} in the documentation of this resource for the id to use
