...
export interface CcBucketProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#access_rules CcBucket#access_rules}
    */
    readonly accessRules?: CcBucket.AccessRulesProperty;
    /**
    * The name for the bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#bucket_name CcBucket#bucket_name}
    */
    readonly bucketName: string;
    /**
    * The ID of the bundle to use for the bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#bundle_id CcBucket#bundle_id}
    */
    readonly bundleId: string;
    /**
    * Specifies whether to enable or disable versioning of objects in the bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#object_versioning CcBucket#object_versioning}
    */
    readonly objectVersioning?: boolean | cdktn.IResolvable;
    /**
    * An array of strings to specify the AWS account IDs that can access the bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#read_only_access_accounts CcBucket#read_only_access_accounts}
    */
    readonly readOnlyAccessAccounts?: string[];
    /**
    * The names of the Lightsail resources for which to set bucket access.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#resources_receiving_access CcBucket#resources_receiving_access}
    */
    readonly resourcesReceivingAccess?: string[];
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#tags CcBucket#tags}
    */
...
export class CcBucket extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#import import section} in the documentation of this resource for the id to use
...
export interface AccessRulesProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#allow_public_overrides CcBucket#allow_public_overrides}
    */
    readonly allowPublicOverrides?: boolean | cdktn.IResolvable;
    /**
    * Specifies the anonymous access to all objects in a bucket.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#get_object CcBucket#get_object}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#key CcBucket#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lightsail_bucket#value CcBucket#value}
    */
