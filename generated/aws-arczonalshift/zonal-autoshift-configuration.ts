...
export interface CcZonalAutoshiftConfigurationProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#practice_run_configuration CcZonalAutoshiftConfiguration#practice_run_configuration}
    */
    readonly practiceRunConfiguration?: CcZonalAutoshiftConfiguration.PracticeRunConfigurationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#resource_identifier CcZonalAutoshiftConfiguration#resource_identifier}
    */
    readonly resourceIdentifier?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#zonal_autoshift_status CcZonalAutoshiftConfiguration#zonal_autoshift_status}
    */
...
export class CcZonalAutoshiftConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcZonalAutoshiftConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#import import section} in the documentation of this resource for the id to use
...
export interface ControlConditionProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#alarm_identifier CcZonalAutoshiftConfiguration#alarm_identifier}
    */
    readonly alarmIdentifier?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#type CcZonalAutoshiftConfiguration#type}
    */
...
export interface PracticeRunConfigurationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#blocked_dates CcZonalAutoshiftConfiguration#blocked_dates}
    */
    readonly blockedDates?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#blocked_windows CcZonalAutoshiftConfiguration#blocked_windows}
    */
    readonly blockedWindows?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#blocking_alarms CcZonalAutoshiftConfiguration#blocking_alarms}
    */
    readonly blockingAlarms?: ControlConditionProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/arczonalshift_zonal_autoshift_configuration#outcome_alarms CcZonalAutoshiftConfiguration#outcome_alarms}
    */
