...
export interface CcChannelPolicyProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_channel_policy#channel_group_name CcChannelPolicy#channel_group_name}
    */
    readonly channelGroupName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_channel_policy#channel_name CcChannelPolicy#channel_name}
    */
    readonly channelName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_channel_policy#policy CcChannelPolicy#policy}
    */
...
export class CcChannelPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcChannelPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_channel_policy#import import section} in the documentation of this resource for the id to use
