...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcChannelPolicyProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy#channel_group_name CcChannelPolicy#channel_group_name}
    */
    readonly channelGroupName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy#channel_name CcChannelPolicy#channel_name}
    */
    readonly channelName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy#policy CcChannelPolicy#policy}
    */
    readonly policy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy awscc_mediapackagev2_channel_policy}
*/
export class CcChannelPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcChannelPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/mediapackagev2_channel_policy awscc_mediapackagev2_channel_policy} Resource
    *
    * @param scope The scope in which to define this construct
