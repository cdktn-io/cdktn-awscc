...
export interface CcOriginEndpointPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#cdn_auth_configuration CcOriginEndpointPolicy#cdn_auth_configuration}
    */
    readonly cdnAuthConfiguration?: CcOriginEndpointPolicy.CdnAuthConfigurationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#channel_group_name CcOriginEndpointPolicy#channel_group_name}
    */
    readonly channelGroupName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#channel_name CcOriginEndpointPolicy#channel_name}
    */
    readonly channelName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#origin_endpoint_name CcOriginEndpointPolicy#origin_endpoint_name}
    */
    readonly originEndpointName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#policy CcOriginEndpointPolicy#policy}
    */
...
export class CcOriginEndpointPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcOriginEndpointPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#import import section} in the documentation of this resource for the id to use
...
export interface CdnAuthConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#cdn_identifier_secret_arns CcOriginEndpointPolicy#cdn_identifier_secret_arns}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/mediapackagev2_origin_endpoint_policy#secrets_role_arn CcOriginEndpointPolicy#secrets_role_arn}
    */
