...
export interface CcCertificateAuthorityProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/eks_certificate_authority#cluster_name CcCertificateAuthority#cluster_name}
    */
...
export class CcCertificateAuthority extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/eks_certificate_authority#import import section} in the documentation of this resource for the id to use
