...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/eks_certificate_authority
...
export interface CcCertificateAuthorityProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/eks_certificate_authority#cluster_name CcCertificateAuthority#cluster_name}
    */
    readonly clusterName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/eks_certificate_authority awscc_eks_certificate_authority}
*/
export class CcCertificateAuthority extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/eks_certificate_authority#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/eks_certificate_authority awscc_eks_certificate_authority} Resource
    *
    * @param scope The scope in which to define this construct
