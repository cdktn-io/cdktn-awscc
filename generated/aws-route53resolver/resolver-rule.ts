...
export interface CcResolverRuleProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#delegation_record CcResolverRule#delegation_record}
    */
    readonly delegationRecord?: string;
    /**
    * DNS queries for this domain name are forwarded to the IP addresses that are specified in TargetIps
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#domain_name CcResolverRule#domain_name}
    */
    readonly domainName?: string;
    /**
    * The name for the Resolver rule
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#name CcResolverRule#name}
    */
    readonly name?: string;
    /**
    * The ID of the endpoint that the rule is associated with.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#resolver_endpoint_id CcResolverRule#resolver_endpoint_id}
    */
    readonly resolverEndpointId?: string;
    /**
    * When you want to forward DNS queries for specified domain name to resolvers on your network, specify FORWARD. When you have a forwarding rule to forward DNS queries for a domain to your network and you want Resolver to process queries for a subdomain of that domain, specify SYSTEM.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#rule_type CcResolverRule#rule_type}
    */
    readonly ruleType: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#tags CcResolverRule#tags}
    */
    readonly tags?: CcResolverRule.TagProperty[] | cdktn.IResolvable;
    /**
    * An array that contains the IP addresses and ports that an outbound endpoint forwards DNS queries to. Typically, these are the IP addresses of DNS resolvers on your network. Specify IPv4 addresses. IPv6 is not supported.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#target_ips CcResolverRule#target_ips}
    */
...
export class CcResolverRule extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResolverRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#key CcResolverRule#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#value CcResolverRule#value}
    */
...
export interface TargetAddressProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#ip CcResolverRule#ip}
    */
    readonly ip?: string;
    /**
    * One IPv6 address that you want to forward DNS queries to. You can specify only IPv6 addresses. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#ipv_6 CcResolverRule#ipv_6}
    */
    readonly ipv6?: string;
    /**
    * The port at Ip that you want to forward DNS queries to. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#port CcResolverRule#port}
    */
    readonly port?: string;
    /**
    * The protocol that you want to use to forward DNS queries. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#protocol CcResolverRule#protocol}
    */
    readonly protocol?: string;
    /**
    * The SNI of the target name servers for DoH/DoH-FIPS outbound endpoints
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/route53resolver_resolver_rule#server_name_indication CcResolverRule#server_name_indication}
    */
