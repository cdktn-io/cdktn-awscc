...
export interface CcResolverDNSSECConfigProps extends cdktn.TerraformMetaArguments {
    ...
    * ResourceId
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_dnssec_config#resource_id CcResolverDNSSECConfig#resource_id}
    */
...
export class CcResolverDNSSECConfig extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResolverDNSSECConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_dnssec_config#import import section} in the documentation of this resource for the id to use
