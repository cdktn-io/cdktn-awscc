...
export interface CcResolverEndpointProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#direction CcResolverEndpoint#direction}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#dns_64_enabled CcResolverEndpoint#dns_64_enabled}
    */
    readonly dns64Enabled?: boolean | cdktn.IResolvable;
    /**
    * The subnets and IP addresses in your VPC that DNS queries originate from (for outbound endpoints) or that you forward DNS queries to (for inbound endpoints). The subnet ID uniquely identifies a VPC.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#ip_addresses CcResolverEndpoint#ip_addresses}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#ipv_6_internet_access_enabled CcResolverEndpoint#ipv_6_internet_access_enabled}
    */
    readonly ipv6InternetAccessEnabled?: boolean | cdktn.IResolvable;
    /**
    * A friendly name that lets you easily find a configuration in the Resolver dashboard in the Route 53 console.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#name CcResolverEndpoint#name}
    */
    readonly name?: string;
    /**
    * The ARN (Amazon Resource Name) for the Outpost.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#outpost_arn CcResolverEndpoint#outpost_arn}
    */
    readonly outpostArn?: string;
    /**
    * The Amazon EC2 instance type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#preferred_instance_type CcResolverEndpoint#preferred_instance_type}
    */
    readonly preferredInstanceType?: string;
    /**
    * Protocols used for the endpoint. DoH-FIPS is applicable for inbound endpoints only.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#protocols CcResolverEndpoint#protocols}
    */
    readonly protocols?: string[];
    /**
    * The Resolver endpoint IP address type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#resolver_endpoint_type CcResolverEndpoint#resolver_endpoint_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#rni_enhanced_metrics_enabled CcResolverEndpoint#rni_enhanced_metrics_enabled}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#security_group_ids CcResolverEndpoint#security_group_ids}
    */
    readonly securityGroupIds: string[];
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#tags CcResolverEndpoint#tags}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#target_name_server_metrics_enabled CcResolverEndpoint#target_name_server_metrics_enabled}
    */
...
export class CcResolverEndpoint extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcResolverEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#import import section} in the documentation of this resource for the id to use
...
export interface IpAddressRequestProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#ip CcResolverEndpoint#ip}
    */
    readonly ip?: string;
    /**
    * The IPv6 address that you want to use for DNS queries.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#ipv_6 CcResolverEndpoint#ipv_6}
    */
    readonly ipv6?: string;
    /**
    * The ID of the subnet that contains the IP address.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#subnet_id CcResolverEndpoint#subnet_id}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#key CcResolverEndpoint#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. For example, if Key is account-id, then Value might be the ID of the customer account that you're creating the resource for.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_endpoint#value CcResolverEndpoint#value}
    */
