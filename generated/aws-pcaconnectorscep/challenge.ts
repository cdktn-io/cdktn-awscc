...
export interface CcChallengeProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcaconnectorscep_challenge#connector_arn CcChallenge#connector_arn}
    */
    readonly connectorArn: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcaconnectorscep_challenge#tags CcChallenge#tags}
    */
...
export class CcChallenge extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcChallenge that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/pcaconnectorscep_challenge#import import section} in the documentation of this resource for the id to use
