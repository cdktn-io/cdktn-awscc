...
export interface CcLogAnomalyDetectorProps extends cdktn.TerraformMetaArguments {
    /**
    * Account ID for owner of detector
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#account_id CcLogAnomalyDetector#account_id}
    */
    readonly accountId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#anomaly_visibility_time CcLogAnomalyDetector#anomaly_visibility_time}
    */
    readonly anomalyVisibilityTime?: number;
    /**
    * Name of detector
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#detector_name CcLogAnomalyDetector#detector_name}
    */
    readonly detectorName?: string;
    /**
    * How often log group is evaluated
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#evaluation_frequency CcLogAnomalyDetector#evaluation_frequency}
    */
    readonly evaluationFrequency?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#filter_pattern CcLogAnomalyDetector#filter_pattern}
    */
    readonly filterPattern?: string;
    /**
    * The Amazon Resource Name (ARN) of the CMK to use when encrypting log data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#kms_key_id CcLogAnomalyDetector#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * List of Arns for the given log group
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#log_group_arn_list CcLogAnomalyDetector#log_group_arn_list}
    */
...
export class CcLogAnomalyDetector extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLogAnomalyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_log_anomaly_detector#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcLogAnomalyDetectorProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcLogAnomalyDetectorProps = {}) {
        super(scope, id, {
...
export namespace CcLogAnomalyDetector {
}
