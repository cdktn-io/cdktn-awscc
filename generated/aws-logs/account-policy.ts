...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcAccountPolicyProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#policy_document CcAccountPolicy#policy_document}
    */
    readonly policyDocument: string;
    /**
    * The name of the account policy
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#policy_name CcAccountPolicy#policy_name}
    */
    readonly policyName: string;
    /**
    * Type of the policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#policy_type CcAccountPolicy#policy_type}
    */
    readonly policyType: string;
    /**
    * Scope for policy application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#scope CcAccountPolicy#scope}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#selection_criteria CcAccountPolicy#selection_criteria}
    */
    readonly selectionCriteria?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy awscc_logs_account_policy}
*/
export class CcAccountPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccountPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/logs_account_policy awscc_logs_account_policy} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcAccountPolicyProps
    */
    public constructor(scope: Construct, id: string, config: CcAccountPolicyProps) {
        super(scope, id, {
...
export namespace CcAccountPolicy {
}
