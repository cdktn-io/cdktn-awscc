...
export interface CcAccountPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#policy_document CcAccountPolicy#policy_document}
    */
    readonly policyDocument: string;
    /**
    * The name of the account policy
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#policy_name CcAccountPolicy#policy_name}
    */
    readonly policyName: string;
    /**
    * Type of the policy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#policy_type CcAccountPolicy#policy_type}
    */
    readonly policyType: string;
    /**
    * Scope for policy application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#scope CcAccountPolicy#scope}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#selection_criteria CcAccountPolicy#selection_criteria}
    */
...
export class CcAccountPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccountPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_account_policy#import import section} in the documentation of this resource for the id to use
