...
export interface CcStorageTierPolicyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_storage_tier_policy#storage_tier CcStorageTierPolicy#storage_tier}
    */
...
export class CcStorageTierPolicy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStorageTierPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/logs_storage_tier_policy#import import section} in the documentation of this resource for the id to use
