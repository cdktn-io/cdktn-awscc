...
export interface CcQueryDefinitionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#log_group_names CcQueryDefinition#log_group_names}
    */
    readonly logGroupNames?: string[];
    /**
    * A name for the saved query definition
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#name CcQueryDefinition#name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#parameters CcQueryDefinition#parameters}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#query_language CcQueryDefinition#query_language}
    */
    readonly queryLanguage?: string;
    /**
    * The query string to use for this definition
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#query_string CcQueryDefinition#query_string}
    */
...
export class CcQueryDefinition extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcQueryDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#import import section} in the documentation of this resource for the id to use
...
export interface QueryParameterProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#default_value CcQueryDefinition#default_value}
    */
    readonly defaultValue?: string;
    /**
    * A description of the query parameter that explains its purpose or expected values.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_query_definition#description CcQueryDefinition#description}
    */
