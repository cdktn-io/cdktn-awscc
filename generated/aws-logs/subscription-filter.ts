...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcSubscriptionFilterProps extends cdktn.TerraformMetaArguments {
    /**
    * This parameter is valid only for log groups that have an active log transformer. For more information about log transformers, see [PutTransformer](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutTransformer.html).
    *  If this value is ``true``, the subscription filter is applied on the transformed version of the log events instead of the original ingested log events.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#apply_on_transformed_logs CcSubscriptionFilter#apply_on_transformed_logs}
    */
    readonly applyOnTransformedLogs?: boolean | cdktn.IResolvable;
    /**
    * The Amazon Resource Name (ARN) of the destination.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#destination_arn CcSubscriptionFilter#destination_arn}
    */
    readonly destinationArn: string;
    /**
    * The method used to distribute log data to the destination, which can be either random or grouped by log stream.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#distribution CcSubscriptionFilter#distribution}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#emit_system_fields CcSubscriptionFilter#emit_system_fields}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#field_selection_criteria CcSubscriptionFilter#field_selection_criteria}
    */
    readonly fieldSelectionCriteria?: string;
    /**
    * The name of the subscription filter.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#filter_name CcSubscriptionFilter#filter_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#filter_pattern CcSubscriptionFilter#filter_pattern}
    */
    readonly filterPattern: string;
    /**
    * The log group to associate with the subscription filter. All log events that are uploaded to this log group are filtered and delivered to the specified AWS resource if the filter pattern matches the log events.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#log_group_name CcSubscriptionFilter#log_group_name}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#role_arn CcSubscriptionFilter#role_arn}
    */
...
export class CcSubscriptionFilter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcSubscriptionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/logs_subscription_filter#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcSubscriptionFilterProps
    */
    public constructor(scope: Construct, id: string, config: CcSubscriptionFilterProps) {
        super(scope, id, {
...
export namespace CcSubscriptionFilter {
}
