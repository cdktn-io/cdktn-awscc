...
export interface CcDomainProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#domain_name CcDomain#domain_name}
    */
    readonly domainName: string;
    /**
    * The access control resource policy on the provided domain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#permissions_policy_document CcDomain#permissions_policy_document}
    */
    readonly permissionsPolicyDocument?: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#tags CcDomain#tags}
    */
...
export class CcDomain extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#key CcDomain#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codeartifact_domain#value CcDomain#value}
    */
