...
export interface CcRepositoryProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#description CcRepository#description}
    */
    readonly description?: string;
    /**
    * The name of the domain that contains the repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#domain_name CcRepository#domain_name}
    */
    readonly domainName: string;
    /**
    * A list of external connections associated with the repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#external_connections CcRepository#external_connections}
    */
    readonly externalConnections?: string[];
    /**
    * The access control resource policy on the provided repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#permissions_policy_document CcRepository#permissions_policy_document}
    */
    readonly permissionsPolicyDocument?: string;
    /**
    * The name of the repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#repository_name CcRepository#repository_name}
    */
    readonly repositoryName: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#tags CcRepository#tags}
    */
    readonly tags?: CcRepository.TagProperty[] | cdktn.IResolvable;
    /**
    * A list of upstream repositories associated with the repository.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#upstreams CcRepository#upstreams}
    */
...
export class CcRepository extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#import import section} in the documentation of this resource for the id to use
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#key CcRepository#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/codeartifact_repository#value CcRepository#value}
    */
