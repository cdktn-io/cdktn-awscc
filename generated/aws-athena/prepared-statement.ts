...
export interface CcPreparedStatementProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/athena_prepared_statement#description CcPreparedStatement#description}
    */
    readonly description?: string;
    /**
    * The query string for the prepared statement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/athena_prepared_statement#query_statement CcPreparedStatement#query_statement}
    */
    readonly queryStatement: string;
    /**
    * The name of the prepared statement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/athena_prepared_statement#statement_name CcPreparedStatement#statement_name}
    */
    readonly statementName: string;
    /**
    * The name of the workgroup to which the prepared statement belongs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/athena_prepared_statement#work_group CcPreparedStatement#work_group}
    */
...
export class CcPreparedStatement extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPreparedStatement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/athena_prepared_statement#import import section} in the documentation of this resource for the id to use
