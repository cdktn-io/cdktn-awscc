...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcPreparedStatementProps extends cdktn.TerraformMetaArguments {
    /**
    * The description of the prepared statement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement#description CcPreparedStatement#description}
    */
    readonly description?: string;
    /**
    * The query string for the prepared statement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement#query_statement CcPreparedStatement#query_statement}
    */
    readonly queryStatement: string;
    /**
    * The name of the prepared statement.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement#statement_name CcPreparedStatement#statement_name}
    */
    readonly statementName: string;
    /**
    * The name of the workgroup to which the prepared statement belongs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement#work_group CcPreparedStatement#work_group}
    */
    readonly workGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement awscc_athena_prepared_statement}
*/
export class CcPreparedStatement extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcPreparedStatement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/athena_prepared_statement awscc_athena_prepared_statement} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcPreparedStatementProps
    */
    public constructor(scope: Construct, id: string, config: CcPreparedStatementProps) {
        super(scope, id, {
...
export namespace CcPreparedStatement {
}
