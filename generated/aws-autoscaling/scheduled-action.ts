...
export interface CcScheduledActionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#auto_scaling_group_name CcScheduledAction#auto_scaling_group_name}
    */
    readonly autoScalingGroupName: string;
    /**
    * The desired capacity is the initial capacity of the Auto Scaling group after the scheduled action runs and the capacity it attempts to maintain.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#desired_capacity CcScheduledAction#desired_capacity}
    */
    readonly desiredCapacity?: number;
    /**
    * The latest scheduled start time to return. If scheduled action names are provided, this parameter is ignored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#end_time CcScheduledAction#end_time}
    */
    readonly endTime?: string;
    /**
    * The minimum size of the Auto Scaling group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#max_size CcScheduledAction#max_size}
    */
    readonly maxSize?: number;
    /**
    * The minimum size of the Auto Scaling group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#min_size CcScheduledAction#min_size}
    */
    readonly minSize?: number;
    /**
    * The recurring schedule for the action, in Unix cron syntax format. When StartTime and EndTime are specified with Recurrence , they form the boundaries of when the recurring action starts and stops.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#recurrence CcScheduledAction#recurrence}
    */
    readonly recurrence?: string;
    /**
    * The earliest scheduled start time to return. If scheduled action names are provided, this parameter is ignored.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#start_time CcScheduledAction#start_time}
    */
    readonly startTime?: string;
    /**
    * The time zone for the cron expression.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#time_zone CcScheduledAction#time_zone}
    */
...
export class CcScheduledAction extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcScheduledAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/autoscaling_scheduled_action#import import section} in the documentation of this resource for the id to use
