...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcLaunchConfigurationProps extends cdktn.TerraformMetaArguments {
    /**
    * For Auto Scaling groups that are running in a virtual private cloud (VPC), specifies whether to assign a public IP address to the group's instances.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#associate_public_ip_address CcLaunchConfiguration#associate_public_ip_address}
    */
    readonly associatePublicIpAddress?: boolean | cdktn.IResolvable;
    /**
    * Specifies how block devices are exposed to the instance. You can specify virtual devices and EBS volumes.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#block_device_mappings CcLaunchConfiguration#block_device_mappings}
    */
    readonly blockDeviceMappings?: CcLaunchConfiguration.BlockDeviceMappingProperty[] | cdktn.IResolvable;
    /**
    * The ID of a ClassicLink-enabled VPC to link your EC2-Classic instances to.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#classic_link_vpc_id CcLaunchConfiguration#classic_link_vpc_id}
    */
    readonly classicLinkVpcId?: string;
    /**
    * The IDs of one or more security groups for the VPC that you specified in the ClassicLinkVPCId property.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#classic_link_vpc_security_groups CcLaunchConfiguration#classic_link_vpc_security_groups}
    */
    readonly classicLinkVpcSecurityGroups?: string[];
    /**
    * Specifies whether the launch configuration is optimized for EBS I/O (true) or not (false).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#ebs_optimized CcLaunchConfiguration#ebs_optimized}
    */
    readonly ebsOptimized?: boolean | cdktn.IResolvable;
    /**
    * Provides the name or the Amazon Resource Name (ARN) of the instance profile associated with the IAM role for the instance. The instance profile contains the IAM role.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#iam_instance_profile CcLaunchConfiguration#iam_instance_profile}
    */
    readonly iamInstanceProfile?: string;
    /**
    * Provides the unique ID of the Amazon Machine Image (AMI) that was assigned during registration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#image_id CcLaunchConfiguration#image_id}
    */
    readonly imageId: string;
    /**
    * The ID of the Amazon EC2 instance you want to use to create the launch configuration.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#instance_id CcLaunchConfiguration#instance_id}
    */
    readonly instanceId?: string;
    /**
    * Controls whether instances in this group are launched with detailed (true) or basic (false) monitoring.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#instance_monitoring CcLaunchConfiguration#instance_monitoring}
    */
    readonly instanceMonitoring?: boolean | cdktn.IResolvable;
    /**
    * Specifies the instance type of the EC2 instance.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#instance_type CcLaunchConfiguration#instance_type}
    */
    readonly instanceType: string;
    /**
    * Provides the ID of the kernel associated with the EC2 AMI.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#kernel_id CcLaunchConfiguration#kernel_id}
    */
    readonly kernelId?: string;
    /**
    * Provides the name of the EC2 key pair.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#key_name CcLaunchConfiguration#key_name}
    */
    readonly keyName?: string;
    /**
    * The name of the launch configuration. This name must be unique per Region per account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#launch_configuration_name CcLaunchConfiguration#launch_configuration_name}
    */
    readonly launchConfigurationName?: string;
    /**
    * The metadata options for the instances.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#metadata_options CcLaunchConfiguration#metadata_options}
    */
    readonly metadataOptions?: CcLaunchConfiguration.MetadataOptionsProperty;
    /**
    * The tenancy of the instance, either default or dedicated.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#placement_tenancy CcLaunchConfiguration#placement_tenancy}
    */
    readonly placementTenancy?: string;
    /**
    * The ID of the RAM disk to select.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#ram_disk_id CcLaunchConfiguration#ram_disk_id}
    */
    readonly ramDiskId?: string;
    /**
    * A list that contains the security groups to assign to the instances in the Auto Scaling group.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#security_groups CcLaunchConfiguration#security_groups}
    */
    readonly securityGroups?: string[];
    /**
    * The maximum hourly price you are willing to pay for any Spot Instances launched to fulfill the request.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#spot_price CcLaunchConfiguration#spot_price}
    */
    readonly spotPrice?: string;
    /**
    * The Base64-encoded user data to make available to the launched EC2 instances.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#user_data CcLaunchConfiguration#user_data}
    */
    readonly userData?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration awscc_autoscaling_launch_configuration}
*/
export class CcLaunchConfiguration extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcLaunchConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration awscc_autoscaling_launch_configuration} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcLaunchConfigurationProps
    */
    public constructor(scope: Construct, id: string, config: CcLaunchConfigurationProps) {
        super(scope, id, {
    ...
    private _blockDeviceMappings = new CcLaunchConfiguration.BlockDeviceMappingPropertyList(this, "block_device_mappings", true);
    public get blockDeviceMappings() {
        return this._blockDeviceMappings;
    }
    public putBlockDeviceMappings(value: CcLaunchConfiguration.BlockDeviceMappingProperty[] | cdktn.IResolvable) {
    ...
    private _metadataOptions = new CcLaunchConfiguration.MetadataOptionsPropertyOutputReference(this, "metadata_options");
    public get metadataOptions() {
        return this._metadataOptions;
    }
    public putMetadataOptions(value: CcLaunchConfiguration.MetadataOptionsProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            block_device_mappings: cdktn.listMapper(ccLaunchConfigurationBlockDeviceMappingPropertyToTerraform, false)(this._blockDeviceMappings.internalValue),
            ...
            metadata_options: ccLaunchConfigurationMetadataOptionsPropertyToTerraform(this._metadataOptions.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            block_device_mappings: {
                value: cdktn.listMapperHcl(ccLaunchConfigurationBlockDeviceMappingPropertyToHclTerraform, false)(this._blockDeviceMappings.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcLaunchConfiguration.BlockDeviceMappingPropertyList",
            },
            classic_link_vpc_id: {
            ...
            metadata_options: {
                value: ccLaunchConfigurationMetadataOptionsPropertyToHclTerraform(this._metadataOptions.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcLaunchConfiguration.MetadataOptionsProperty",
            },
            placement_tenancy: {
...
export function ccLaunchConfigurationBlockDevicePropertyToTerraform(struct?: CcLaunchConfiguration.BlockDeviceProperty | cdktn.IResolvable): any {
...
export function ccLaunchConfigurationBlockDevicePropertyToHclTerraform(struct?: CcLaunchConfiguration.BlockDeviceProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLaunchConfigurationBlockDeviceMappingPropertyToTerraform(struct?: CcLaunchConfiguration.BlockDeviceMappingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        ebs: ccLaunchConfigurationBlockDevicePropertyToTerraform(struct!.ebs),
...
export function ccLaunchConfigurationBlockDeviceMappingPropertyToHclTerraform(struct?: CcLaunchConfiguration.BlockDeviceMappingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        ebs: {
            value: ccLaunchConfigurationBlockDevicePropertyToHclTerraform(struct!.ebs),
            isBlock: true,
            type: "struct",
            storageClassType: "BlockDeviceProperty",
        },
        no_device: {
...
export function ccLaunchConfigurationMetadataOptionsPropertyToTerraform(struct?: CcLaunchConfiguration.MetadataOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccLaunchConfigurationMetadataOptionsPropertyToHclTerraform(struct?: CcLaunchConfiguration.MetadataOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcLaunchConfiguration {
export interface BlockDeviceProperty {
    /**
    * Indicates whether the volume is deleted on instance termination. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#delete_on_termination CcLaunchConfiguration#delete_on_termination}
    */
    readonly deleteOnTermination?: boolean | cdktn.IResolvable;
    /**
    * Specifies whether the volume should be encrypted. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#encrypted CcLaunchConfiguration#encrypted}
    */
    readonly encrypted?: boolean | cdktn.IResolvable;
    /**
    * The number of input/output (I/O) operations per second (IOPS) to provision for the volume. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#iops CcLaunchConfiguration#iops}
    */
    readonly iops?: number;
    /**
    * The snapshot ID of the volume to use.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#snapshot_id CcLaunchConfiguration#snapshot_id}
    */
    readonly snapshotId?: string;
    /**
    * The throughput (MiBps) to provision for a gp3 volume.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#throughput CcLaunchConfiguration#throughput}
    */
    readonly throughput?: number;
    /**
    * The volume size, in GiBs.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#volume_size CcLaunchConfiguration#volume_size}
    */
    readonly volumeSize?: number;
    /**
    * The volume type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#volume_type CcLaunchConfiguration#volume_type}
    */
    readonly volumeType?: string;
}
export class BlockDevicePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): BlockDeviceProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: BlockDeviceProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export interface BlockDeviceMappingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#device_name CcLaunchConfiguration#device_name}
    */
    readonly deviceName?: string;
    /**
    * Parameters used to automatically set up EBS volumes when an instance is launched.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#ebs CcLaunchConfiguration#ebs}
    */
    readonly ebs?: BlockDeviceProperty;
    /**
    * Setting this value to true suppresses the specified device included in the block device mapping of the AMI.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#no_device CcLaunchConfiguration#no_device}
    */
    readonly noDevice?: boolean | cdktn.IResolvable;
    /**
    * The name of the virtual device.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#virtual_name CcLaunchConfiguration#virtual_name}
    */
...
export class BlockDeviceMappingPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    private _ebs = new BlockDevicePropertyOutputReference(this, "ebs");
    public get ebs() {
        return this._ebs;
    }
    public putEbs(value: BlockDeviceProperty) {
...
export interface MetadataOptionsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#http_endpoint CcLaunchConfiguration#http_endpoint}
    */
    readonly httpEndpoint?: string;
    /**
    * The desired HTTP PUT response hop limit for instance metadata requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#http_put_response_hop_limit CcLaunchConfiguration#http_put_response_hop_limit}
    */
    readonly httpPutResponseHopLimit?: number;
    /**
    * The state of token usage for your instance metadata requests.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/autoscaling_launch_configuration#http_tokens CcLaunchConfiguration#http_tokens}
    */
