...
export interface CcGameSessionQueueProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#custom_event_data CcGameSessionQueue#custom_event_data}
    */
    readonly customEventData?: string;
    /**
    * A list of fleets and/or fleet aliases that can be used to fulfill game session placement requests in the queue.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#destinations CcGameSessionQueue#destinations}
    */
    readonly destinations?: CcGameSessionQueue.GameSessionQueueDestinationProperty[] | cdktn.IResolvable;
    /**
    * A list of locations where a queue is allowed to place new game sessions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#filter_configuration CcGameSessionQueue#filter_configuration}
    */
    readonly filterConfiguration?: CcGameSessionQueue.FilterConfigurationProperty;
    /**
    * A descriptive label that is associated with game session queue. Queue names must be unique within each Region.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#name CcGameSessionQueue#name}
    */
    readonly name: string;
    /**
    * An SNS topic ARN that is set up to receive game session placement notifications.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#notification_target CcGameSessionQueue#notification_target}
    */
    readonly notificationTarget?: string;
    /**
    * A set of policies that act as a sliding cap on player latency.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#player_latency_policies CcGameSessionQueue#player_latency_policies}
    */
    readonly playerLatencyPolicies?: CcGameSessionQueue.PlayerLatencyPolicyProperty[] | cdktn.IResolvable;
    /**
    * Custom settings to use when prioritizing destinations and locations for game session placements.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#priority_configuration CcGameSessionQueue#priority_configuration}
    */
    readonly priorityConfiguration?: CcGameSessionQueue.PriorityConfigurationProperty;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#tags CcGameSessionQueue#tags}
    */
    readonly tags?: CcGameSessionQueue.TagProperty[] | cdktn.IResolvable;
    /**
    * The maximum time, in seconds, that a new game session placement request remains in the queue.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#timeout_in_seconds CcGameSessionQueue#timeout_in_seconds}
    */
...
export class CcGameSessionQueue extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcGameSessionQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#import import section} in the documentation of this resource for the id to use
...
export interface GameSessionQueueDestinationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#destination_arn CcGameSessionQueue#destination_arn}
    */
...
export interface FilterConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#allowed_locations CcGameSessionQueue#allowed_locations}
    */
...
export interface PlayerLatencyPolicyProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#maximum_individual_player_latency_milliseconds CcGameSessionQueue#maximum_individual_player_latency_milliseconds}
    */
    readonly maximumIndividualPlayerLatencyMilliseconds?: number;
    /**
    * The length of time, in seconds, that the policy is enforced while placing a new game session.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#policy_duration_seconds CcGameSessionQueue#policy_duration_seconds}
    */
...
export interface PriorityConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#location_order CcGameSessionQueue#location_order}
    */
    readonly locationOrder?: string[];
    /**
    * The recommended sequence to use when prioritizing where to place new game sessions.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#priority_order CcGameSessionQueue#priority_order}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#key CcGameSessionQueue#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/gamelift_game_session_queue#value CcGameSessionQueue#value}
    */
