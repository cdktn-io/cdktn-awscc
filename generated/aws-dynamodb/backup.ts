...
export interface CcBackupProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dynamodb_backup#backup_name CcBackup#backup_name}
    */
    readonly backupName: string;
    /**
    * The name of the table to back up.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dynamodb_backup#table_name CcBackup#table_name}
    */
...
export class CcBackup extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dynamodb_backup#import import section} in the documentation of this resource for the id to use
