...
// https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcFilterProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#action CcFilter#action}
    */
    readonly action?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#description CcFilter#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#detector_id CcFilter#detector_id}
    */
    readonly detectorId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#finding_criteria CcFilter#finding_criteria}
    */
    readonly findingCriteria: CcFilter.FindingCriteriaProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#name CcFilter#name}
    */
    readonly name: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#rank CcFilter#rank}
    */
    readonly rank?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#tags CcFilter#tags}
    */
...
export class CcFilter extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _findingCriteria = new CcFilter.FindingCriteriaPropertyOutputReference(this, "finding_criteria");
    public get findingCriteria() {
        return this._findingCriteria;
    }
    public putFindingCriteria(value: CcFilter.FindingCriteriaProperty) {
    ...
    private _tags = new CcFilter.TagItemPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcFilter.TagItemProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            finding_criteria: ccFilterFindingCriteriaPropertyToTerraform(this._findingCriteria.internalValue),
            name: cdktn.stringToTerraform(this._name),
            rank: cdktn.numberToTerraform(this._rank),
            tags: cdktn.listMapper(ccFilterTagItemPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            finding_criteria: {
                value: ccFilterFindingCriteriaPropertyToHclTerraform(this._findingCriteria.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcFilter.FindingCriteriaProperty",
            },
            name: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccFilterTagItemPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcFilter.TagItemPropertyList",
            },
        };
...
export function ccFilterConditionPropertyToTerraform(struct?: CcFilter.ConditionProperty | cdktn.IResolvable): any {
...
export function ccFilterConditionPropertyToHclTerraform(struct?: CcFilter.ConditionProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFilterFindingCriteriaPropertyToTerraform(struct?: CcFilter.FindingCriteriaProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        criterion: cdktn.hashMapper(ccFilterConditionPropertyToTerraform)(struct!.criterion),
    }
}


export function ccFilterFindingCriteriaPropertyToHclTerraform(struct?: CcFilter.FindingCriteriaProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        criterion: {
            value: cdktn.hashMapperHcl(ccFilterConditionPropertyToHclTerraform)(struct!.criterion),
            isBlock: true,
            type: "map",
            storageClassType: "ConditionPropertyMap",
        },
    };
...
export function ccFilterTagItemPropertyToTerraform(struct?: CcFilter.TagItemProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccFilterTagItemPropertyToHclTerraform(struct?: CcFilter.TagItemProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface ConditionProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#eq CcFilter#eq}
    */
    readonly eq?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#equals CcFilter#equals}
    */
    readonly equalTo?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#greater_than CcFilter#greater_than}
    */
    readonly greaterThan?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#greater_than_or_equal CcFilter#greater_than_or_equal}
    */
    readonly greaterThanOrEqual?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#gt CcFilter#gt}
    */
    readonly gt?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#gte CcFilter#gte}
    */
    readonly gte?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#less_than CcFilter#less_than}
    */
    readonly lessThan?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#less_than_or_equal CcFilter#less_than_or_equal}
    */
    readonly lessThanOrEqual?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#lt CcFilter#lt}
    */
    readonly lt?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#lte CcFilter#lte}
    */
    readonly lte?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#matches CcFilter#matches}
    */
    readonly matches?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#neq CcFilter#neq}
    */
    readonly neq?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#not_equals CcFilter#not_equals}
    */
    readonly notEquals?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#not_matches CcFilter#not_matches}
    */
...
export class ConditionPropertyMap extends cdktn.ComplexMap {
    public internalValue? : { [key: string]: ConditionProperty } | cdktn.IResolvable
    ...
    */
    public get(key: string): ConditionPropertyOutputReference {
        return new ConditionPropertyOutputReference(this.terraformResource, this.terraformAttribute, key);
    }
}
export interface FindingCriteriaProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#criterion CcFilter#criterion}
    */
...
export class FindingCriteriaPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    private _criterion = new ConditionPropertyMap(this, "criterion");
    public get criterion() {
        return this._criterion;
    }
    public putCriterion(value: { [key: string]: ConditionProperty } | cdktn.IResolvable) {
...
export interface TagItemProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#key CcFilter#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/guardduty_filter#value CcFilter#value}
    */
