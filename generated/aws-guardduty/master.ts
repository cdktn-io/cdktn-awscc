...
export interface CcMasterProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_master#detector_id CcMaster#detector_id}
    */
    readonly detectorId: string;
    /**
    * Value used to validate the master account to the member account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_master#invitation_id CcMaster#invitation_id}
    */
    readonly invitationId?: string;
    /**
    * ID of the account used as the master account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_master#master_id CcMaster#master_id}
    */
...
export class CcMaster extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMaster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/guardduty_master#import import section} in the documentation of this resource for the id to use
