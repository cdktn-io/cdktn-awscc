...
export interface CcInferenceSchedulerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#data_delay_offset_in_minutes CcInferenceScheduler#data_delay_offset_in_minutes}
    */
    readonly dataDelayOffsetInMinutes?: number;
    /**
    * Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#data_input_configuration CcInferenceScheduler#data_input_configuration}
    */
    readonly dataInputConfiguration: CcInferenceScheduler.DataInputConfigurationProperty;
    /**
    * Specifies configuration information for the output results for the inference scheduler, including the S3 location for the output.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#data_output_configuration CcInferenceScheduler#data_output_configuration}
    */
    readonly dataOutputConfiguration: CcInferenceScheduler.DataOutputConfigurationProperty;
    /**
    * How often data is uploaded to the source S3 bucket for the input data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#data_upload_frequency CcInferenceScheduler#data_upload_frequency}
    */
    readonly dataUploadFrequency: string;
    /**
    * The name of the inference scheduler being created.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#inference_scheduler_name CcInferenceScheduler#inference_scheduler_name}
    */
    readonly inferenceSchedulerName?: string;
    /**
    * The name of the previously trained ML model being used to create the inference scheduler.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#model_name CcInferenceScheduler#model_name}
    */
    readonly modelName: string;
    /**
    * The Amazon Resource Name (ARN) of a role with permission to access the data source being used for the inference.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#role_arn CcInferenceScheduler#role_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#server_side_kms_key_id CcInferenceScheduler#server_side_kms_key_id}
    */
    readonly serverSideKmsKeyId?: string;
    /**
    * Any tags associated with the inference scheduler.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#tags CcInferenceScheduler#tags}
    */
...
export class CcInferenceScheduler extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcInferenceScheduler that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#import import section} in the documentation of this resource for the id to use
...
export interface InputNameConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#component_timestamp_delimiter CcInferenceScheduler#component_timestamp_delimiter}
    */
    readonly componentTimestampDelimiter?: string;
    /**
    * The format of the timestamp, whether Epoch time, or standard, with or without hyphens (-).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#timestamp_format CcInferenceScheduler#timestamp_format}
    */
...
export interface S3InputConfigurationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#bucket CcInferenceScheduler#bucket}
    */
    readonly bucket: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#prefix CcInferenceScheduler#prefix}
    */
...
export interface DataInputConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#inference_input_name_configuration CcInferenceScheduler#inference_input_name_configuration}
    */
    readonly inferenceInputNameConfiguration?: InputNameConfigurationProperty;
    /**
    * Indicates the difference between your time zone and Greenwich Mean Time (GMT).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#input_time_zone_offset CcInferenceScheduler#input_time_zone_offset}
    */
    readonly inputTimeZoneOffset?: string;
    /**
    * Specifies configuration information for the input data for the inference, including input data S3 location.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#s3_input_configuration CcInferenceScheduler#s3_input_configuration}
    */
...
export interface DataOutputConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#kms_key_id CcInferenceScheduler#kms_key_id}
    */
    readonly kmsKeyId?: string;
    /**
    * Specifies configuration information for the output results from the inference, including output S3 location.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#s3_output_configuration CcInferenceScheduler#s3_output_configuration}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#key CcInferenceScheduler#key}
    */
    readonly key?: string;
    /**
    * The value for the specified tag.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/lookoutequipment_inference_scheduler#value CcInferenceScheduler#value}
    */
