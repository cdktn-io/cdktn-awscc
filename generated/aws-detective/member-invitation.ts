...
export interface CcMemberInvitationProps extends cdktn.TerraformMetaArguments {
    /**
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#disable_email_notification CcMemberInvitation#disable_email_notification}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#graph_arn CcMemberInvitation#graph_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#member_email_address CcMemberInvitation#member_email_address}
    */
    readonly memberEmailAddress: string;
    /**
    * The AWS account ID to be invited to join the graph as a member
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#member_id CcMemberInvitation#member_id}
    */
    readonly memberId: string;
    /**
    * A message to be included in the email invitation sent to the invited account. Updating this field has no effect.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#message CcMemberInvitation#message}
    */
...
export class CcMemberInvitation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcMemberInvitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/detective_member_invitation#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcMemberInvitationProps
    */
    public constructor(scope: Construct, id: string, config: CcMemberInvitationProps) {
        super(scope, id, {
...
export namespace CcMemberInvitation {
}
