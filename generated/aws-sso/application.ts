...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application
...
export interface CcApplicationProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#application_provider_arn CcApplication#application_provider_arn}
    */
    readonly applicationProviderArn: string;
    /**
    * The description information for the Identity Center (SSO) Application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#description CcApplication#description}
    */
    readonly description?: string;
    /**
    * The ARN of the instance of IAM Identity Center under which the operation will run
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#instance_arn CcApplication#instance_arn}
    */
    readonly instanceArn: string;
    /**
    * The name you want to assign to this Identity Center (SSO) Application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#name CcApplication#name}
    */
    readonly name: string;
    /**
    * A structure that describes the options for the portal associated with an application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#portal_options CcApplication#portal_options}
    */
    readonly portalOptions?: CcApplication.PortalOptionsConfigurationProperty;
    /**
    * Specifies whether the application is enabled or disabled
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#status CcApplication#status}
    */
    readonly status?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#tags CcApplication#tags}
    */
    readonly tags?: CcApplication.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application awscc_sso_application}
*/
export class CcApplication extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application awscc_sso_application} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _portalOptions = new CcApplication.PortalOptionsConfigurationPropertyOutputReference(this, "portal_options");
    public get portalOptions() {
        return this._portalOptions;
    }
    public putPortalOptions(value: CcApplication.PortalOptionsConfigurationProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            portal_options: ccApplicationPortalOptionsConfigurationPropertyToTerraform(this._portalOptions.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            portal_options: {
                value: ccApplicationPortalOptionsConfigurationPropertyToHclTerraform(this._portalOptions.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcApplication.PortalOptionsConfigurationProperty",
            },
            status: {
...
export function ccApplicationSignInOptionsPropertyToTerraform(struct?: CcApplication.SignInOptionsProperty | cdktn.IResolvable): any {
...
export function ccApplicationSignInOptionsPropertyToHclTerraform(struct?: CcApplication.SignInOptionsProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccApplicationPortalOptionsConfigurationPropertyToTerraform(struct?: CcApplication.PortalOptionsConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        sign_in_options: ccApplicationSignInOptionsPropertyToTerraform(struct!.signInOptions),
        visibility: cdktn.stringToTerraform(struct!.visibility),
    }
}


export function ccApplicationPortalOptionsConfigurationPropertyToHclTerraform(struct?: CcApplication.PortalOptionsConfigurationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        sign_in_options: {
            value: ccApplicationSignInOptionsPropertyToHclTerraform(struct!.signInOptions),
            isBlock: true,
            type: "struct",
            storageClassType: "SignInOptionsProperty",
        },
        visibility: {
...
export interface SignInOptionsProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#application_url CcApplication#application_url}
    */
    readonly applicationUrl?: string;
    /**
    * This determines how IAM Identity Center navigates the user to the target application
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#origin CcApplication#origin}
    */
...
export interface PortalOptionsConfigurationProperty {
    /**
    * A structure that describes the sign-in options for the access portal
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#sign_in_options CcApplication#sign_in_options}
    */
    readonly signInOptions?: SignInOptionsProperty;
    /**
    * Indicates whether this application is visible in the access portal
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#visibility CcApplication#visibility}
    */
    readonly visibility?: string;
}
export class PortalOptionsConfigurationPropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): PortalOptionsConfigurationProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: PortalOptionsConfigurationProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
    ...
    private _signInOptions = new SignInOptionsPropertyOutputReference(this, "sign_in_options");
    public get signInOptions() {
        return this._signInOptions;
    }
    public putSignInOptions(value: SignInOptionsProperty) {
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#key CcApplication#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/sso_application#value CcApplication#value}
    */
