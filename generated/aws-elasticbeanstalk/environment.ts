...
export interface CcEnvironmentProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#application_name CcEnvironment#application_name}
    */
    readonly applicationName: string;
    /**
    * If specified, the environment attempts to use this value as the prefix for the CNAME in your Elastic Beanstalk environment URL. If not specified, the CNAME is generated automatically by appending a random alphanumeric string to the environment name.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#cname_prefix CcEnvironment#cname_prefix}
    */
    readonly cnamePrefix?: string;
    /**
    * Your description for this environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#description CcEnvironment#description}
    */
    readonly description?: string;
    /**
    * A unique name for the environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#environment_name CcEnvironment#environment_name}
    */
    readonly environmentName?: string;
    /**
    * The Amazon Resource Name (ARN) of an existing IAM role to be used as the environment's operations role.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#operations_role CcEnvironment#operations_role}
    */
    readonly operationsRole?: string;
    /**
    * Key-value pairs defining configuration options for this environment, such as the instance type.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#option_settings CcEnvironment#option_settings}
    */
    readonly optionSettings?: CcEnvironment.OptionSettingProperty[] | cdktn.IResolvable;
    /**
    * The Amazon Resource Name (ARN) of the custom platform to use with the environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#platform_arn CcEnvironment#platform_arn}
    */
    readonly platformArn?: string;
    /**
    * The name of an Elastic Beanstalk solution stack (platform version) to use with the environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#solution_stack_name CcEnvironment#solution_stack_name}
    */
    readonly solutionStackName?: string;
    /**
    * Specifies the tags applied to resources in the environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#tags CcEnvironment#tags}
    */
    readonly tags?: CcEnvironment.TagProperty[] | cdktn.IResolvable;
    /**
    * The name of the Elastic Beanstalk configuration template to use with the environment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#template_name CcEnvironment#template_name}
    */
    readonly templateName?: string;
    /**
    * Specifies the tier to use in creating this environment. The environment tier that you choose determines whether Elastic Beanstalk provisions resources to support a web application that handles HTTP(S) requests or a web application that handles background-processing tasks.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#tier CcEnvironment#tier}
    */
    readonly tier?: CcEnvironment.TierProperty;
    /**
    * The name of the application version to deploy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#version_label CcEnvironment#version_label}
    */
...
export class CcEnvironment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#import import section} in the documentation of this resource for the id to use
...
export interface OptionSettingProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#namespace CcEnvironment#namespace}
    */
    readonly namespace?: string;
    /**
    * The name of the configuration option.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#option_name CcEnvironment#option_name}
    */
    readonly optionName?: string;
    /**
    * A unique resource name for the option setting. Use it for a time–based scaling configuration option.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#resource_name CcEnvironment#resource_name}
    */
    readonly resourceName?: string;
    /**
    * The current value for the configuration option.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#value CcEnvironment#value}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#key CcEnvironment#key}
    */
    readonly key?: string;
    /**
...
export interface TierProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#name CcEnvironment#name}
    */
    readonly name?: string;
    /**
    * The type of this environment tier.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#type CcEnvironment#type}
    */
    readonly type?: string;
    /**
    * The version of this environment tier. When you don't set a value to it, Elastic Beanstalk uses the latest compatible worker tier version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_environment#version CcEnvironment#version}
    */
