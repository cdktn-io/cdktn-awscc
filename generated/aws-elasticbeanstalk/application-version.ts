...
export interface CcApplicationVersionProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#application_name CcApplicationVersion#application_name}
    */
    readonly applicationName: string;
    /**
    * A description of this application version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#description CcApplicationVersion#description}
    */
    readonly description?: string;
    /**
    * The Amazon S3 bucket and key that identify the location of the source bundle for this version. 
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#source_bundle CcApplicationVersion#source_bundle}
    */
...
export class CcApplicationVersion extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcApplicationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#import import section} in the documentation of this resource for the id to use
...
export interface SourceBundleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#s3_bucket CcApplicationVersion#s3_bucket}
    */
    readonly s3Bucket: string;
    /**
    * The Amazon S3 key where the data is located.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/elasticbeanstalk_application_version#s3_key CcApplicationVersion#s3_key}
    */
