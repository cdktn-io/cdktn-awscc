...
// https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcUserPoolIdentityProviderProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#attribute_mapping CcUserPoolIdentityProvider#attribute_mapping}
    */
    readonly attributeMapping?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#idp_identifiers CcUserPoolIdentityProvider#idp_identifiers}
    */
    readonly idpIdentifiers?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#provider_details CcUserPoolIdentityProvider#provider_details}
    */
    readonly providerDetails: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#provider_name CcUserPoolIdentityProvider#provider_name}
    */
    readonly providerName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#provider_type CcUserPoolIdentityProvider#provider_type}
    */
    readonly providerType: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#user_pool_id CcUserPoolIdentityProvider#user_pool_id}
    */
...
export class CcUserPoolIdentityProvider extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUserPoolIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_identity_provider#import import section} in the documentation of this resource for the id to use
