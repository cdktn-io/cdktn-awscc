...
export interface CcUserPoolReplicaProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_replica#region_name CcUserPoolReplica#region_name}
    */
    readonly regionName: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_replica#user_pool_id CcUserPoolReplica#user_pool_id}
    */
    readonly userPoolId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_replica#user_pool_tags_at_create CcUserPoolReplica#user_pool_tags_at_create}
    */
...
export class CcUserPoolReplica extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUserPoolReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_user_pool_replica#import import section} in the documentation of this resource for the id to use
