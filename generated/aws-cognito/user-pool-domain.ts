...
export interface CcUserPoolDomainProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#custom_domain_config CcUserPoolDomain#custom_domain_config}
    */
    readonly customDomainConfig?: CcUserPoolDomain.CustomDomainConfigTypeProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#domain CcUserPoolDomain#domain}
    */
    readonly domain: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#managed_login_version CcUserPoolDomain#managed_login_version}
    */
    readonly managedLoginVersion?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#routing CcUserPoolDomain#routing}
    */
    readonly routing?: CcUserPoolDomain.RoutingTypeProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#user_pool_id CcUserPoolDomain#user_pool_id}
    */
...
export class CcUserPoolDomain extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUserPoolDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#import import section} in the documentation of this resource for the id to use
...
export interface CustomDomainConfigTypeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#certificate_arn CcUserPoolDomain#certificate_arn}
    */
    readonly certificateArn?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#security_policy CcUserPoolDomain#security_policy}
    */
...
export interface FailoverTypeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#primary_route_53_health_check_id CcUserPoolDomain#primary_route_53_health_check_id}
    */
    readonly primaryRoute53HealthCheckId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#secondary_region CcUserPoolDomain#secondary_region}
    */
...
export interface RoutingTypeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/cognito_user_pool_domain#failover CcUserPoolDomain#failover}
    */
