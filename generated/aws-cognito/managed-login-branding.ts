...
export interface CcManagedLoginBrandingProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#assets CcManagedLoginBranding#assets}
    */
    readonly assets?: CcManagedLoginBranding.AssetTypeProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#client_id CcManagedLoginBranding#client_id}
    */
    readonly clientId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#return_merged_resources CcManagedLoginBranding#return_merged_resources}
    */
    readonly returnMergedResources?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#settings CcManagedLoginBranding#settings}
    */
    readonly settings?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#use_cognito_provided_values CcManagedLoginBranding#use_cognito_provided_values}
    */
    readonly useCognitoProvidedValues?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#user_pool_id CcManagedLoginBranding#user_pool_id}
    */
...
export class CcManagedLoginBranding extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcManagedLoginBranding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcManagedLoginBrandingProps
    */
    public constructor(scope: Construct, id: string, config: CcManagedLoginBrandingProps) {
        super(scope, id, {
    ...
    private _assets = new CcManagedLoginBranding.AssetTypePropertyList(this, "assets", false);
    public get assets() {
        return this._assets;
    }
    public putAssets(value: CcManagedLoginBranding.AssetTypeProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            assets: cdktn.listMapper(ccManagedLoginBrandingAssetTypePropertyToTerraform, false)(this._assets.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            assets: {
                value: cdktn.listMapperHcl(ccManagedLoginBrandingAssetTypePropertyToHclTerraform, false)(this._assets.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcManagedLoginBranding.AssetTypePropertyList",
            },
            client_id: {
...
export function ccManagedLoginBrandingAssetTypePropertyToTerraform(struct?: CcManagedLoginBranding.AssetTypeProperty | cdktn.IResolvable): any {
...
export function ccManagedLoginBrandingAssetTypePropertyToHclTerraform(struct?: CcManagedLoginBranding.AssetTypeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface AssetTypeProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#bytes CcManagedLoginBranding#bytes}
    */
    readonly bytes?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#category CcManagedLoginBranding#category}
    */
    readonly category?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#color_mode CcManagedLoginBranding#color_mode}
    */
    readonly colorMode?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#extension CcManagedLoginBranding#extension}
    */
    readonly extension?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/cognito_managed_login_branding#resource_id CcManagedLoginBranding#resource_id}
    */
    readonly resourceId?: string;
}
export class AssetTypePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): AssetTypeProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: AssetTypeProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class AssetTypePropertyList extends cdktn.ComplexList {
    public internalValue? : AssetTypeProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): AssetTypePropertyOutputReference {
        return new AssetTypePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
}
