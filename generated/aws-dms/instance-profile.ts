...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcInstanceProfileProps extends cdktn.TerraformMetaArguments {
    /**
    * The property describes an availability zone of the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#availability_zone CcInstanceProfile#availability_zone}
    */
    readonly availabilityZone?: string;
    /**
    * The optional description of the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#description CcInstanceProfile#description}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#instance_profile_identifier CcInstanceProfile#instance_profile_identifier}
    */
    readonly instanceProfileIdentifier?: string;
    /**
    * The property describes a name for the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#instance_profile_name CcInstanceProfile#instance_profile_name}
    */
    readonly instanceProfileName?: string;
    /**
    * The property describes kms key arn for the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#kms_key_arn CcInstanceProfile#kms_key_arn}
    */
    readonly kmsKeyArn?: string;
    /**
    * The property describes a network type for the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#network_type CcInstanceProfile#network_type}
    */
    readonly networkType?: string;
    /**
    * The property describes the publicly accessible of the instance profile
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#publicly_accessible CcInstanceProfile#publicly_accessible}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#subnet_group_identifier CcInstanceProfile#subnet_group_identifier}
    */
    readonly subnetGroupIdentifier?: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#tags CcInstanceProfile#tags}
    */
    readonly tags?: CcInstanceProfile.TagProperty[] | cdktn.IResolvable;
    /**
    * The property describes vps security groups for the instance profile.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#vpc_security_groups CcInstanceProfile#vpc_security_groups}
    */
    readonly vpcSecurityGroups?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile awscc_dms_instance_profile}
*/
export class CcInstanceProfile extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcInstanceProfile resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcInstanceProfile to import
    * @param importFromId The id of the existing CcInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcInstanceProfile to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile awscc_dms_instance_profile} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcInstanceProfileProps = {}
    */
    public constructor(scope: Construct, id: string, config: CcInstanceProfileProps = {}) {
        super(scope, id, {
    ...
    private _tags = new CcInstanceProfile.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcInstanceProfile.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccInstanceProfileTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccInstanceProfileTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcInstanceProfile.TagPropertyList",
            },
            vpc_security_groups: {
...
export function ccInstanceProfileTagPropertyToTerraform(struct?: CcInstanceProfile.TagProperty | cdktn.IResolvable): any {
...
export function ccInstanceProfileTagPropertyToHclTerraform(struct?: CcInstanceProfile.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcInstanceProfile {
export interface TagProperty {
    /**
    * The key name of the tag. You can specify a value that is 1 to 128 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#key CcInstanceProfile#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_instance_profile#value CcInstanceProfile#value}
    */
