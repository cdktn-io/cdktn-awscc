...
export interface CcCertificateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_certificate#certificate_identifier CcCertificate#certificate_identifier}
    */
    readonly certificateIdentifier?: string;
    /**
    * The certificate Pem
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_certificate#certificate_pem CcCertificate#certificate_pem}
    */
    readonly certificatePem?: string;
    /**
    * The certificate Wallet
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_certificate#certificate_wallet CcCertificate#certificate_wallet}
    */
...
export class CcCertificate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/dms_certificate#import import section} in the documentation of this resource for the id to use
