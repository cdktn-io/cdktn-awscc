...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate
...
export interface CcCertificateProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate#certificate_identifier CcCertificate#certificate_identifier}
    */
    readonly certificateIdentifier?: string;
    /**
    * The certificate Pem
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate#certificate_pem CcCertificate#certificate_pem}
    */
    readonly certificatePem?: string;
    /**
    * The certificate Wallet
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate#certificate_wallet CcCertificate#certificate_wallet}
    */
    readonly certificateWallet?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate awscc_dms_certificate}
*/
export class CcCertificate extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/dms_certificate awscc_dms_certificate} Resource
    *
    * @param scope The scope in which to define this construct
