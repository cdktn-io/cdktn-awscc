...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcMethodProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#api_key_required CcMethod#api_key_required}
    */
    readonly apiKeyRequired?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#authorization_scopes CcMethod#authorization_scopes}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#authorization_type CcMethod#authorization_type}
    */
    readonly authorizationType?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#authorizer_id CcMethod#authorizer_id}
    */
    readonly authorizerId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#http_method CcMethod#http_method}
    */
    readonly httpMethod: string;
    /**
    * ``Integration`` is a property of the [AWS::ApiGateway::Method](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-method.html) resource that specifies information about the target backend that a method calls.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#integration CcMethod#integration}
    */
    readonly integration?: CcMethod.IntegrationProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#method_responses CcMethod#method_responses}
    */
    readonly methodResponses?: CcMethod.MethodResponseProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#operation_name CcMethod#operation_name}
    */
    readonly operationName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#request_models CcMethod#request_models}
    */
    readonly requestModels?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#request_parameters CcMethod#request_parameters}
    */
    readonly requestParameters?: { [key: string]: (boolean | cdktn.IResolvable) };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#request_validator_id CcMethod#request_validator_id}
    */
    readonly requestValidatorId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#resource_id CcMethod#resource_id}
    */
    readonly resourceId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#rest_api_id CcMethod#rest_api_id}
    */
    readonly restApiId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method awscc_apigateway_method}
*/
export class CcMethod extends cdktn.TerraformResource {
    ...
    // ==============
    /**
    * Generates CDKTN code for importing a CcMethod resource upon running "cdktn plan <stack-name>"
    * @param scope The scope in which to define this construct
    * @param importToId The construct id used in the generated config for the CcMethod to import
    * @param importFromId The id of the existing CcMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#import import section} in the documentation of this resource for the id to use
    * @param provider? Optional instance of the provider where the CcMethod to import is found
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method awscc_apigateway_method} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcMethodProps
    */
    public constructor(scope: Construct, id: string, config: CcMethodProps) {
        super(scope, id, {
    ...
    private _integration = new CcMethod.IntegrationPropertyOutputReference(this, "integration");
    public get integration() {
        return this._integration;
    }
    public putIntegration(value: CcMethod.IntegrationProperty) {
    ...
    private _methodResponses = new CcMethod.MethodResponsePropertyList(this, "method_responses", false);
    public get methodResponses() {
        return this._methodResponses;
    }
    public putMethodResponses(value: CcMethod.MethodResponseProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            integration: ccMethodIntegrationPropertyToTerraform(this._integration.internalValue),
            method_responses: cdktn.listMapper(ccMethodMethodResponsePropertyToTerraform, false)(this._methodResponses.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            integration: {
                value: ccMethodIntegrationPropertyToHclTerraform(this._integration.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcMethod.IntegrationProperty",
            },
            method_responses: {
                value: cdktn.listMapperHcl(ccMethodMethodResponsePropertyToHclTerraform, false)(this._methodResponses.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcMethod.MethodResponsePropertyList",
            },
            operation_name: {
...
export function ccMethodIntegrationResponsePropertyToTerraform(struct?: CcMethod.IntegrationResponseProperty | cdktn.IResolvable): any {
...
export function ccMethodIntegrationResponsePropertyToHclTerraform(struct?: CcMethod.IntegrationResponseProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccMethodIntegrationPropertyToTerraform(struct?: CcMethod.IntegrationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    return {
        ...
        integration_responses: cdktn.listMapper(ccMethodIntegrationResponsePropertyToTerraform, false)(struct!.integrationResponses),
...
export function ccMethodIntegrationPropertyToHclTerraform(struct?: CcMethod.IntegrationProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
    const attrs = {
        ...
        integration_responses: {
            value: cdktn.listMapperHcl(ccMethodIntegrationResponsePropertyToHclTerraform, false)(struct!.integrationResponses),
            isBlock: true,
            type: "list",
            storageClassType: "IntegrationResponsePropertyList",
        },
        integration_target: {
...
export function ccMethodMethodResponsePropertyToTerraform(struct?: CcMethod.MethodResponseProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccMethodMethodResponsePropertyToHclTerraform(struct?: CcMethod.MethodResponseProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcMethod {
export interface IntegrationResponseProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#content_handling CcMethod#content_handling}
    */
    readonly contentHandling?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#response_parameters CcMethod#response_parameters}
    */
    readonly responseParameters?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#response_templates CcMethod#response_templates}
    */
    readonly responseTemplates?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#selection_pattern CcMethod#selection_pattern}
    */
    readonly selectionPattern?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#status_code CcMethod#status_code}
    */
    readonly statusCode?: string;
}
export class IntegrationResponsePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): IntegrationResponseProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: IntegrationResponseProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class IntegrationResponsePropertyList extends cdktn.ComplexList {
    public internalValue? : IntegrationResponseProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): IntegrationResponsePropertyOutputReference {
        return new IntegrationResponsePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface IntegrationProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#cache_key_parameters CcMethod#cache_key_parameters}
    */
    readonly cacheKeyParameters?: string[];
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#cache_namespace CcMethod#cache_namespace}
    */
    readonly cacheNamespace?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#connection_id CcMethod#connection_id}
    */
    readonly connectionId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#connection_type CcMethod#connection_type}
    */
    ...
    */
    readonly contentHandling?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#credentials CcMethod#credentials}
    */
    readonly credentials?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#integration_http_method CcMethod#integration_http_method}
    */
    readonly integrationHttpMethod?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#integration_responses CcMethod#integration_responses}
    */
    readonly integrationResponses?: IntegrationResponseProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#integration_target CcMethod#integration_target}
    */
    readonly integrationTarget?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#passthrough_behavior CcMethod#passthrough_behavior}
    */
    ...
    */
    ...
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#request_templates CcMethod#request_templates}
    */
    readonly requestTemplates?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#response_transfer_mode CcMethod#response_transfer_mode}
    */
    readonly responseTransferMode?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#timeout_in_millis CcMethod#timeout_in_millis}
    */
    readonly timeoutInMillis?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#type CcMethod#type}
    */
    readonly type?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#uri CcMethod#uri}
    */
    readonly uri?: string;
}
export class IntegrationPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    private _integrationResponses = new IntegrationResponsePropertyList(this, "integration_responses", false);
    public get integrationResponses() {
        return this._integrationResponses;
    }
    public putIntegrationResponses(value: IntegrationResponseProperty[] | cdktn.IResolvable) {
...
export interface MethodResponseProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_method#response_models CcMethod#response_models}
    */
...
export class MethodResponsePropertyOutputReference extends cdktn.ComplexObject {
    private isEmptyObject = false;
    private resolvableValue?: cdktn.IResolvable;
    ...
    */
    ...
    public get internalValue(): MethodResponseProperty | cdktn.IResolvable | undefined {
        if (this.resolvableValue) {
            return this.resolvableValue;
        }
        let hasAnyValues = this.isEmptyObject;
    ...
    public set internalValue(value: MethodResponseProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
            this.isEmptyObject = false;
            this.resolvableValue = undefined;
...
export class MethodResponsePropertyList extends cdktn.ComplexList {
    public internalValue? : MethodResponseProperty[] | cdktn.IResolvable
    ...
    * @param index the index of the item to return
    */
    public get(index: number): MethodResponsePropertyOutputReference {
        return new MethodResponsePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
}
