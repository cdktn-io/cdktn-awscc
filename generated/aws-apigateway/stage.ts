...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface CcStageProps extends cdktn.TerraformMetaArguments {
    /**
    * The ``AccessLogSetting`` property type specifies settings for logging access in this stage.
    *  ``AccessLogSetting`` is a property of the [AWS::ApiGateway::Stage](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-stage.html) resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#access_log_setting CcStage#access_log_setting}
    */
    readonly accessLogSetting?: CcStage.AccessLogSettingProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#cache_cluster_enabled CcStage#cache_cluster_enabled}
    */
    readonly cacheClusterEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#cache_cluster_size CcStage#cache_cluster_size}
    */
    readonly cacheClusterSize?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#canary_setting CcStage#canary_setting}
    */
    readonly canarySetting?: CcStage.CanarySettingProperty;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#client_certificate_id CcStage#client_certificate_id}
    */
    readonly clientCertificateId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#deployment_id CcStage#deployment_id}
    */
    readonly deploymentId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#description CcStage#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#documentation_version CcStage#documentation_version}
    */
    readonly documentationVersion?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#method_settings CcStage#method_settings}
    */
    readonly methodSettings?: CcStage.MethodSettingProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#rest_api_id CcStage#rest_api_id}
    */
    readonly restApiId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#stage_name CcStage#stage_name}
    */
    readonly stageName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#tags CcStage#tags}
    */
    readonly tags?: CcStage.TagProperty[] | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#tracing_enabled CcStage#tracing_enabled}
    */
    readonly tracingEnabled?: boolean | cdktn.IResolvable;
    /**
    * A map (string-to-string map) that defines the stage variables, where the variable name is the key and the variable value is the value. Variable names are limited to alphanumeric characters. Values must match the following regular expression: ``[A-Za-z0-9-._~:/?#&=,]+``.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#variables CcStage#variables}
    */
    readonly variables?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage awscc_apigateway_stage}
*/
export class CcStage extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage awscc_apigateway_stage} Resource
    *
    * @param scope The scope in which to define this construct
    * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
    * @param options CcStageProps
    */
    public constructor(scope: Construct, id: string, config: CcStageProps) {
        super(scope, id, {
    ...
    private _accessLogSetting = new CcStage.AccessLogSettingPropertyOutputReference(this, "access_log_setting");
    public get accessLogSetting() {
        return this._accessLogSetting;
    }
    public putAccessLogSetting(value: CcStage.AccessLogSettingProperty) {
    ...
    private _canarySetting = new CcStage.CanarySettingPropertyOutputReference(this, "canary_setting");
    public get canarySetting() {
        return this._canarySetting;
    }
    public putCanarySetting(value: CcStage.CanarySettingProperty) {
    ...
    private _methodSettings = new CcStage.MethodSettingPropertyList(this, "method_settings", true);
    public get methodSettings() {
        return this._methodSettings;
    }
    public putMethodSettings(value: CcStage.MethodSettingProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcStage.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcStage.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            access_log_setting: ccStageAccessLogSettingPropertyToTerraform(this._accessLogSetting.internalValue),
            ...
            canary_setting: ccStageCanarySettingPropertyToTerraform(this._canarySetting.internalValue),
            ...
            method_settings: cdktn.listMapper(ccStageMethodSettingPropertyToTerraform, false)(this._methodSettings.internalValue),
            rest_api_id: cdktn.stringToTerraform(this._restApiId),
            stage_name: cdktn.stringToTerraform(this._stageName),
            tags: cdktn.listMapper(ccStageTagPropertyToTerraform, false)(this._tags.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            access_log_setting: {
                value: ccStageAccessLogSettingPropertyToHclTerraform(this._accessLogSetting.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcStage.AccessLogSettingProperty",
            },
            ...
            canary_setting: {
                value: ccStageCanarySettingPropertyToHclTerraform(this._canarySetting.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcStage.CanarySettingProperty",
            },
            ...
            method_settings: {
                value: cdktn.listMapperHcl(ccStageMethodSettingPropertyToHclTerraform, false)(this._methodSettings.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcStage.MethodSettingPropertyList",
            },
            rest_api_id: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccStageTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcStage.TagPropertyList",
            },
            tracing_enabled: {
...
export function ccStageAccessLogSettingPropertyToTerraform(struct?: CcStage.AccessLogSettingProperty | cdktn.IResolvable): any {
...
export function ccStageAccessLogSettingPropertyToHclTerraform(struct?: CcStage.AccessLogSettingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageCanarySettingPropertyToTerraform(struct?: CcStage.CanarySettingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageCanarySettingPropertyToHclTerraform(struct?: CcStage.CanarySettingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageMethodSettingPropertyToTerraform(struct?: CcStage.MethodSettingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageMethodSettingPropertyToHclTerraform(struct?: CcStage.MethodSettingProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageTagPropertyToTerraform(struct?: CcStage.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccStageTagPropertyToHclTerraform(struct?: CcStage.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcStage {
export interface AccessLogSettingProperty {
    /**
    * The Amazon Resource Name (ARN) of the CloudWatch Logs log group or Kinesis Data Firehose delivery stream to receive access logs. If you specify a Kinesis Data Firehose delivery stream, the stream name must begin with ``amazon-apigateway-``. This parameter is required to enable access logging.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#destination_arn CcStage#destination_arn}
    */
    readonly destinationArn?: string;
    /**
    * A single line format of the access logs of data, as specified by selected [$context variables](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#context-variable-reference). The format must include at least ``$context.requestId``. This parameter is required to enable access logging.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#format CcStage#format}
    */
...
export interface CanarySettingProperty {
    ...
    */
    readonly deploymentId?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#percent_traffic CcStage#percent_traffic}
    */
    readonly percentTraffic?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#stage_variable_overrides CcStage#stage_variable_overrides}
    */
    readonly stageVariableOverrides?: { [key: string]: string };
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#use_stage_cache CcStage#use_stage_cache}
    */
...
export interface MethodSettingProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#cache_data_encrypted CcStage#cache_data_encrypted}
    */
    readonly cacheDataEncrypted?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#cache_ttl_in_seconds CcStage#cache_ttl_in_seconds}
    */
    readonly cacheTtlInSeconds?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#caching_enabled CcStage#caching_enabled}
    */
    readonly cachingEnabled?: boolean | cdktn.IResolvable;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#data_trace_enabled CcStage#data_trace_enabled}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#http_method CcStage#http_method}
    */
    readonly httpMethod?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#logging_level CcStage#logging_level}
    */
    readonly loggingLevel?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#metrics_enabled CcStage#metrics_enabled}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#resource_path CcStage#resource_path}
    */
    readonly resourcePath?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#throttling_burst_limit CcStage#throttling_burst_limit}
    */
    readonly throttlingBurstLimit?: number;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#throttling_rate_limit CcStage#throttling_rate_limit}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#key CcStage#key}
    */
    readonly key?: string;
    /**
    * The value for the specified tag key.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/apigateway_stage#value CcStage#value}
    */
