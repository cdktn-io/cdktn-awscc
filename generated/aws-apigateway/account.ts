...
export interface CcAccountProps extends cdktn.TerraformMetaArguments {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_account#cloudwatch_role_arn CcAccount#cloudwatch_role_arn}
    */
...
export class CcAccount extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_account#import import section} in the documentation of this resource for the id to use
