...
export interface CcDomainNameAccessAssociationProps extends cdktn.TerraformMetaArguments {
    /**
    * The source of the domain name access association resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#access_association_source CcDomainNameAccessAssociation#access_association_source}
    */
    readonly accessAssociationSource: string;
    /**
    * The source type of the domain name access association resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#access_association_source_type CcDomainNameAccessAssociation#access_association_source_type}
    */
    readonly accessAssociationSourceType: string;
    /**
    * The amazon resource name (ARN) of the domain name resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#domain_name_arn CcDomainNameAccessAssociation#domain_name_arn}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#tags CcDomainNameAccessAssociation#tags}
    */
...
export class CcDomainNameAccessAssociation extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDomainNameAccessAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcDomainNameAccessAssociationProps
    */
    public constructor(scope: Construct, id: string, config: CcDomainNameAccessAssociationProps) {
        super(scope, id, {
    ...
    private _tags = new CcDomainNameAccessAssociation.TagPropertyList(this, "tags", false);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDomainNameAccessAssociation.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccDomainNameAccessAssociationTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDomainNameAccessAssociationTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDomainNameAccessAssociation.TagPropertyList",
            },
        };
...
export function ccDomainNameAccessAssociationTagPropertyToTerraform(struct?: CcDomainNameAccessAssociation.TagProperty | cdktn.IResolvable): any {
...
export function ccDomainNameAccessAssociationTagPropertyToHclTerraform(struct?: CcDomainNameAccessAssociation.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface TagProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#key CcDomainNameAccessAssociation#key}
    */
    readonly key?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/apigateway_domain_name_access_association#value CcDomainNameAccessAssociation#value}
    */
