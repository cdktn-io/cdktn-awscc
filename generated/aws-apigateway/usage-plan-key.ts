...
export interface CcUsagePlanKeyProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_usage_plan_key#key_id CcUsagePlanKey#key_id}
    */
    readonly keyId: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_usage_plan_key#key_type CcUsagePlanKey#key_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_usage_plan_key#usage_plan_id CcUsagePlanKey#usage_plan_id}
    */
...
export class CcUsagePlanKey extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUsagePlanKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.98.0/docs/resources/apigateway_usage_plan_key#import import section} in the documentation of this resource for the id to use
