...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment
...
export interface CcDeploymentProps extends cdktn.TerraformMetaArguments {
    ...
    * The application ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#application_id CcDeployment#application_id}
    */
    readonly applicationId: string;
    /**
    * The configuration profile ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#configuration_profile_id CcDeployment#configuration_profile_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#configuration_version CcDeployment#configuration_version}
    */
    readonly configurationVersion: string;
    /**
    * The deployment strategy ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#deployment_strategy_id CcDeployment#deployment_strategy_id}
    */
    readonly deploymentStrategyId: string;
    /**
    * A description of the deployment.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#description CcDeployment#description}
    */
    readonly description?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#dynamic_extension_parameters CcDeployment#dynamic_extension_parameters}
    */
    readonly dynamicExtensionParameters?: CcDeployment.DynamicExtensionParametersProperty[] | cdktn.IResolvable;
    /**
    * The environment ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#environment_id CcDeployment#environment_id}
    */
    readonly environmentId: string;
    /**
    * The AWS Key Management Service key identifier (key ID, key alias, or key ARN) provided when the resource was created or updated.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#kms_key_identifier CcDeployment#kms_key_identifier}
    */
    readonly kmsKeyIdentifier?: string;
    /**
    * An array of key-value pairs to apply to this resource.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#tags CcDeployment#tags}
    */
    readonly tags?: CcDeployment.TagProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment awscc_appconfig_deployment}
*/
export class CcDeployment extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment awscc_appconfig_deployment} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _dynamicExtensionParameters = new CcDeployment.DynamicExtensionParametersPropertyList(this, "dynamic_extension_parameters", false);
    public get dynamicExtensionParameters() {
        return this._dynamicExtensionParameters;
    }
    public putDynamicExtensionParameters(value: CcDeployment.DynamicExtensionParametersProperty[] | cdktn.IResolvable) {
    ...
    private _tags = new CcDeployment.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDeployment.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            dynamic_extension_parameters: cdktn.listMapper(ccDeploymentDynamicExtensionParametersPropertyToTerraform, false)(this._dynamicExtensionParameters.internalValue),
            ...
            tags: cdktn.listMapper(ccDeploymentTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            dynamic_extension_parameters: {
                value: cdktn.listMapperHcl(ccDeploymentDynamicExtensionParametersPropertyToHclTerraform, false)(this._dynamicExtensionParameters.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcDeployment.DynamicExtensionParametersPropertyList",
            },
            environment_id: {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDeploymentTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcDeployment.TagPropertyList",
            },
        };
...
export function ccDeploymentDynamicExtensionParametersPropertyToTerraform(struct?: CcDeployment.DynamicExtensionParametersProperty | cdktn.IResolvable): any {
...
export function ccDeploymentDynamicExtensionParametersPropertyToHclTerraform(struct?: CcDeployment.DynamicExtensionParametersProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface DynamicExtensionParametersProperty {
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#extension_reference CcDeployment#extension_reference}
    */
    readonly extensionReference?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#parameter_name CcDeployment#parameter_name}
    */
    readonly parameterName?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#parameter_value CcDeployment#parameter_value}
    */
    readonly parameterValue?: string;
}
export class DynamicExtensionParametersPropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): DynamicExtensionParametersProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: DynamicExtensionParametersProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class DynamicExtensionParametersPropertyList extends cdktn.ComplexList {
    public internalValue? : DynamicExtensionParametersProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): DynamicExtensionParametersPropertyOutputReference {
        return new DynamicExtensionParametersPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#key CcDeployment#key}
    */
    readonly key?: string;
    /**
    * The tag value can be up to 256 characters.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/appconfig_deployment#value CcDeployment#value}
    */
