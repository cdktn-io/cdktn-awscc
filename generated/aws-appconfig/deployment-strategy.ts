...
export interface CcDeploymentStrategyProps extends cdktn.TerraformMetaArguments {
    /**
    * Total amount of time for a deployment to last.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#deployment_duration_in_minutes CcDeploymentStrategy#deployment_duration_in_minutes}
    */
    readonly deploymentDurationInMinutes: number;
    /**
    * A description of the deployment strategy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#description CcDeploymentStrategy#description}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#final_bake_time_in_minutes CcDeploymentStrategy#final_bake_time_in_minutes}
    */
    readonly finalBakeTimeInMinutes?: number;
    /**
    * The percentage of targets to receive a deployed configuration during each interval.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#growth_factor CcDeploymentStrategy#growth_factor}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#growth_type CcDeploymentStrategy#growth_type}
    */
    readonly growthType?: string;
    /**
    * A name for the deployment strategy.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#name CcDeploymentStrategy#name}
    */
    readonly name: string;
    /**
    * Save the deployment strategy to a Systems Manager (SSM) document.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#replicate_to CcDeploymentStrategy#replicate_to}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#tags CcDeploymentStrategy#tags}
    */
...
export class CcDeploymentStrategy extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcDeploymentStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#import import section} in the documentation of this resource for the id to use
    ...
    * @param options CcDeploymentStrategyProps
    */
    public constructor(scope: Construct, id: string, config: CcDeploymentStrategyProps) {
        super(scope, id, {
    ...
    private _tags = new CcDeploymentStrategy.TagPropertyList(this, "tags", true);
    public get tags() {
        return this._tags;
    }
    public putTags(value: CcDeploymentStrategy.TagProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            tags: cdktn.listMapper(ccDeploymentStrategyTagPropertyToTerraform, false)(this._tags.internalValue),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            tags: {
                value: cdktn.listMapperHcl(ccDeploymentStrategyTagPropertyToHclTerraform, false)(this._tags.internalValue),
                isBlock: true,
                type: "set",
                storageClassType: "CcDeploymentStrategy.TagPropertyList",
            },
        };
...
export function ccDeploymentStrategyTagPropertyToTerraform(struct?: CcDeploymentStrategy.TagProperty | cdktn.IResolvable): any {
...
export function ccDeploymentStrategyTagPropertyToHclTerraform(struct?: CcDeploymentStrategy.TagProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export namespace CcDeploymentStrategy {
export interface TagProperty {
    /**
    * The key name of the tag. You can specify a value that is 1 to 128 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#key CcDeploymentStrategy#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/appconfig_deployment_strategy#value CcDeploymentStrategy#value}
    */
