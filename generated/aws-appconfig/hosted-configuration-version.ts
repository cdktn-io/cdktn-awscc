...
export interface CcHostedConfigurationVersionProps extends cdktn.TerraformMetaArguments {
    ...
    * The application ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#application_id CcHostedConfigurationVersion#application_id}
    */
    readonly applicationId: string;
    /**
    * The configuration profile ID.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#configuration_profile_id CcHostedConfigurationVersion#configuration_profile_id}
    */
    readonly configurationProfileId: string;
    /**
    * The content of the configuration or the configuration data.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#content CcHostedConfigurationVersion#content}
    */
    readonly content: string;
    /**
    * A standard MIME type describing the format of the configuration content.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#content_type CcHostedConfigurationVersion#content_type}
    */
    readonly contentType: string;
    /**
    * A description of the hosted configuration version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#description CcHostedConfigurationVersion#description}
    */
    readonly description?: string;
    /**
    * An optional locking token used to prevent race conditions from overwriting configuration updates when creating a new version. To ensure your data is not overwritten when creating multiple hosted configuration versions in rapid succession, specify the version number of the latest hosted configuration version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#latest_version_number CcHostedConfigurationVersion#latest_version_number}
    */
    readonly latestVersionNumber?: number;
    /**
    * A user-defined label for an AWS AppConfig hosted configuration version.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.99.0/docs/resources/appconfig_hosted_configuration_version#version_label CcHostedConfigurationVersion#version_label}
    */
