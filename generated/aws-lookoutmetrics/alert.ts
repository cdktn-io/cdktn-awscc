...
export interface CcAlertProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#action CcAlert#action}
    */
    readonly action: CcAlert.ActionProperty;
    /**
    * A description for the alert.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#alert_description CcAlert#alert_description}
    */
    readonly alertDescription?: string;
    /**
    * The name of the alert. If not provided, a name is generated automatically.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#alert_name CcAlert#alert_name}
    */
    readonly alertName?: string;
    /**
    * A number between 0 and 100 (inclusive) that tunes the sensitivity of the alert.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#alert_sensitivity_threshold CcAlert#alert_sensitivity_threshold}
    */
    readonly alertSensitivityThreshold: number;
    /**
    * The Amazon resource name (ARN) of the Anomaly Detector to alert.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#anomaly_detector_arn CcAlert#anomaly_detector_arn}
    */
...
export class CcAlert extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#import import section} in the documentation of this resource for the id to use
...
export interface LambdaConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#lambda_arn CcAlert#lambda_arn}
    */
    readonly lambdaArn?: string;
    /**
    * ARN of an IAM role that LookoutMetrics should assume to access the Lambda function.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#role_arn CcAlert#role_arn}
    */
...
export interface SNSConfigurationProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#sns_topic_arn CcAlert#sns_topic_arn}
    */
...
export interface ActionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#lambda_configuration CcAlert#lambda_configuration}
    */
    readonly lambdaConfiguration?: LambdaConfigurationProperty;
    /**
    * Configuration options for an SNS alert action.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/lookoutmetrics_alert#sns_configuration CcAlert#sns_configuration}
    */
