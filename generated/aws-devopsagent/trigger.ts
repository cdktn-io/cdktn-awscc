...
export interface CcTriggerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#action CcTrigger#action}
    */
    readonly action: string;
    /**
    * The unique identifier of the parent Agent Space.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#agent_space_id CcTrigger#agent_space_id}
    */
    readonly agentSpaceId: string;
    /**
    * The condition that causes the trigger to fire.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#condition CcTrigger#condition}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#status CcTrigger#status}
    */
    readonly status?: string;
    /**
    * The type of trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#type CcTrigger#type}
    */
...
export class CcTrigger extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#import import section} in the documentation of this resource for the id to use
...
export interface ScheduleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#expression CcTrigger#expression}
    */
...
export interface ConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_trigger#schedule CcTrigger#schedule}
    */
