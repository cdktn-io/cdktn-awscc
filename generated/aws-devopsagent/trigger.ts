...
export interface CcTriggerProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#action CcTrigger#action}
    */
    readonly action: string;
    /**
    * The unique identifier of the parent Agent Space.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#agent_space_id CcTrigger#agent_space_id}
    */
    readonly agentSpaceId: string;
    /**
    * The condition that causes the trigger to fire.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#condition CcTrigger#condition}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#status CcTrigger#status}
    */
    readonly status?: string;
    /**
    * The type of trigger.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#type CcTrigger#type}
    */
...
export class CcTrigger extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _condition = new CcTrigger.ConditionPropertyOutputReference(this, "condition");
    public get condition() {
        return this._condition;
    }
    public putCondition(value: CcTrigger.ConditionProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            condition: ccTriggerConditionPropertyToTerraform(this._condition.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            condition: {
                value: ccTriggerConditionPropertyToHclTerraform(this._condition.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcTrigger.ConditionProperty",
            },
            status: {
...
export function ccTriggerSchedulePropertyToTerraform(struct?: CcTrigger.ScheduleProperty | cdktn.IResolvable): any {
...
export function ccTriggerSchedulePropertyToHclTerraform(struct?: CcTrigger.ScheduleProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export function ccTriggerConditionPropertyToTerraform(struct?: CcTrigger.ConditionProperty | cdktn.IResolvable): any {
    ...
    return {
        schedule: ccTriggerSchedulePropertyToTerraform(struct!.schedule),
    }
}
...
export function ccTriggerConditionPropertyToHclTerraform(struct?: CcTrigger.ConditionProperty | cdktn.IResolvable): any {
    ...
    const attrs = {
        schedule: {
            value: ccTriggerSchedulePropertyToHclTerraform(struct!.schedule),
            isBlock: true,
            type: "struct",
...
export interface ScheduleProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#expression CcTrigger#expression}
    */
...
export interface ConditionProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/devopsagent_trigger#schedule CcTrigger#schedule}
    */
