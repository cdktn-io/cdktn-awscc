...
export interface CcAssetProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#agent_space_id CcAsset#agent_space_id}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#asset_type CcAsset#asset_type}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#files CcAsset#files}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#metadata CcAsset#metadata}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#zip CcAsset#zip}
    */
    readonly zip?: string;
}
...
export class CcAsset extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _files = new CcAsset.AssetFilePropertyList(this, "files", false);
    public get files() {
        return this._files;
    }
    public putFiles(value: CcAsset.AssetFileProperty[] | cdktn.IResolvable) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            files: cdktn.listMapper(ccAssetAssetFilePropertyToTerraform, false)(this._files.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            files: {
                value: cdktn.listMapperHcl(ccAssetAssetFilePropertyToHclTerraform, false)(this._files.internalValue),
                isBlock: true,
                type: "list",
                storageClassType: "CcAsset.AssetFilePropertyList",
            },
            metadata: {
...
export function ccAssetAssetFilePropertyToTerraform(struct?: CcAsset.AssetFileProperty | cdktn.IResolvable): any {
...
export function ccAssetAssetFilePropertyToHclTerraform(struct?: CcAsset.AssetFileProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface AssetFileProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#content_bytes CcAsset#content_bytes}
    */
    readonly contentBytes?: string;
    /**
    * UTF-8 text contents of the file. Mutually exclusive with ContentBytes (max 1.5 MiB).
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#content_text CcAsset#content_text}
    */
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/devopsagent_asset#path CcAsset#path}
    */
    readonly path?: string;
}
export class AssetFilePropertyOutputReference extends cdktn.ComplexObject {
    ...
    */
    ...
    public get internalValue(): AssetFileProperty | cdktn.IResolvable | undefined {
    ...
    public set internalValue(value: AssetFileProperty | cdktn.IResolvable | undefined) {
        if (value === undefined) {
...
export class AssetFilePropertyList extends cdktn.ComplexList {
    public internalValue? : AssetFileProperty[] | cdktn.IResolvable
    ...
    */
    public get(index: number): AssetFilePropertyOutputReference {
        return new AssetFilePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
    }
}
}
