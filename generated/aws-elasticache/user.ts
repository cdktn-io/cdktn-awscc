...
// https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user
...
export interface CcUserProps extends cdktn.TerraformMetaArguments {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#access_string CcUser#access_string}
    */
    readonly accessString?: string;
    /**
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#authentication_mode CcUser#authentication_mode}
    */
    readonly authenticationMode?: CcUser.AuthenticationModeProperty;
    /**
    * The target cache engine for the user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#engine CcUser#engine}
    */
    readonly engine: string;
    /**
    * Indicates a password is not required for this user account.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#no_password_required CcUser#no_password_required}
    */
    readonly noPasswordRequired?: boolean | cdktn.IResolvable;
    /**
    * Passwords used for this user account. You can create up to two passwords for each user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#passwords CcUser#passwords}
    */
    readonly passwords?: string[];
    /**
    * An array of key-value pairs to apply to this user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#tags CcUser#tags}
    */
    readonly tags?: CcUser.TagProperty[] | cdktn.IResolvable;
    /**
    * The ID of the user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#user_id CcUser#user_id}
    */
    readonly userId: string;
    /**
    * The username of the user.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#user_name CcUser#user_name}
    */
    readonly userName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user awscc_elasticache_user}
*/
export class CcUser extends cdktn.TerraformResource {
    ...
    * @param importFromId The id of the existing CcUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    /**
    * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user awscc_elasticache_user} Resource
    *
    * @param scope The scope in which to define this construct
    ...
    */
    ...
    private _authenticationMode = new CcUser.AuthenticationModePropertyOutputReference(this, "authentication_mode");
    public get authenticationMode() {
        return this._authenticationMode;
    }
    public putAuthenticationMode(value: CcUser.AuthenticationModeProperty) {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            authentication_mode: ccUserAuthenticationModePropertyToTerraform(this._authenticationMode.internalValue),
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            authentication_mode: {
                value: ccUserAuthenticationModePropertyToHclTerraform(this._authenticationMode.internalValue),
                isBlock: true,
                type: "struct",
                storageClassType: "CcUser.AuthenticationModeProperty",
            },
            engine: {
...
export function ccUserAuthenticationModePropertyToTerraform(struct?: CcUser.AuthenticationModeProperty | cdktn.IResolvable): any {
...
export function ccUserAuthenticationModePropertyToHclTerraform(struct?: CcUser.AuthenticationModeProperty | cdktn.IResolvable): any {
    if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
    if (cdktn.isComplexElement(struct)) {
        throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
    }
...
export interface AuthenticationModeProperty {
    ...
    * Authentication Type
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#type CcUser#type}
    */
...
export interface TagProperty {
    ...
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#key CcUser#key}
    */
    readonly key?: string;
    /**
    * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
    *
    * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/latest/docs/resources/elasticache_user#value CcUser#value}
    */
