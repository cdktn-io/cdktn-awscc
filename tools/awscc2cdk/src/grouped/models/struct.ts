...
export class Struct {
  constructor(
     ...
     * resource has been parsed and CFN definition names have been recovered — see
     * naming.ts#propertyTypeNamesForResource. Every other getter here reads `this.name` fresh,
